package com.sulake.habbo.catalog.club
{
    ...
    public class ClubBuyController
    {
        ...
        {
            var _loc1_: int = HabboClubLevelEnum.HC_LEVEL_NONE;
            if (this._catalog.getPurse().hasClubLeft)
            {
                _loc1_ = this._catalog.getPurse().isVIP ? HabboClubLevelEnum.HC_LEVEL_VIP : HabboClubLevelEnum.HC_LEVEL_HABBO_CLUB;
            }
