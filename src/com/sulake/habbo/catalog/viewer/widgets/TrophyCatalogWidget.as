package com.sulake.habbo.catalog.viewer.widgets
{
    ...
    public class TrophyCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
    {
        ...
        private static const var_2810: int = 0xFFCC00;
        private static const var_2811: int = 0xCCCCCC;
        private static const var_2812: int = 0xCC6600;

        private var var_2765: IBitmapWrapperWindow;
        private var var_2813: Map;
        private var var_2814: int = 0;
        private var var_2815: String = "g";
        ...
        {
            if (this.var_2813 != null)
            {
                this.var_2813.dispose();
            }
        ...
        override public function init(): Boolean
        {
            ...
            this.var_2765 = (window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow);
            ...
            for each (_loc3_ in page.offers)
            {
                ...
                if (this.var_2813.getValue(_loc5_) == null)
                {
                    this.var_2813.add(_loc5_, new Map());
                }

                _loc7_ = (this.var_2813.getValue(_loc5_) as Map);
                _loc7_.add(_loc6_, _loc3_);
            }

            _loc4_ = this.var_2813.getWithIndex(this.var_2814);
            if (_loc4_ != null)
            {
                _loc3_ = _loc4_.getValue(this.var_2815);
                if (_loc3_ == null)
                {
        ...
        {
            var _loc2_: Array = [];
            _loc2_.push(var_2810);
            _loc2_.push(var_2811);
            _loc2_.push(var_2812);
        ...
        private function onColourIndex(param1: CatalogWidgetColourIndexEvent): void
        {
            ...
            var _loc2_: Map = this.var_2813.getWithIndex(this.var_2814);
            if (_loc2_ != null)
            {
                _loc3_ = _loc2_.getValue(this.var_2815);
                if (_loc3_ == null)
                {
        ...
        private function onClickNext(param1: WindowMouseEvent): void
        {
            var _loc3_: Offer;
            this.var_2814++;
            if (this.var_2814 >= this.var_2813.length)
            {
                this.var_2814 = 0;
            }
        ...
        private function onClickPrev(param1: WindowMouseEvent): void
        {
            ...
            if (this.var_2814 < 0)
            {
                this.var_2814 = this.var_2813.length - 1;
            }
        ...
        {
            var _loc3_: Point;
            if (!window.disposed && this.var_2765 != null)
            {
                if (param1 == null)
                {
                ...
                _loc3_ = new Point((this.var_2765.width - param1.width) / 2, (this.var_2765.height - param1.height) / 2);
                this.var_2765.bitmap.copyPixels(param1, param1.rect, _loc3_, null, null, true);
