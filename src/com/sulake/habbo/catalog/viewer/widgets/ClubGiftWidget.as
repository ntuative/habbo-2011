    ...
    public class ClubGiftWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
    {
        ...
        private function updateInfo(): void
        {
            ...
            if (_loc5_)
            {
                ...
                _loc2_ = _loc7_ >= this.var_2732 ? "catalog.club_gift.past_club.long" : "catalog.club_gift.past_club";
                _loc3_ = _loc7_ % this.var_2732;
                _loc4_ = int(_loc7_ / this.var_2732);
            ...
            if (_loc6_)
            {
                _loc2_ = this._controller.purse.pastVipDays >= this.var_2732
                        ? "catalog.club_gift.past_vip.long"
                        : "catalog.club_gift.past_vip";
                _loc3_ = this._controller.purse.pastVipDays % this.var_2732;
                _loc4_ = int(this._controller.purse.pastVipDays / this.var_2732);
                this._controller.localization.registerParameter(_loc2_, "days", _loc3_.toString());
                this._controller.localization.registerParameter(_loc2_, "months", _loc4_.toString());
        ...
        private function createListItem(param1: Offer, param2: ClubGiftData): IWindow
        {
            ...
            if (!param2.isSelectable && _loc6_ > 0)
            {
                ...
                if (_loc6_ >= this.var_2732)
                {
                    _loc7_ = _loc7_ + ".long";
                }

                _loc12_ = _loc6_ % this.var_2732;
                _loc13_ = int(_loc6_ / this.var_2732);
            ...
            this.setText(_loc3_.findChildByName("months_required"), _loc7_.length > 0
                    ? this._controller.localization.getKey(_loc7_)
                    : "");
        ...
        private function showPreview(param1: Offer, param2: Rectangle): void
        {
            ...
            if (!this.var_2731)
            {
                this.var_2731 = (this.createWindow("club_gift_preview") as IWindowContainer);
            }
            ...
            var _loc5_: IBitmapWrapperWindow = this.var_2731.findChildByName("image") as IBitmapWrapperWindow;
            if (!_loc5_)
            {
                return;
            }
            ...
            this.var_2731.setGlobalPosition(_loc6_.subtract(new Point(this.var_2731.width / 2, this.var_2731.height / 2)));
            this.var_2731.visible = true;
            this.var_2731.activate();
        }
