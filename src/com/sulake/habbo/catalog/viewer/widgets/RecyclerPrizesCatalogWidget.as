package com.sulake.habbo.catalog.viewer.widgets
{
    ...
    public class RecyclerPrizesCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid
    {
        ...
        override public function init(): Boolean
        {
            ...
            this.var_2710 = this.recycler.getPrizeTable();
            ...
            if (this.var_2710.length > 0 && this.var_2710[0].prizes.length > 0)
            {
                this.select(this.var_2710[0].prizes[0] as IGridItem);
            }
        ...
        {
            var _loc2_: int;
            while (_loc2_ < this.var_2710.length)
            {
                this.createLevelItem(this.var_2710[_loc2_]);
                _loc2_++;
            }
        ...
        private function createLevelItem(param1: PrizeLevelContainer): void
        {
            ...
            var _loc2_: IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(this.var_2783) as IWindowContainer;
        ...
        private function createPrizeItem(param1: PrizeContainer, param2: IItemGridWindow): void
        {
            ...
            var _loc3_: IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(this.var_2728) as IWindowContainer;
