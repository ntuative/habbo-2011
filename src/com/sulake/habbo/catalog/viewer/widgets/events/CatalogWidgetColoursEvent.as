package com.sulake.habbo.catalog.viewer.widgets.events
{
    ...
    public class CatalogWidgetColoursEvent extends Event
    {
        ...
        public function CatalogWidgetColoursEvent(colours: Array, backgroundAssetName: String, colourAssetName: String, chosenColourAssetName: String, param5: Boolean = false, param6: Boolean = false)
        {
