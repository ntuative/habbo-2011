package com.sulake.habbo.catalog.viewer.widgets
{
    ...
    public class MarketPlaceCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
    {
        ...
        private const var_2743: int = 1;
        private const var_2744: int = 2;
        private const var_2745: int = 40;
        private const var_2746: int = 10;

        private var var_2747: Array = [];
        private var var_2748: MarketPlaceOfferData;
        private var _itemList: IItemListWindow;
        private var var_2749: IWindowContainer;
        private var var_2750: Timer;
        ...
        override public function dispose(): void
        {
            ...
            if (this.var_2749)
            {
                this.var_2749.dispose();
                this.var_2749 = null;
            }

            if (this.var_2750)
            {
                this.var_2750.removeEventListener(TimerEvent.TIMER, this.onPopulationTimer);
                this.var_2750 = null;
            }
        ...
        private function selectSearchCategory(param1: String): void
        {
            ...
            switch (param1)
            {
                ...
                case "search_by_activity":
                    _loc5_ = "marketplace_search_simple";
                    this.var_2747 = [3, 4, 5, 6];
                    break;
                case "search_advanced":
                    _loc5_ = "marketplace_search_advanced";
                    this.var_2747 = [1, 2, 3, 4, 5, 6];
                    break;
                default:
                    return;
            }
            ...
            if (_loc7_ != null)
            {
                _loc7_.populate(this.getSortKeys(this.var_2747));
                _loc7_.selection = 0;
            }
        ...
        {
            var _loc3_: XML;
            var _loc4_: IHabboWindowManager;
            ...
            if (!this.var_2749)
            {
                ...
                this.var_2749 = (_loc4_.buildFromXML(_loc3_) as IWindowContainer);
            }
            ...
            this.updateStatusDisplay(this.var_2744, _loc2_.length);
            if (!this.var_2750)
            {
                this.var_2750 = new Timer(25);
                this.var_2750.addEventListener(TimerEvent.TIMER, this.onPopulationTimer);
            }
        ...
        private function populateList(): Boolean
        {
            ...
            while (_loc1_ < 5)
            {
                if (this.var_2751 >= this._offers.length)
                {
                    return true;
                }

                this.addListItem(this._offers.getWithIndex(this.var_2751));
                this.var_2751++;
                _loc1_++;
            }
        ...
        private function addListItem(param1: MarketPlaceOfferData): void
        {
            ...
            var _loc11_: Point;
            if (!param1 || !this._itemList || !this.var_2749 || !this.marketPlace.localization)
            {
                return;
            }

            var _loc2_: IWindowContainer = this.var_2749.clone() as IWindowContainer;
        ...
        private function doSearch(): void
        {
            ...
            this.updateStatusDisplay(this.var_2743);
            var _loc1_: int = -1;
            var _loc2_: int = -1;
            var _loc3_: String = "";
            var _loc4_: int = 1;
            ...
            if (_loc6_ && _loc6_.selection >= 0 && _loc6_.selection < this.var_2747.length)
            {
                _loc4_ = this.var_2747[_loc6_.selection];
            }
                    ...
                    if (param1.type == WindowEvent.var_590)
                    {
                        ...
                        switch (_loc7_.name)
                        {
                            ...
                            case "max_price_input":
                                _loc8_ = this.var_2746;
                                break;
                            case "search_input":
                                _loc8_ = this.var_2745;
                                break;
                            default:
                                return;
                        }
            ...
            if (param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
            {
                switch (param2.name)
                {
                    case "back_button":
                        ...
                        return;
                    case "buy_button":
                        this.marketPlace.buyOffer(this.var_2748.offerId);
                        return;
                }
