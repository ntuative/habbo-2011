package com.sulake.habbo.catalog.viewer.widgets
{
    ...
    public class LocalizationCatalogWidget extends CatalogWidget implements ICatalogWidget 
    {
        ...
        private function onClickLink(param1:WindowMouseEvent):void
        {
            ...
            switch (page.layoutCode)
            {
                ...
                case "info_pixels":
                    ...
                    {
                        case "ctlg_text_5":
                            page.viewer.catalog.openInventoryCategory(InventoryCategory.var_253);
                            break;
                        case "ctlg_text_7":
                ...
                case "club1":
                    ...
                    {
                        case "ctlg_text_5":
                            page.viewer.catalog.openCatalogPage(CatalogPageName.var_159, true);
                            break;
                    };
                    return;
                case "club_buy":
        ...
        private function retrieveCatalogImage(param1:String):void
        {
            ...
            var _loc5_:String = this.var_2741[param1];
            ...
            _loc9_.addEventListener(AssetLoaderEvent.var_35, this.onCatalogImageReady);
        }
