    ...
    public class MarketPlaceOwnItemsCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
    {
        ...
        override public function init(): Boolean
        {
            ...
            if (_loc3_ != null)
            {
                ...
                if (_loc2_)
                {
                    this.var_2752.add(MarketPlaceOfferState.var_1656, _loc2_);
                }
            ...
            if (_loc3_ != null)
            {
                ...
                if (_loc2_)
                {
                    this.var_2752.add(MarketPlaceOfferState.var_776, _loc2_);
                }
            ...
            if (_loc3_ != null)
            {
                ...
                if (_loc2_)
                {
                    this.var_2752.add(MarketPlaceOfferState.var_1657, _loc2_);
                }
        ...
        private function updateList(param1: Map): void
        {
            ...
            this.updateStatusDisplay(this.var_2744, _loc6_.length);
            var _loc7_: int;
            while (_loc7_ < _loc6_.length)
            {
                _loc10_ = _loc6_[_loc7_];
                _loc11_ = (param1.getValue(_loc10_) as MarketPlaceOfferData);
                if (_loc11_.status == MarketPlaceOfferState.var_776)
                {
                    _loc5_++;
                }

                _loc4_ = this.var_2752.getValue(_loc11_.status);
                if (_loc4_)
                {
                    ...
                    if (!(!_loc12_ || _loc12_.disposed))
                    {
                        ...
                        if (_loc13_ != null)
                        {
                            _loc13_.text = this.marketPlace != null
                                    ? "$" + "{" + this.marketPlace.getNameLocalizationKey(_loc11_) + "}"
                                    : "";
                        }
                        ...
                        if (_loc14_ != null)
                        {
                            _loc14_.text = this.marketPlace != null
                                    ? "$" + "{" + this.marketPlace.getDescriptionLocalizationKey(_loc11_) + "}"
                                    : "";
                        }
                        ...
                        if (_loc11_.status == MarketPlaceOfferState.var_1656)
                        {
                        ...
                        if (_loc11_.status == MarketPlaceOfferState.var_1657)
                        {
