            ...
            for each (_loc2_ in page.offers)
            {
                ...
                switch (_loc4_.furnitureData.name)
                {
                    ...
                    case "wallpaper":
                        ...
                        {
                            Logger.log("[SpacesCatalogWidget] Could not find wallpaper pattern configuration! " + [
                                _loc2_.localizationId,
                                _loc4_.furnitureData.name
                            ]);
                        }
                    ...
                    case "landscape":
                        ...
                        {
                            Logger.log("[SpacesCatalogWidget] Could not find landscape pattern configuration! " + [
                                _loc2_.localizationId,
                                _loc4_.furnitureData.name
                            ]);
                        }
