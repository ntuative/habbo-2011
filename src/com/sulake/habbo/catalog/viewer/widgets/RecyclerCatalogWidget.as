package com.sulake.habbo.catalog.viewer.widgets
{
    ...
    public class RecyclerCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IRecyclerVisualization
    {
        ...
        private var var_2782: CatalogObjectMover;
        ...
        {
            if (this.var_2782 != null)
            {
                this.var_2782.dispose();
                this.var_2782 = null;
            }
        ...
        private function renderSlotGraphics(): void
        {
            ...
            _loc2_ = 1;
            while (_loc2_ <= RecyclerLogic.var_779)
            {
        ...
        public function updateSlots(): void
        {
            ...
            var _loc1_: int;
            while (_loc1_ < RecyclerLogic.var_779)
            {
        ...
        private function onMainContainerEvent(param1: WindowEvent, param2: IWindow): void
        {
            ...
            switch (param1.type)
            {
                ...
                case WindowMouseEvent.var_626:
                    if (this.var_2782 != null)
                    {
                        this.var_2782.onMainContainerEvent(param1, param2, _loc4_);
                    }
                ...
                case WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER:
                    if (this.var_2782 == null)
                    {
                        this.var_2782 = new CatalogObjectMover();
                        this.var_2782.mainContainer = window;
                        this.var_2782.roomEngine = _loc3_;
                    }
        ...
        private function onSlotMouseEvent(event: WindowEvent, target: IWindow): void
        {
            ...
            if (event.type == WindowMouseEvent.var_633)
            {
