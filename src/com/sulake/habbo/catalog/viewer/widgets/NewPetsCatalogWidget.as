package com.sulake.habbo.catalog.viewer.widgets
{
    ...
    public class NewPetsCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener 
    {
        ...
        private static const var_2753:int = 18;
        ...
        private var var_2758:Array = null;
        ...
        override public function init():Boolean
        {
            ...
            _loc1_.addEventListener(WindowEvent.var_590, this.onTextWindowEvent);
            ...
            this.var_2754 = this.getPetTypeIndexFromProduct(_loc2_.localizationId);
            if (this.var_2754 < 8)
            {
                return (false);
            };
            this.var_2756 = _loc2_.localizationId;
            this.updateAvailableBreeds(_loc2_.localizationId);
            if (((!(this.var_2758 == null)) && (this.var_2758.length > 0)))
            {
                this.var_2755 = this.var_2758[0];
            }
            else
            {
                this.var_2755 = -1;
            };
            this._offers.add(this.var_2754, _loc2_);
        ...
        private function initializeBreedSelection():void
        {
            ...
            if (this.var_2758 != null)
            {
                _loc1_ = [];
                _loc2_ = 0;
                while (((_loc2_ < var_2753) && (_loc2_ < this.var_2758.length)))
                {
                    _loc3_ = (page.viewer.catalog as HabboCatalog).roomEngine.getPetColor(this.var_2754, this.var_2758[_loc2_]);
                    if (_loc3_ != null)
                    {
        ...
        private function selectedBreed(param1:int):void
        {
            if (((!(this.var_2758 == null)) && (this.var_2758.length > 0)))
            {
                if (((param1 < 0) || (param1 > this.var_2758.length)))
                {
                    param1 = 0;
                };
                this.var_2755 = this.var_2758[param1];
                this.updateImage();
            };
        }
        ...
        private function getPetLocalization():String
        {
            ...
            if (((!(page == null)) && (!(page.viewer == null))))
            {
                ...
                {
                    return (_loc1_.localization.getKey(this.getRaceLocalizationKey(this.var_2754, this.var_2755), this.getRaceLocalizationKey(this.var_2754, this.var_2755)));
                };
            };
            return (this.getRaceLocalizationKey(this.var_2754, this.var_2755));
        }
        ...
        private function updateImage():void
        {
            ...
            if (((_loc1_ == null) || (this.var_2755 < 0)))
            {
                return;
            };
            var _loc2_:int = this.var_2754;
            var _loc3_:int = this.var_2755;
        ...
        private function getPurchaseParameters():String
        {
            ...
            var p:String = ((((this._name + String.fromCharCode(10)) + this.var_2755) + String.fromCharCode(10)) + this.addZeroPadding(color.toString(16).toUpperCase(), 6));
            return (p);
        }
