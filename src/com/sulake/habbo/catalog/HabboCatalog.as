package com.sulake.habbo.catalog
{
    ...
    public class HabboCatalog extends Component implements IHabboCatalog, IProductDataListener 
    {
        ...
        private var var_2851:RecyclerLogic;
        private var var_2852:IMarketPlace;
        ...
        private var var_2860:GiftWrappingConfiguration;
        private var var_2861:ClubGiftController;
        private var var_2862:ClubBuyController;
        ...
        override public function dispose():void
        {
            ...
            {
                this.var_2851.dispose();
                this.var_2851 = null;
            };
            this.var_2850 = null;
            this.var_2852 = null;
            if (this.var_2862 != null)
            {
                this.var_2862.dispose();
                this.var_2862 = null;
            };
            ...
            {
                this.var_2845.events.removeEventListener(RoomSessionEvent.var_94, this.onRoomSessionEvent);
                this.var_2845.events.removeEventListener(RoomSessionEvent.var_98, this.onRoomSessionEvent);
        ...
        public function showPurchaseConfirmation(param1:IPurchasableOffer, param2:int, param3:String="", param4:Boolean=true):void
        {
            ...
            if (((param1.priceInCredits > 0) && (param1.priceInCredits > this.var_2850.credits)))
            {
                this.showNotEnoughCreditsAlert();
                return;
            };
            if (((param1.priceInActivityPoints > 0) && (param1.priceInActivityPoints > this.var_2850.getActivityPointsForType(param1.activityPointType))))
            {
            ...
            else
            {
                ...
                {
                    this.var_2862.showConfirmation((param1 as ClubBuyOfferData), param2);
                };
            };
        }
        ...
        public function openCreditsHabblet():void
        {
            ...
            var _loc1_:* = (this.var_2063.getKey("client.credits.embed.enabled", "false") == "true");
            ...
            {
                _loc2_ = this.var_2063.getKey("link.format.credits", "/credits");
        ...
        {
            return (this.var_2847.getProductData(param1));
        }
        ...
        public function getFurnitureData(param1:int, param2:String):IFurnitureData
        {
            ...
            {
                _loc3_ = this.var_2847.getFloorItemData(param1);
            };
            if (param2 == ProductTypeEnum.var_113)
            {
                _loc3_ = this.var_2847.getWallItemData(param1);
            };
            return (_loc3_);
        }
        ...
        private function updatePurse():void
        {
            ...
            this._localization.registerParameter("catalog.purse.creditbalance", "balance", String(this.var_2850.credits));
            this._localization.registerParameter("catalog.purse.pixelbalance", "balance", String(this.var_2850.getActivityPointsForType(Purse.var_142)));
            var _loc1_:uint = HabboIconType.var_143;
            if (!this.var_2850.hasClubLeft)
            {
            ...
            else
            {
                ...
                this._localization.registerParameter(_loc2_, "days", String(this.var_2850.clubDays));
                this._localization.registerParameter(_loc2_, "months", String(this.var_2850.clubPeriods));
            };
        ...
        private function toggleCatalog(param1:Boolean=false):void
        {
            ...
            if (!this.var_2047)
            {
                if (!this.var_2847.loadProductData(this))
                {
                    return;
                };
                this.init();
            ...
            {
                this.var_2844.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.var_146, HabboToolbarIconEnum.CATALOGUE, this._mainContainer));
            };
            if (this.mainWindowVisible())
            {
                events.dispatchEvent(new Event(HabboCatalogTrackingEvent.HABBO_CATALOG_TRACKING_EVENT_OPEN));
                if (((!(this.var_2851 == null)) && (this.getCurrentLayoutCode() == "recycler")))
                {
                    this.var_2851.activate();
                };
            }
            else
            {
                ...
                if (((!(this.var_2851 == null)) && (this.getCurrentLayoutCode() == "recycler")))
                {
                    this.var_2851.cancel();
                };
            };
            this.setupInventoryForRecycler(((this.var_2851.active) && (this.mainWindowVisible())));
        }
        ...
        private function onRoomSessionEvent(param1:RoomSessionEvent):void
        {
            switch (param1.type)
            {
                case RoomSessionEvent.var_94:
                    this.var_2859 = param1.session.isPrivateRoom;
                    this.var_2846 = param1.session;
                    if (this.var_2851 != null)
                    {
                        this.var_2851.setRoomSessionActive(true);
                    };
                    return;
                case RoomSessionEvent.var_98:
                    ...
                    if (this.var_2851 != null)
                    {
                        this.var_2851.setRoomSessionActive(false);
                    };
                    return;
            };
        }
        ...
        {
            this.var_2851 = new RecyclerLogic(this, this._windowManager);
            this.getRecyclerPrizes();
        }

        private function createMarketPlace():void
        {
            if (this.var_2852 == null)
            {
                this.var_2852 = new MarketPlaceLogic(this, this._windowManager, this._roomEngine);
            };
        }

        private function createClubGiftController():void
        {
            if (this.var_2861 == null)
            {
                this.var_2861 = new ClubGiftController(this);
            };
        }
        ...
        private function createClubBuyController():void
        {
            if (this.var_2862 == null)
            {
                this.var_2862 = new ClubBuyController(this);
            };
        }
        ...
        private function onCreditBalance(param1:IMessageEvent):void
        {
            ...
            this.var_2850.credits = _loc3_.balance;
            this.updatePurse();
            ...
            events.dispatchEvent(new PurseEvent(PurseEvent.var_150, this.var_2850.credits));
        }
        ...
        private function onActivityPointNotification(param1:IMessageEvent):void
        {
            ...
            this.var_2850.activityPoints[_loc2_.type] = _loc2_.amount;
            this.updatePurse();
            ...
            if (_loc2_.type == Purse.var_142)
            {
                events.dispatchEvent(new PurseEvent(PurseEvent.var_152, _loc2_.amount));
            };
        }
        ...
        private function onActivityPoints(param1:IMessageEvent):void
        {
            ...
            this.var_2850.activityPoints = _loc2_.points;
            this.updatePurse();
            if (_loc2_.points[Purse.var_142] != null)
            {
                events.dispatchEvent(new PurseEvent(PurseEvent.var_152, _loc2_.points[Purse.var_142]));
            };
        }
        ...
        private function onSubscriptionInfo(param1:IMessageEvent):void
        {
            ...
            this.var_2850.clubDays = Math.max(0, _loc2_.daysToPeriodEnd);
            this.var_2850.clubPeriods = Math.max(0, _loc2_.periodsSubscribedAhead);
            this.var_2850.isVIP = _loc2_.isVIP;
            this.var_2850.pastClubDays = _loc2_.pastClubDays;
            this.var_2850.pastVipDays = _loc2_.pastVipDays;
            this.updatePurse();
        ...
        private function onClubGiftInfo(param1:ClubGiftInfoEvent):void
        {
            ...
            this.var_2861.setInfo(_loc2_.daysUntilNextGift, _loc2_.giftsAvailable, _loc2_.offers, _loc2_.giftData);
        }
        ...
        private function onRecyclerStatus(param1:IMessageEvent):void
        {
            ...
            if (((_loc2_ == null) || (this.var_2851 == null)))
            {
                return;
            };
            this.var_2851.setSystemStatus(_loc2_.recyclerStatus, _loc2_.recyclerTimeoutSeconds);
        }
        ...
        private function onRecyclerFinished(param1:IMessageEvent):void
        {
            ...
            this.var_2851.setFinished(_loc2_.recyclerFinishedStatus, _loc2_.prizeId);
        }
        ...
        private function onRecyclerPrizes(param1:IMessageEvent):void
        {
            ...
            this.var_2851.storePrizeTable(_loc2_.prizeLevels);
        }
        ...
        private function onMarketPlaceOwnOffers(param1:IMessageEvent):void
        {
            if (this.var_2852 != null)
            {
                this.var_2852.onOwnOffers(param1);
            };
        }
        ...
        private function onMarketPlaceBuyResult(param1:IMessageEvent):void
        {
            if (this.var_2852 != null)
            {
                this.var_2852.onBuyResult(param1);
            };
        }
        ...
        private function onMarketPlaceCancelResult(param1:IMessageEvent):void
        {
            if (this.var_2852 != null)
            {
                this.var_2852.onCancelResult(param1);
            };
        }
        ...
        private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent):void
        {
            ...
            this.var_2860 = new GiftWrappingConfiguration(param1);
        }
        ...
        private function onMarketplaceItemStats(param1:MarketplaceItemStatsEvent):void
        {
            ...
            this.var_2852.itemStats = _loc3_;
        }
        ...
        private function onMarketplaceConfiguration(param1:MarketplaceConfigurationEvent):void
        {
            ...
            this.var_2852.averagePricePeriod = _loc2_.averagePricePeriod;
        }
        ...
        private function noCreditsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:WindowEvent):void
        {
            ...
            {
                if (((ExternalInterface.available) && ("true" == this.var_2063.getKey("client.credits.embed.enabled"))))
                {
                    ExternalInterface.call("FlashExternalInterface.openHabblet", "credits");
                }
                else
                {
                    _loc3_ = this.var_2063.getKey("link.format.credits");
                    if (_loc3_ != "")
                    {
                        this._windowManager.alert("${catalog.alert.external.link.title}", "${catalog.alert.external.link.desc}", 0, this.onExternalLink);
        ...
        private function noPixelsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:WindowEvent):void
        {
            ...
            if (param2.type == WindowEvent.var_138)
            {
                _loc3_ = this.var_2063.getKey("link.format.pixels");
                if (_loc3_ != "")
                {
                    this._windowManager.alert("${catalog.alert.external.link.title}", "${catalog.alert.external.link.desc}", 0, this.onExternalLink);
                    HabboWebTools.navigateToURL(_loc3_, "habboMain");
        ...
        public function requestSelectedItemToMover(param1:IDragAndDropDoneReceiver, param2:Offer):void
        {
            var _loc4_:int;
            var _loc6_:Boolean;
            if (((!(this.var_2063.keyExists("catalog.drag_and_drop"))) || (!(this.var_2063.getKey("catalog.drag_and_drop") == "true"))))
            {
                return;
            };
            ...
            _loc6_ = this._roomEngine.var_485(-(param2.offerId), _loc4_, _loc3_.productClassId, _loc3_.extraParam.toString());
            if (_loc6_)
            {
        ...
        private function onObjectPlaced(param1:RoomEngineObjectPlacedEvent):void
        {
            ...
            if (((this.var_2864) && (param1.type == RoomEngineObjectEvent.var_141)))
            {
                ...
                if (_loc5_)
                {
                    _loc5_.getModelController().setNumber(RoomObjectVariableEnum.var_154, 0.5);
                };
            };
        }
