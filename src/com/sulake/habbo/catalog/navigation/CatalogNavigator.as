package com.sulake.habbo.catalog.navigation
{
    ...
    public class CatalogNavigator implements ICatalogNavigator 
    {
        ...
        private var var_2656:String = "magic.credits";
        private var var_2657:String = "magic.pixels";
        private var var_2658:String = "catalog.page.club";
        ...
        public function CatalogNavigator(param1:IHabboCatalog, param2:IWindowContainer)
        {
            ...
            this.var_2655 = [];
            this.var_2190 = (this._container.findChildByName("navigationList") as IItemListWindow);
            ...
            _loc3_.addEventListener(WindowMouseEvent.var_626, this.onNavigatorEvent);
            ...
            _loc4_.addEventListener(WindowMouseEvent.var_626, this.onNavigatorEvent);
            ...
            _loc5_.addEventListener(WindowMouseEvent.var_626, this.onNavigatorEvent);
        ...
        public function buildCatalogIndex(param1:NodeData):void
        {
            ...
            for each (_loc2_ in this._index.children)
            {
                ...
                {
                    (_loc2_ as CatalogNodeRenderable).addToList(this.var_2190);
                };
            };
        }
        ...
        public function activateNode(param1:ICatalogNode):void
        {
            ...
            var _loc7_:int;
            var _loc2_:* = (this.var_2655.indexOf(param1) > -1);
            var _loc3_:Boolean = param1.isOpen;
            var _loc4_:Array = [];
            for each (_loc5_ in this.var_2655)
            {
                _loc5_.deActivate();
            ...
            {
                _loc6_.close();
                _loc7_ = this.var_2655.indexOf(_loc6_);
                this.var_2655.splice(_loc7_, 1);
            };
            param1.activate();
            if (((_loc2_) && (_loc3_)))
            {
            ...
            if (this.var_2655.indexOf(param1) == -1)
            {
                this.var_2655.push(param1);
            };
        ...
        private function openNavigatorAtNode(param1:ICatalogNode):void
        {
            ...
            for each (_loc2_ in this.var_2655)
            {
                _loc2_.deActivate();
                _loc2_.close();
            };
        ...
        {
            this.openPage(this.var_2657);
        }

        private function openClubPage():void
        {
            this._catalog.openCatalogPage(this.var_2658, true);
        }
