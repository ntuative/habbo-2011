package com.sulake.habbo.catalog.navigation
{
    ...
    public class CatalogNodeRenderable extends CatalogNode 
    {
        ...
        private static var var_2662:XML;
        private static var var_2663:XML;

        private var var_2665:Number = 0xFFFFFFFF;
        private var _icon:BitmapData;
        private var _window:IWindowContainer;
        private var var_2666:IWindowContainer;
        ...
        public function addToList(param1:IItemListWindow):void
        {
            ...
            if (isBranch)
            {
                ...
                param1.addListItem(this.var_2190);
            };
        }
        ...
        public function removeFromList(param1:IItemListWindow):void
        {
            ...
            if (isBranch)
            {
                param1.removeListItem(this.var_2190);
            };
        }
        ...
        override public function activate():void
        {
            ...
            if (_loc1_ != null)
            {
                ...
                {
                    this.var_2665 = _loc1_.color;
                };
                _loc1_.color = var_2664;
            };
        }
        ...
        override public function open():void
        {
            ...
            if (isBranch)
            {
                ...
                if (_loc1_ != null)
                {
                    _loc1_.style = HabboIconType.var_654;
                };
            };
        }
        ...
        override public function close():void
        {
            ...
            if (isBranch)
            {
                ...
                if (_loc1_ != null)
                {
                    _loc1_.style = HabboIconType.var_652;
                };
            };
        }
        ...
        private function showChildren():void
        {
            ...
            for each (_loc1_ in children)
            {
                ...
                {
                    (_loc1_ as CatalogNodeRenderable).addToList(this.var_2190);
                };
            };
            if (this.var_2190 != null)
            {
                this.var_2190.visible = true;
                this.var_2190.height = (this.var_2190.numListItems * 21);
            };
        }
        ...
        private function removeChildren():void
        {
            ...
            for each (_loc1_ in children)
            {
                if (_loc1_.isNavigateable)
                {
                    (_loc1_ as CatalogNodeRenderable).removeFromList(this.var_2190);
                };
            };
            if (this.var_2190 != null)
            {
                this.var_2190.height = 0;
        ...
        {
            this.var_2190 = (navigator.catalog.windowManager.buildFromXML(var_2663) as IItemListWindow);
            if (this.var_2190 == null)
            {
        ...
        private function createWindow():void
        {
            if (depth == 1)
            {
                this._window = (navigator.catalog.windowManager.buildFromXML(var_2662) as IWindowContainer);
            }
            else
            {
        ...
        private function retrieveIconImage(param1:String):void
        {
            ...
            _loc5_.addEventListener(AssetLoaderEvent.var_35, this.onIconImageReady);
        }
