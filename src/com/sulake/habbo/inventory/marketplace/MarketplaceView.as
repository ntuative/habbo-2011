package com.sulake.habbo.inventory.marketplace
{
    ...
    public class MarketplaceView implements IGetImageListener 
    {
        ...
        private var var_2446:MarketplaceModel;
        private var _roomEngine:IRoomEngine;
        private var _localization:IHabboLocalizationManager;
        private var _config:IHabboConfigurationManager;
        private var _disposed:Boolean = false;
        private var var_3575:int;
        private var var_3576:int;
        private var var_3577:String;
        ...
        public function showMakeOffer(param1:IItem):void
        {
            ...
            if (((((!(param1)) || (!(this._localization))) || (!(this._roomEngine))) || (!(this.var_2446))))
            {
                return;
            };
            ...
            this.checkPrice();
            this._localization.registerParameter("inventory.marketplace.make_offer.expiration_info", "time", this.var_2446.expirationHours.toString());
            this._localization.registerParameter("inventory.marketplace.make_offer.min_price", "minprice", this.var_2446.offerMinPrice.toString());
            this._localization.registerParameter("inventory.marketplace.make_offer.max_price", "maxprice", this.var_2446.offerMaxPrice.toString());
            ...
            this.var_3575 = _loc4_.id;
            this.setFurniImage(_loc4_.data);
            var _loc5_:String = ("roomItem.name." + param1.type);
            var _loc6_:String = ("roomItem.desc." + param1.type);
            if (param1.category == FurniCategory.var_598)
            {
                _loc5_ = (("poster_" + param1.stuffData) + "_name");
                _loc6_ = (("poster_" + param1.stuffData) + "_desc");
            };
            this.var_3577 = this._localization.getKey(_loc5_);
        ...
        {
            this._localization.registerParameter("inventory.marketplace.confirm_offer.info", "furniname", this.var_3577);
            this._localization.registerParameter("inventory.marketplace.confirm_offer.info", "price", this.var_3576.toString());
        ...
        private function confirmationCallback(param1:IConfirmDialog, param2:WindowEvent):void
        {
            ...
            {
                this.var_2446.makeOffer(this.var_3576);
            };
            this.var_2446.releaseItem();
        }
            ...
            if (param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
            {
                switch (param2.name)
                {
                    case "buy_tokens_button":
                        this.var_2446.buyMarketplaceTokens();
                        this.disposeView();
                        break;
                    ...
                    case "make_offer_button":
                        ...
                        if (_loc3_ != null)
                        {
                            this.var_3576 = parseInt(_loc3_.text);
        ...
        private function checkPrice():void
        {
            ...
            if (_loc2_ > this.var_2446.offerMaxPrice)
            {
                _loc1_.text = this.var_2446.offerMaxPrice.toString();
                _loc2_ = this.var_2446.offerMaxPrice;
            };
            var _loc3_:int = Math.max(Math.ceil(((this.var_2446.commission * 0.01) * _loc2_)), 1);
            ...
            if (_loc2_ < this.var_2446.offerMinPrice)
            {
        ...
        {
            if ((((!(this._view)) || (!(this._localization))) || (!(this.var_2446))))
            {
                return;
            };
            ...
            var _loc4_:int = int(Math.floor((param1 / (1 + (this.var_2446.commission * 0.01)))));
