package com.sulake.habbo.inventory.effects
{
    ...
    public class EffectsModel implements IInventoryModel
    {
        ...
        private function getEffect(param1: int): Effect
        {
            var _loc3_: Effect;
            var _loc2_: int;
            while (_loc2_ < this.var_3192.length)
            {
                _loc3_ = this.var_3192[_loc2_];
        ...
        public function useEffect(param1: int): void
        {
            ...
            {
                _loc2_.isInUse = true;
                this._controller.communication.getHabboMainConnection(null)
                        .send(new AvatarEffectSelectedComposer(param1));
                this.refreshViews();
            }
        ...
        public function stopUsingEffect(param1: int, param2: Boolean = false): void
        {
            ...
            if (_loc3_ != null)
            {
                if (_loc3_.isInUse)
                {
                    ...
                    {
                        this._controller.communication.getHabboMainConnection(null)
                                .send(new AvatarEffectSelectedComposer(-1));
                    }
        ...
        public function stopUsingAllEffects(param1: Boolean = true, param2: Boolean = true): void
        {
            var _loc4_: Effect;
            var _loc3_: int;
            while (_loc3_ < this.var_3192.length)
            {
                _loc4_ = this.var_3192[_loc3_];
