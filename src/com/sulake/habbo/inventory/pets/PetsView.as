    ...
    public class PetsView implements IInventoryView, IPetImageListener, IGetImageListener 
    {
        ...
        public function addPet(param1:PetData):void
        {
            ...
            if (_loc2_ != null)
            {
                ...
                this.var_3581.add(param1.id, _loc2_);
        ...
        public function getPetImage(param1:int, param2:int, param3:String, param4:int, param5:Boolean):BitmapData
        {
            ...
            if (param1 < 8)
            {
                ...
                _loc8_ = this._avatarRenderer.createPetImage(param1, param2, _loc7_, AvatarScaleType.var_106, this);
                if (_loc8_ != null)
                {
                    _loc8_.setDirection(AvatarSetType.var_136, param4);
                    if (param5)
                    {
                        _loc6_ = _loc8_.getCroppedImage(AvatarSetType.var_136);
                    }
                    else
                    {
