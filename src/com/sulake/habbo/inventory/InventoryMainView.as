package com.sulake.habbo.inventory
{
    ...
    public class InventoryMainView
    {
        ...
        public function showInventory(): void
        {
            ...
            {
                this.var_2844.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.HTSME_ANIMATE_MENU_IN, HabboToolbarIconEnum.INVENTORY, _loc1_ as IWindowContainer));
                this.var_2464 = false;
            }
        ...
        public function toggleCategoryView(param1: String, param2: Boolean = true): void
        {
            ...
            else
            {
                ...
                if (this.var_2844 != null && this.var_2464)
                {
                    this.var_2844.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.HTSME_ANIMATE_MENU_IN, HabboToolbarIconEnum.INVENTORY, _loc3_ as IWindowContainer));
                    this.var_2464 = false;
                }
        ...
        private function onHabboToolbarEvent(param1: HabboToolbarEvent): void
        {
            ...
            {
                if (this.var_3606 == InventoryCategory.PETS)
                {
                    this.toggleCategoryView(InventoryCategory.PETS);
                }
                else
                {
                    if (this.var_3606 == InventoryCategory.FURNI)
                    {
