package com.sulake.habbo.inventory.furni
{
    ...
    public class FurniModel implements IInventoryModel
    {
        ...
        public function FurniModel(param1: HabboInventory, param2: MarketplaceModel, param3: IHabboWindowManager, param4: IHabboCommunicationManager, param5: IAssetLibrary, param6: IRoomEngine, param7: IHabboCatalog, param8: IHabboSoundManager)
        {
            ...
            this._view.switchCategory(FLOOR);
        }
        ...
        public function insertFurniList(param1: String, param2: Array, param3: int, param4: int): void
        {
            ...
            this._controller.setInventoryCategoryInit(InventoryCategory.FURNI);
            var _loc7_: Array = [];
            var _loc8_: Array = [];
            var _loc9_: Array = [];
            var _loc10_: Array = [];
            ...
            if (this.getSelectedItemIndex(FurniModel.FLOOR) == -1)
            {
                this.toggleItemSelection(FurniModel.FLOOR, 0);
            }

            if (this.getSelectedItemIndex(FurniModel.WALL) == -1)
            {
                this.toggleItemSelection(FurniModel.WALL, 0);
            }
        ...
        {
            if (param1 == InventoryCategory.FURNI && this._controller.isVisible)
            {
                switch (this._view.visibleCategoryId)
                {
                    ...
                    case WALL:
                        ...
                        return;
                    case PET:
                        this._controller.toggleInventoryPage(InventoryCategory.PETS);
                        return;
                }
        ...
        public function clearFurniList(): void
        {
            ...
            this.var_2678.add(FLOOR, []);
            this.var_2678.add(WALL, []);
            if (this._view != null)
            {
        ...
        public function updatePostItCount(param1: int, param2: int): void
        {
            var _loc5_: GroupItem;
            var _loc6_: WallItem;
            var _loc3_: Array = this.getCategoryContent(WALL);
            if (_loc3_ == null)
            {
                return;
            }
        ...
        {
            return this._controller.getSubCategoryViewId() == InventorySubCategory.TRADING;
        }
