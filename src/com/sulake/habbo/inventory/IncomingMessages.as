package com.sulake.habbo.inventory
{
    ...
    public class IncomingMessages
    {
        ...
        public function onFurniListUpdate(param1: IMessageEvent): void
        {
            ...
            this._inventory.setInventoryCategoryInit(InventoryCategory.FURNI, false);
        }
        ...
        public function onAvatarEffects(param1: IMessageEvent): void
        {
            ...
            this._inventory.setInventoryCategoryInit(InventoryCategory.EFFECTS);
            _loc2_.refreshViews();
        ...
        public function onBadges(param1: IMessageEvent): void
        {
            ...
            _loc3_.updateView();
            this._inventory.setInventoryCategoryInit(InventoryCategory.BADGES);
        }
        ...
        private function onTradingItemList(param1: IMessageEvent): void
        {
            ...
            while (_loc10_ < _loc5_)
            {
                ...
                if (_loc9_.itemType == "S")
                {
                    if (_loc6_ == null)
                    {
                        _loc6_ = _loc11_.createNewGroupItemTemplate(_loc7_, FurniModel.FLOOR, _loc9_.category, _loc9_.stuffData);
                ...
                else
                {
                    if (_loc9_.itemType == "I")
                    {
                        if (_loc6_ == null)
                        {
                            _loc6_ = _loc11_.createNewGroupItemTemplate(_loc7_, FurniModel.WALL, _loc9_.category, _loc9_.stuffData);
                            _loc3_.add(_loc8_, _loc6_);
                        }
        ...
        private function onPets(param1: PetInventoryEvent): void
        {
            ...
            this._inventory.setInventoryCategoryInit(InventoryCategory.PETS);
        ...
        private function onMarketplaceConfiguration(param1: MarketplaceConfigurationEvent): void
        {
            ...
            this._inventory.setInventoryCategoryInit(InventoryCategory.MARKETPLACE);
        ...
        private function onUserRights(param1: IMessageEvent): void
        {
            ...
            if (this._inventory.isInventoryCategoryInit(InventoryCategory.MARKETPLACE))
            {
