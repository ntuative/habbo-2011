package com.sulake.habbo.widget.doorbell
{
    ...
    public class DoorbellWidget extends RoomWidgetBase 
    {
        ...
        private static const var_1362:int = 50;
        ...
        override public function registerUpdateEvents(param1:IEventDispatcher):void
        {
            ...
            param1.addEventListener(RoomWidgetDoorbellEvent.var_1361, this.onDoorbellRinging);
            param1.addEventListener(RoomWidgetDoorbellEvent.var_369, this.onDoorbellHandled);
            param1.addEventListener(RoomWidgetDoorbellEvent.var_370, this.onDoorbellHandled);
        ...
        override public function unregisterUpdateEvents(param1:IEventDispatcher):void
        {
            ...
            param1.removeEventListener(RoomWidgetDoorbellEvent.var_1361, this.onDoorbellRinging);
            param1.removeEventListener(RoomWidgetDoorbellEvent.var_369, this.onDoorbellHandled);
            param1.removeEventListener(RoomWidgetDoorbellEvent.var_370, this.onDoorbellHandled);
        }
        ...
        public function addUser(param1:String):void
        {
            ...
            if (this._users.length >= var_1362)
            {
                this.deny(param1);
                return;
            };
