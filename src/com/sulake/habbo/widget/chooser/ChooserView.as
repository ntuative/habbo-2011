package com.sulake.habbo.widget.chooser
{
    ...
    public class ChooserView
    {
        ...
        private const var_2694: uint = 0;
        private const var_4690: uint = 4282169599;
        ...
        public function populate(param1: Array, param2: Boolean): void
        {
            ...
            while (_loc6_ < param1.length)
            {
                ...
                if (_loc4_ != null)
                {
                    ...
                    _loc5_.color = _loc6_ % 2 ? this.var_2694 : this.var_2693;
        ...
        private function highlightItem(param1: int): void
        {
            ...
            if (this._itemList == null || param1 < 0 || param1 > this._itemList.numListItems || param1 == this.var_4689)
            {
                return;
            }
            ...
            if (this.var_4689 != -1)
            {
                _loc2_ = (this._itemList.getListItemAt(this.var_4689) as IWindowContainer);
                if (_loc2_ != null)
                {
                    _loc2_.color = this.var_4689 % 2 ? this.var_2694 : this.var_2693;
                }
            ...
            if (_loc2_ != null)
            {
                _loc2_.color = this.var_4690;
                this.var_4689 = param1;
            }
        ...
        public function removeItem(param1: int, param2: int): void
        {
            ...
            this.populate(this._items, this.var_4688);
        }
