package com.sulake.habbo.widget.avatarinfo
{
    ...
    public class AvatarInfoWidget extends RoomWidgetBase implements IUpdateReceiver
    {
        ...
        override public function registerUpdateEvents(param1: IEventDispatcher): void
        {
            ...
            param1.addEventListener(RoomWidgetUserInfoUpdateEvent.RWUIUE_PEER, this.updateEventHandler);
            param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.RWROUE_OBJECT_DESELECTED, this.updateEventHandler);
        ...
        override public function unregisterUpdateEvents(param1: IEventDispatcher): void
        {
            ...
            param1.removeEventListener(RoomWidgetUserInfoUpdateEvent.RWUIUE_PEER, this.updateEventHandler);
            param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.RWROUE_OBJECT_DESELECTED, this.updateEventHandler);
        ...
        private function updateEventHandler(param1: RoomWidgetUpdateEvent): void
        {
            ...
            switch (param1.type)
            {
                ...
                case RoomWidgetUserInfoUpdateEvent.RWUIUE_PEER:
                    ...
                    this.updateView(_loc3_.webID, _loc3_.name, _loc3_.userRoomId, RoomObjectTypeEnum.var_1262, false, _loc3_.isSpectatorMode
                            ? null
                            : this.var_4665);
                    break;
