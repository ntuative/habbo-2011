package com.sulake.habbo.widget.infostand
{
    ...
    public class InfoStandBotView extends InfoStandUserView 
    {
        ...
        override protected function createWindow(param1:String, param2:Boolean):void
        {
            ...
            _loc3_ = (var_4783.getListItemByName("score_spacer") as ITextWindow);
            var_4783.removeListItem(_loc3_);
            _loc3_ = (var_4783.getListItemByName("score_text") as ITextWindow);
            var_4783.removeListItem(_loc3_);
            _loc3_ = (var_4783.getListItemByName("score_value") as ITextWindow);
            var_4783.removeListItem(_loc3_);
        }
        ...
        override protected function updateButtons(param1:RoomWidgetUserInfoUpdateEvent):void
        {
            ...
            var_4784.visible = param1.canBeKicked;
        }
        ...
        override protected function onButtonClicked(param1:WindowMouseEvent):void
        {
            ...
            if (_loc2_.name == "kick")
            {
                ...
                _widget.messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.var_1850, _loc3_));
            };
        }
