package com.sulake.habbo.widget.infostand
{
    ...
    public class InfoStandJukeboxView extends InfoStandFurniView
    {
        ...
        override protected function createWindow(param1: String): void
        {
            ...
            var_4785 = (_window.getListItemByName("info_border") as IBorderWindow);
            _buttons = (_window.getListItemByName("button_list") as IItemListWindow);
            if (var_4785 != null)
            {
                var_4783 = (var_4785.findChildByName("infostand_element_list") as IItemListWindow);
            }

            _window.name = param1;
            _widget.mainContainer.addChild(_window);
            var _loc3_: IWindow = var_4785.findChildByTag("close");
            if (_loc3_ != null)
            {
            ...
            var_4786 = var_4785.findChildByTag("catalog");
            if (var_4786 != null)
            {
                var_4786.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK, onCatalogButtonClicked);
            }

            var _loc7_: IBitmapWrapperWindow = var_4785.findChildByName("icon_disc") as IBitmapWrapperWindow;
            if (_loc7_ != null)
            {
            ...
            var _loc8_: IBitmapWrapperWindow = var_4785.findChildByName("icon_composer") as IBitmapWrapperWindow;
            if (_loc8_ != null)
            {
        ...
        {
            var _loc2_: IWindowContainer = var_4783.getListItemByName("trackname_container") as IWindowContainer;
            if (_loc2_ == null)
            {
                return;
            }
        ...
        {
            var _loc2_: IWindowContainer = var_4783.getListItemByName("creatorname_container") as IWindowContainer;
            if (_loc2_ == null)
            {
                return;
            }
        ...
        {
            if (param1.type == RoomWidgetSongUpdateEvent.var_1344)
            {
                this.var_2941 = param1.songId;
            }

            if (param1.songId == this.var_2941)
            {
                this._songName = param1.songName;
                this.var_4716 = param1.songAuthor;
                this.updateNowPlaying(this.var_2941 >= 0);
            }
        ...
        {
            var _loc3_: String;
            var _loc2_: ITextWindow = var_4783.getListItemByName("now_playing_text") as ITextWindow;
            if (_loc2_ != null)
            {
                if (param1)
                {
            ...
            if (param1)
            {
                ...
                this.nowPlayingAuthorName = this.var_4716;
            }
            else
            {
