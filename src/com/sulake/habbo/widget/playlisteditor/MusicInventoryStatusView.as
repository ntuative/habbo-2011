package com.sulake.habbo.widget.playlisteditor
{
    ...
    public class MusicInventoryStatusView 
    {
        ...
        public static const var_1807:String = "MISV_BUY_MORE";
        public static const var_1806:String = "MISV_PREVIEW_PLAYING";

        private var _container:IWindowContainer;
        private var var_4887:Map = new Map();
        private var _widget:PlayListEditorWidget;
        private var var_3495:String;
        private var var_4888:ITextWindow;
        private var var_4889:ITextWindow;
        ...
        public function destroy():void
        {
            ...
            for each (_loc1_ in this.var_4887.getValues())
            {
                _loc1_.destroy();
            };
            this.var_4887 = null;
        ...
        public function selectView(param1:String):void
        {
            ...
            this._container.addChildAt((this.var_4887[param1] as IWindowContainer), 0);
            this.var_3495 = param1;
        }

        public function set songName(param1:String):void
        {
            if (this.var_4888 == null)
            {
                return;
            };
            this.var_4888.text = param1;
        }
        ...
        public function set authorName(param1:String):void
        {
            ...
            this.var_4889.text = param1;
        }

        public function setPreviewPlayingBackgroundImage(param1:BitmapData, param2:Boolean=true):void
        {
            this.blitBackgroundImage(var_1806, "preview_play_background_image", param1);
        ...
        {
            this.blitBackgroundImage(var_1807, "get_more_music_background_image", param1);
            if (((param2) && (!(param1 == null))))
            {
                param1.dispose();
            };
        ...
        private function createWindows():void
        {
            ...
            if (_loc1_ != null)
            {
                this.var_4887.add(var_1806, _loc1_);
                this.var_4888 = (_loc1_.getChildByName("preview_play_track_name") as ITextWindow);
                this.var_4889 = (_loc1_.getChildByName("preview_play_author_name") as ITextWindow);
                ...
                this.setPreviewPlayingBackgroundImage(this._widget.getImageGalleryAssetBitmap(PlayListEditorWidgetAssetsEnum.var_1800));
            ...
            if (_loc1_ != null)
            {
                this.var_4887.add(var_1807, _loc1_);
                ...
                this.setGetMoreMusicBackgroundImage(this._widget.getImageGalleryAssetBitmap(PlayListEditorWidgetAssetsEnum.var_1801));
            };
        }
        ...
        private function blitBackgroundImage(param1:String, param2:String, param3:BitmapData):void
        {
            ...
            var _loc4_:IWindowContainer = (this.var_4887[param1] as IWindowContainer);
            if (_loc4_ == null)
            {
                return;
            };
