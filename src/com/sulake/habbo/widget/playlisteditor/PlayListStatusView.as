package com.sulake.habbo.widget.playlisteditor
{
    ...
    public class PlayListStatusView
    {
        ...
        public static const var_1805: String = "PLSV_ADD_SONGS";
        public static const var_1804: String = "PLSV_START_PLAYBACK";
        public static const var_1803: String = "PLSV_NOW_PLAYING";
        ...
        {
            if (this.var_3495 != var_1803)
            {
                return;
            }

            var _loc2_: IWindowContainer = this.var_4887[this.var_3495];
        ...
        public function set addSongsBackgroundImage(param1: BitmapData): void
        {
            ...
            var _loc2_: IWindowContainer = this.var_4887[var_1805];
            if (_loc2_ == null)
            {
                return;
            }
        ...
        private function createWindows(): void
        {
            ...
            if (_loc1_ != null)
            {
                this.var_4887.add(var_1805, _loc1_);
            }
            ...
            if (_loc1_ != null)
            {
                this.var_4887.add(var_1804, _loc1_);
            ...
            if (_loc1_ != null)
            {
                this.var_4887.add(var_1803, _loc1_);
