package com.sulake.habbo.widget.playlisteditor
{
    ...
    public class MainWindowHandler
    {
        ...
        public function MainWindowHandler(param1: PlayListEditorWidget, param2: IHabboMusicController)
        {
            ...
            var _loc3_: Array = [
                PlayListEditorWidgetAssetsEnum.var_1798,
                PlayListEditorWidgetAssetsEnum.var_1799,
                PlayListEditorWidgetAssetsEnum.var_1800,
                PlayListEditorWidgetAssetsEnum.var_1801,
                PlayListEditorWidgetAssetsEnum.var_1802
            ];
