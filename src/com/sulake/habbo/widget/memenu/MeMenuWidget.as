package com.sulake.habbo.widget.memenu
{
    ...
    public class MeMenuWidget extends RoomWidgetBase
    {
        ...
        override public function registerUpdateEvents(param1: IEventDispatcher): void
        {
            ...
            param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.RWROUE_OBJECT_DESELECTED, this.onAvatarDeselected);
        ...
        override public function unregisterUpdateEvents(param1: IEventDispatcher): void
        {
            ...
            param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.RWROUE_OBJECT_DESELECTED, this.onAvatarDeselected);
        ...
        private function onTutorialEvent(param1: RoomWidgetTutorialEvent): void
        {
            switch (param1.type)
            {
                case RoomWidgetTutorialEvent.var_1307:
                    ...
                    if (!this.var_3542 || this.var_3495.window.name != var_1291)
                    {
                        return;
                    }
                    ;
        ...
        private function onHabboClubEvent(param1: RoomWidgetHabboClubUpdateEvent): void
        {
            ...
            this.var_4849 = param1.allowClubDances;
