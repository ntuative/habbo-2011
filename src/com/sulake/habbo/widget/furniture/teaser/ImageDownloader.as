package com.sulake.habbo.widget.furniture.teaser
{
    ...
    public class ImageDownloader implements IDisposable
    {
        ...
        public function dispose(): void
        {
            ...
            if (this.var_2103)
            {
                this.var_2103.removeEventListener(AssetLoaderEvent.ASSET_LOADER_EVENT_COMPLETE, this.onImageReady);
            }
        ...
        public function downloadImage(param1: String, param2: String): void
        {
            ...
            if (_loc3_ != null)
            {
                ...
                this.var_2103.addEventListener(AssetLoaderEvent.ASSET_LOADER_EVENT_COMPLETE, this.onImageReady);
            }
