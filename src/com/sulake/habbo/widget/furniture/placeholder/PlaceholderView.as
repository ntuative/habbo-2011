package com.sulake.habbo.widget.furniture.placeholder
{
    ...
    public class PlaceholderView 
    {
        ...
        private function createWindow():void
        {
            ...
            this._window = (this._windowManager.createWindow("habbohelp_window", "", HabboWindowType.var_182, HabboWindowStyle.var_156, (HabboWindowParam.var_526 | HabboWindowParam.var_157), new Rectangle(-300, 300, 10, 10), null) as IWindowContainer);
