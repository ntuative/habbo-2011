package com.sulake.habbo.widget.furniture.ecotronbox
{
    ...
    public class EcotronBoxFurniWidget extends RoomWidgetBase 
    {
        ...
        override public function registerUpdateEvents(param1:IEventDispatcher):void
        {
            ...
            param1.addEventListener(RoomWidgetEcotronBoxDataUpdateEvent.var_1274, this.onObjectUpdate);
            param1.addEventListener(RoomWidgetEcotronBoxDataUpdateEvent.var_1275, this.onObjectUpdate);
            param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.var_1280, this.onRoomObjectRemoved);
            param1.addEventListener(RoomWidgetPresentDataUpdateEvent.var_1274, this.onPresentUpdate);
        ...
        override public function unregisterUpdateEvents(param1:IEventDispatcher):void
        {
            ...
            param1.removeEventListener(RoomWidgetEcotronBoxDataUpdateEvent.var_1274, this.onObjectUpdate);
            param1.removeEventListener(RoomWidgetEcotronBoxDataUpdateEvent.var_1275, this.onObjectUpdate);
            param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.var_1274, this.onPresentUpdate);
        ...
        private function onObjectUpdate(param1:RoomWidgetEcotronBoxDataUpdateEvent):void
        {
            ...
            switch (param1.type)
            {
                case RoomWidgetEcotronBoxDataUpdateEvent.var_1274:
                    ...
                    this.showInterface();
                    return;
                case RoomWidgetEcotronBoxDataUpdateEvent.var_1275:
                    if (!this.var_4752)
                    {
                        return;
                    };
        ...
        private function showInterface():void
        {
            ...
            this._window = (windowManager.createWindow("ecotronboxcardui_container", "", HabboWindowType.var_182, HabboWindowStyle.var_525, (HabboWindowParam.var_526 | HabboWindowParam.var_157), new Rectangle(var_1359, WINDOW_INITIAL_Y, 2, 2), null, 0) as IWindowContainer);
        ...
        private function sendOpen():void
        {
            ...
            {
                _loc1_ = new RoomWidgetEcotronBoxOpenMessage(RoomWidgetEcotronBoxOpenMessage.var_1370, this.var_2358);
