package com.sulake.habbo.widget.furniture.trophy
{
    ...
    public class TrophyFurniWidget extends RoomWidgetBase 
    {
        ...
        private static const var_1290:Array = new Array("trophy_bg_gold", "trophy_bg_silver", "trophy_bg_bronze");
        private static const var_1289:Array = new Array(4293707079, 4291411404, 4290279476);
        ...
        override public function registerUpdateEvents(param1:IEventDispatcher):void
        {
            ...
            param1.addEventListener(RoomWidgetTrophyDataUpdateEvent.var_1288, this.onObjectUpdate);
        ...
        override public function unregisterUpdateEvents(param1:IEventDispatcher):void
        {
            ...
            param1.removeEventListener(RoomWidgetTrophyDataUpdateEvent.var_1288, this.onObjectUpdate);
        }
        ...
        private function showInterface():void
        {
            ...
            if (_loc4_ != null)
            {
                _loc4_.color = var_1289[this._color];
            };
            ...
            _loc8_ = (assets.getAssetByName(var_1290[this._color]) as BitmapDataAsset);
