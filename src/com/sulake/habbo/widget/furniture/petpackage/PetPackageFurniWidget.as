package com.sulake.habbo.widget.furniture.petpackage
{
    ...
    public class PetPackageFurniWidget extends RoomWidgetBase
    {
        ...
        private var var_4753: BitmapData;
        private var var_4754: Boolean = false;
        ...
        override public function registerUpdateEvents(param1: IEventDispatcher): void
        {
            ...
            param1.addEventListener(RoomWidgetPetPackageUpdateEvent.var_1347, this.onObjectUpdate);
            param1.addEventListener(RoomWidgetPetPackageUpdateEvent.var_1348, this.onObjectUpdate);
            param1.addEventListener(RoomWidgetPetPackageUpdateEvent.var_1349, this.onObjectUpdate);
        ...
        override public function unregisterUpdateEvents(param1: IEventDispatcher): void
        {
            ...
            param1.removeEventListener(RoomWidgetPetPackageUpdateEvent.var_1347, this.onObjectUpdate);
            param1.removeEventListener(RoomWidgetPetPackageUpdateEvent.var_1348, this.onObjectUpdate);
            param1.removeEventListener(RoomWidgetPetPackageUpdateEvent.var_1349, this.onObjectUpdate);
        ...
        private function onObjectUpdate(event: RoomWidgetPetPackageUpdateEvent): void
        {
            ...
            switch (event.type)
            {
                case RoomWidgetPetPackageUpdateEvent.var_1347:
                    this.hideInterface();
                    this.var_2358 = event.objectId;
                    this.var_4753 = event.image;
                    this.showInterface();
                    this.showPetImage();
                    return;
                case RoomWidgetPetPackageUpdateEvent.var_1348:
                    if (!this.var_4754)
                    {
                        return;
                    }
                    ...
                    return;
                case RoomWidgetPetPackageUpdateEvent.var_1349:
                    if (event.objectId != this.var_2358)
                    {
                        return;
                    }
        ...
        {
            var _loc2_: Point;
            if (this.var_4753 == null || this._window == null)
            {
                return;
            }
            ...
            if (_loc1_ != null)
            {
                ...
                _loc2_ = new Point((_loc1_.width - this.var_4753.width) / 2, (_loc1_.height - this.var_4753.height) / 2);
                _loc1_.bitmap.copyPixels(this.var_4753, this.var_4753.rect, _loc2_);
            }
        ...
        private function sendOpenPetPackage(): void
        {
            ...
            if (this.var_4754 || this.var_2358 == -1)
            {
                return;
            }
            ...
            {
                this.var_4754 = true;
                message = new RoomWidgetOpenPetPackageMessage(RoomWidgetOpenPetPackageMessage.var_1350, this.var_2358, name);
