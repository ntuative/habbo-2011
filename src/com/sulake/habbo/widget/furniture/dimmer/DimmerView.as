package com.sulake.habbo.widget.furniture.dimmer
{
    ...
    public class DimmerView 
    {
        ...
        private var var_4741:XML;
        private var _widget:DimmerFurniWidget;
        private var var_4742:DimmerViewColorGrid;
        private var var_4743:DimmerViewAlphaSlider;
        private var var_4744:int;
        private var var_2760:int;
        private var var_4745:int;
        ...
        public function hideInterface():void
        {
            ...
            if (this.var_4742 != null)
            {
                this.var_4742.dispose();
                this.var_4742 = null;
            };
            if (this.var_4743 != null)
            {
                this.var_4743.dispose();
                this.var_4743 = null;
            };
            this.var_3653 = null;
            if (this._window != null)
        ...
        private function createWindow():void
        {
            ...
            this._window = (this._widget.windowManager.createWindow("dimmerui_container", "", HabboWindowType.var_182, HabboWindowStyle.var_525, (HabboWindowParam.var_526 | HabboWindowParam.var_157), new Rectangle(var_1359, WINDOW_INITIAL_Y, 2, 2), null, 0) as IWindowContainer);
            ...
            if (_loc1_ != null)
            {
                ...
                if (_loc5_ != null)
                {
                    this.var_4742 = new DimmerViewColorGrid(this, (_loc5_ as IItemGridWindow), this._widget.windowManager, this._widget.assets);
                };
            };
            _loc1_ = this._window.findChildByName("brightness_container");
            if (_loc1_ != null)
            {
                this.var_4743 = new DimmerViewAlphaSlider(this, (_loc1_ as IWindowContainer), this._widget.assets);
            };
            this.var_3653 = ITabContextWindow(this._window.findChildByName("tab_context"));
            this.selectTab(this._widget.selectedPresetIndex);
            var _loc2_:int;
            while (_loc2_ < this.var_3653.numTabItems)
            {
                _loc6_ = this.var_3653.getTabItemAt(_loc2_);
                _loc6_.setParamFlag(HabboWindowParam.var_157, true);
        ...
        private function selectPreset(param1:int):void
        {
            ...
            this.var_4744 = _loc2_.light;
            if (this.var_4743 != null)
            {
                this.var_4743.setValue(this.var_4744);
            };
            this.var_2760 = this.colors.indexOf(_loc2_.color);
            if (this.var_4742 != null)
            {
                this.var_4742.setSelectedColorIndex(this.var_2760);
            };
        ...
        {
            if (this.var_3653 == null)
            {
                return;
            };
            var _loc2_:IWindow = this.var_3653.getTabItemAt(param1);
            if (_loc2_ != null)
            {
                this.var_3653.selector.setSelected((_loc2_ as ISelectableWindow));
            };
        }
        ...
        private function getSelectedTabIndex():int
        {
            ...
            var _loc1_:ISelectableWindow = this.var_3653.selector.getSelected();
            return (this.var_3653.selector.getSelectableIndex(_loc1_));
        }

        private function get windowXML():XML
        {
            if (this.var_4741 != null)
            {
                return (this.var_4741);
            };
            ...
            this.var_4741 = XML(_loc1_.content);
            return (this.var_4741);
        }
        ...
        public function set selectedType(param1:int):void
        {
            ...
            if (this.var_4743 != null)
            {
                this.var_4743.min = this._widget.minLights[(param1 - 1)];
            };
        }
        ...
        public function set selectedColorIndex(param1:int):void
        {
            ...
            if (this.var_4742 != null)
            {
                this.var_4742.setSelectedColorIndex(param1);
            };
            this._widget.previewCurrentSetting();
        }
