package com.sulake.habbo.widget.roomchat
{
    ...
    public class RoomChatItem 
    {
        ...
        private static const var_4929:Number = 18;
        ...
        private static const var_3393:String = "message";
        private static const var_4933:String = "pointer";
        ...
        {
            return (this.var_4939);
        }

        public function set senderX(param1:Number):void
        {
            this.var_4939 = param1;
        }
        ...
        {
            var _loc5_:Rectangle = new Rectangle(this._x, this.var_2497, this.width, var_4929);
        ...
        public function renderView():void
        {
            ...
            var background:IBitmapWrapperWindow = (this._window.findChildByName(var_23) as IBitmapWrapperWindow);
            var nameWindow:ILabelWindow = (this._window.findChildByName(var_341) as ILabelWindow);
            var textWindow:ITextWindow = (this._window.findChildByName(var_3393) as ITextWindow);
            var pointerWindow:IBitmapWrapperWindow = (this._window.findChildByName(var_4933) as IBitmapWrapperWindow);
            ...
            if (((this.var_4940) && (!(isRespect))))
            {
                ...
                if (userIconWindow)
                {
                    ...
                    this.var_2237 = (this.var_2237 + (userIconWindow.x + this.var_4940.width));
                };
            };
            if (nameWindow != null)
            {
                ...
                this.var_2237 = (this.var_2237 + nameWindow.width);
            };
            if (this.var_4404 == RoomWidgetChatUpdateEvent.var_531)
            {
                textWindow.text = this.var_1364.registerParameter("widgets.chatbubble.respect", "username", this.var_2907);
                this.var_2237 = var_4932;
            }
            else
            {
                if (this.var_4404 == RoomWidgetChatUpdateEvent.var_532)
                {
                    textWindow.text = this.var_1364.registerParameter("widget.chatbubble.petrespect", "petname", this.var_2907);
                    this.var_2237 = var_4932;
                }
                else
                {
            ...
            if (textWindow.visible)
            {
                ...
                this.var_2237 = (this.var_2237 + textWindow.width);
            };
            if (((!(pointerWindow == null)) && (pointerWindow.visible)))
            {
                pointerWindow.bitmap = pointerBitmapData;
                pointerWindow.disposesBitmap = false;
                pointerWindow.x = (this.var_2237 / 2);
            ...
            this.var_2237 = this._window.width;
        ...
        {
            var _loc5_:int;
            var _loc3_:ITextWindow = (this._window.getChildByName(var_3393) as ITextWindow);
