package com.sulake.habbo.widget.roomchat
{
    ...
    public class RoomChatHistoryViewer implements IDisposable
    {
        ...
        public function set visible(param1: Boolean): void
        {
            ...
            this.var_4917.state = param1
                    ? RoomChatHistoryPulldown.var_1834
                    : RoomChatHistoryPulldown.var_1833;
        }
        ...
        private function processDrag(param1: Number, param2: Boolean = false): void
        {
            ...
            if (this.var_4921 > 0 && param2)
            {
                ...
                if (this.var_4920)
                {
                    ...
                    _loc8_ = this.var_4918.scrollV >= 1 - var_4919 / this.var_4918.scrollable.scrollableRegion.height;
