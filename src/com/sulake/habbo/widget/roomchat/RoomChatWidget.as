package com.sulake.habbo.widget.roomchat
{
    ...
    public class RoomChatWidget extends RoomWidgetBase implements IUpdateReceiver
    {
        ...
        public function RoomChatWidget(param1: IHabboWindowManager, param2: IAssetLibrary, param3: IHabboLocalizationManager, param4: IHabboConfigurationManager, param5: int, param6: Component)
        {
            ...
            this._mainWindow = (param1.createWindow("chat_container", "", HabboWindowType.var_182, HabboWindowStyle.var_525, HabboWindowParam.var_156, new Rectangle(0, 0, 200, this.var_4945 + RoomChatHistoryPulldown.var_1322), null, 0) as IWindowContainer);
            this._mainWindow.background = true;
            this._mainWindow.color = 0x1FFFFFF;
            ...
            this._mainWindow.addChild(this.var_4946);
            ...
            this.var_4947 = new RoomChatHistoryViewer(this, param1, this._mainWindow, param2);
            this.var_4955 = param4.getKey("site.url");
            this.var_4960 = int(param4.getKey("chat.history.item.max.count", "150"));
            var _loc7_: Boolean = int(param4.getKey("chat.history.disabled", "0")) == 1;
        ...
        private function onRoomViewUpdate(param1: RoomWidgetRoomViewUpdateEvent): void
        {
            ...
            if (param1.rect != null)
            {
                ...
                this._mainWindow.width = _loc2_.width;
                this._mainWindow.height = this.var_4945 + this.var_4947.pulldownBarHeight;
                this.var_4946.width = this._mainWindow.width - this.var_4947.scrollbarWidth;
                this.var_4946.height = this.var_4945;
                this.var_4946.x = this._mainWindow.x;
                this.var_4946.y = this._mainWindow.y;
                this._activeContentWindow.width = this._mainWindow.width - this.var_4947.scrollbarWidth;
                ...
                this.var_4947.containerResized(this._mainWindow.rectangle, true);
            }
        ...
        private function activateItemFromBuffer(): void
        {
            ...
            if (!this.checkLastItemAllowsAdding(this.var_4950[0]))
            {
                ...
                if (!this.checkLastItemAllowsAdding(this.var_4950[0]))
                {
                    ...
                    if (this.var_4947 != null)
                    {
                        this.var_4947.containerResized(this._mainWindow.rectangle);
                    }
        ...
        private function checkLastItemAllowsAdding(param1: RoomChatItem): Boolean
        {
            ...
            return this._activeContentWindow.rectangle.bottom - (this._activeContentWindow.y + _loc2_.y + _loc2_.height) > this.getItemSpacing(_loc2_, param1);
        ...
        private function setChatItemLocHorizontal(param1: RoomChatItem): void
        {
            ...
            var _loc5_: Number = -this._mainWindow.width / 2 - var_1332;
            var _loc6_: Number = (this._mainWindow.width / 2 + var_1332) - this.var_4947.scrollbarWidth;
            ...
            param1.x = _loc9_ + this._mainWindow.width / 2 + this._mainWindow.x;
        ...
        private function getAreaBottom(): Number
        {
            ...
            return this.var_4945 + this._mainWindow.y;
        }
        ...
        public function onItemMouseClick(param1: int, param2: String, param3: int, param4: int, param5: int, param6: WindowMouseEvent): void
        {
            ...
            var _loc7_: RoomWidgetRoomObjectMessage = new RoomWidgetRoomObjectMessage(RoomWidgetRoomObjectMessage.RWROM_GET_OBJECT_INFO, param1, param3);
        ...
        {
            var _loc2_: Number = (this._mainWindow.rectangle.bottom + param1) - RoomChatHistoryPulldown.var_1322;
            this.stretchAreaBottomTo(_loc2_);
        }

        public function stretchAreaBottomTo(param1: Number): void
        {
            var _loc2_: int = this._mainWindow.context.getDesktopWindow().height - RoomChatHistoryPulldown.var_1322;
            param1 = Math.min(param1, _loc2_);
            this.var_4945 = param1 - this._mainWindow.y;
            this._mainWindow.height = this.var_4945 + RoomChatHistoryPulldown.var_1322;
            if (this.var_4947 != null)
            {
                this.var_4947.containerResized(this._mainWindow.rectangle);
            }
        ...
        public function resizeContainerToLowestItem(): void
        {
            ...
            var _loc3_: int = this._mainWindow.rectangle.bottom;
            this.stretchAreaBottomTo(this._mainWindow.rectangle.top + _loc1_);
            _loc3_ = _loc3_ - this._mainWindow.rectangle.bottom;
        ...
        {
            var _loc1_: Number = this._mainWindow.rectangle.bottom - RoomChatHistoryPulldown.var_1322;
            if (_loc1_ < var_1338)
            {
                if (_loc1_ <= this.var_4945 + this._mainWindow.y)
                {
                    if (this.historyViewerActive())
                    {
                        this.hideHistoryViewer();
