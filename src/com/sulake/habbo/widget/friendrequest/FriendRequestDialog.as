package com.sulake.habbo.widget.friendrequest
{
    ...
    public class FriendRequestDialog
    {
        ...
        private var var_4658: Boolean = false;
        private var var_4735: Boolean = false;
        private var var_4736: Boolean = false;
        ...
        private function createWindow(): void
        {
            ...
            this._window.addEventListener(WindowEvent.var_558, this.onDeactivated);
        ...
        public function set targetRect(param1: Rectangle): void
        {
            ...
            if (!param1)
            {
                this._widget.ignoreRequest(this.var_2913);
                return;
            }

            if (this.var_4658 || this.var_4735)
            {
                return;
            }
        ...
        private function onAccept(param1: WindowMouseEvent): void
        {
            if (this._widget != null)
            {
                this._widget.acceptRequest(this.var_2913);
            }
        ...
        private function onDecline(param1: WindowMouseEvent): void
        {
            if (this._widget != null)
            {
                this._widget.declineRequest(this.var_2913);
            }
