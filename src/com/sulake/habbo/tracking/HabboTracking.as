    ...
    public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver 
    {
        ...
        public function HabboTracking(param1:IContext, param2:uint=0, param3:IAssetLibrary=null)
        {
            ...
            if (_loc5_ != null)
            {
                ...
                ErrorReportStorage.setParameter(HabboErrorVariableEnum.var_44, ((ExternalInterface.available) ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown"));
        ...
        override public function dispose():void
        {
            if (!disposed)
            {
                ...
                if (this.var_4581)
                {
                    ...
                    {
                        Component(this.var_4581).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED, this.onFriendlistTrackingEvent);
                        Component(this.var_4581).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS, this.onFriendlistTrackingEvent);
                        Component(this.var_4581).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH, this.onFriendlistTrackingEvent);
                        Component(this.var_4581).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST, this.onFriendlistTrackingEvent);
                        Component(this.var_4581).events.removeEventListener(HabboFriendListTrackingEvent.var_48, this.onFriendlistTrackingEvent);
                    };
                ...
                if (this.var_2844)
                {
                    ...
                    {
                        this.var_2844.events.removeEventListener(HabboToolbarEvent.var_49, this.onToolbarClick);
                    };
                ...
                if (this._roomEngine)
                {
                    if (!this._roomEngine.disposed)
                    {
                        ...
                        this._roomEngine.events.removeEventListener(RoomEngineEvent.var_52, this.onRoomAction);
                    };
        ...
        private function onFriendlistReady(param1:IID, param2:IUnknown):void
        {
            ...
            Component(this.var_4581).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED, this.onFriendlistTrackingEvent);
            Component(this.var_4581).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS, this.onFriendlistTrackingEvent);
            Component(this.var_4581).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH, this.onFriendlistTrackingEvent);
            Component(this.var_4581).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST, this.onFriendlistTrackingEvent);
            Component(this.var_4581).events.addEventListener(HabboFriendListTrackingEvent.var_48, this.onFriendlistTrackingEvent);
        }
        ...
        private function onRoomWidgetReady(param1:IID, param2:IUnknown):void
        {
            ...
            Component(this.var_2822).events.addEventListener(HabboMeMenuTrackingEvent.HABBO_MEMENU_TRACKING_EVENT_CLOSE, this.onWidgetTrackingEvent);
            Component(this.var_2822).events.addEventListener(HabboMeMenuTrackingEvent.HABBO_MEMENU_TRACKING_EVENT_DEFAULT, this.onWidgetTrackingEvent);
            Component(this.var_2822).events.addEventListener(HabboMeMenuTrackingEvent.HABBO_MEMENU_TRACKING_EVENT_DANCE, this.onWidgetTrackingEvent);
            Component(this.var_2822).events.addEventListener(HabboMeMenuTrackingEvent.HABBO_MEMENU_TRACKING_EVENT_EFFECTS, this.onWidgetTrackingEvent);
        }
        ...
        private function onRoomEngineReady(param1:IID=null, param2:IUnknown=null):void
        {
            ...
            Component(this._roomEngine).events.addEventListener(RoomEngineEvent.var_52, this.onRoomAction);
        }

        private function onAdManagerReady(param1:IID=null, param2:IUnknown=null):void
        {
            this.var_4345 = (param2 as IAdManager);
            this.var_4345.events.addEventListener(AdEvent.var_70, this.onRoomAdLoad);
        }

        private function onToolbarReady(param1:IID=null, param2:IUnknown=null):void
        {
            this.var_2844 = (param2 as IHabboToolbar);
            this.var_2844.events.addEventListener(HabboToolbarEvent.var_49, this.onToolbarClick);
        }
        ...
        private function onRoomAction(param1:RoomEngineEvent):void
        {
            ...
            {
                if (param1.type == RoomEngineEvent.var_52)
                {
                    if (this.var_4593)
                    {
                        this.var_4593.removeEventListener(TimerEvent.TIMER, this.onRoomActionTimerEvent);
