package com.sulake.habbo.ui
{
    ...
    public class PlayListEditorWidgetHandler implements IRoomWidgetHandler 
    {
        ...
        {
            return ([RoomWidgetFurniToWidgetMessage.var_1544, RoomWidgetPlayListModificationMessage.var_1250, RoomWidgetPlayListModificationMessage.var_1251, RoomWidgetPlayListPlayStateMessage.var_1252, RoomWidgetPlayListUserActionMessage.var_1253]);
        }
