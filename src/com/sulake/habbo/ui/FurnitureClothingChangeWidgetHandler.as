package com.sulake.habbo.ui
{
    ...
    public class FurnitureClothingChangeWidgetHandler implements IRoomWidgetHandler, IHabboAvatarEditorDataSaver 
    {
        ...
        {
            return ([RoomWidgetFurniToWidgetMessage.var_1543, RoomWidgetClothingChangeMessage.var_1376, RoomWidgetAvatarEditorMessage.var_1822]);
        }
                ...
                case RoomWidgetClothingChangeMessage.var_1376:
                    ...
                    if (_loc3_ != null)
                    {
                        ...
                        if (_loc4_ != null)
                        {
                            ...
                            if (this._container.avatarEditor.openEditor(_loc7_.window, this, [AvatarEditorFigureCategory.var_521, AvatarEditorFigureCategory.var_522], true))
                            {
                                _loc11_ = HabboClubLevelEnum.var_255;
                                this._container.avatarEditor.loadAvatarInEditor(_loc10_, _loc9_, _loc11_);
                                _loc2_ = _loc4_.getString(RoomObjectVariableEnum.var_503);
                                if (_loc2_ == null)
                                {
                                    _loc2_ = "";
                                };
