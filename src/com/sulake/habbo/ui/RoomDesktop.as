package com.sulake.habbo.ui
{
    ...
    public class RoomDesktop implements IRoomDesktop, IRoomWidgetMessageListener, IRoomWidgetHandlerContainer 
    {
        ...
        public function set friendList(param1:IHabboFriendList):void
        {
            ...
            if (this._friendList)
            {
                this._friendList.events.addEventListener(FriendRequestEvent.var_370, this.processEvent);
                this._friendList.events.addEventListener(FriendRequestEvent.var_1533, this.processEvent);
            };
        }
        ...
        public function set roomEngine(param1:IRoomEngine):void
        {
            ...
            {
                this._roomEngine.events.addEventListener(RoomContentLoadedEvent.var_293, this.onRoomContentLoaded);
                this._roomEngine.events.addEventListener(RoomContentLoadedEvent.var_294, this.onRoomContentLoaded);
                this._roomEngine.events.addEventListener(RoomContentLoadedEvent.var_295, this.onRoomContentLoaded);
            };
        }
        ...
        public function dispose():void
        {
            ...
            {
                this._friendList.events.removeEventListener(FriendRequestEvent.var_370, this.processEvent);
                this._friendList.events.removeEventListener(FriendRequestEvent.var_1533, this.processEvent);
            };
            ...
            if (((!(this._roomEngine == null)) && (!(this._roomEngine.events == null))))
            {
                this._roomEngine.events.removeEventListener(RoomContentLoadedEvent.var_293, this.onRoomContentLoaded);
                this._roomEngine.events.removeEventListener(RoomContentLoadedEvent.var_294, this.onRoomContentLoaded);
                this._roomEngine.events.removeEventListener(RoomContentLoadedEvent.var_295, this.onRoomContentLoaded);
            };
        ...
        public function init():void
        {
            if (((!(this._roomEngine == null)) && (!(this.var_4405 == null))))
            {
                this.var_4648 = this._roomEngine.loadRoomResources(this.var_4405.var_3236);
            ...
            if (((!(this.var_4345 == null)) && (this.var_4405.state == RoomSessionEvent.var_93)))
            {
        ...
        public function createWidget(param1:String):void
        {
            ...
            if (_loc3_)
            {
                ...
                _loc12_ = new RoomWidgetRoomViewUpdateEvent(param1, this.var_4645.var_1534);
        ...
        public function roomObjectEventHandler(param1:RoomEngineObjectEvent):void
        {
            ...
            switch (param1.type)
            {
                case RoomEngineObjectEvent.var_402:
                    _loc4_ = new RoomWidgetRoomObjectUpdateEvent(RoomWidgetRoomObjectUpdateEvent.var_1340, _loc2_, _loc3_, param1.roomId, param1.roomCategory);
                    ...
                    break;
                case RoomEngineObjectEvent.var_404:
                    switch (_loc3_)
                    {
                    ...
                    break;
                case RoomEngineObjectEvent.var_405:
                    switch (_loc3_)
                    {
                        case RoomObjectCategoryEnum.var_72:
                        case RoomObjectCategoryEnum.var_73:
                    ...
                    break;
                case RoomEngineObjectEvent.var_403:
                    _loc4_ = new RoomWidgetRoomObjectUpdateEvent(RoomWidgetRoomObjectUpdateEvent.var_1257, _loc2_, _loc3_, param1.roomId, param1.roomCategory);
                    break;
                case RoomEngineObjectEvent.var_406:
                ...
                case RoomEngineObjectEvent.ROOM_OBJECT_WIDGET_REQUEST_CREDITFURNI:
                    ...
                    break;
                case RoomEngineObjectEvent.var_407:
                    ...
                    this.processWidgetMessage(_loc5_);
                    break;
                case RoomEngineObjectEvent.var_408:
                ...
                case RoomEngineObjectEvent.ROOM_OBJECT_WIDGET_REQUEST_TROPHY:
                    ...
                    this.processWidgetMessage(_loc5_);
                    break;
                case RoomEngineObjectEvent.var_409:
                    ...
                    this.processWidgetMessage(_loc5_);
                    break;
                case RoomEngineObjectEvent.var_410:
                    ...
                    this.processWidgetMessage(_loc5_);
                    break;
                case RoomEngineObjectEvent.var_412:
                    ...
                    this.processWidgetMessage(_loc5_);
                    break;
                case RoomEngineObjectEvent.var_411:
                    ...
                    this.processWidgetMessage(_loc5_);
                    break;
                case RoomEngineObjectEvent.var_413:
                case RoomEngineObjectEvent.var_414:
                    this.handleRoomAdClick(param1);
                    break;
                case RoomEngineObjectEvent.var_415:
                case RoomEngineObjectEvent.var_416:
                    this.handleRoomAdTooltip(param1);
                    break;
                case RoomEngineObjectEvent.var_417:
                    this.processEvent(param1);
                    break;
                case RoomEngineObjectEvent.var_418:
                    ...
                    this.processWidgetMessage(_loc5_);
                    break;
                case RoomEngineObjectEvent.var_419:
        ...
        public function createRoomView(param1:int):void
        {
            ...
            var _loc20_:Number;
            var _loc21_:IWindow;
            var _loc2_:Rectangle = this.var_4645.var_1534;
