package com.sulake.habbo.ui
{
    ...
    public class FurnitureDimmerWidgetHandler implements IRoomWidgetHandler
    {
        ...
        {
            return [
                RoomWidgetFurniToWidgetMessage.var_1541,
                RoomWidgetDimmerSavePresetMessage.var_1818,
                RoomWidgetDimmerChangeStateMessage.CHANGE_STATE,
                RoomWidgetDimmerPreviewMessage.var_1817
            ];
        }
        ...
        public function getProcessedEvents(): Array
        {
            ...
            _loc1_.push(RoomEngineDimmerStateEvent.REDSE_ROOM_COLOR);
            _loc1_.push(RoomEngineObjectEvent.REOR_REMOVE_DIMMER);
            return _loc1_;
        }
