package com.sulake.habbo.ui
{
    ...
    public class InfoStandWidgetHandler implements IRoomWidgetHandler 
    {
        ...
        {
            var _loc1_:Array = [];
            _loc1_.push(RoomWidgetRoomObjectMessage.var_1336);
        ...
        public function processWidgetMessage(param1:RoomWidgetMessage):RoomWidgetUpdateEvent
        {
            ...
            switch (param1.type)
            {
                case RoomWidgetRoomObjectMessage.var_1336:
                ...
                case RoomWidgetUserActionMessage.var_1840:
                    _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.var_1355, _loc3_.name);
        ...
        private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage):RoomWidgetUpdateEvent
        {
            ...
            switch (param1.category)
            {
                ...
                case RoomObjectCategoryEnum.var_73:
                    ...
                    {
                        _loc25_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.var_487);
                    ...
                    _loc11_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.var_490);
                ...
                case RoomObjectCategoryEnum.var_71:
                    ...
                    if (_loc13_.type == RoomObjectTypeEnum.var_1262)
                    {
                        ...
                        {
                            _loc14_ = RoomWidgetUserInfoUpdateEvent.var_1256;
                        };
                    }
                    else
                    {
                    ...
                    if (_loc18_ != null)
                    {
                        _loc15_.carryItem = _loc18_.getModel().getNumber(RoomObjectVariableEnum.var_725);
                    };
                    if (_loc14_ == RoomWidgetUserInfoUpdateEvent.var_1255)
                    {
                        _loc15_.realName = this._container.sessionDataManager.realName;
                    };
                    if (_loc14_ == RoomWidgetUserInfoUpdateEvent.var_1256)
                    {
                        ...
                        if (_loc18_ != null)
                        {
                            _loc39_ = _loc18_.getModel().getString(RoomObjectVariableEnum.var_732);
        ...
        private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent):void
        {
            ...
            if (((!(this._container == null)) && (!(this._container.events == null))))
            {
                ...
                if (_loc13_ != null)
                {
                    ...
                    if (_loc14_ != null)
                    {
                        _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.var_732);
