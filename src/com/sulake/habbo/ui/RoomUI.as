package com.sulake.habbo.ui
{
    ...
    public class RoomUI extends Component implements IRoomUI, IUpdateReceiver 
    {
        ...
        private function onAdManagerReady(param1:IID=null, param2:IUnknown=null):void
        {
            ...
            {
                this.var_4345.events.addEventListener(AdEvent.var_350, this.adEventHandler);
                this.var_4345.events.addEventListener(AdEvent.var_349, this.adEventHandler);
                this.var_4345.events.addEventListener(AdEvent.var_70, this.adEventHandler);
            };
        }
        ...
        private function registerSessionEvents():void
        {
            if (this.var_2845)
            {
                ...
                this.var_2845.events.addEventListener(RoomSessionChatEvent.var_366, this.roomSessionEventHandler);
                this.var_2845.events.addEventListener(RoomSessionChatEvent.var_367, this.roomSessionEventHandler);
        ...
        private function initializeRoomEngineEvents():void
        {
            ...
            {
                this._roomEngine.events.addEventListener(RoomEngineEvent.var_356, this.roomEngineEventHandler);
                this._roomEngine.events.addEventListener(RoomEngineEvent.var_51, this.roomEventHandler);
                this._roomEngine.events.addEventListener(RoomEngineEvent.var_52, this.roomEventHandler);
                this._roomEngine.events.addEventListener(RoomEngineEvent.var_358, this.roomEngineEventHandler);
                this._roomEngine.events.addEventListener(RoomEngineEvent.var_357, this.roomEngineEventHandler);
                this._roomEngine.events.addEventListener(RoomEngineDimmerStateEvent.var_400, this.roomEventHandler);
                this._roomEngine.events.addEventListener(RoomEngineRoomColorEvent.var_401, this.roomEventHandler);
                this._roomEngine.events.addEventListener(RoomEngineObjectEvent.var_402, this.roomObjectEventHandler);
                this._roomEngine.events.addEventListener(RoomEngineObjectEvent.var_403, this.roomObjectEventHandler);
                this._roomEngine.events.addEventListener(RoomEngineObjectEvent.var_404, this.roomObjectEventHandler);
                this._roomEngine.events.addEventListener(RoomEngineObjectEvent.var_405, this.roomObjectEventHandler);
                this._roomEngine.events.addEventListener(RoomEngineObjectEvent.var_141, this.roomObjectEventHandler);
                this._roomEngine.events.addEventListener(RoomEngineObjectEvent.var_406, this.roomObjectEventHandler);
                ...
                this._roomEngine.events.addEventListener(RoomEngineObjectEvent.var_407, this.roomObjectEventHandler);
                this._roomEngine.events.addEventListener(RoomEngineObjectEvent.var_408, this.roomObjectEventHandler);
                ...
                this._roomEngine.events.addEventListener(RoomEngineObjectEvent.var_409, this.roomObjectEventHandler);
                this._roomEngine.events.addEventListener(RoomEngineObjectEvent.var_410, this.roomObjectEventHandler);
                this._roomEngine.events.addEventListener(RoomEngineObjectEvent.var_411, this.roomObjectEventHandler);
                this._roomEngine.events.addEventListener(RoomEngineObjectEvent.var_412, this.roomObjectEventHandler);
                this._roomEngine.events.addEventListener(RoomEngineObjectEvent.var_413, this.roomObjectEventHandler);
                this._roomEngine.events.addEventListener(RoomEngineObjectEvent.var_414, this.roomObjectEventHandler);
                this._roomEngine.events.addEventListener(RoomEngineObjectEvent.var_415, this.roomObjectEventHandler);
                this._roomEngine.events.addEventListener(RoomEngineObjectEvent.var_416, this.roomObjectEventHandler);
                this._roomEngine.events.addEventListener(RoomEngineObjectEvent.var_417, this.roomObjectEventHandler);
                this._roomEngine.events.addEventListener(RoomEngineObjectEvent.var_418, this.roomObjectEventHandler);
                this._roomEngine.events.addEventListener(RoomEngineObjectEvent.var_419, this.roomObjectEventHandler);
        ...
        private function roomEngineEventHandler(param1:RoomEngineEvent):void
        {
            ...
            if (param1.type == RoomEngineEvent.var_356)
            {
                if (this.var_2845 != null)
                {
                    this.var_2845.roomEngineReady = true;
            ...
            {
                if (((param1.type == RoomEngineEvent.var_357) || (param1.type == RoomEngineEvent.var_358)))
                {
        ...
        private function roomEventHandler(param1:RoomEngineEvent):void
        {
            ...
            switch (param1.type)
            {
                case RoomEngineEvent.var_51:
                    ...
                    return;
                case RoomEngineEvent.var_52:
                    this.disposeDesktop(_loc2_);
                    return;
                case RoomEngineRoomColorEvent.var_401:
