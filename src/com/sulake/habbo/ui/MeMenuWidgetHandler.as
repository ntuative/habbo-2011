    ...
    public class MeMenuWidgetHandler implements IRoomWidgetHandler, IHabboAvatarEditorDataSaver, IAvatarImageListener 
    {
        ...
        public function set container(param1:IRoomWidgetHandlerContainer):void
        {
            if (this._container != null)
            {
                ...
                {
                    this._container.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.var_1432, this.onFigureUpdate);
                };
                ...
                {
                    this._container.catalog.events.removeEventListener(PurseEvent.var_150, this.onCreditBalance);
                };
            };
            ...
            {
                this._container.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.var_1432, this.onFigureUpdate);
            };
            ...
            {
                this._container.catalog.events.addEventListener(PurseEvent.var_150, this.onCreditBalance);
            };
        }
        ...
        public function processWidgetMessage(param1:RoomWidgetMessage):RoomWidgetUpdateEvent
        {
            ...
            switch (param1.type)
            {
                case RoomWidgetRequestWidgetMessage.var_1310:
                    ...
                    {
                        _loc7_ = new HabboToolbarEvent(HabboToolbarEvent.var_49);
                ...
                case RoomWidgetToolbarMessage.var_1309:
                    ...
                    if (this.var_2844)
                    {
                        this.var_2844.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.var_146, HabboToolbarIconEnum.MEMENU, _loc5_.window));
                        if (this._inventory != null)
                        {
                            _loc12_ = false;
                            if (((!(this._container == null)) && (!(this._container.sessionDataManager == null))))
                            {
                                _loc12_ = this._container.sessionDataManager.hasUserRight("fuse_use_club_dance", HabboClubLevelEnum.var_256);
                            };
                    ...
                    {
                        _loc13_ = ((this._container.sessionDataManager != null) ? this._container.sessionDataManager.userId : -1);
                ...
                case RoomWidgetToolbarMessage.var_1308:
                    ...
                    {
                        this.var_2844.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.var_433, HabboToolbarIconEnum.MEMENU, _loc6_.window));
                    };
                    break;
                case RoomWidgetAvatarEditorMessage.var_1822:
                    ...
                    if (this._container)
                    {
                        ...
                        _loc21_ = HabboClubLevelEnum.var_255;
                        if (this._container.sessionDataManager.hasUserRight("fuse_use_club_outfits", HabboClubLevelEnum.var_256))
                        {
                            _loc21_ = HabboClubLevelEnum.var_256;
                        };
                        if (this._container.sessionDataManager.hasUserRight("fuse_use_vip_outfits", HabboClubLevelEnum.var_122))
                        {
                            _loc21_ = HabboClubLevelEnum.var_122;
                        };
                        ...
                        {
                            this._container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.var_1430));
                        };
                    };
                    break;
                ...
                case RoomWidgetAvatarEditorMessage.var_1821:
                    if (((this._container.habboHelp) && (this._container.habboHelp.events)))
                    {
                        this._container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.var_1431));
                    };
                    break;
