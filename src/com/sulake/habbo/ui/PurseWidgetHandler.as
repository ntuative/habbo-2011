package com.sulake.habbo.ui
{
    ...
    public class PurseWidgetHandler implements IRoomWidgetHandler 
    {
        ...
        public function dispose():void
        {
            if (!this._disposed)
            {
                this._container.catalog.events.removeEventListener(PurseEvent.var_150, this.purseEventHandler);
                this._container.catalog.events.removeEventListener(PurseEvent.var_152, this.purseEventHandler);
        ...
        public function set container(param1:IRoomWidgetHandlerContainer):void
        {
            ...
            {
                this._container.catalog.events.addEventListener(PurseEvent.var_150, this.purseEventHandler);
                this._container.catalog.events.addEventListener(PurseEvent.var_152, this.purseEventHandler);
            };
        }
        ...
        public function processWidgetMessage(param1:RoomWidgetMessage):RoomWidgetUpdateEvent
        {
            ...
            switch (param1.type)
            {
                case RoomWidgetGetPurseData.var_1814:
                    ...
                    this._container.events.dispatchEvent(new RoomWidgetPurseUpdateEvent(RoomWidgetPurseUpdateEvent.var_152, _loc2_.getActivityPointsForType(Purse.var_142)));
                    break;
