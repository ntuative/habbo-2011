package com.sulake.habbo.toolbar
{
    ...
    public class HabboToolbar extends Component implements IHabboToolbar 
    {
        ...
        private function onAuthenticationOK(param1:IMessageEvent):void
        {
            ...
            events.addEventListener(HabboToolbarShowMenuEvent.var_146, this.onAnimateWindowEvent);
            events.addEventListener(HabboToolbarShowMenuEvent.var_433, this.onAnimateWindowEvent);
            events.addEventListener(HabboToolbarShowMenuEvent.var_434, this.onDisplayWindowEvent);
            events.addEventListener(HabboToolbarShowMenuEvent.var_435, this.onHideWindowEvent);
            this._state = true;
        ...
        private function onAnimateWindowEvent(param1:HabboToolbarShowMenuEvent):void
        {
            ...
            {
                if (param1.type == HabboToolbarShowMenuEvent.var_146)
                {
                    if (param1.alignToIcon)
                    {
                        this._view.var_436(param1.menuId, param1.window);
                    }
                    else
                    {
                        this._view.var_436(param1.menuId, param1.window, new Point(param1.window.x, param1.window.y));
                    };
                }
                else
                {
