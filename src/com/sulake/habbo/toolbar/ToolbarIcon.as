package com.sulake.habbo.toolbar
{
    ...
    public class ToolbarIcon 
    {
        ...
        private var var_4547:Array = new Array();
        private var var_4548:Array = new Array();
        ...
        public function get var_1981():ToolbarIconGroup
        {
        ...
        public function defineFromXML(param1:XML):void
        {
            ...
            this.var_4549 = new Array();
            this.var_4550 = new Array();
        ...
        public function var_436(param1:String, param2:IWindowContainer, param3:Number, param4:String, param5:Point):void
        {
            if (this.var_4552 != null)
            {
                this.var_4552.var_436(this, param1, param2, this.var_2661, param3, param4, this.getMenuYieldList(param1));
            };
        }
        ...
        private function onMouseEvent(param1:WindowEvent, param2:IWindow):void
        {
            ...
            switch (param1.type)
            {
                case WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK:
                    ...
                    {
                        _loc4_ = new HabboToolbarEvent(HabboToolbarEvent.var_49);
