package com.sulake.habbo.toolbar
{
    ...
    public class ToolbarBarMenuAnimator 
    {
        ...
        private var var_4540:Array = new Array();
        private var _itemList:Object = new Object();
        private var var_4541:Object = new Object();
        private var var_4542:Array = new Array();
        private var var_4543:Array = new Array();
        ...
        public function var_436(param1:ToolbarIcon, param2:String, param3:IWindowContainer, param4:String, param5:Number, param6:String, param7:Array=null):void
        {
            if (param3 == null)
            {
                return;
        ...
        private function registerDependentMenu(param1:String, param2:Array):void
        {
            ...
            while (_loc4_ < param2.length)
            {
                ...
                {
                    this.var_4541[_loc3_] = new Array();
                };
