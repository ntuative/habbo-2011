package com.sulake.habbo.toolbar
{
    ...
    public class ToolbarView 
    {
        ...
        private var var_4565:Array = new Array();
        private var var_4566:Array = new Array();
        ...
        public function var_436(param1:String, param2:IWindowContainer, param3:Point=null):void
        {
            var _loc4_:ToolbarIcon = this.getIconByMenuId(param1);
            if (_loc4_ != null)
            {
                _loc4_.var_436(param1, param2, this.var_2090, this.var_2085, param3);
            };
        }
