package com.sulake.habbo.moderation
{
    ...
    public class StartPanelCtrl implements IDisposable
    {
        ...
        private function onChatlogButton(param1: WindowEvent, param2: IWindow): void
        {
            ...
            this.var_3486.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(this.var_3710
                                                                                                       ? 0
                                                                                                       : 1, this._roomId), this.var_3486, WindowTracker.var_1518, this._roomId), this._frame, false, false, true);
        }
