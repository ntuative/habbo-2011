package com.sulake.habbo.moderation
{
    ...
    public class StartPanelCtrl implements IDisposable 
    {
        ...
        public function show():void
        {
            if (this._frame == null)
            {
                this._frame = IFrameWindow(this.var_3486.getXmlWindow("start_panel"));
                ...
                this._frame.findChildByName("room_tool_but").disable();
                this._frame.findChildByName("chatlog_but").disable();
                this.var_3486.disableButton(this.var_3486.initMsg.cfhPermission, this._frame, "ticket_queue_but");
        ...
        {
            if (this.var_3486.initMsg.chatlogsPermission)
            {
        ...
        private function onRoomToolButton(param1:WindowEvent, param2:IWindow):void
        {
            ...
            this.var_3486.windowTracker.show(new RoomToolCtrl(this.var_3486, this._roomId), this._frame, false, false, true);
        }
        ...
        private function onChatlogButton(param1:WindowEvent, param2:IWindow):void
        {
            ...
            this.var_3486.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(((this.var_3710) ? 0 : 1), this._roomId), this.var_3486, WindowTracker.var_1518, this._roomId), this._frame, false, false, true);
        }
        ...
        private function onUserinfoButton(param1:WindowEvent, param2:IWindow):void
        {
            ...
            this.var_3486.windowTracker.show(new UserInfoFrameCtrl(this.var_3486, this._userId), this._frame, false, false, true);
        }
        ...
        private function onTicketQueueButton(param1:WindowEvent, param2:IWindow):void
        {
            ...
            this.var_3486.issueManager.init();
        }
