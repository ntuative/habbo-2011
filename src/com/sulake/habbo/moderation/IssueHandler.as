package com.sulake.habbo.moderation
{
    ...
    public class IssueHandler implements TrackedWindow
    {
        ...
        private var var_3664: IssueBundle;
        private var _window: IFrameWindow;
        private var var_3665: UserInfoCtrl;
        private var var_3666: UserInfoCtrl;
        private var _disposed: Boolean;

        public function IssueHandler(param1: ModerationManager, param2: IssueBundle)
        {
            this.var_3663 = param1;
            this.var_3664 = param2;
        }
        ...
        public function dispose(): void
        {
            ...
            if (this.var_3665 != null)
            {
                this.var_3665.dispose();
                this.var_3665 = null;
            }

            if (this.var_3666 != null)
            {
                this.var_3666.dispose();
                this.var_3666 = null;
            }
        ...
        private function createView(): void
        {
            ...
            if (this.var_3663.windowManager == null || this.var_3663.assets == null)
            {
                return;
            }

            var _loc1_: XmlAsset = this.var_3663.assets.getAssetByName("issue_handler_xml") as XmlAsset;
            if (_loc1_ == null || _loc1_.content == null)
            {
                return;
            }

            this._window = (this.var_3663.windowManager.buildFromXML(_loc1_.content as XML) as IFrameWindow);
            if (this._window == null)
            {
                return;
            }
            ...
            if (_loc2_ != null)
            {
                _loc2_.addEventListener(WindowEvent.var_573, this.onResized);
            }
            ...
            this.var_3663.disableButton(this.var_3663.initMsg.chatlogsPermission, this._window, "show_chatlog");
            ...
            var _loc3_: IssueMessageData = this.var_3664.getHighestPriorityIssue();
            this.var_3665 = new UserInfoCtrl(this._window, this.var_3663, _loc3_.message);
            this.var_3666 = new UserInfoCtrl(this._window, this.var_3663, _loc3_.message);
            this.var_3665.load(IWindowContainer(this._window.findChildByName("caller_user_info")), _loc3_.reporterUserId);
            var _loc4_: IWindowContainer = IWindowContainer(this._window.findChildByName("reported_user_info"));
            if (this.var_3664.reportedUserId > 0)
            {
                this.var_3666.load(_loc4_, this.var_3664.reportedUserId);
            }
            else
            {
            ...
            Logger.log("HARASSER: " + this.var_3664.reportedUserId);
        ...
        private function updateIssueList(): void
        {
            ...
            var _loc2_: Array = this.var_3664.issues;
            var _loc3_: int;
            var _loc5_: int = _loc1_.numListItems;
            var _loc6_: int = _loc2_.length;
            if (_loc5_ < _loc6_)
            {
                _loc9_ = (this.var_3663.assets.getAssetByName("issue_handler_issue_info_xml") as XmlAsset);
                if (_loc9_ == null || _loc9_.content == null)
                {
                    return;
                }

                _loc4_ = (this.var_3663.windowManager.buildFromXML(_loc9_.content as XML) as IWindowContainer);
                if (_loc4_ == null)
                {
                    return;
                }
        ...
        private function updateMessages(): void
        {
            ...
            if (_loc5_ < _loc6_)
            {
                _loc8_ = (this.var_3663.assets.getAssetByName("issue_handler_message_list_item_xml") as XmlAsset);
                if (_loc8_ == null || _loc8_.content == null)
                {
                    return;
                }

                _loc4_ = (this.var_3663.windowManager.buildFromXML(_loc8_.content as XML) as ITextWindow);
                if (_loc4_ == null)
                {
                    return;
                }
        ...
        {
            if (this.var_3663 != null && this.var_3663.issueManager != null && this.var_3664 != null)
            {
                this.var_3663.issueManager.removeHandler(this.var_3664.id);
            }
        ...
        private function onCloseUseless(param1: WindowMouseEvent): void
        {
            ...
            this.var_3663.issueManager.closeBundle(this.var_3664.id, 1);
        ...
        private function onCloseAbusive(param1: WindowMouseEvent): void
        {
            ...
            this.var_3663.issueManager.closeBundle(this.var_3664.id, 2);
            this.checkAutoHandling();
            this.dispose();
        }
        ...
        private function onCloseResolved(param1: WindowMouseEvent): void
        {
            ...
            this.var_3663.issueManager.closeBundle(this.var_3664.id, 3);
            this.checkAutoHandling();
            this.dispose();
        }
        ...
        private function onRelease(param1: WindowMouseEvent): void
        {
            ...
            this.var_3663.issueManager.releaseBundle(this.var_3664.id);
            this.checkAutoHandling();
            this.dispose();
        }
        ...
        private function onShowChatlog(param1: WindowMouseEvent): void
        {
            ...
            var _loc2_: int = this.var_3664.getHighestPriorityIssue().issueId;
            this.var_3663.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_), this.var_3663, WindowTracker.var_1519, _loc2_), this._window, false, false, true);
        }
        ...
        private function onReporterClicked(param1: WindowMouseEvent): void
        {
            ...
            if (_loc2_ != 0)
            {
                ...
                _loc3_ = this.var_3664.getHighestPriorityIssue();
                this.var_3665 = new UserInfoCtrl(this._window, this.var_3663, _loc3_.message);
                this.var_3665.load(IWindowContainer(this._window.findChildByName("caller_user_info")), _loc2_);
            }
        ...
        {
            if (this._window == null || this.var_3663 == null || this.var_3663.issueManager == null)
            {
                return;
            }
            ...
            {
                this.var_3663.issueManager.autoPick();
            }
