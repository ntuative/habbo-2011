package com.sulake.habbo.moderation
{
    ...
    public class WindowTracker
    {
        ...
        public static const var_1521: int = 1;
        public static const var_1522: int = 2;
        public static const var_1519: int = 3;
        public static const var_1518: int = 4;
        public static const var_1520: int = 5;
        public static const var_1523: int = 6;
        public static const var_1524: int = 7;
        public static const TYPE_ISSUEHANDLER: int = 8;
        public static const var_1525: int = 9;

        private var var_3718: Dictionary = new Dictionary();
        ...
        {
            var _loc2_: Dictionary = this.var_3718[param1];
            if (_loc2_ == null)
            {
                _loc2_ = new Dictionary();
                this.var_3718[param1] = _loc2_;
            }
