package com.sulake.habbo.moderation
{
    ...
    public class IssueListView 
    {
        ...
        private static const var_3668:int = 20;

        private var _issueManager:IssueManager;
        private var var_3667:IssueBrowser;
        private var var_2190:IItemListWindow;
        private var var_2120:String;
        private var var_3669:IWindowContainer;
        private var var_3670:BitmapData;
        private var var_3671:BitmapData;
        ...
        public function IssueListView(param1:IssueManager, param2:IssueBrowser, param3:IItemListWindow, param4:String)
        {
            ...
            this.var_3669 = (this.var_3667.createWindow(param4) as IWindowContainer);
        }
        ...
        public function update(param1:Array):void
        {
            ...
            var _loc4_:int = this.var_2190.numListItems;
            ...
            if (_loc4_ < _loc5_)
            {
                ...
                {
                    _loc3_ = (this.var_3669.clone() as IWindowContainer);
            ...
            else
            {
                if (_loc4_ > _loc5_)
                {
                    ...
                    {
                        _loc9_ = this.var_2190.removeListItemAt(0);
                        _loc9_.dispose();
                        _loc2_++;
                    };
                };
            ...
            {
                if (_loc2_ > var_3668) break;
                if (((_loc7_ == null) || (this.var_3669 == null)))
                {
                    return;
                };
                _loc3_ = (this.var_2190.getListItemAt((_loc2_ - 1)) as IWindowContainer);
                if (_loc3_ == null)
                {
                    return;
                };
                _loc3_.width = this.var_2190.width;
                ...
                if (_loc11_ != null)
                {
                    ...
                    _loc13_ = (this.var_3667.assets.getAssetByName(_loc12_) as BitmapDataAsset);
