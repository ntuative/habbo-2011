package com.sulake.habbo.moderation
{
    ...
    public class IssueManager
    {
        ...
        public function autoPick(param1: Boolean = false, param2: int = 0): void
        {
            ...
            {
                if (_loc5_.state == IssueMessageData.PRIORITY_HIGH && (_loc4_ == null || _loc5_.prioritySum > _loc4_.prioritySum))
                {
                    _loc4_ = _loc5_;
                }
        ...
        public function releaseAll(): void
        {
            ...
            {
                if (_loc3_.state == IssueMessageData.PRIORITY_MEDIUM && _loc3_.pickerUserId == _loc1_)
                {
        ...
        public function updateIssue(param1: IssueMessageData): void
        {
            ...
            if (param1.state == IssueMessageData.PRIORITY_LOW)
            {
                this._issues.remove(param1.issueId);
                return;
            }
            ...
            if (this.var_3675.indexOf(param1.issueId) != -1)
            {
                ...
                {
                    if (param1.state == IssueMessageData.PRIORITY_MEDIUM)
                    {
            ...
            if (param1.state == IssueMessageData.PRIORITY_HIGH)
            {
        ...
        public function getBundles(param1: String): Array
        {
            ...
            for each (_loc4_ in this.var_3673)
            {
                ...
                {
                    case var_1526:
                        if (_loc4_.state == IssueMessageData.PRIORITY_HIGH)
                        {
                            _loc2_.push(_loc4_);
                        }
                        ...
                        break;
                    case var_1527:
                        if (_loc4_.state == IssueMessageData.PRIORITY_MEDIUM && _loc4_.pickerUserId == _loc3_)
                        {
                            _loc2_.push(_loc4_);
                        }
        ...
        public function autoHandle(param1: int): void
        {
            ...
            {
                if (_loc5_.state == IssueMessageData.PRIORITY_MEDIUM && _loc5_.pickerUserId == _loc4_ && _loc5_.id != param1 && (_loc3_ == null || _loc5_.prioritySum > _loc3_.prioritySum))
                {
                    _loc3_ = _loc5_;
                }
