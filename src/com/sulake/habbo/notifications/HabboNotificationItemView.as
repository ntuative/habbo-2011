package com.sulake.habbo.notifications
{
    ...
    public class HabboNotificationItemView implements IUpdateReceiver 
    {
        ...
        public function reposition(param1:int=-1):void
        {
            ...
            if (param1 != -1)
            {
                this.var_3903 = param1;
            };
            var _loc3_:int = ((this.var_2844.orientation == "TOP") ? var_3896 : 0);
            var _loc4_:int = ((this.var_2844.orientation == "BOTTOM") ? (_loc2_.height - var_3896) : _loc2_.height);
            var _loc5_:int = ((this.var_2844.orientation == "LEFT") ? var_3896 : 0);
            var _loc6_:int = ((this.var_2844.orientation == "RIGHT") ? (_loc2_.width - var_3896) : _loc2_.width);
            if (((this.var_3899["position_horizontal_follow_toolbar"] == "true") && ((!(this.var_2844.orientation == "TOP")) && (!(this.var_2844.orientation == "BOTTOM")))))
            {
                if (this.var_2844.orientation == "LEFT")
                {
            ...
            if (((this.var_3899["position_vertical_follow_toolbar"] == "true") && ((!(this.var_2844.orientation == "RIGHT")) && (!(this.var_2844.orientation == "LEFT")))))
            {
                if (this.var_2844.orientation == "TOP")
                {
                    this._window.y = (_loc3_ + this.var_3903);
                }
                else
                {
                    this._window.y = ((_loc4_ - this._window.height) - this.var_3903);
                };
            }
            else
            {
        ...
        private function adjustBlend(param1:Number):void
        {
            ...
            this._window.blend = this.var_1033;
        }
