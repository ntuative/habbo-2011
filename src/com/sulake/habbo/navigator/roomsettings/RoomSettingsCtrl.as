package com.sulake.habbo.navigator.roomsettings
{
    ...
    public class RoomSettingsCtrl 
    {
        ...
        private var var_3821:RoomSettingsData;
        ...
        public function load(param1:int):void
        {
            ...
            this._navigator.send(new GetRoomSettingsMessageComposer(this.var_2972));
        ...
        {
            if (param1.roomId != this.var_2972)
            {
                return;
            };
            this.var_3821 = param1;
            this._active = true;
            this.var_3823 = true;
        ...
        {
            if (param1 != this.var_2972)
            {
                return;
            };
            if (!this.controllerExists(param2.userId))
            {
                this.var_3821.controllers.splice(0, 0, param2);
                this.var_3821.controllerCount++;
            };
            if (this.var_3824)
            {
                this.var_2197.roomSettingsRefreshNeeded();
        ...
        private function controllerExists(param1:int):Boolean
        {
            ...
            var _loc2_:int;
            while (_loc2_ < this.var_3821.controllers.length)
            {
                _loc3_ = this.var_3821.controllers[_loc2_];
        ...
        public function onFlatControllerRemoved(param1:int, param2:int):void
        {
            ...
            this.var_3821.controllerCount--;
            var _loc3_:int;
            while (_loc3_ < this.var_3821.controllers.length)
            {
                _loc4_ = this.var_3821.controllers[_loc3_];
                if (_loc4_.userId == param2)
                {
                    this.var_3821.controllers.splice(_loc3_, 1);
                }
                else
                {
                    _loc3_++;
        ...
        {
            if (((!(param1 == this.var_2972)) || (this.var_3822 < 1)))
            {
                return;
            };
            this.close();
        ...
        public function onRoomSettingsSaveError(param1:int, param2:int, param3:String):void
        {
            ...
            this.var_3822 = 0;
            if (param2 == RoomSettingsSaveErrorMessageParser.var_1690)
            {
                this.var_3825.displayError("${navigator.roomsettings.roomnameismandatory}");
            }
            else
            {
                if (param2 == RoomSettingsSaveErrorMessageParser.var_1691)
                {
                    this.var_3825.displayError("${navigator.roomsettings.unacceptablewords}");
                }
                else
                {
                    if (param2 == RoomSettingsSaveErrorMessageParser.var_1692)
                    {
                        this.var_3826.displayError("${navigator.roomsettings.unacceptablewords}");
                    }
                    else
                    {
                        if (param2 == RoomSettingsSaveErrorMessageParser.var_1693)
                        {
                        ...
                        {
                            if (param2 == RoomSettingsSaveErrorMessageParser.var_1694)
                            {
                            ...
                            {
                                if (param2 == RoomSettingsSaveErrorMessageParser.var_1695)
                                {
        ...
        public function refresh(param1:IWindowContainer):void
        {
            ...
            this.var_3842.text = ((this.var_3824) ? "${navigator.roomsettings.tobasicsettings}" : "${navigator.roomsettings.toadvancedsettings}");
            Util.moveChildrenToColumn(this._window, [this.var_3833.name, this.var_3834.name, this.var_3835.name, this.var_3836.name, this.var_3837.name, this._switchViewContainer.name], 0, 0);
        ...
        private function populateForm():void
        {
            ...
            this.var_3823 = false;
            var _loc1_:RoomSettingsData = this.var_3821;
            ...
            this.changePasswordField((_loc1_.doorMode == RoomSettingsData.var_897));
        ...
        {
            return (this._navigator.sessionData.hasUserRight("fuse_hide_room_walls", HabboClubLevelEnum.var_122));
        }
        ...
        private function onSaveButtonClick(param1:WindowMouseEvent):void
        {
            var _loc8_:String;
            var _loc9_:String;
            if ((((this.var_3821 == null) || (this._window == null)) || (this._window.disposed)))
            {
                return;
            };
            var _loc2_:SaveableRoomSettingsData = new SaveableRoomSettingsData();
            _loc2_.roomId = this.var_3821.roomId;
            ...
            switch (_loc4_.name)
            {
                case "doormode_doorbell":
                    _loc2_.doorMode = RoomSettingsFlatInfo.var_896;
                    break;
                case "doormode_password":
                    _loc2_.doorMode = RoomSettingsFlatInfo.var_897;
                    break;
                default:
                    _loc2_.doorMode = RoomSettingsFlatInfo.var_1687;
            };
            if (_loc2_.doorMode == RoomSettingsFlatInfo.var_897)
            {
            ...
            var _loc6_:FlatCategory = this.getFlatCategoryByIndex(this.var_3821.categoryId, _loc5_.selection);
        ...
        {
            Logger.log(("[RoomSettingsCtrl.onDeleteButtonClick] " + this.var_2972));
            this._navigator.registerParameter("navigator.roomsettings.deleteroom.confirm.message", "room_name", this.var_3821.name);
            var _loc2_:ConfirmDialogView = new ConfirmDialogView(IFrameWindow(this._navigator.getXmlWindow("ros_room_delete_confirm")), this, this.onConfirmRoomDelete, [this.var_2972]);
            _loc2_.show();
        }
        ...
        private function refreshFlatControllers():void
        {
            ...
            this._navigator.registerParameter("navigator.roomsettings.flatctrls.caption", "cnt", ("" + this.var_3821.controllerCount));
            _loc4_.visible = true;
            Util.hideChildren(_loc1_);
            var _loc8_:Boolean;
            var _loc9_:int;
            while (_loc9_ < this.var_3821.controllers.length)
            {
                _loc10_ = this.var_3821.controllers[_loc9_];
            ...
            if (this.var_3821.controllers.length > 0)
            {
                _loc1_.visible = true;
                _loc7_.visible = true;
                _loc5_.visible = true;
                if (this.var_3821.controllerCount > this.var_3821.controllers.length)
                {
                    this._navigator.registerParameter("navigator.roomsettings.flatctrls.limitinfo", "cnt", ("" + this.var_3821.controllers.length));
                    _loc6_.visible = true;
                };
                Util.moveChildrenToColumn(this.var_3838, ["flat_ctrls_caption_txt", "flat_ctrls_limit_txt", "flat_controller_list", "flat_ctrls_info_txt", "flat_controllers_footer"], _loc4_.y, 5);
            }
            else
            {
        ...
        private function getFlatCtrl(param1:int):FlatControllerData
        {
            ...
            for each (_loc2_ in this.var_3821.controllers)
            {
        ...
        private function hasSelectedFlatCtrls():Boolean
        {
            ...
            for each (_loc1_ in this.var_3821.controllers)
            {
                if (_loc1_.selected)
                {
                    return (true);
        ...
        private function onRemoveAllFlatCtrlsClick(param1:WindowEvent):void
        {
            ...
            this._navigator.send(new RemoveAllRightsMessageComposer(this.var_2972));
        }
        ...
        private function onRemoveFlatCtrlClick(param1:WindowEvent):void
        {
            ...
            var _loc2_:Array = new Array();
            for each (_loc3_ in this.var_3821.controllers)
            {
                if (_loc3_.selected)
                {
