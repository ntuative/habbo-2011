package com.sulake.habbo.navigator.roomsettings
{
    ...
    public class RoomCreateViewCtrl 
    {
        ...
        public function RoomCreateViewCtrl(param1:HabboNavigator)
        {
            ...
            this.var_3817 = new Array();
            this.var_3817.push(new RoomLayout(HabboClubLevelEnum.var_255, 104, "a"));
            this.var_3817.push(new RoomLayout(HabboClubLevelEnum.var_255, 94, "b"));
            this.var_3817.push(new RoomLayout(HabboClubLevelEnum.var_255, 36, "c"));
            this.var_3817.push(new RoomLayout(HabboClubLevelEnum.var_255, 84, "d"));
            this.var_3817.push(new RoomLayout(HabboClubLevelEnum.var_255, 80, "e"));
            this.var_3817.push(new RoomLayout(HabboClubLevelEnum.var_255, 80, "f"));
            this.var_3817.push(new RoomLayout(HabboClubLevelEnum.var_255, 416, "i"));
            this.var_3817.push(new RoomLayout(HabboClubLevelEnum.var_255, 320, "j"));
            this.var_3817.push(new RoomLayout(HabboClubLevelEnum.var_255, 448, "k"));
            this.var_3817.push(new RoomLayout(HabboClubLevelEnum.var_255, 352, "l"));
            this.var_3817.push(new RoomLayout(HabboClubLevelEnum.var_255, 384, "m"));
            this.var_3817.push(new RoomLayout(HabboClubLevelEnum.var_255, 372, "n"));
            this.var_3817.push(new RoomLayout(HabboClubLevelEnum.var_256, 80, "g"));
            this.var_3817.push(new RoomLayout(HabboClubLevelEnum.var_256, 74, "h"));
            this.var_3817.push(new RoomLayout(HabboClubLevelEnum.var_256, 416, "o"));
            this.var_3817.push(new RoomLayout(HabboClubLevelEnum.var_256, 352, "p"));
            this.var_3817.push(new RoomLayout(HabboClubLevelEnum.var_256, 304, "q"));
            this.var_3817.push(new RoomLayout(HabboClubLevelEnum.var_256, 336, "r"));
            this.var_3817.push(new RoomLayout(HabboClubLevelEnum.var_256, 748, "u"));
            this.var_3817.push(new RoomLayout(HabboClubLevelEnum.var_256, 438, "v"));
            this.var_3817.push(new RoomLayout(HabboClubLevelEnum.var_122, 540, "t"));
            this.var_3817.push(new RoomLayout(HabboClubLevelEnum.var_122, 0x0200, "w"));
            this.var_3817.push(new RoomLayout(HabboClubLevelEnum.var_122, 396, "x"));
            this.var_3817.push(new RoomLayout(HabboClubLevelEnum.var_122, 440, "y"));
            this.var_3817.push(new RoomLayout(HabboClubLevelEnum.var_122, 456, "z"));
            this.var_3817.push(new RoomLayout(HabboClubLevelEnum.var_122, 208, "0"));
        }
        ...
        private function refreshRoomThumbnails():void
        {
            ...
            {
                if (this._navigator.sessionData.hasUserRight("fuse_use_vip_room_layouts", HabboClubLevelEnum.var_122))
                {
                    _loc5_ = null;
                }
                else
        ...
        private function isAllowed(param1:RoomLayout):Boolean
        {
            switch (param1.requiredClubLevel)
            {
                ...
                case HabboClubLevelEnum.var_122:
                    return (this._navigator.sessionData.hasUserRight("fuse_use_vip_room_layouts", HabboClubLevelEnum.var_122));
            };
            return (false);
        }
