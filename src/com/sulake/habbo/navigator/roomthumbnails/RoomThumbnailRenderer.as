package com.sulake.habbo.navigator.roomthumbnails
{
    ...
    public class RoomThumbnailRenderer 
    {
        ...
        private var var_3848:Dictionary;
        private var var_3849:ThumbnailImageConfigurations;
        private var _order:Dictionary = new Dictionary();
        private var var_3850:BitmapData;

        public function RoomThumbnailRenderer(param1:HabboNavigator)
        {
            this._navigator = param1;
            this.var_3849 = new ThumbnailImageConfigurations(this._navigator);
        ...
        public function refreshThumbnail(param1:IWindowContainer, param2:RoomThumbnailData, param3:Boolean):void
        {
            ...
            if (_loc5_ == null)
            {
                ...
                _loc5_ = IBitmapWrapperWindow(this._navigator.windowManager.createWindow(_loc4_, "", HabboWindowType.var_155, HabboWindowStyle.var_156, (HabboWindowParam.var_158 | ((param3) ? HabboWindowParam.var_157 : HabboWindowParam.var_156)), new Rectangle(0, 0, _loc7_.width, _loc7_.height)));
        ...
        private function refreshBg(param1:BitmapData, param2:int):void
        {
            ...
            var _loc3_:ThumbnailImageConfiguration = this.var_3849.getImage(ThumbnailEditorModel.var_904, param2);
            if (_loc3_ == null)
            {
                Logger.log(("Unknown bg image id: " + param2));
                _loc3_ = this.var_3849.getImage(ThumbnailEditorModel.var_904, 1);
            };
        ...
        private function refreshFront(param1:BitmapData, param2:int):void
        {
            ...
            var _loc3_:ThumbnailImageConfiguration = this.var_3849.getImage(ThumbnailEditorModel.var_905, param2);
            if (_loc3_ == null)
            {
        ...
        {
            if (this.var_3850 == null)
            {
                this.var_3850 = this._navigator.getButtonImage("rico_rnd");
            };
            param1.copyPixels(this.var_3850, this.var_3850.rect, new Point(0, 0), null, null, true);
        }

        private function refreshObj(param1:BitmapData, param2:RoomThumbnailObjectData):void
        {
            var _loc3_:ThumbnailImageConfiguration = this.var_3849.getImage(ThumbnailEditorModel.var_908, param2.imgId);
            if (_loc3_ == null)
            {
        ...
        {
            return (Point(this.var_3848[param1]));
        }
