package com.sulake.habbo.navigator.roomthumbnails
{
    ...
    public class RoomThumbnailCtrl
    {
        ...
        public function RoomThumbnailCtrl(param1: HabboNavigator)
        {
            ...
            this._model = new ThumbnailEditorModel();
        }
        ...
        public function set active(param1: Boolean): void
        {
            ...
            if (this._active)
            {
                this._model.data = this._navigator.data.enteredGuestRoom.thumbnail.getCopy();
            }
        ...
        private function onSaveButton(param1: WindowEvent, param2: IWindow): void
        {
            ...
            var _loc3_: Array = [];
            for each (_loc4_ in this._model.data.objects)
            {
                if (_loc4_.imgId > 0)
                {
                    _loc3_.push(_loc4_);
            ...
            _loc5_ = new UpdateRoomThumbnailMessageComposer(this._navigator.data.enteredGuestRoom.flatId, this._model.data.bgImgId, this._model.data.frontImgId, _loc3_.length);
        ...
        private function onBgTabButton(param1: WindowEvent, param2: IWindow): void
        {
            ...
            this._model.mode = ThumbnailEditorModel.MODE_IMAGE_BACKGROUND;
            this.reload();
        }
        ...
        private function onTopTabButton(param1: WindowEvent, param2: IWindow): void
        {
            ...
            this._model.mode = ThumbnailEditorModel.MODE_IMAGE_FOREGROUND;
            this.reload();
        }
        ...
        private function onObjTabButton(param1: WindowEvent, param2: IWindow): void
        {
            ...
            this._model.mode = ThumbnailEditorModel.MODE_IMAGE_DEFAULT;
            this.reload();
        }
        ...
        {
            this.setEnabled(this.var_3843, this._model.mode != ThumbnailEditorModel.MODE_IMAGE_BACKGROUND);
            this.setEnabled(this.var_3844, this._model.mode != ThumbnailEditorModel.MODE_IMAGE_FOREGROUND);
            this.setEnabled(this.var_3845, this._model.mode != ThumbnailEditorModel.MODE_IMAGE_DEFAULT);
        }
        ...
        private function refreshEditArea(): void
        {
            ...
            this.refreshEditImg(_loc1_, "edit_bg", this._model.mode == ThumbnailEditorModel.MODE_IMAGE_BACKGROUND);
            this.refreshEditImg(_loc1_, "edit_top", this._model.mode == ThumbnailEditorModel.MODE_IMAGE_FOREGROUND);
            this.refreshEditImg(_loc1_, "edit_obj", this._model.mode == ThumbnailEditorModel.MODE_IMAGE_DEFAULT, false);
            if (this._model.mode == ThumbnailEditorModel.MODE_IMAGE_DEFAULT)
            {
        ...
        private function refreshPositionGrid(): void
        {
            ...
            _loc2_.visible = true;
            this.refreshTileLoc(_loc2_, this._model.selected.pos);
        ...
        {
            var _loc3_: int;
            var _loc2_: Dictionary = this._model.getBlockedPositions();
            while (_loc3_ <= RoomThumbnailRenderer.var_901)
            {
        ...
        {
            this.refreshImgSelector(ThumbnailEditorModel.MODE_IMAGE_BACKGROUND);
            this.refreshImgSelector(ThumbnailEditorModel.MODE_IMAGE_FOREGROUND);
            this.refreshImgSelector(ThumbnailEditorModel.MODE_IMAGE_DEFAULT);
        }
        ...
        private function refreshImgSelector(param1: int): void
        {
            ...
            var _loc5_: int = this._model.getImgId();
            var _loc6_: int;
        ...
        private function setEnabled(button: IButtonWindow, value: Boolean): void
        {
            if (value)
            {
                button.enable();
        ...
        {
            this._navigator.thumbRenderer.refreshThumbnail(IWindowContainer(this._window.findChildByName("picframe")), this._model.data, false);
        }
