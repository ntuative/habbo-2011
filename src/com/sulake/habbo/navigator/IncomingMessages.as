    ...
    public class IncomingMessages 
    {
        ...
        private function onRoomInfo(param1:IMessageEvent):void
        {
            ...
            else
            {
                ...
                {
                    if (((_loc2_.data.doorMode == RoomSettingsData.var_896) && (!(this._navigator.sessionData.userName == _loc2_.data.ownerName))))
                    {
                        this._navigator.doorbell.show(_loc2_.data);
                    }
                    else
                    {
                        if (((_loc2_.data.doorMode == RoomSettingsData.var_897) && (!(this._navigator.sessionData.userName == _loc2_.data.ownerName))))
                        {
        ...
        private function onFlatCreated(param1:IMessageEvent):void
        {
            ...
            this._navigator.mainViewCtrl.reloadRoomList(Tabs.var_166);
        }
        ...
        private function onUserFlatCats(param1:IMessageEvent):void
        {
            ...
            var _loc3_:RoomsTabPageDecorator = RoomsTabPageDecorator(this._navigator.tabs.getTab(Tabs.var_160).tabPageDecorator);
        ...
        private function onCanCreateRoom(param1:IMessageEvent):void
        {
            ...
            else
            {
                ...
                if (this._navigator.sessionData.hasUserRight("fuse_can_create_more_rooms", HabboClubLevelEnum.var_122))
                {
