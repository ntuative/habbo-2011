package com.sulake.habbo.navigator
{
    ...
    public class RoomPopupCtrl extends PopupCtrl
    {
        ...
        override public function refreshContent(param1: IWindowContainer): void
        {
            ...
            this.refreshTextWithCaption("roomctg", this.var_3871, this.var_2955.event
                    ? this.getEventCtg(this.var_2955.categoryId)
                    : this.getRoomCtg(this.var_2955.categoryId));
            ...
            Util.moveChildrenToColumn(this.var_3871, [
                "roomname",
                "roomctg_cont",
                "roomowner_cont",
                "roomdesc",
        ...
        private function onOwnerName(param1: WindowEvent, param2: IWindow): void
        {
            ...
            if (_loc3_ != null)
            {
                navigator.mainViewCtrl.startSearch(Tabs.TAB_SEARCH_PAGE, Tabs.SEARCH_TYPE_TEXT_SEARCH, _loc3_.text);
                this.hideInstantly();
            }
