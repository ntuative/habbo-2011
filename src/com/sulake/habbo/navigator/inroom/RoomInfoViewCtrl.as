package com.sulake.habbo.navigator.inroom
{
    ...
    public class RoomInfoViewCtrl implements IRoomSettingsCtrlOwner
    {
        ...
        public function close(): void
        {
            if (this.var_3790)
            {
                this._navigator.toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.HTSME_HIDE_WINDOW, HabboToolbarIconEnum.ROOMINFO, this._window, false));
            }
        ...
        public function open(param1: Boolean): void
        {
            ...
            if (this.var_3790)
            {
                this._navigator.toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.HTSME_ANIMATE_MENU_IN, HabboToolbarIconEnum.ROOMINFO, this._window, false));
            }
        ...
        public function toggle(): void
        {
            ...
            if (this.var_3790)
            {
                ...
                {
                    this._navigator.toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.HTSME_ANIMATE_MENU_OUT, HabboToolbarIconEnum.ROOMINFO, this._window, false));
                }
        ...
        private function refresh(): void
        {
            ...
            {
                Util.moveChildrenToColumn(this.var_1997, [
                    "room_info",
                    "event_info",
                    "embed_info",
                    "buttons_container"
        ...
        private function refreshRoomDetails(param1: GuestRoomData, param2: Boolean): void
        {
            ...
            Util.moveChildrenToColumn(this.var_3759, [
                "room_name",
                "owner_name_cont",
                "tags",
                "room_desc",
        ...
        private function refreshStuffPick(): void
        {
            ...
            _loc1_.visible = true;
            _loc1_.caption = this._navigator.getText(this._navigator.data.currentRoomIsStaffPick
                                                             ? "navigator.staffpicks.unpick"
                                                             : "navigator.staffpicks.pick");
        }
        ...
        private function refreshEventDetails(param1: RoomEventData): void
        {
            ...
            this.var_3757.refreshTags(this.var_3770, [
                this._navigator.getText("roomevent_type_" + param1.eventType),
                param1.tags[0],
                param1.tags[1]
            ]);
        ...
        private function prepareWindow(): void
        {
            ...
            Util.moveChildrenToRow(this.var_3762, [
                "rating_caption",
                "rating_txt"
            ], this.var_3768.x, this.var_3768.y, 3);
        ...
        private function onZoomClick(param1: WindowEvent, param2: IWindow): void
        {
            ...
            var _loc3_: HabboToolbarEvent = new HabboToolbarEvent(HabboToolbarEvent.HTE_TOOLBAR_CLICK);
        ...
        {
            if (!this.var_3790 || param1.type != HabboToolbarEvent.HTE_TOOLBAR_CLICK)
            {
                return;
            }
