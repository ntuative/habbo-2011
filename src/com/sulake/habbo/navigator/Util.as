package com.sulake.habbo.navigator
{
    ...
    public class Util
    {
        ...
        private static var var_3882: CutToWidth = new CutToWidth();
        private static var var_3883: CutToHeight = new CutToHeight();
        ...
        public static function setProc(param1: IWindowContainer, param2: String, param3: Function): void
        {
            ...
            _loc4_.setParamFlag(HabboWindowParam.var_157, true);
        ...
        public static function fillParams(param1: String, param2: Dictionary): String
        {
            ...
            while (_loc4_ < 10)
            {
                ...
                _loc6_ = param1.indexOf(_loc3_, _loc5_ + 1);
                if (_loc6_ < 0)
                {
                    break;
                }
        ...
        public static function cutTextToWidth(param1: ITextWindow, param2: String, param3: int): void
        {
            ...
            var_3882.beforeSearch(param2, param1, param3);
            binarySearch(var_3882, param2.length - 1);
        }
        ...
        public static function cutTextToHeight(param1: ITextWindow, param2: String, param3: int): void
        {
            ...
            var_3883.beforeSearch(param2, param1, param3);
            binarySearch(var_3883, param2.length - 1);
        }
