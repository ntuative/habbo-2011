package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
    ...
    public class RoomsTabPageDecorator implements ITabPageDecorator
    {
        ...
        private function startSearch(): void
        {
            ...
            if (_loc1_ == 0)
            {
                this._navigator.mainViewCtrl.startSearch(Tabs.TAB_ROOMS_PAGE, Tabs.SEARCH_TYPE_POPULAR_ROOMS);
            }
            else
            {
                if (_loc1_ == 1)
                {
                    this._navigator.mainViewCtrl.startSearch(Tabs.TAB_ROOMS_PAGE, Tabs.SEARCH_TYPE_ROOMS_WITH_HIGHEST_SCORE);
                }
                else
                {
                    ...
                    this._navigator.mainViewCtrl.startSearch(Tabs.TAB_ROOMS_PAGE, Tabs.SEARCH_TYPE_POPULAR_ROOMS, "" + _loc3_);
                }
