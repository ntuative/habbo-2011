    ...
    public class OfficialRoomEntryManager implements IDisposable 
    {
        ...
        public function refreshEntry(param1:IWindowContainer, param2:Boolean, param3:int, param4:OfficialRoomEntryData):void
        {
            ...
            if (param2)
            {
                ...
                if (param4.type == OfficialRoomEntryData.var_909)
                {
        ...
        private function refreshUserCount(param1:IWindowContainer, param2:OfficialRoomEntryData):void
        {
            ...
            var _loc4_:int;
            var _loc5_:int;
            if (((param2.showDetails) && ((param2.type == OfficialRoomEntryData.var_910) || (param2.type == OfficialRoomEntryData.var_911))))
            {
                _loc3_ = 3;
                _loc4_ = 34;
                _loc5_ = 13;
        ...
        private function handleClick(param1:IWindow):void
        {
            ...
            if (_loc2_.guestRoomData != null)
            {
                ...
                if (_loc2_.guestRoomData.doorMode == RoomSettingsFlatInfo.var_897)
                {
            ...
            else
            {
                if (_loc2_.tag != null)
                {
                    ...
                    this._navigator.mainViewCtrl.startSearch(Tabs.var_164, Tabs.var_165, _loc2_.tag);
                }
                else
                {
