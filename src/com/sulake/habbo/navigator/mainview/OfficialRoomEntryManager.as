package com.sulake.habbo.navigator.mainview
{
    ...
    public class OfficialRoomEntryManager implements IDisposable
    {
        ...
        private static const var_913: int = 267;
        private static const var_912: int = 65;
        private static const var_914: int = -70;

        private var _disposed: Boolean;
        private var _navigator: HabboNavigator;
        private var _userCountRenderer: UserCountRenderer;
        private var var_3810: PublicRoomThumbs = new PublicRoomThumbs();
        ...
        public function refreshEntry(param1: IWindowContainer, param2: Boolean, param3: int, param4: OfficialRoomEntryData): void
        {
            ...
            if (param2)
            {
                ...
                if (param4.type == OfficialRoomEntryData.UNKNOWN2)
                {
        ...
        private function refreshUserCount(param1: IWindowContainer, param2: OfficialRoomEntryData): void
        {
            ...
            var _loc4_: int;
            var _loc5_: int;
            if (param2.showDetails && (param2.type == OfficialRoomEntryData.GUEST_ROOM || param2.type == OfficialRoomEntryData.PUBLIC_ROOM))
            {
                _loc3_ = 3;
                _loc4_ = 34;
                _loc5_ = 13;
        ...
        private function refreshCell(param1: IWindowContainer, param2: OfficialRoomEntryData): void
        {
            ...
            _loc3_.visible = true;
            _loc3_.width = param2.showDetails ? var_912 : var_913;
        ...
        {
            var _loc4_: String = this.var_3810.resolveRoomImageName(param2);
            ...
            param3.x = param2.showDetails ? var_914 : 0;
        ...
        private function handleClick(param1: IWindow): void
        {
            ...
            if (_loc2_.guestRoomData != null)
            {
                ...
                if (_loc2_.guestRoomData.doorMode == RoomSettingsFlatInfo.DOOR_MODE_PASSWORD)
                {
            ...
            else
            {
                if (_loc2_.tag != null)
                {
                    ...
                    this._navigator.mainViewCtrl.startSearch(Tabs.TAB_SEARCH_PAGE, Tabs.SEARCH_TYPE_TAG_SEARCH, _loc2_.tag);
                }
                else
                {
        ...
        {
            return this._navigator.data.guestRoomSearchResults == null
                    ? null
                    : this._navigator.data.guestRoomSearchResults.ad;
        }
