package com.sulake.habbo.roomevents.userdefinedroomevents
{
    ...
    public class UserDefinedRoomEventsCtrl 
    {
        ...
        public static var var_624:int = 3;
        private static var var_625:int = 2;

        private var var_4378:HabboUserDefinedRoomEvents;
        private var _window:IFrameWindow;
        private var var_4395:IWindowContainer;
        private var var_4396:TriggerConfs = new TriggerConfs();
        private var var_4397:ActionTypes = new ActionTypes();
        private var var_4398:ConditionTypes = new ConditionTypes();
        private var var_4399:Dictionary = new Dictionary();
        private var var_4400:Triggerable;
        private var var_4401:RoomObjectHightLighter;
        private var var_3498:UserDefinedRoomEventsHelp;
        private var var_4402:SliderWindowController;

        public function UserDefinedRoomEventsCtrl(param1:HabboUserDefinedRoomEvents)
        {
            this.var_4378 = param1;
            this.var_4401 = new RoomObjectHightLighter(param1);
            this.var_3498 = new UserDefinedRoomEventsHelp(param1);
        }
        ...
        public function stuffSelected(param1:int, param2:String):void
        {
            ...
            if (this.var_4399[param1])
            {
                delete this.var_4399[param1];
                this.var_4401.hide(param1);
            }
            else
            {
                if (this.getStuffIds().length < this.var_4400.furniLimit)
                {
                    this.var_4399[param1] = param2;
                    this.var_4401.show(param1);
                };
            };
            this.refresh();
        }
        ...
        {
            return (this.resolveHolder().getElementByCode(this.var_4400.code));
        }

        private function resolveHolder():ElementTypeHolder
        {
            if ((this.var_4400 as TriggerDefinition) != null)
            {
                return (this.var_4396);
            };
            if ((this.var_4400 as ActionDefinition) != null)
            {
                return (this.var_4397);
            };
            if ((this.var_4400 as ConditionDefinition) != null)
            {
                return (this.var_4398);
            };
            return (null);
        }
        ...
        private function prepareWindow():void
        {
            ...
            this._window = IFrameWindow(this.var_4378.getXmlWindow("ude_main"));
            this.var_4395 = IWindowContainer(this.find(this._window, "configure_container"));
            Util.setProcDirectly(this.find(this.var_4395, "save_button"), this.onSave);
            Util.setProcDirectly(this.find(this.var_4395, "cancel_save_button"), this.onWindowClose);
            Util.setProcDirectly(this.find(this.var_4395, "helplink"), this.onHelp);
            Util.setProcDirectly(this.find(this.var_4395, "apply_snapshot_txt"), this.onApplySnapshot);
            Util.setProcDirectly(this.find(this.var_4395, "dec_stuff_sel_txt"), this.onDecStuffSelectionType);
            Util.setProcDirectly(this.find(this.var_4395, "inc_stuff_sel_txt"), this.onIncStuffSelectionType);
            this.find(this.var_4395, "dec_stuff_sel_txt").mouseThreshold = 0;
            this.find(this.var_4395, "inc_stuff_sel_txt").mouseThreshold = 0;
            this.find(this.var_4395, "helplink").mouseThreshold = 0;
            this.find(this.var_4395, "apply_snapshot_txt").mouseThreshold = 0;
            this.var_4402 = new SliderWindowController(this.var_4378, IWindowContainer(this.find(this.var_4395, "delay_slider_container")), this.var_4378.assets, 0, 20, 1);
            this.var_4402.addEventListener(Event.CHANGE, this.onDelaySliderChange);
            this.var_4402.setValue(0);
        ...
        private function onDelaySliderChange(param1:Event):void
        {
            ...
            if (param1.type == Event.CHANGE)
            {
                ...
                if (_loc2_)
                {
                    ...
                    this.var_4378.localization.registerParameter("wiredfurni.params.delay", "seconds", _loc5_);
                };
            };
        }
        ...
        private function setIcon(param1:String, param2:String, param3:String="icon_bitmap"):void
        {
            ...
            this.var_4378.refreshButton(_loc4_, param3, true, null, 0, param2);
        }
        ...
        public function close():void
        {
            if (this._window)
            {
                ...
                this.var_4401.hideAll(this.var_4399);
            };
        }
        ...
        public function prepareForUpdate(param1:Triggerable):void
        {
            ...
            Logger.log(((("Received: " + this.var_4400) + ", ") + param1.code));
            var _loc2_:Element = this.resolveType();
            this.var_4401.hideAll(this.var_4399);
            this.var_4399 = new Dictionary();
            for each (_loc3_ in this.var_4400.stuffIds)
            {
                this.var_4399[_loc3_] = "yes";
            };
            _loc4_ = ((_loc2_.hasSpecialInputs) ? this.prepareCustomInput() : null);
            _loc2_.onEditStart(_loc4_, this.var_4400);
            this.var_4401.showAll(this.var_4399);
            if ((this.var_4400 as ActionDefinition) != null)
            {
                _loc5_ = ActionDefinition(this.var_4400);
                _loc6_ = _loc5_.delayInPulses;
                this.var_4402.setValue(_loc6_);
            };
        ...
        private function prepareStuffSelectionForUpdate():void
        {
            ...
            if (this.var_4400.stuffTypeSelectionEnabled)
            {
                ...
                if (_loc2_.requiresFurni == STUFF_SELECTION_OPTION_BY_ID_OR_BY_TYPE)
                {
                    ...
                    this.getFurniTypeMatchesText().caption = this.var_4378.localization.getKey("wiredfurni.pickfurnis.furnitypematches");
                    this.getFurniTypeMatchesCheckBox().visible = true;
                    this.getFurniTypeMatchesText().visible = true;
                }
                else
                {
                    if (_loc2_.requiresFurni == var_624)
                    {
            ...
            var _loc1_:IWindowContainer = IWindowContainer(this.var_4395.findChildByName("select_furni_container"));
            _loc1_.height = Util.getLowestPoint(_loc1_);
        }

        private function refreshStuffTypeSelectionToggler():void
        {
            this.getFurniTypeMatchesText().caption = this.var_4378.localization.getKey(("wiredfurni.pickfurnis.stuffselectiontype." + this.var_4400.stuffTypeSelectionCode));
        }
        ...
        private function onSave(param1:WindowEvent, param2:IWindow):void
        {
            ...
            if ((this.var_4400 as TriggerDefinition) != null)
            {
                this.var_4378.send(new UpdateTriggerMessageComposer(this.var_4400.id, this.resolveIntParams(), this.resolveStringParam(), this.getStuffIds(), this.resolveStuffSelectionType()));
            }
            else
            {
                if ((this.var_4400 as ActionDefinition) != null)
                {
                    this.var_4378.send(new UpdateActionMessageComposer(this.var_4400.id, this.resolveIntParams(), this.resolveStringParam(), this.getStuffIds(), this.getActionDelay(), this.resolveStuffSelectionType()));
                }
                else
                {
                    if ((this.var_4400 as ConditionDefinition) != null)
                    {
                        this.var_4378.send(new UpdateConditionMessageComposer(this.var_4400.id, this.resolveIntParams(), this.resolveStringParam(), this.getStuffIds(), this.resolveStuffSelectionType()));
                    };
                };
            };
            this.close();
        ...
        public function getActionDelay():int
        {
            ...
            return ((_loc1_.allowDelaying) ? this.var_4402.getValue() : 0);
        }
        ...
        private function onHelp(param1:WindowEvent, param2:IWindow):void
        {
            ...
            this.var_3498.open(((this._window.x + this._window.width) + 5), this._window.y);
        }
        ...
        private function onDecStuffSelectionType(param1:WindowEvent, param2:IWindow):void
        {
            ...
            this.var_4400.stuffTypeSelectionCode = ((this.var_4400.stuffTypeSelectionCode < 1) ? var_625 : (this.var_4400.stuffTypeSelectionCode - 1));
            this.refreshStuffTypeSelectionToggler();
        }
        ...
        private function onIncStuffSelectionType(param1:WindowEvent, param2:IWindow):void
        {
            ...
            this.var_4400.stuffTypeSelectionCode = ((this.var_4400.stuffTypeSelectionCode + 1) % (var_625 + 1));
            this.refreshStuffTypeSelectionToggler();
        }
        ...
        private function onApplySnapshot(param1:WindowEvent, param2:IWindow):void
        {
            ...
            this.var_4378.send(new ApplySnapshotMessageComposer(this.var_4400.id));
        }
        ...
        private function resolveStuffSelectionType():int
        {
            ...
            if (_loc1_.requiresFurni == var_624)
            {
                return (this.var_4400.stuffTypeSelectionCode);
            };
            return (0);
        }
        ...
        {
            this.var_4395.visible = false;
            this.refreshConfigureElement(this.var_4396);
            this.refreshConfigureElement(this.var_4397);
            this.refreshConfigureElement(this.var_4398);
        ...
        {
            if (!param1.acceptTriggerable(this.var_4400))
            {
                this.find(this.var_4395, (param1.getKey() + "_icon_bitmap")).visible = false;
                return;
            };
            this.var_4395.visible = true;
            var _loc2_:Element = this.resolveType();
            this.refreshHeader(_loc2_, param1.getKey());
            this.refreshCustomInputs();
            this.refreshSelectFurni();
            this.find(this.var_4395, "warning_container").visible = false;
            this.refreshConflictingTriggers();
            this.refreshConflictingActions();
            this.refreshActionInputs();
            Util.moveAllChildrenToColumn(this.var_4395, 3, 5);
            this.var_4395.height = (Util.getLowestPoint(this.var_4395) + 1);
        }

        private function getElementName(param1:int):String
        {
            var _loc2_:IFurnitureData = this.var_4378.sessionDataManager.getFloorItemData(param1);
            if (_loc2_ == null)
            {
        ...
        {
            var _loc3_:IWindowContainer = IWindowContainer(this.find(this.var_4395, "header_container"));
            this.find(_loc3_, (param2 + "_icon_bitmap")).visible = true;
            this.setText(_loc3_, "conf_name_txt", this.getElementName(this.var_4400.stuffTypeId));
            this.setText(_loc3_, "conf_desc_txt", this.getElementDesc(this.var_4400.stuffTypeId));
        ...
        {
            var _loc1_:IWindowContainer = IWindowContainer(this.find(this.var_4395, "action_inputs_container"));
            if ((this.var_4400 as ActionDefinition) == null)
            {
        ...
        private function refreshConflictingTriggers():void
        {
            ...
            var _loc1_:ActionDefinition = ActionDefinition(this.var_4400);
            ...
            this.var_4378.localization.registerParameter("wiredfurni.conflictingtriggers.text", "triggers", _loc2_);
            this.refreshWarning(this.var_4378.localization.getKey("wiredfurni.conflictingtriggers.caption"), this.var_4378.localization.getKey("wiredfurni.conflictingtriggers.text"));
        }
        ...
        private function refreshConflictingActions():void
        {
            ...
            var _loc1_:TriggerDefinition = TriggerDefinition(this.var_4400);
            ...
            this.var_4378.localization.registerParameter("wiredfurni.conflictingactions.text", "actions", _loc2_);
            this.refreshWarning(this.var_4378.localization.getKey("wiredfurni.conflictingactions.caption"), this.var_4378.localization.getKey("wiredfurni.conflictingactions.text"));
        }

        private function refreshWarning(param1:String, param2:String):void
        {
            var _loc3_:IWindowContainer = IWindowContainer(this.find(this.var_4395, "warning_container"));
            ...
            _loc3_.height = (Util.getLowestPoint(_loc3_) + 4);
            this.find(this.var_4395, "warning_container").visible = true;
        }

        private function refreshCustomInputs():void
        {
            var _loc2_:IWindowContainer;
            var _loc1_:IWindowContainer = IWindowContainer(this.var_4395.findChildByName("custom_inputs_container"));
        ...
        private function prepareCustomInput():IWindowContainer
        {
            ...
            var _loc2_:Element = this.resolveType();
            var _loc3_:IWindowContainer = IWindowContainer(this.var_4395.findChildByName("custom_inputs_container"));
            var _loc4_:String = (_loc1_.getKey() + _loc2_.code);
            var _loc5_:IWindowContainer = IWindowContainer(_loc3_.getChildByName(_loc4_));
            if (_loc5_ == null)
            {
                _loc5_ = IWindowContainer(this.var_4378.getXmlWindow(((("ude_" + _loc1_.getKey()) + "_inputs_") + _loc2_.code)));
                _loc5_.name = _loc4_;
                _loc3_.addChild(_loc5_);
                _loc2_.onInit(_loc5_, this.var_4378);
            };
            return (_loc5_);
        }
        ...
        private function refreshSelectFurni():void
        {
            ...
            var _loc4_:int = this.var_4400.furniLimit;
            this.var_4378.localization.registerParameter("wiredfurni.pickfurnis.caption", "count", ("" + _loc3_));
            this.var_4378.localization.registerParameter("wiredfurni.pickfurnis.caption", "limit", ("" + _loc4_));
        }

        private function getFurniTypeMatchesCheckBox():ICheckBoxWindow
        {
            return (ICheckBoxWindow(this.var_4395.findChildByName("furni_type_matches_checkbox")));
        }

        private function getDecStuffSelTxt():IWindow
        {
            return (this.var_4395.findChildByName("dec_stuff_sel_txt"));
        }

        private function getIncStuffSelTxt():IWindow
        {
            return (this.var_4395.findChildByName("inc_stuff_sel_txt"));
        }

        private function getFurniTypeMatchesText():IWindow
        {
            return (this.var_4395.findChildByName("furni_type_matches_txt"));
        }
