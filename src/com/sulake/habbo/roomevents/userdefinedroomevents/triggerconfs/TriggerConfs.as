package com.sulake.habbo.roomevents.userdefinedroomevents.triggerconfs
{
    ...
    public class TriggerConfs implements ElementTypeHolder
    {
        ...
        {
            this.var_4393.push(new AvatarSaysSomething());
            this.var_4393.push(new AvatarEntersStuff());
            this.var_4393.push(new AvatarExitsStuff());
            this.var_4393.push(new TriggerOnce());
            this.var_4393.push(new StuffIsUsed());
            this.var_4393.push(new TriggerPeriodically());
            this.var_4393.push(new AvatarEntersRoom());
            this.var_4393.push(new GameStarts());
            this.var_4393.push(new GameEnds());
            this.var_4393.push(new ScoreAchieved());
            this.var_4393.push(new AvatarCaught());
