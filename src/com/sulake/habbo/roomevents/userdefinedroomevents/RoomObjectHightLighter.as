package com.sulake.habbo.roomevents.userdefinedroomevents
{
    ...
    public class RoomObjectHightLighter
    {
        ...
        {
            return this.var_4378.roomEngine.getRoomObject(this.var_4378.roomId, this.var_4378.roomCategory, param1, RoomObjectCategoryEnum.var_72);
        }
