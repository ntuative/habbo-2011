package com.sulake.habbo.roomevents.userdefinedroomevents.conditions
{
    ...
    public class ConditionTypes implements ElementTypeHolder
    {
        ...
        {
            this.var_2374.push(new ActorIsOnFurni());
            this.var_2374.push(new FurnisHaveAvatars());
            this.var_2374.push(new StatesMatch());
            this.var_2374.push(new TimeElapsedMore());
            this.var_2374.push(new TimeElapsedLess());
            this.var_2374.push(new UserCountIn());
            this.var_2374.push(new ActorIsInTeam());
            this.var_2374.push(new HasStackedFurnis());
            this.var_2374.push(new StuffTypeMatches());
