    ...
    public class HabboConfigurationManager extends Component implements IHabboConfigurationManager
    {
        ...
        private function init(): void
        {
            ...
            if (!this.var_2047)
            {
                ...
                _loc3_.addEventListener(AssetLoaderEvent.ASSET_LOADER_EVENT_ERROR, this.onConfigurationError);
            }
        ...
        private function onConfigurationError(param1: Event = null): void
        {
            ...
            Core.error("Could not load external variables. URL " + this.getKey("external.variables.txt") + "HTTP status " + _loc3_ + ". Client startup failed!", true, Core.ERROR_CATEGORY_DOWNLOAD_EXTERNAL_VARS);
        }
        ...
        private function onInitConfiguration(param1: Event = null): void
        {
            ...
            if (_loc4_ && _loc4_ != "")
            {
                ...
                _loc6_.addEventListener(AssetLoaderEvent.ASSET_LOADER_EVENT_ERROR, this.onConfigurationOverrideError);
            }
            else
            {
                if (!this.var_2047)
