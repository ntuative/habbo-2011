package com.sulake.habbo.room.object
{
    ...
    public class RoomPlaneBitmapMaskParser 
    {
        ...
        private var var_4189:Map = null;

        public function RoomPlaneBitmapMaskParser()
        {
            this.var_4189 = new Map();
        }
        ...
        {
            if (this.var_4189 != null)
            {
                this.reset();
                this.var_4189.dispose();
                this.var_4189 = null;
            };
        }
        ...
        public function initialize(param1:XML):Boolean
        {
            ...
            while (_loc6_ < _loc5_.length())
            {
                ...
                this.var_4189.add(_loc8_, _loc14_);
                _loc6_++;
            };
            return (true);
        }
        ...
        public function reset():void
        {
            ...
            var _loc1_:int;
            while (_loc1_ < this.var_4189.length)
            {
                _loc2_ = (this.var_4189.getWithIndex(_loc1_) as RoomPlaneBitmapMaskData);
                if (_loc2_ != null)
                {
                    _loc2_.dispose();
                };
        ...
        public function addMask(param1:String, param2:String, param3:IVector3d, param4:String):void
        {
            ...
            this.var_4189.remove(param1);
            this.var_4189.add(param1, _loc5_);
        }

        public function removeMask(param1:String):Boolean
        {
            var _loc2_:RoomPlaneBitmapMaskData = (this.var_4189.remove(param1) as RoomPlaneBitmapMaskData);
            if (_loc2_ != null)
            {
                _loc2_.dispose();
                return (true);
        ...
        public function getMaskLocation(param1:int):IVector3d
        {
            ...
            var _loc2_:RoomPlaneBitmapMaskData = (this.var_4189.getWithIndex(param1) as RoomPlaneBitmapMaskData);
            if (_loc2_ != null)
            {
                return (_loc2_.loc);
            };
