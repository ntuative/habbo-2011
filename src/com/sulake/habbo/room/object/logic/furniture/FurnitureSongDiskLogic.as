package com.sulake.habbo.room.object.logic.furniture
{
    ...
    public class FurnitureSongDiskLogic extends FurnitureLogic
    {
        ...
        override public function processUpdateMessage(param1: RoomObjectUpdateMessage): void
        {
            ...
            {
                _loc2_ = object.getModelController().getString(RoomObjectVariableEnum.FURNITURE_EXTRAS);
                _loc3_ = int(_loc2_);
                object.getModelController()
                        .setString(RoomWidgetInfostandExtraParamEnum.var_1211, RoomWidgetInfostandExtraParamEnum.var_1221 + _loc3_);
            }
