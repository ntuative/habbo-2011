package com.sulake.habbo.room.object.logic.furniture
{
    ...
    public class FurnitureJukeboxLogic extends FurnitureMultiStateLogic
    {
        ...
        {
            var _loc1_: Array = [
                RoomObjectFurnitureActionEvent.var_1207,
                RoomObjectFurnitureActionEvent.var_1208,
                RoomObjectFurnitureActionEvent.var_1209,
                RoomObjectFurnitureActionEvent.var_1210,
                RoomObjectWidgetRequestEvent.var_419
            ];
        ...
        override public function processUpdateMessage(param1: RoomObjectUpdateMessage): void
        {
            ...
            if (object.getModelController().getNumber(RoomObjectVariableEnum.FURNITURE_REAL_ROOM_OBJECT) == 1)
            {
                object.getModelController()
                        .setString(RoomWidgetInfostandExtraParamEnum.var_1211, RoomWidgetInfostandExtraParamEnum.var_1212);
