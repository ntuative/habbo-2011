package com.sulake.habbo.room.object.logic.furniture
{
    ...
    public class FurnitureBillboardLogic extends FurnitureLogic
    {
            ...
            if (param1 is RoomObjectRoomAdUpdateMessage)
            {
                ...
                switch (_loc2_.type)
                {
                    ...
                    case RoomObjectRoomAdUpdateMessage.RORUM_ROOM_BILLBOARD_IMAGE_LOADING_FAILED:
                        ...
                        Logger.log("failed to load billboard image from url " + object.getModelController()
                                .getString(RoomObjectVariableEnum.var_751));
                        break;
                }
        ...
        private function setupBillBoard(): void
        {
            ...
            if (object != null)
            {
                _loc1_ = object.getModel().getString(RoomObjectVariableEnum.FURNITURE_DATA);
                if (_loc1_ != null)
                {
                    _loc2_ = _loc1_.split("\t");
                    if (_loc2_ != null && _loc2_.length >= 2)
                    {
                        ...
                        object.getModelController()
                                .setString(RoomObjectVariableEnum.FURNITURE_BILLBOARD_CLICK_URL, _loc4_);
