package com.sulake.habbo.room.object.logic.furniture
{
    ...
    public class FurniturePushableLogic extends FurnitureMultiStateLogic 
    {
        ...
        private static const var_1206:int = 0;
        private static const var_3965:int = 1;
        private static const var_1205:int = 10;

        private var var_3966:Vector3d = null;

        public function FurniturePushableLogic()
        {
            moveUpdateInterval = var_1178;
            this.var_3966 = new Vector3d();
        }
        ...
        override public function processUpdateMessage(param1:RoomObjectUpdateMessage):void
        {
            ...
            if (_loc3_ != null)
            {
                if (_loc3_.state > 0)
                {
                    moveUpdateInterval = (var_1178 / this.getUpdateIntervalValue(_loc3_.state));
                }
                else
                {
        ...
        override public function update(param1:int):void
        {
            if (object != null)
            {
                this.var_3966.assign(object.getLocation());
                super.update(param1);
                if (Vector3d.dif(object.getLocation(), this.var_3966).length == 0)
                {
                    if (object.getState(0) != var_1206)
                    {
                        object.setState(var_1206, 0);
                    };
                };
            };
        }
