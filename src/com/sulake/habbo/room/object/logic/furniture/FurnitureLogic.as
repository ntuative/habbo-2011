package com.sulake.habbo.room.object.logic.furniture
{
    ...
    public class FurnitureLogic extends MovingObjectLogic 
    {
        ...
        {
            var _loc1_:Array = [RoomObjectRoomAdEvent.var_345, RoomObjectRoomAdEvent.var_346, RoomObjectRoomAdEvent.var_344, RoomObjectStateChangeEvent.var_1180, RoomObjectMouseEvent.var_483, RoomObjectRoomAdEvent.var_50, RoomObjectMouseEvent.ROOM_OBJECT_MOUSE_DOWN];
        ...
        override public function initialize(param1:XML):void
        {
            ...
            object.getModelController().setNumber(RoomObjectVariableEnum.var_738, this.var_3038, true);
            object.getModelController().setNumber(RoomObjectVariableEnum.var_739, this.var_3039, true);
            object.getModelController().setNumber(RoomObjectVariableEnum.var_740, this.var_3960, true);
            object.getModelController().setNumber(RoomObjectVariableEnum.var_741, this.var_3961, true);
            object.getModelController().setNumber(RoomObjectVariableEnum.var_742, this.var_3962, true);
            object.getModelController().setNumber(RoomObjectVariableEnum.var_743, this.var_3963, true);
            object.getModelController().setNumberArray(RoomObjectVariableEnum.var_744, this.var_3964, true);
            object.getModelController().setNumber(RoomObjectVariableEnum.var_154, 1);
        }
        ...
        override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry):void
        {
            ...
            switch (param1.type)
            {
                ...
                case MouseEvent.DOUBLE_CLICK:
                    ...
                    if (eventDispatcher != null)
                    {
                        eventDispatcher.dispatchEvent(new RoomObjectStateChangeEvent(RoomObjectStateChangeEvent.var_1180, _loc4_, _loc5_));
                    };
                    return;
                case MouseEvent.CLICK:
                    ...
                    if (eventDispatcher != null)
                    {
                        _loc6_ = new RoomObjectMouseEvent(RoomObjectMouseEvent.var_483, param1.eventId, _loc4_, _loc5_, param1.altKey, param1.ctrlKey, param1.shiftKey, param1.buttonDown);
        ...
        override public function processUpdateMessage(param1:RoomObjectUpdateMessage):void
        {
            ...
            if (_loc3_ != null)
            {
                ...
                if (_loc2_ != null)
                {
                    _loc2_.setString(RoomObjectVariableEnum.var_503, _loc3_.data);
                    if (!isNaN(_loc3_.extra))
                    {
                        _loc2_.setString(RoomObjectVariableEnum.var_496, String(_loc3_.extra));
                    };
            ...
            if (_loc4_ != null)
            {
                if (_loc2_ != null)
                {
                    _loc2_.setString(RoomObjectVariableEnum.var_745, _loc4_.itemData);
                };
                return;
            };
            this.var_3959 = false;
