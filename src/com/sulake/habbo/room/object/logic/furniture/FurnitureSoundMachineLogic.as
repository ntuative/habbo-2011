package com.sulake.habbo.room.object.logic.furniture
{
    ...
    public class FurnitureSoundMachineLogic extends FurnitureMultiStateLogic
    {
        ...
        {
            var _loc1_: Array = [
                RoomObjectFurnitureActionEvent.var_1191,
                RoomObjectFurnitureActionEvent.var_1192,
                RoomObjectFurnitureActionEvent.var_1193,
                RoomObjectFurnitureActionEvent.var_1194
            ];
