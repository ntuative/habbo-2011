    ...
    public class RoomTileCursorLogic extends ObjectLogicBase
    {
        ...
        override public function initialize(param1: XML): void
        {
            ...
            if (object != null)
            {
                ...
                if (_loc2_ != null)
                {
                    _loc2_.setNumber(RoomObjectVariableEnum.FURNITURE_ALPHA_MULTIPLIER, 1);
                    object.setState(1, 0);
                }
        ...
        override public function processUpdateMessage(param1: RoomObjectUpdateMessage): void
        {
            ...
            if (_loc2_ != null)
            {
                if (_loc2_.type == RoomObjectVisibilityUpdateMessage.var_1185)
                {
                    if (object != null)
                    {
                        object.setState(0, 0);
                ...
                {
                    if (_loc2_.type == RoomObjectVisibilityUpdateMessage.var_1186)
                    {
                        if (object != null)
                        {
                            object.setState(1, 0);
