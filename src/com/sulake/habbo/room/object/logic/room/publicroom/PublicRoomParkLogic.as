package com.sulake.habbo.room.object.logic.room.publicroom
{
    ...
    public class PublicRoomParkLogic extends PublicRoomLogic
    {
        ...
        {
            var _loc1_: Array = [RoomObjectRoomActionEvent.RORAE_CHANGE_ROOM, RoomObjectRoomActionEvent.RORAE_TRY_BUS];
        ...
        override public function mouseEvent(param1: RoomSpriteMouseEvent, param2: IRoomGeometry): void
        {
            ...
            switch (_loc3_.type)
            {
                case MouseEvent.CLICK:
                    ...
                    {
                        case var_1199:
                            _loc6_ = new RoomObjectRoomActionEvent(RoomObjectRoomActionEvent.RORAE_CHANGE_ROOM, 0, _loc4_, _loc5_);
                            break;
                        case var_1200:
                        case var_1201:
                            _loc6_ = new RoomObjectRoomActionEvent(RoomObjectRoomActionEvent.RORAE_TRY_BUS, 0, _loc4_, _loc5_);
                            break;
                    }
