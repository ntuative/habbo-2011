package com.sulake.habbo.room.object.logic
{
    ...
    public class AvatarLogic extends MovingObjectLogic
    {
        ...
        {
            var _loc1_: Array = [RoomObjectMouseEvent.ROOM_OBJECT_MOUSE_CLICK, RoomObjectMoveEvent.var_1202];
        ...
        override public function processUpdateMessage(param1: RoomObjectUpdateMessage): void
        {
            ...
            if (param1 is RoomObjectAvatarPostureUpdateMessage)
            {
                ...
                _loc2_.setString(RoomObjectVariableEnum.AVATAR_POSTURE, _loc3_.postureType);
                _loc2_.setString(RoomObjectVariableEnum.AVATAR_POSTURE_PARAMETER, _loc3_.parameter);
                return;
            }
            ...
            if (param1 is RoomObjectAvatarChatUpdateMessage)
            {
                ...
                _loc2_.setNumber(RoomObjectVariableEnum.AVATAR_TALK, 1);
            ...
            if (param1 is RoomObjectAvatarTypingUpdateMessage)
            {
                ...
                _loc2_.setNumber(RoomObjectVariableEnum.AVATAR_IS_TYPING, Number(_loc5_.typing));
                return;
            }
            ...
            if (param1 is RoomObjectAvatarUpdateMessage)
            {
                ...
                _loc2_.setNumber(RoomObjectVariableEnum.HEAD_DIRECTION, _loc6_.dirHead);
                return;
            }
            ...
            if (param1 is RoomObjectAvatarGestureUpdateMessage)
            {
                ...
                _loc2_.setNumber(RoomObjectVariableEnum.AVATAR_GESTURE, _loc7_.gesture);
            ...
            if (param1 is RoomObjectAvatarWaveUpdateMessage)
            {
                ...
                if (_loc8_.isWaving)
                {
                    _loc2_.setNumber(RoomObjectVariableEnum.AVATAR_WAVE, 1);
                    this.var_3985 = getTimer() + AvatarAction.var_1216 * 1000;
                }
                else
                {
                    _loc2_.setNumber(RoomObjectVariableEnum.AVATAR_WAVE, 0);
                    this.var_3985 = 0;
                }
            ...
            if (param1 is RoomObjectAvatarDanceUpdateMessage)
            {
                ...
                _loc2_.setNumber(RoomObjectVariableEnum.AVATAR_DANCE, _loc9_.danceStyle);
                return;
            }
            ...
            if (param1 is RoomObjectAvatarSleepUpdateMessage)
            {
                ...
                _loc2_.setNumber(RoomObjectVariableEnum.AVATAR_SLEEP, Number(_loc10_.isSleeping));
                return;
            }
            ...
            if (param1 is RoomObjectAvatarPlayerValueUpdateMessage)
            {
                ...
                _loc2_.setNumber(RoomObjectVariableEnum.AVATAR_NUMBER_VALUE, _loc11_.value);
            ...
            if (param1 is RoomObjectAvatarCarryObjectUpdateMessage)
            {
                ...
                _loc2_.setNumber(RoomObjectVariableEnum.AVATAR_CARRY_OBJECT, _loc15_.itemType);
            ...
            if (param1 is RoomObjectAvatarUseObjectUpdateMessage)
            {
                ...
                _loc2_.setNumber(RoomObjectVariableEnum.AVATAR_USE_OBJECT, _loc16_.itemType);
                return;
            }
            ...
            if (param1 is RoomObjectAvatarSignUpdateMessage)
            {
                ...
                _loc2_.setNumber(RoomObjectVariableEnum.AVATAR_SIGN, _loc17_.signType);
            ...
            if (param1 is RoomObjectAvatarFlatControlUpdateMessage)
            {
                ...
                _loc2_.setString(RoomObjectVariableEnum.AVATAR_FLAT_CONTROL, _loc18_.rawData);
                _loc2_.setNumber(RoomObjectVariableEnum.AVATAR_IS_ADMIN, Number(_loc18_.isAdmin));
                return;
            }
            ...
            if (param1 is RoomObjectAvatarFigureUpdateMessage)
            {
                ...
                _loc20_ = _loc2_.getString(RoomObjectVariableEnum.FIGURE);
                ...
                _loc2_.setString(RoomObjectVariableEnum.FIGURE, _loc21_);
                _loc2_.setString(RoomObjectVariableEnum.GENDER, _loc22_);
                return;
            }
        ...
        private function updateEffect(param1: int, param2: int, param3: IRoomObjectModelController): void
        {
            ...
            {
                if (param3.getNumber(RoomObjectVariableEnum.AVATAR_EFFECT) == var_1219)
                {
                    this.var_3980 = getTimer() + var_1218;
            ...
            param3.setNumber(RoomObjectVariableEnum.AVATAR_EFFECT, param1);
        }
        ...
        private function updateActions(param1: int, param2: IRoomObjectModelController): void
        {
            if (this.var_3982 > 0)
            {
                ...
                {
                    param2.setNumber(RoomObjectVariableEnum.AVATAR_TALK, 0);
                    this.var_3982 = 0;
                    this.var_3984 = 0;
                    this.var_3983 = 0;
                }
                else
                {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            {
                                param2.setNumber(RoomObjectVariableEnum.AVATAR_TALK, 1);
                                this.var_3983 = 0;
                            }
            ...
            {
                param2.setNumber(RoomObjectVariableEnum.AVATAR_WAVE, 0);
                this.var_3985 = 0;
            }

            if (this.var_3986 > 0 && param1 > this.var_3986)
            {
                param2.setNumber(RoomObjectVariableEnum.AVATAR_GESTURE, 0);
                this.var_3986 = 0;
            }

            if (this.var_3987 > 0 && param1 > this.var_3987)
            {
                param2.setNumber(RoomObjectVariableEnum.AVATAR_SIGN, 0);
                this.var_3987 = 0;
            }
            ...
            if (this.var_3988 > 0)
            {
                ...
                {
                    param2.setNumber(RoomObjectVariableEnum.AVATAR_CARRY_OBJECT, 0);
                    this.var_3988 = 0;
                }
                else
                {
                    ...
                    {
                        param2.setNumber(RoomObjectVariableEnum.AVATAR_USE_OBJECT, 1);
                    }
                    else
                    {
                        param2.setNumber(RoomObjectVariableEnum.AVATAR_USE_OBJECT, 0);
                    }
            ...
            {
                param2.setNumber(RoomObjectVariableEnum.AVATAR_BLINK, 1);
            ...
            {
                param2.setNumber(RoomObjectVariableEnum.AVATAR_BLINK, 0);
                this.var_3990 = 0;
            }

            if (this.var_3980 > 0 && param1 > this.var_3980)
            {
                param2.setNumber(RoomObjectVariableEnum.AVATAR_EFFECT, this.var_3981);
                this.var_3980 = 0;
            }

            if (this.var_3992 > 0 && param1 > this.var_3992)
            {
                param2.setNumber(RoomObjectVariableEnum.AVATAR_NUMBER_VALUE, 0);
                this.var_3992 = 0;
            }
        ...
        private function targetIsWarping(param1: IVector3d): Boolean
        {
            ...
            return Math.abs(_loc2_.x - param1.x) > var_1220 || Math.abs(_loc2_.y - param1.y) > var_1220;
