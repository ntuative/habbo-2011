    ...
    public class PetLogic extends MovingObjectLogic
    {
        ...
        override public function processUpdateMessage(param1: RoomObjectUpdateMessage): void
        {
            ...
            if (!this.var_3996)
            {
                ...
                if (param1 is RoomObjectAvatarUpdateMessage)
                {
                    ...
                    _loc2_.setNumber(RoomObjectVariableEnum.HEAD_DIRECTION, _loc4_.dirHead);
                    return;
                }
                ...
                if (param1 is RoomObjectAvatarPetGestureUpdateMessage)
                {
                    ...
                    _loc2_.setString(RoomObjectVariableEnum.AVATAR_GESTURE, _loc6_.gesture);
                ...
                if (param1 is RoomObjectAvatarSleepUpdateMessage)
                {
                    ...
                    _loc2_.setNumber(RoomObjectVariableEnum.AVATAR_SLEEP, Number(_loc7_.isSleeping));
                    return;
                }
            ...
            if (param1 is RoomObjectAvatarExperienceUpdateMessage)
            {
                ...
                _loc2_.setNumber(RoomObjectVariableEnum.AVATAR_GAINED_EXPERIENCE, Number(_loc9_.gainedExperience));
                return;
            }
            ...
            if (param1 is RoomObjectAvatarFigureUpdateMessage)
            {
                ...
                _loc11_ = _loc2_.getString(RoomObjectVariableEnum.FIGURE);
                _loc2_.setString(RoomObjectVariableEnum.FIGURE, _loc10_.figure);
                _loc2_.setString(RoomObjectVariableEnum.RACE, _loc10_.race);
        ...
        private function debugMouseEvent(param1: RoomSpriteMouseEvent): void
        {
            ...
            if (!param1.altKey && !param1.ctrlKey)
            {
                ...
                _loc2_.setNumber(RoomObjectVariableEnum.HEAD_DIRECTION, _loc3_ + this.var_3999);
            }
            else
            {
                if (param1.altKey && !param1.ctrlKey)
                {
                    this.var_3997++;
                    _loc2_.setNumber(RoomObjectVariableEnum.AVATAR_POSTURE, this.var_3997);
                    _loc2_.setNumber(RoomObjectVariableEnum.AVATAR_GESTURE, NaN);
                }
                else
                {
                    ...
                    {
                        this.var_3998++;
                        _loc2_.setNumber(RoomObjectVariableEnum.AVATAR_GESTURE, this.var_3998);
                    }
                    else
                    {
        ...
        private function updateActions(param1: int, param2: IRoomObjectModelController): void
        {
            ...
            {
                param2.setString(RoomObjectVariableEnum.AVATAR_GESTURE, null);
                this.var_3986 = 0;
            }
