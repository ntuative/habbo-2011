package com.sulake.habbo.room.object.visualization.room.mask
{
    ...
    public class PlaneMask 
    {
        ...
        private var var_4183:Map;
        private var _sizes:Array = [];
        private var var_4184:PlaneMaskVisualization = null;
        private var var_4157:int = -1;

        public function PlaneMask()
        {
            this.var_4183 = new Map();
        }
        ...
        public function dispose():void
        {
            ...
            var _loc2_:int;
            if (this.var_4183 != null)
            {
                _loc1_ = null;
                _loc2_ = 0;
                while (_loc2_ < this.var_4183.length)
                {
                    _loc1_ = (this.var_4183.getWithIndex(_loc2_) as PlaneMaskVisualization);
                    if (_loc1_ != null)
                    {
                        _loc1_.dispose();
                    };
        ...
        {
            if (this.var_4183.getValue(String(param1)) != null)
            {
                return (null);
            };
            var _loc2_:PlaneMaskVisualization = new PlaneMaskVisualization();
            this.var_4183.add(String(param1), _loc2_);
        ...
        protected function getMaskVisualization(param1:int):PlaneMaskVisualization
        {
            ...
            {
                this.var_4184 = (this.var_4183.getValue(String(this._sizes[_loc2_])) as PlaneMaskVisualization);
            }
            else
            {
                this.var_4184 = null;
