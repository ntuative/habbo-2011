package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
    ...
    public class PlaneMaterial
    {
        ...
        public function dispose(): void
        {
            ...
            if (this.var_4213 != null)
            {
                _loc1_ = 0;
                while (_loc1_ < this.var_4213.length)
                {
                    _loc2_ = (this.var_4213[_loc1_] as PlaneMaterialCellMatrix);
                    if (_loc2_ != null)
                    {
                        _loc2_.dispose();
                    }
        ...
        private function getMaterialCellMatrix(param1: IVector3d): PlaneMaterialCellMatrix
        {
            ...
            var _loc2_: int;
            while (_loc2_ < this.var_4213.length)
            {
                _loc3_ = (this.var_4213[_loc2_] as PlaneMaterialCellMatrix);
                if (_loc3_ != null)
                {
