package com.sulake.habbo.room.object.visualization.room
{
    ...
    public class RoomPlane 
    {
        ...
        private function needsNewTexture(param1:IRoomGeometry, param2:int):Boolean
        {
            ...
            if (((this.var_4249) && (((_loc3_ == null) || ((_loc3_.timeStamp >= 0) && (param2 > _loc3_.timeStamp))) || (this.var_4245))))
            {
                return (true);
            };
            return (false);
        ...
        {
            this.var_4124.assign(param1.getScreenPosition(this.var_3041));
            this.var_4125.assign(param1.getScreenPosition(Vector3d.sum(this.var_3041, this.var_4113)));
            this.var_4126.assign(param1.getScreenPosition(Vector3d.sum(Vector3d.sum(this.var_3041, this.var_4112), this.var_4113)));
            this.var_4127.assign(param1.getScreenPosition(Vector3d.sum(this.var_3041, this.var_4112)));
