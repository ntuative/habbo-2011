package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
    ...
    public class PlaneMaterialCellColumn 
    {
        ...
        public static const var_1883:int = 0;
        ...
        public function dispose():void
        {
            ...
            if (this.var_4219 != null)
            {
                _loc1_ = 0;
                while (_loc1_ < this.var_4219.length)
                {
                    _loc2_ = (this.var_4219[_loc1_] as PlaneMaterialCell);
                    if (_loc2_ != null)
                    {
                        _loc2_.dispose();
                    };
        ...
        {
            var _loc3_:int;
            if (this.var_4220 == var_1883)
            {
                _loc3_ = this.getCellsHeight(this.var_4219, param2);
                param1 = _loc3_;
            };
            if (this._cachedBitmapNormal == null)
            {
            ...
            if (this.isStatic)
            {
                if (this.var_4216 != null)
                {
                    if (((this.var_4216.height == param1) && (Vector3d.isEqual(this._cachedBitmapNormal, param2))))
                    {
            ...
            else
            {
                if (this.var_4216 != null)
                {
                    if (this.var_4216.height == param1)
                    {
            ...
            if (this.var_4216 == null)
            {
                this.var_4216 = new BitmapData(this.var_2237, param1, true, 0xFFFFFF);
            };
            this._cachedBitmapNormal.assign(param2);
            if (this.var_4219.length == 0)
            {
                return (this.var_4216);
            };
        ...
        {
            if ((((param1 == null) || (param1.length == 0)) || (this.var_4216 == null)))
            {
                return (param2);
            };
            var _loc5_:PlaneMaterialCell;
            ...
            while (_loc7_ < param1.length)
            {
                ...
                if (_loc5_ != null)
                {
                    ...
                    if (_loc6_ != null)
                    {
                        ...
                        this.var_4216.copyPixels(_loc6_, _loc6_.rect, new Point(0, param2), _loc6_, null, true);
                        if (param3)
                        {
                            param2 = (param2 + _loc6_.height);
                        };
                        if ((((param3) && (param2 >= this.var_4216.height)) || ((!(param3)) && (param2 <= 0))))
                        {
                            return (param2);
                        };
                    };
        ...
        {
            if (((this.var_4219.length == 0) || (this.var_4216 == null)))
            {
                return;
            };
            this.renderCells(this.var_4219, 0, true, param1);
        }
        ...
        private function renderRepeatAll(param1:IVector3d):void
        {
            ...
            var _loc2_:int = this.getCellsHeight(this.var_4219, param1);
            var _loc3_:int;
            if (_loc2_ > this.var_4216.height)
            {
            };
            while (_loc3_ < this.var_4216.height)
            {
                _loc3_ = this.renderCells(this.var_4219, _loc3_, true, param1);
                if (_loc3_ == 0)
                {
                    return;
                };
        ...
        private function renderRepeatBorders(param1:IVector3d):void
        {
            ...
            var _loc7_:int;
            _loc7_ = 1;
            while (_loc7_ < (this.var_4219.length - 1))
            {
                _loc2_ = (this.var_4219[_loc7_] as PlaneMaterialCell);
                if (_loc2_ != null)
                {
            ...
            if (this.var_4219.length == 1)
            {
                _loc2_ = (this.var_4219[0] as PlaneMaterialCell);
                if (_loc2_ != null)
                {
                    _loc6_ = _loc2_.getHeight(param1);
                    if (_loc6_ > 0)
            ...
            var _loc8_:* = ((this.var_4216.height - _loc5_) >> 1);
            ...
            _loc2_ = (this.var_4219[(this.var_4219.length - 1)] as PlaneMaterialCell);
            if (_loc2_ != null)
            {
                _loc4_ = [_loc2_];
                while (_loc9_ < this.var_4216.height)
                {
        ...
        private function renderRepeatCenter(param1:IVector3d):void
        {
            ...
            var _loc9_:int;
            _loc9_ = 0;
            while (_loc9_ < (this.var_4219.length >> 1))
            {
                _loc2_ = (this.var_4219[_loc9_] as PlaneMaterialCell);
                if (_loc2_ != null)
                {
            ...
            _loc9_ = ((this.var_4219.length >> 1) + 1);
            while (_loc9_ < this.var_4219.length)
            {
                _loc2_ = (this.var_4219[_loc9_] as PlaneMaterialCell);
                if (_loc2_ != null)
                {
            ...
            var _loc10_:int;
            var _loc11_:int;
            var _loc12_:int = this.var_4216.height;
            if ((_loc6_ + _loc7_) > this.var_4216.height)
            {
                _loc10_ = ((_loc6_ + _loc7_) - this.var_4216.height);
            ...
            if (_loc10_ == 0)
            {
                ...
                if (_loc2_ != null)
                {
                    ...
                    if (_loc8_ > 0)
                    {
                        _loc13_ = (this.var_4216.height - (_loc6_ + _loc7_));
        ...
        private function renderRepeatFirst(param1:IVector3d):void
        {
            ...
            var _loc2_:PlaneMaterialCell;
            var _loc3_:int = this.var_4216.height;
            _loc3_ = this.renderCells(this.var_4219, _loc3_, false, param1);
            _loc2_ = (this.var_4219[0] as PlaneMaterialCell);
            if (_loc2_ != null)
            {
                _loc4_ = [_loc2_];
