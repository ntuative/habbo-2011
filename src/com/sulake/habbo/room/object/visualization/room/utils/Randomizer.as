package com.sulake.habbo.room.object.visualization.room.utils
{
    ...
    public class Randomizer
    {
        ...
        public static const var_1976: int = 1;
        public static const var_1977: int = 0x1000000;
        private static var _randomizer: Randomizer = null;

        private var var_4227: int = 1;
        private var var_4228: int = 0x1000000;
        private var var_4229: int = 69069;
        private var var_4230: int = 5;
        ...
        {
            var _loc1_: int = this.var_4229 * this.var_4227 + this.var_4230;
            if (_loc1_ < 0)
            {
                _loc1_ = -_loc1_;
            }

            _loc1_ = _loc1_ % this.var_4228;
            this.var_4227 = _loc1_;
            return _loc1_;
        }
        ...
        private function iterateScaled(param1: int, param2: int): int
        {
            ...
            return int(param1 + (_loc3_ / this.var_4228) * param2);
        }
