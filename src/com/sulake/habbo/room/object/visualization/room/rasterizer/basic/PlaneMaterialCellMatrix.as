package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
    ...
    public class PlaneMaterialCellMatrix
    {
        ...
        public static const var_1882: int = 1;
        public static const var_1875: int = 2;
        public static const var_1876: int = 3;
        public static const var_1877: int = 4;
        public static const var_1878: int = 5;
        public static const var_1879: int = 6;
        public static const var_1874: int = var_1882;//1
        public static const var_1873: Number = -1;
        public static const MAX_NORMAL_COORDINATE_VALUE: Number = 1;
        public static const var_1880: int = 1;
        public static const var_1881: int = 2;
        public static const ALIGN_DEFAULT: int = var_1880;//1

        private var var_4222: Array = [];
        private var var_4220: int = 1;
        private var _align: int = 1;
        private var var_4216: BitmapData;
        private var _cachedBitmapNormal: Vector3d = null;
        private var var_4223: int = 0;
        private var var_4214: Boolean = false;
        private var var_4221: Boolean = true;
        ...
        public function PlaneMaterialCellMatrix(param1: int, param2: int = 1, param3: int = 1, param4: Number = -1, param5: Number = 1, param6: Number = -1, param7: Number = 1)
        {
            ...
            while (_loc8_ < param1)
            {
                this.var_4222.push(null);
                _loc8_++;
            }

            this.var_4220 = param2;
            this._align = param3;
            this.var_4185 = param4;
            this._normalMaxX = param5;
            this.var_4186 = param6;
            this.var_4187 = param7;
            if (this.var_4220 == var_1879)
            {
                this.var_4221 = false;
            }
        ...
        {
            if (this.var_4216 != null)
            {
                this.var_4216.dispose();
                this.var_4216 = null;
            }
        ...
        public function clearCache(): void
        {
            ...
            this.var_4223 = 0;
            var _loc1_: int;
            while (_loc1_ < this.var_4222.length)
            {
                _loc2_ = (this.var_4222[_loc1_] as PlaneMaterialCellColumn);
                if (_loc2_ != null)
                {
                    _loc2_.clearCache();
                }
        ...
        {
            if (param1 < 0 || param1 >= this.var_4222.length)
            {
                return false;
            }

            var _loc5_: PlaneMaterialCellColumn = new PlaneMaterialCellColumn(param2, param3, param4);
            var _loc6_: PlaneMaterialCellColumn = this.var_4222[param1] as PlaneMaterialCellColumn;
            if (_loc6_ != null)
            {
                _loc6_.dispose();
            }

            this.var_4222[param1] = _loc5_;
        ...
        public function render(param1: BitmapData, param2: int, param3: int, param4: IVector3d, param5: Boolean, param6: int, param7: Boolean): BitmapData
        {
            ...
            if (this.isStatic)
            {
                if (this.var_4216 != null)
                {
                    if (this.var_4216.width == param2 && this.var_4216.height == param3 && Vector3d.isEqual(this._cachedBitmapNormal, param4))
                    {
                        if (param1 != null)
                        {
                            this.copyCachedBitmapOnCanvas(param1, this.var_4223, param6, param7);
                            return param1;
                        }
            ...
            else
            {
                if (this.var_4216 != null)
                {
                    if (this.var_4216.width == param2 && this.var_4216.height == param3)
                    {
                        this.var_4216.fillRect(this.var_4216.rect, 0xFFFFFF);
                    }
                    else
                    {
                        this.var_4216.dispose();
            ...
            if (!param5)
            {
                this.var_4223 = param3;
                if (this.var_4216 == null)
                {
                    this.var_4216 = new BitmapData(param2, param3, true, 0xFFFFFFFF);
                }
                else
                {
                    this.var_4216.fillRect(this.var_4216.rect, 0xFFFFFFFF);
                }
            ...
            {
                this.var_4223 = param3;
                this.var_4216 = new BitmapData(param2, param3, true, 0xFFFFFF);
            }

            var _loc8_: Array = [];
            var _loc9_: int;
            while (_loc9_ < this.var_4222.length)
            {
                _loc11_ = (this.var_4222[_loc9_] as PlaneMaterialCellColumn);
                if (_loc11_ != null)
                {
            ...
            var _loc10_: int;
            switch (this.var_4220)
            {
                case var_1875:
                    _loc10_ = this.renderRepeatBorders(this.var_4216, _loc8_);
                    break;
                case var_1876:
                    _loc10_ = this.renderRepeatCenter(this.var_4216, _loc8_);
                    break;
                case var_1877:
                    _loc10_ = this.renderRepeatFirst(this.var_4216, _loc8_);
                    break;
                case var_1878:
                    _loc10_ = this.renderRepeatLast(this.var_4216, _loc8_);
                    break;
                case var_1879:
                    _loc10_ = this.renderRepeatRandom(this.var_4216, _loc8_);
                    break;
                default:
                    _loc10_ = this.renderRepeatAll(this.var_4216, _loc8_);
            }

            this.var_4223 = _loc10_;
            if (param1 != null)
            {
        ...
        {
            if (param1 == null || this.var_4216 == null || param1 == this.var_4216)
            {
                return;
            }
            ...
            if (this._align == var_1880)
            {
                _loc5_ = new Rectangle(0, 0, this.var_4216.width, this.var_4223);
            }
            else
            {
                _loc5_ = new Rectangle(0, this.var_4216.height - this.var_4223, this.var_4216.width, this.var_4223);
            }

            param1.copyPixels(this.var_4216, _loc5_, new Point(0, param3), null, null, true);
        }
        ...
        private function renderRepeatBorders(param1: BitmapData, param2: Array): int
        {
            ...
            if (this.var_4222.length == 1)
            {
                _loc4_ = (this.var_4222[0] as BitmapData);
                if (_loc4_ != null)
                {
                    _loc6_ = _loc4_.width;
                    _loc5_.push(_loc4_);
