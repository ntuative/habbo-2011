package com.sulake.habbo.room.object.visualization.room.rasterizer.animated
{
    ...
    public class AnimationItem
    {
        ...
        private var var_4206: Number = 0;
        private var var_4207: Number = 0;
        ...
        public function AnimationItem(param1: Number, param2: Number, param3: Number, param4: Number, param5: BitmapData)
        {
            ...
            this.var_4206 = param3;
            this.var_4207 = param4;
            if (isNaN(this._x))
            {
                this._x = 0;
            }

            if (isNaN(this.var_2497))
            {
                this.var_2497 = 0;
            }

            if (isNaN(this.var_4206))
            {
                this.var_4206 = 0;
            }

            if (isNaN(this.var_4207))
            {
                this.var_4207 = 0;
            }
        ...
        public function getPosition(param1: int, param2: int, param3: Number, param4: Number, param5: int): Point
        {
            ...
            var _loc7_: Number = this.var_2497;
            if (param3 > 0)
            {
                _loc6_ = _loc6_ + ((this.var_4206 / param3) * param5) / 1000;
            }

            if (param4 > 0)
            {
                _loc7_ = _loc7_ + ((this.var_4207 / param4) * param5) / 1000;
            }
