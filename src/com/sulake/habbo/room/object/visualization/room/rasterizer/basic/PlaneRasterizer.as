package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
    ...
    public class PlaneRasterizer implements IPlaneRasterizer
    {
        ...
        public function PlaneRasterizer()
        {
            ...
            this.var_4224 = new Map();
            this.var_4068 = new Map();
        ...
        public function dispose(): void
        {
            ...
            if (this.var_4068 != null)
            {
                ...
                {
                    _loc2_ = (this.var_4068.getWithIndex(_loc1_) as Plane);
                    if (_loc2_ != null)
                    {
                        _loc2_.dispose();
                    }
            ...
            {
                _loc1_ = 0;
                while (_loc1_ < this.var_4225.length)
                {
                    _loc3_ = this.var_4225.getWithIndex(_loc1_);
                    if (_loc3_ != null)
                    {
                        _loc3_.dispose();
                    }
        ...
        public function clearCache(): void
        {
            ...
            {
                _loc3_ = (this.var_4224.getWithIndex(_loc1_) as PlaneMaterial);
                if (_loc3_ != null)
                {
                    _loc3_.clearCache();
                }
        ...
        private function parseTextures(param1: XML, param2: IGraphicAssetCollection): void
        {
            ...
            while (_loc4_ < _loc3_.length())
            {
                ...
                {
                    _loc6_ = _loc5_.@id;
                    if (this.var_4121.getValue(_loc6_) == null)
                    {
                        ...
                        while (_loc9_ < _loc8_.length())
                        {
                            ...
                            {
                                _loc11_ = PlaneTexture.var_1873;
                                _loc12_ = PlaneTexture.MAX_NORMAL_COORDINATE_VALUE;
                                _loc13_ = PlaneTexture.var_1873;
            ...
            while (_loc3_ < _loc2_.length())
            {
                ...
                if (XMLValidator.checkRequiredAttributes(_loc4_, ["id"]))
                {
                    ...
                    while (_loc8_ < _loc7_.length())
                    {
                        ...
                        _loc12_ = PlaneMaterialCellMatrix.var_1874;
                        switch (_loc10_)
                        {
                            case "borders":
                                _loc12_ = PlaneMaterialCellMatrix.var_1875;
                                break;
                            case "center":
                                _loc12_ = PlaneMaterialCellMatrix.var_1876;
                                break;
                            case "first":
                                _loc12_ = PlaneMaterialCellMatrix.var_1877;
                                break;
                            case "last":
                                _loc12_ = PlaneMaterialCellMatrix.var_1878;
                                break;
                            case "random":
                        ...
                        {
                            case "top":
                                _loc13_ = PlaneMaterialCellMatrix.var_1880;
                                break;
                            case "bottom":
        ...
        private function parsePlaneMaterialCellColumn(param1: XML, param2: PlaneMaterialCellMatrix, param3: int): void
        {
            ...
            {
                case "borders":
                    _loc6_ = PlaneMaterialCellColumn.var_1875;
                    break;
                case "center":
                    _loc6_ = PlaneMaterialCellColumn.var_1876;
                    break;
                case "first":
                    _loc6_ = PlaneMaterialCellColumn.var_1877;
                    break;
                case "last":
                    _loc6_ = PlaneMaterialCellColumn.var_1878;
                    break;
                case "none":
            ...
            while (_loc4_ < _loc3_.length())
            {
                ...
                if (_loc7_ != null)
                {
                    ...
                    while (_loc19_ < _loc7_.length)
                    {
                        ...
                        _loc21_ = this.var_4188.getAsset(_loc20_);
                        if (_loc21_ != null)
                        {
                            _loc8_.push(_loc21_);
                        }
                ...
                if (XMLValidator.checkRequiredAttributes(_loc4_, ["size"]))
                {
                    ...
                    if (_loc11_ != null)
                    {
                        ...
                        while (_loc12_ < _loc10_.length())
                        {
                            ...
                            if (_loc20_ == "bottom")
                            {
                                _loc15_ = PlaneVisualizationLayer.var_1881;
                            }
                            else
                            {
                                if (_loc20_ == "top")
