package com.sulake.habbo.room.object.visualization.furniture
{
    ...
    public class FurnitureGiftWrappedVisualization extends FurnitureVisualization
    {
        ...
        private var var_4073: int = 0;
        private var var_4074: int = 0;
        ...
        private function updateTypes(): void
        {
            ...
            if (_loc1_ != null)
            {
                ...
                {
                    _loc3_ = 1000;
                    _loc4_ = _loc2_.getString(RoomObjectVariableEnum.FURNITURE_EXTRAS);
                    _loc5_ = parseInt(_loc4_);
                    this.var_4073 = Math.floor(_loc5_ / _loc3_);
                    this.var_4074 = _loc5_ % _loc3_;
                }
