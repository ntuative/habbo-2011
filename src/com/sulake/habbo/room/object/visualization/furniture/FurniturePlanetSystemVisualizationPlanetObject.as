package com.sulake.habbo.room.object.visualization.furniture
{
    ...
    public class FurniturePlanetSystemVisualizationPlanetObject 
    {
        ...
        private static const var_4130:Number = 30;

        private var _index:int;
        private var _name:String;
        private var var_2488:Number;
        private var var_4131:Number;
        private var var_4132:Number;
        private var _height:Number;
        private var var_2084:Number;
        private var var_4133:Vector3d = new Vector3d(0, 0, 0);
        ...
        public function FurniturePlanetSystemVisualizationPlanetObject(param1:String, param2:int, param3:Number, param4:Number, param5:Number, param6:Number)
        {
            ...
            this.var_4131 = (((param4 * Math.PI) * 2) / 360);
            this.var_4132 = (((param5 * Math.PI) * 2) / 360);
            this._height = param6;
            this.var_2084 = 0;
        }
        ...
        {
            var _loc3_:Number = (this.var_2488 * Math.cos((this.var_2084 + this.var_4132)));
            var _loc4_:Number = (this.var_2488 * Math.sin((this.var_2084 + this.var_4132)));
            var _loc5_:Number = this._height;
            this.var_4133.x = ((_loc3_ - _loc4_) * (param2 / 2));
            this.var_4133.y = ((((_loc4_ + _loc3_) * (param2 / 2)) * 0.5) - (this._height * (param2 / 2)));
            this.var_4133.z = -(int(((4 * (_loc3_ + _loc4_)) - 0.7)));
            if (param1 != null)
            {
                this.var_4133.add(param1);
            };
