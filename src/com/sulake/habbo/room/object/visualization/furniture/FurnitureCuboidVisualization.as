package com.sulake.habbo.room.object.visualization.furniture
{
    ...
    public class FurnitureCuboidVisualization extends RoomObjectSpriteVisualization 
    {
        ...
        protected function initializePlanes():void
        {
            ...
            var _loc2_:int = 1;
            var _loc3_:Number = _loc1_.getModel().getNumber(RoomObjectVariableEnum.var_738);
            var _loc4_:Number = _loc1_.getModel().getNumber(RoomObjectVariableEnum.var_739);
            var _loc5_:Number = _loc1_.getModel().getNumber(RoomObjectVariableEnum.var_740);
