    ...
    public class FurnitureCuboidVisualization extends RoomObjectSpriteVisualization
    {
        ...
        override public function dispose(): void
        {
            ...
            if (this.var_4068 != null)
            {
                ...
                {
                    _loc2_ = (this.var_4068[_loc1_] as FurniturePlane);
                    if (_loc2_ != null)
                    {
                        _loc2_.dispose();
                    }
        ...
        protected function initializePlanes(): void
        {
            ...
            var _loc2_: int = 1;
            var _loc3_: Number = _loc1_.getModel().getNumber(RoomObjectVariableEnum.FURNITURE_SIZE_X);
            var _loc4_: Number = _loc1_.getModel().getNumber(RoomObjectVariableEnum.FURNITURE_SIZE_Y);
            var _loc5_: Number = _loc1_.getModel().getNumber(RoomObjectVariableEnum.FURNITURE_SIZE_Z);
        ...
        protected function updatePlanes(param1: IRoomGeometry, param2: int): void
        {
            ...
            var _loc5_: int;
            while (_loc5_ < this.var_4068.length)
            {
                _loc6_ = false;
                ...
                _loc9_ = (this.var_4068[_loc5_] as FurniturePlane);
                if (_loc9_ != null)
                {
                ...
                if (_loc10_ != null)
                {
                    ...
                    if (_loc6_)
                    {
                        _loc10_.assetName = _loc7_ + "_" + _loc3_.getInstanceId() + "_" + this.var_4070;
                    }
