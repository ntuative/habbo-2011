package com.sulake.habbo.room.object.visualization.furniture
{
    ...
    public class FurniturePlanetSystemVisualization extends AnimatedFurnitureVisualization 
    {
        ...
        private var var_4128:Array;
        private var _planetNameIndex:Array;
        private var _offsetArray:Array = new Array();
        private var var_4129:Vector3d = new Vector3d(0, 0, 0);

        override public function dispose():void
        {
            var _loc1_:FurniturePlanetSystemVisualizationPlanetObject;
            if (this.var_4128 != null)
            {
                while (this.var_4128.length > 0)
                {
                    _loc1_ = this.var_4128.shift();
                    _loc1_.dispose();
                };
            };
            this.var_4128 = null;
        ...
        override protected function updateAnimation(param1:Number):int
        {
            ...
            var _loc3_:int;
            if (((this.var_4128 == null) && (spriteCount > 0)))
            {
            ...
            {
                _loc3_ = 0;
                while (_loc3_ < this.var_4128.length)
                {
                    _loc2_ = this.var_4128[_loc3_];
                    _loc2_.update(this._offsetArray, this.var_4129, param1);
                    _loc3_++;
                };
        ...
        private function readDefinition():Boolean
        {
            ...
            var _loc3_:String = _loc2_.getString(RoomObjectVariableEnum.var_748);
            var _loc4_:XMLList = XMLList(_loc3_);
            var _loc5_:XMLList = _loc4_.children();
            var _loc6_:int = _loc5_.length();
            this.var_4128 = new Array();
