package com.sulake.habbo.room.object.visualization.furniture
{
    ...
    public class FurnitureVisualizationData implements IRoomObjectVisualizationData 
    {
        ...
        public static const var_1445:Array = new Array("a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n", "o", "p", "q", "r", "s", "t", "u", "v", "w", "x", "y", "z");

        private var var_4154:Map;
        private var _sizes:Array = [];
        private var var_4155:SizeData = null;
        private var var_4156:int = -1;
        private var var_4157:int = -1;
        private var var_4158:int = -1;
        private var _type:String = "";

        public function FurnitureVisualizationData()
        {
            this.var_4154 = new Map();
        }
        ...
        public function dispose():void
        {
            var _loc1_:SizeData;
            var _loc2_:int;
            if (this.var_4154 != null)
            {
                _loc1_ = null;
                _loc2_ = 0;
                while (_loc2_ < this.var_4154.length)
                {
                    _loc1_ = (this.var_4154.getWithIndex(_loc2_) as SizeData);
                    if (_loc1_ != null)
                    {
                        _loc1_.dispose();
                    };
        ...
        protected function defineVisualizations(param1:XML):Boolean
        {
            ...
            while (_loc4_ < _loc2_.length())
            {
                ...
                if (this.var_4154.getValue(String(_loc6_)) != null)
                {
                    return (false);
                };
                ...
                this.var_4154.add(String(_loc6_), _loc9_);
        ...
        {
            if (param1 == this.var_4158)
            {
                return (this.var_4157);
            };
            ...
            this.var_4158 = param1;
            this.var_4157 = _loc3_;
            return (_loc3_);
        }
        ...
        protected function getSizeData(param1:int):SizeData
        {
            ...
            if (_loc2_ < this._sizes.length)
            {
                this.var_4155 = (this.var_4154.getValue(String(this._sizes[_loc2_])) as SizeData);
            }
            else
            {
                this.var_4155 = null;
            };
            this.var_4156 = param1;
            return (this.var_4155);
        }
