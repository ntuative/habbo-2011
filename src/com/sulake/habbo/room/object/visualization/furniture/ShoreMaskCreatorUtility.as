package com.sulake.habbo.room.object.visualization.furniture
{
    ...
    public class ShoreMaskCreatorUtility 
    {
        ...
        public static const var_1505:int = 0;
        public static const var_1507:int = 1;
        public static const var_1506:int = 2;
        private static const var_4167:int = 3;
                ...
                if (param2.getAsset(_loc4_) == null)
                {
                    if (param3 != null)
                    {
                        ...
                        if (_loc5_ != null)
                        {
                            ...
                            _loc7_ = [var_1505, var_1507, var_1506, var_1505, var_1507, var_1506];
                            _loc8_ = [var_1507, var_1507, var_1507, var_1506, var_1506, var_1506];
                            _loc9_ = null;
                            _loc10_ = 0;
                            if (_loc6_ != null)
                            {
