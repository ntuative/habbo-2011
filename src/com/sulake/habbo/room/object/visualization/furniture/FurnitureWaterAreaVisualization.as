package com.sulake.habbo.room.object.visualization.furniture
{
    ...
    public class FurnitureWaterAreaVisualization extends AnimatedFurnitureVisualization
    {
        ...
        private static const var_1504: String = "shore";

        private var var_4159: Boolean = true;
        private var var_4160: Array = [];
        private var var_4161: Array = [];
        private var var_4162: Array = [];
        private var _needsShoreUpdate: Boolean = false;
        private var var_3038: int = 0;
        private var var_3039: int = 0;
        private var var_4163: int = 0;
        private var var_4164: int = -1;
        private var var_4165: int = -1;
        ...
        override public function dispose(): void
        {
            ...
            {
                for each (_loc1_ in this.var_4162)
                {
        ...
        {
            if (this.var_4164 == param1 && this.var_4165 == direction)
            {
            ...
            while (_loc2_ >= 0)
            {
                if (getSpriteTag(param1, direction, _loc2_) == var_1504)
                {
                    this.var_4163 = _loc2_;
                    this.var_4164 = param1;
                    this.var_4165 = direction;
                    return this.var_4163;
                }
        ...
        private function getInstanceMask(param1: int): IGraphicAsset
        {
            ...
            if (_loc3_ != null)
            {
                if (this.var_4162.indexOf(_loc2_) < 0)
                {
                    this.var_4162.push(_loc2_);
                }
        ...
        private function updateBorderData(): void
        {
            ...
            var _loc3_: int = this.var_3038 + 2;
            var _loc4_: int = this.var_3039 + 2;
            var _loc5_: int;
            ...
            this.var_4159 = false;
            _loc5_ = 0;
            while (_loc5_ < this.var_4160.length)
            {
                if (this.var_4160[_loc5_])
                {
                    this.var_4159 = true;
                }
        ...
        private function updateTopBorder(param1: Array, param2: int): int
        {
            ...
            while (_loc8_ < _loc3_ - 1)
            {
                if (!_loc4_[_loc8_])
                {
                    this.var_4160[param2] = true;
                    if (!_loc5_[(_loc8_ - 1)] && !_loc4_[(_loc8_ - 1)])
                    {
                        _loc6_ = ShoreMaskCreatorUtility.var_1505;
                    }
                    else
                    {
                        if (_loc4_[(_loc8_ - 1)])
                        {
                            _loc6_ = ShoreMaskCreatorUtility.var_1506;
                        }
                        else
                        {
                            _loc6_ = ShoreMaskCreatorUtility.var_1507;
                        }
                    ...
                    if (!_loc5_[(_loc8_ + 1)] && !_loc4_[(_loc8_ + 1)])
                    {
                        _loc7_ = ShoreMaskCreatorUtility.var_1505;
                    }
                    else
                    {
                        if (_loc4_[(_loc8_ + 1)])
                        {
                            _loc7_ = ShoreMaskCreatorUtility.var_1506;
                        }
                        else
                        {
                            _loc7_ = ShoreMaskCreatorUtility.var_1507;
                        }

                    }

                    this.var_4161[param2] = ShoreMaskCreatorUtility.getBorderType(_loc6_, _loc7_);
                }
        ...
        private function updateRightBorder(param1: Array, param2: int): int
        {
            ...
            while (_loc10_ < _loc4_ - 1)
            {
                ...
                {
                    this.var_4160[param2] = true;
                    if (!_loc8_[(_loc3_ - 2)] && !_loc8_[(_loc3_ - 1)])
                    {
                        _loc5_ = ShoreMaskCreatorUtility.var_1505;
                    }
                    else
                    {
                        if (_loc8_[(_loc3_ - 1)])
                        {
                            _loc5_ = ShoreMaskCreatorUtility.var_1506;
                        }
                        else
                        {
                            _loc5_ = ShoreMaskCreatorUtility.var_1507;
                        }

                    }

                    if (!_loc9_[(_loc3_ - 2)] && !_loc9_[(_loc3_ - 1)])
                    {
                        _loc6_ = ShoreMaskCreatorUtility.var_1505;
                    }
                    else
                    ...
                    this.var_4161[param2] = ShoreMaskCreatorUtility.getBorderType(_loc5_, _loc6_);
                }
        ...
        private function updateBottomBorder(param1: Array, param2: int): int
        {
            ...
            while (_loc9_ >= 1)
            {
                ...
                {
                    this.var_4160[param2] = true;
                    if (!_loc8_[(_loc9_ + 1)] && !_loc7_[(_loc9_ + 1)])
                    {
                        _loc5_ = ShoreMaskCreatorUtility.var_1505;
                    }
                    else
        ...
        private function resetBorders(): void
        {
            ...
            if (this.var_3038 == 0 || this.var_3039 == 0)
            {
                ...
                this.var_3038 = _loc2_.getNumber(RoomObjectVariableEnum.FURNITURE_SIZE_X);
                this.var_3039 = _loc2_.getNumber(RoomObjectVariableEnum.FURNITURE_SIZE_Y);
            }

            this.var_4160 = [];
            this.var_4161 = [];
            var _loc1_: int;
            while (_loc1_ < this.var_3038 * 2 + this.var_3039 * 2)
            {
                this.var_4160.push(false);
                this.var_4161.push(ShoreMaskCreatorUtility.var_1507);
                _loc1_++;
            }
        ...
        {
            var _loc1_: int = this.var_3038 + 2;
            var _loc2_: int = this.var_3039 + 2;
            var _loc3_: Array = [];
            var _loc4_: Array;
            var _loc5_: int;
            var _loc6_: int;
        ...
        {
            if (this.var_4166 == null || this.var_4166.width < param1 || this.var_4166.height < param2)
            {
                if (this.var_4166 != null)
                {
                    this.var_4166.dispose();
                ...
                this.var_4166 = ShoreMaskCreatorUtility.createEmptyMask(param1, param2);
            }

            return ShoreMaskCreatorUtility.createShoreMask2x2(this.var_4166, getSize(param3), this.var_4160, this.var_4161, assetCollection);
        }
