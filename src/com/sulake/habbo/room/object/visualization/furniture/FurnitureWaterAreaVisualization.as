    ...
    public class FurnitureWaterAreaVisualization extends AnimatedFurnitureVisualization 
    {
        ...
        private function resetBorders():void
        {
            ...
            if (((this.var_3038 == 0) || (this.var_3039 == 0)))
            {
                ...
                this.var_3038 = _loc2_.getNumber(RoomObjectVariableEnum.var_738);
                this.var_3039 = _loc2_.getNumber(RoomObjectVariableEnum.var_739);
            };
            this.var_4160 = [];
            this.var_4161 = [];
            var _loc1_:int;
