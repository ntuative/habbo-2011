package com.sulake.habbo.room.object.visualization.pet
{
    ...
    public class PetVisualization extends RoomObjectSpriteVisualization implements IPetImageListener 
    {
        ...
        private function updateModel(param1:IRoomObjectModel, param2:Number):Boolean
        {
            ...
            {
                this.var_3949 = (param1.getNumber(RoomObjectVariableEnum.var_722) > 0);
                this.var_3293 = param1.getString(RoomObjectVariableEnum.var_727);
                this.var_4016 = param1.getString(RoomObjectVariableEnum.var_728);
                this._postureParameter = param1.getString(RoomObjectVariableEnum.var_729);
                this.var_4007 = param1.getNumber(RoomObjectVariableEnum.var_495);
                this.var_4170 = param1.getNumber(RoomObjectVariableEnum.AVATAR_EXPERIENCE_TIMESTAMP);
                this.var_3324 = param1.getNumber(RoomObjectVariableEnum.var_736);
                this.validateActions();
                _loc3_ = param1.getString(RoomObjectVariableEnum.var_497);
