package com.sulake.habbo.room.object.visualization.pet
{
    ...
    public class AnimatedPetVisualization extends AnimatedFurnitureVisualization
    {
        ...
        override protected function updateModel(param1: Number): Boolean
        {
            ...
            {
                _loc4_ = _loc3_.getString(RoomObjectVariableEnum.AVATAR_POSTURE);
                _loc5_ = _loc3_.getString(RoomObjectVariableEnum.AVATAR_GESTURE);
                _loc6_ = _loc3_.getNumber(RoomObjectVariableEnum.AVATAR_POSTURE);
                if (!isNaN(_loc6_))
                {
                ...
                _loc7_ = _loc3_.getNumber(RoomObjectVariableEnum.AVATAR_GESTURE);
                if (!isNaN(_loc7_))
                {
                ...
                this.var_3949 = _loc3_.getNumber(RoomObjectVariableEnum.AVATAR_SLEEP) > 0;
                _loc8_ = _loc3_.getNumber(RoomObjectVariableEnum.HEAD_DIRECTION);
                if (!isNaN(_loc8_))
                {
                ...
                this.var_3324 = _loc3_.getNumber(RoomObjectVariableEnum.AVATAR_GAINED_EXPERIENCE);
                _loc9_ = _loc3_.getNumber(RoomObjectVariableEnum.PET_PALETTE_INDEX);
        ...
        private function isHeadSprite(param1: int): Boolean
        {
            ...
            {
                this.var_4173[param1] = this._animationData.getTag(var_1459, DirectionData.USE_DEFAULT_DIRECTION, param1) == var_1468;
