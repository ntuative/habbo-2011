    ...
    public class AvatarVisualization extends RoomObjectSpriteVisualization implements IAvatarImageListener
    {
        ...
        private function updateModel(param1: IRoomObjectModel, param2: Number, param3: Boolean): Boolean
        {
            ...
            if (param1.getUpdateID() != var_1460)
            {
                ...
                _loc6_ = 0;
                _loc7_ = "";
                _loc5_ = param1.getNumber(RoomObjectVariableEnum.AVATAR_TALK) > 0 && param3;
                ...
                _loc5_ = param1.getNumber(RoomObjectVariableEnum.AVATAR_WAVE) > 0;
                ...
                _loc5_ = param1.getNumber(RoomObjectVariableEnum.AVATAR_SLEEP) > 0;
                ...
                _loc5_ = param1.getNumber(RoomObjectVariableEnum.AVATAR_BLINK) > 0 && param3;
                ...
                _loc5_ = param1.getNumber(RoomObjectVariableEnum.AVATAR_IS_TYPING) > 0;
                ...
                _loc6_ = param1.getNumber(RoomObjectVariableEnum.AVATAR_GESTURE);
                ...
                _loc7_ = param1.getString(RoomObjectVariableEnum.AVATAR_POSTURE);
                ...
                _loc7_ = param1.getString(RoomObjectVariableEnum.AVATAR_POSTURE_PARAMETER);
                ...
                _loc6_ = param1.getNumber(RoomObjectVariableEnum.AVATAR_DANCE);
                ...
                _loc6_ = param1.getNumber(RoomObjectVariableEnum.AVATAR_EFFECT);
                ...
                _loc6_ = param1.getNumber(RoomObjectVariableEnum.AVATAR_CARRY_OBJECT);
                ...
                _loc6_ = param1.getNumber(RoomObjectVariableEnum.AVATAR_USE_OBJECT);
                ...
                _loc6_ = param1.getNumber(RoomObjectVariableEnum.HEAD_DIRECTION);
                ...
                if (this.var_4020 > 0 && param1.getNumber(RoomObjectVariableEnum.AVATAR_USE_OBJECT) > 0)
                {
                ...
                _loc6_ = param1.getNumber(RoomObjectVariableEnum.AVATAR_NUMBER_VALUE);
                ...
                _loc7_ = param1.getString(RoomObjectVariableEnum.GENDER);
                ...
                _loc8_ = param1.getString(RoomObjectVariableEnum.FIGURE);
