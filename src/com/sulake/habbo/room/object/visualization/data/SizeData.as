package com.sulake.habbo.room.object.visualization.data
{
    ...
    public class SizeData 
    {
        ...
        public static const var_1444:int = 1000;
        public static const var_1887:int = 0;

        private var var_4053:int = 0;
        private var var_4059:int = 360;
        private var var_4060:DirectionData = null;
        private var var_3964:Map;
        private var _colors:Map;
        private var var_4061:DirectionData = null;
        ...
        public function SizeData(param1:int, param2:int)
        {
            ...
            this.var_4059 = param2;
            this.var_4060 = new DirectionData(param1);
            this.var_3964 = new Map();
        ...
        public function dispose():void
        {
            ...
            if (this.var_4060 != null)
            {
                this.var_4060.dispose();
                this.var_4060 = null;
            };
            var _loc1_:int;
            if (this.var_3964 != null)
            {
                _loc2_ = null;
                _loc1_ = 0;
                while (_loc1_ < this.var_3964.length)
                {
                    _loc2_ = (this.var_3964.getWithIndex(_loc1_) as DirectionData);
                    if (_loc2_ != null)
                    {
                        _loc2_.dispose();
                    };
        ...
        public function defineLayers(param1:XML):Boolean
        {
            ...
            return (this.defineDirection(this.var_4060, _loc2_));
        }
        ...
        public function defineDirections(param1:XML):Boolean
        {
            ...
            while (_loc5_ < _loc4_.length())
            {
                ...
                _loc8_ = _loc6_.layer;
                if (this.var_3964.getValue(String(_loc7_)) != null)
                {
                    return (false);
                };
                _loc3_ = new DirectionData(this.layerCount);
                _loc3_.copyValues(this.var_4060);
                this.defineDirection(_loc3_, _loc8_);
                this.var_3964.add(String(_loc7_), _loc3_);
                this.var_4062 = -1;
                this.var_4061 = null;
                _loc5_++;
            };
        ...
        private function defineDirection(param1:DirectionData, param2:XMLList):Boolean
        {
            ...
            while (_loc4_ < param2.length())
            {
                ...
                {
                    case "ADD":
                        param1.setInk(_loc6_, LayerData.var_1456);
                        break;
                    case "SUBTRACT":
                        param1.setInk(_loc6_, LayerData.var_1457);
                        break;
                    case "DARKEN":
        ...
        public function getDirectionValue(param1:int):int
        {
            var _loc6_:int;
            var _loc7_:int;
            var _loc2_:int = int((((((param1 % 360) + 360) + (this.var_4059 / 2)) % 360) / this.var_4059));
            if (this.var_3964.getValue(String(_loc2_)) != null)
            {
                return (_loc2_);
            };
            ...
            var _loc4_:int = -1;
            var _loc5_:int;
            while (_loc5_ < this.var_3964.length)
            {
                _loc6_ = (int(this.var_3964.getKey(_loc5_)) * this.var_4059);
            ...
            if (_loc4_ >= 0)
            {
                return (int(this.var_3964.getKey(_loc4_)));
            };
            return (var_1887);
        }
        ...
        {
            if (param1 == this.var_4062)
            {
                return (this.var_4061);
            };
            var _loc2_:DirectionData;
            _loc2_ = (this.var_3964.getValue(String(param1)) as DirectionData);
            if (_loc2_ == null)
            {
                _loc2_ = this.var_4060;
            };
            this.var_4062 = param1;
            this.var_4061 = _loc2_;
            return (this.var_4061);
        }
