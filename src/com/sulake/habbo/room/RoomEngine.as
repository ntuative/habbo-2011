package com.sulake.habbo.room
{
    ...
    public class RoomEngine extends Component implements IRoomEngine, IRoomManagerListener, IRoomCreator, IRoomEngineServices, IUpdateReceiver 
    {
        ...
        private var var_4343:IRoomRendererFactory = null;
        private var var_4344:IRoomObjectFactory = null;
        ...
        private var var_4353:int = 0;
        private var var_4354:int = 0;
        ...
        private var var_4366:Array = new Array();
        ...
        override public function dispose():void
        {
            ...
            if (this.var_4344 != null)
            {
                this.var_4344.release(new IIDRoomObjectFactory());
                this.var_4344 = null;
            };
            ...
            if (this.var_4343 != null)
            {
                this.var_4343.release(new IIDRoomRendererFactory());
                this.var_4343 = null;
            };
        ...
        public function update(param1:uint):void
        {
            ...
            if (this._roomManager != null)
            {
                ...
                _loc2_ = this._roomManager.getRoom(this.getRoomIdentifier(this.var_4353, this.var_4354));
        ...
        private function updateRoomCameras(param1:uint):void
        {
            ...
            while (_loc2_ < this.var_4364.length)
            {
                ...
                if (_loc4_ != null)
                {
                    ...
                    if (_loc10_ != null)
                    {
                        if ((((!(_loc5_ == this.var_4353)) || (!(_loc6_ == this.var_4354))) || (!(this.var_4358))))
                        {
        ...
        private function onObjectFactoryReady(param1:IID=null, param2:IUnknown=null):void
        {
            ...
            this.var_4344 = (param2 as IRoomObjectFactory);
        ...
        private function onRendererFactoryReady(param1:IID=null, param2:IUnknown=null):void
        {
            ...
            this.var_4343 = (param2 as IRoomRendererFactory);
            this.initializeRoomManager();
        }
        ...
        private function onHabboConfigurationReady(param1:IID=null, param2:IUnknown=null):void
        {
            ...
            if (this.var_4348 != null)
            {
                events.addEventListener(RoomContentLoader.var_451, this.onContentLoaderReady);
        ...
        {
            if (((!(param1 == null)) && (param1.type == RoomContentLoader.var_451)))
            {
                this.var_4349 = true;
                this.initializeRoomManager();
            };
        ...
        private function onAdManagerReady(param1:IID=null, param2:IUnknown=null):void
        {
            ...
            this.var_4345.events.addEventListener(AdEvent.var_70, this.showRoomAd);
            this.var_4345.events.addEventListener(AdEvent.var_347, this.onRoomAdImageLoaded);
            this.var_4345.events.addEventListener(AdEvent.var_348, this.onRoomAdImageLoaded);
        }
        ...
        private function initializeObjectEvents():void
        {
            if (this.var_4344 != null)
            {
                this.var_4344.addObjectEventListener(this.roomObjectEventHandler);
            };
        }

        private function initializeRoomManager():void
        {
            if ((((((((this.var_4344 == null) || (this.var_4325 == null)) || (this._roomManager == null)) || (this.var_4343 == null)) || (this._communication == null)) || (this.var_2868 == null)) || (!(this.var_4349))))
            {
                return;
            };
        ...
        public function roomManagerInitialized(param1:Boolean=true):void
        {
            ...
            {
                this.var_4352 = true;
                events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.var_356, 0, 0));
                _loc2_ = 0;
        ...
        public function setIsPlayingGame(param1:int, param2:int, param3:Boolean):void
        {
            ...
            if (_loc4_ != null)
            {
                ...
                if (_loc5_ == 0)
                {
                    events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.var_358, param1, param2));
                }
                else
                {
                    events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.var_357, param1, param2));
                };
            };
        }
        ...
        private function createRoom(param1:String, param2:XML, param3:String, param4:String, param5:String, param6:String):IRoomInstance
        {
            ...
            if (((!(_loc9_ == null)) && (!(_loc9_.getEventHandler() == null))))
            {
                ...
                if (param3 != null)
                {
                    _loc19_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.var_464, param3);
                    _loc9_.getEventHandler().processUpdateMessage(_loc19_);
                    _loc7_.setString(RoomObjectVariableEnum.var_465, param3);
                };
                if (param4 != null)
                {
                    _loc19_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.var_466, param4);
                    _loc9_.getEventHandler().processUpdateMessage(_loc19_);
                    _loc7_.setString(RoomObjectVariableEnum.var_467, param4);
                };
                if (param5 != null)
                {
                    _loc19_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.var_468, param5);
                    _loc9_.getEventHandler().processUpdateMessage(_loc19_);
                    ...
                    if (param2.doors.door.length() > 0)
                    {
                        ...
                        while (_loc23_ < _loc20_.length())
                        {
                            ...
                            if (XMLValidator.checkRequiredAttributes(_loc24_, _loc21_))
                            {
                                ...
                                _loc29_ = RoomObjectRoomMaskUpdateMessage.var_470;
                                _loc30_ = ("door_" + _loc23_);
                                _loc31_ = new Vector3d(_loc25_, _loc26_, _loc27_);
                                _loc22_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.var_471, _loc30_, _loc29_, _loc31_, RoomObjectRoomMaskUpdateMessage.var_472);
        ...
        public function updateObjectRoom(param1:int, param2:int, param3:String=null, param4:String=null, param5:String=null):Boolean
        {
            ...
            if (param3 != null)
            {
                ...
                _loc8_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.var_464, param3);
            ...
            if (param4 != null)
            {
                ...
                _loc8_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.var_466, param4);
                _loc6_.getEventHandler().processUpdateMessage(_loc8_);
            };
            if (param5 != null)
            {
                ...
                _loc8_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.var_468, param5);
                _loc6_.getEventHandler().processUpdateMessage(_loc8_);
            };
            return (true);
        }
        ...
        public function updateObjectRoomColor(param1:int, param2:int, param3:uint, param4:int, param5:Boolean):Boolean
        {
            ...
            _loc7_ = new RoomObjectRoomColorUpdateMessage(RoomObjectRoomColorUpdateMessage.var_477, param3, param4, param5);
        ...
        public function updateObjectRoomVisibilities(param1:int, param2:int, param3:Boolean, param4:Boolean=true):Boolean
        {
            ...
            _loc6_ = new RoomObjectRoomPlaneVisibilityUpdateMessage(RoomObjectRoomPlaneVisibilityUpdateMessage.var_478, param3);
            _loc5_.getEventHandler().processUpdateMessage(_loc6_);
            _loc6_ = new RoomObjectRoomPlaneVisibilityUpdateMessage(RoomObjectRoomPlaneVisibilityUpdateMessage.var_479, param4);
            _loc5_.getEventHandler().processUpdateMessage(_loc6_);
            return (true);
        }
        ...
        public function disposeRoom(param1:int, param2:int):void
        {
            ...
            events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.var_52, param1, param2));
        }
        ...
        public function createRoomCanvas(param1:int, param2:int, param3:int, param4:int, param5:int, param6:int):DisplayObject
        {
            ...
            if (_loc9_ == null)
            {
                _loc9_ = this.var_4343.createRenderer();
            };
            if (_loc9_ == null)
            {
                return (null);
            };
            _loc9_.roomObjectVariableAccurateZ = RoomObjectVariableEnum.var_480;
            ...
            else
            {
                if (param4 == MouseEvent.MOUSE_UP)
                {
                    if (this.var_4358)
                    {
                        ...
                        if (this.var_4359)
                        {
                            _loc10_ = this.getRoomInstanceData(this.var_4353, this.var_4354);
                            if (_loc10_ != null)
                            {
        ...
        public function handleRoomCanvasMouseEvent(param1:int, param2:int, param3:int, param4:String, param5:Boolean, param6:Boolean, param7:Boolean, param8:Boolean):void
        {
            ...
            var _loc9_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_4353, this.var_4354, param1);
            if (_loc9_ != null)
            {
                ...
                if (!this.handleRoomDragging(_loc9_, param2, param3, param4, param5, param6, param7))
                {
                    if (!_loc9_.handleMouseEvent(param2, param3, param4, param5, param6, param7, param8))
                    {
                        ...
                        if (param4 == MouseEvent.CLICK)
                        {
                            if (events != null)
                            {
                                events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.var_403, this.var_4353, this.var_4354, -1, RoomObjectCategoryEnum.var_352));
                            };
                            _loc13_ = RoomObjectMouseEvent.var_483;
                        }
                        else
                        {
                            if (param4 == MouseEvent.MOUSE_MOVE)
                            {
                                _loc13_ = RoomObjectMouseEvent.var_484;
                            }
                            else
                            {
                                if (param4 == MouseEvent.MOUSE_DOWN)
                        ...
                        if (this.var_4346 != null)
                        {
                            ...
                            this.var_4346.handleRoomObjectEvent(_loc14_, this.var_4353, this.var_4354);
                        };
                    };
                };
        ...
        public function setObjectMoverIconSprite(param1:int, param2:int, param3:Boolean, param4:String=null):void
        {
            ...
            if (param3)
            {
                _loc5_ = this.getRoomObjectImage(this.var_4353, this.var_4354, param1, param2, new Vector3d(), 1, null);
            }
            else
            {
                if (this.var_4348 != null)
            ...
            var _loc6_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_4353, this.var_4354, this.var_4355);
            if (_loc6_ != null)
            {
        ...
        public function setObjectMoverIconSpriteVisible(param1:Boolean):void
        {
            var _loc3_:Sprite;
            var _loc4_:Sprite;
            var _loc2_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_4353, this.var_4354, this.var_4355);
            if (_loc2_ != null)
            {
        ...
        {
            var _loc2_:Sprite;
            var _loc1_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_4353, this.var_4354, this.var_4355);
            if (_loc1_ != null)
            {
        ...
        public function modifyRoomObject(param1:int, param2:int, param3:String):Boolean
        {
            if (this.var_4346 != null)
            {
                return (this.var_4346.modifyRoomObject(this.var_4353, this.var_4354, param1, param2, param3));
            };
            return (false);
        }
        ...
        public function modifyRoomObjectData(param1:int, param2:int, param3:String):Boolean
        {
            if (this.var_4346 != null)
            {
                if (param2 == RoomObjectCategoryEnum.var_73)
                {
                    return (this.var_4346.modifyWallItemData(this.var_4353, this.var_4354, param1, param3));
                };
            };
            return (false);
        }
        ...
        public function deleteRoomObject(param1:int, param2:int):Boolean
        {
            if (this.var_4346 != null)
            {
                if (param2 == RoomObjectCategoryEnum.var_73)
                {
                    return (this.var_4346.deleteWallItem(this.var_4353, this.var_4354, param1));
                };
            };
            return (false);
        }

        public function var_485(param1:int, param2:int, param3:int, param4:String=null):Boolean
        {
            var _loc5_:IRoomInstance = this.getRoom(this.var_4353, this.var_4354);
            ...
            if (this.var_4346 != null)
            {
                return (this.var_4346.var_485(this.var_4353, this.var_4354, param1, param2, param3, param4));
            };
            return (false);
        }
        ...
        public function cancelRoomObjectInsert():void
        {
            if (this.var_4346 != null)
            {
                this.var_4346.cancelRoomObjectInsert(this.var_4353, this.var_4354);
            };
        }
        ...
        private function addObjectFurnitureFromData(param1:int, param2:int, param3:int, param4:FurnitureData):Boolean
        {
            ...
            {
                _loc9_.getModelController().setNumber(RoomObjectVariableEnum.var_486, _loc7_, true);
                _loc9_.getModelController().setNumber(RoomObjectVariableEnum.var_487, param4.typeId, true);
                _loc9_.getModelController().setString(RoomObjectVariableEnum.var_488, _loc8_, true);
                _loc9_.getModelController().setNumber(RoomObjectVariableEnum.var_489, 1, true);
                _loc9_.getModelController().setNumber(RoomObjectVariableEnum.var_490, param4.expiryTime);
            ...
            if (events != null)
            {
                events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.var_404, param1, param2, param3, RoomObjectCategoryEnum.var_72));
            };
        ...
        private function addObjectWallItemFromData(param1:int, param2:int, param3:int, param4:FurnitureData):Boolean
        {
            ...
            {
                _loc8_.getModelController().setNumber(RoomObjectVariableEnum.var_486, _loc6_, false);
                _loc8_.getModelController().setNumber(RoomObjectVariableEnum.var_487, param4.typeId, true);
                _loc8_.getModelController().setString(RoomObjectVariableEnum.var_488, _loc7_, true);
                _loc8_.getModelController().setNumber(RoomObjectVariableEnum.var_480, 1, true);
            };
            ...
            if (events != null)
            {
                events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.var_404, param1, param2, param3, RoomObjectCategoryEnum.var_73));
            };
            ...
            if (_loc7_ != null)
            {
                if (_loc7_.getModel() != null)
                {
                    if (_loc7_.getModel().getNumber(RoomObjectVariableEnum.var_492) > 0)
                    {
                        ...
                        if (param4)
                        {
                            _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.var_471, _loc5_, _loc9_, _loc10_);
                        }
                        else
                        {
                            _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.var_494, _loc5_);
                        };
                    };
                };
            }
        ...
        public function addObjectUser(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:Number, param7:int, param8:String=null):Boolean
        {
            ...
            if (events != null)
            {
                events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.var_404, param1, param2, param3, RoomObjectCategoryEnum.var_71));
            };
            return (true);
        }

        public function var_4312(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:IVector3d=null, param7:Number=NaN):Boolean
        {
            ...
            if (isNaN(param7))
            {
                param7 = _loc8_.getModel().getNumber(RoomObjectVariableEnum.var_495);
            };
        ...
        private function disposeObject(param1:String, param2:int, param3:int):void
        {
            ...
            if (_loc4_.disposeObject(param2, param3))
            {
                if (events != null)
                {
                    events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.var_405, this.var_4353, this.var_4354, param2, param3));
                };
            };
        }
        ...
        private function roomObjectEventHandler(param1:RoomObjectEvent):void
        {
            if (this.var_4346 != null)
            {
                this.var_4346.handleRoomObjectEvent(param1, this.var_4353, this.var_4354);
            };
        }
                ...
                if (((!(_loc14_ == null)) && (!(_loc14_.getModel() == null))))
                {
                    ...
                    switch (param4)
                    {
                        ...
                        case RoomObjectCategoryEnum.var_73:
                            _loc10_ = String(_loc14_.getModel().getNumber(RoomObjectVariableEnum.var_486));
                            _loc11_ = _loc14_.getModel().getString(RoomObjectVariableEnum.var_496);
                            break;
                        case RoomObjectCategoryEnum.var_71:
                            _loc10_ = _loc14_.getModel().getString(RoomObjectVariableEnum.var_497);
                            break;
                    };
                };
            };
        ...
        private function initializeRoomForGettingImage(param1:IRoomObjectController, param2:String):void
        {
            ...
            if (param2 != null)
            {
                ...
                if (_loc3_.length >= 3)
                {
                    ...
                    _loc8_.addPlane(RoomPlaneData.var_498, new Vector3d(0, 0, 0), new Vector3d(10, 0, 0), new Vector3d(0, 10, 0));
                    _loc8_.addPlane(RoomPlaneData.var_499, new Vector3d(0, 0, 0), new Vector3d(0, 10, 0), new Vector3d(0, 0, 10));
                    _loc8_.addPlane(RoomPlaneData.var_499, new Vector3d(10, 0, 0), new Vector3d(-10, 0, 0), new Vector3d(0, 0, 10));
                    _loc8_.addPlane(RoomPlaneData.var_500, new Vector3d(10, 0, 0), new Vector3d(-10, 0, 0), new Vector3d(0, 0, 10));
                    ...
                    if (_loc7_ != null)
                    {
                        ...
                        _loc10_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.var_471, _loc11_, _loc7_, new Vector3d(2, 0, 1.75));
        ...
        public function getGenericRoomObjectImage(param1:String, param2:String, param3:IVector3d, param4:int, param5:IGetImageListener, param6:uint=0, param7:String=null, param8:int=-1, param9:int=-1):ImageResult
        {
            ...
            switch (_loc13_)
            {
                case RoomObjectCategoryEnum.var_72:
                case RoomObjectCategoryEnum.var_73:
                    _loc14_.getModelController().setNumber(RoomObjectVariableEnum.var_486, int(param2));
                    _loc14_.getModelController().setString(RoomObjectVariableEnum.var_496, param7);
                    break;
                case RoomObjectCategoryEnum.var_71:
                    if ((((param1 == "user") || (param1 == "bot")) || (param1 == "pet")))
                    {
                        _loc14_.getModelController().setString(RoomObjectVariableEnum.var_497, param2);
                    }
                    else
                    {
                        _loc14_.getModelController().setNumber(RoomObjectVariableEnum.var_502, int(param2));
                    };
                    break;
            ...
            if (param8 > -1)
            {
                _loc18_ = _loc14_.getModel().getString(RoomObjectVariableEnum.var_503);
            ...
            if (((!(this.isRoomObjectContentAvailable(param1))) && (!(param5 == null))))
            {
                ...
                _loc14_.getModelController().setNumber(RoomObjectVariableEnum.var_504, param4, true);
            }
            else
            {
                _loc11_.disposeObject(_loc12_, _loc13_);
        ...
        {
            return (this.getRoomObjectBoundingRectangle(this.var_4353, this.var_4354, var_453, RoomObjectCategoryEnum.var_354, param1));
        }
        ...
        public function contentLoaded(param1:String, param2:Boolean=false):void
        {
            ...
            while (_loc8_ >= 0)
            {
                ...
                if ((((!(_loc9_ == null)) && (!(_loc9_.getModel() == null))) && (_loc9_.getType() == param1)))
                {
                    ...
                    if (_loc12_ != null)
                    {
                        _loc14_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.var_504);
        ...
        public function objectInitialized(param1:String, param2:int, param3:int):void
        {
            ...
            {
                _loc7_ = _loc6_.getModel().getString(RoomObjectVariableEnum.var_503);
                if (_loc7_ != null)
                {
        ...
        private function showRoomAd(param1:AdEvent):void
        {
            ...
            if (this.var_4348 != null)
            {
                ...
                _loc4_ = null;
                _loc4_ = new RoomObjectRoomAdUpdateMessage(RoomObjectRoomAdUpdateMessage.var_508, RoomObjectVariableEnum.var_505, param1.clickUrl);
        ...
        private function onRoomAdImageLoaded(param1:AdEvent):void
        {
            ...
            switch (param1.type)
            {
                case AdEvent.var_347:
                    _loc4_ = new RoomObjectRoomAdUpdateMessage(RoomObjectRoomAdUpdateMessage.var_509, param1.imageUrl, param1.clickUrl, param1.objectId, param1.image);
                    break;
                case AdEvent.var_348:
                    _loc4_ = new RoomObjectRoomAdUpdateMessage(RoomObjectRoomAdUpdateMessage.var_510, param1.imageUrl, param1.clickUrl, param1.objectId, param1.image);
                    break;
            };
            if (_loc4_ != null)
            {
