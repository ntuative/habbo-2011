package com.sulake.habbo.room.utils
{
    ...
    public class LegacyWallGeometry implements IDisposable 
    {
        ...
        private static const var_4281:String = "l";
        ...
        public function initialize(param1:int, param2:int, param3:int):void
        {
            var _loc5_:Array;
            var _loc6_:int;
            if (((param1 <= this.var_2237) && (param2 <= this._height)))
            {
        ...
        public function getLocation(param1:int, param2:int, param3:int, param4:int, param5:String):IVector3d
        {
            ...
            {
                param1 = this.var_2237;
                param2 = this._height;
                _loc12_ = int(Math.round((this.scale / 10)));
                if (param5 == DIRECTION_RIGHT)
                {
                    _loc7_ = (this.var_2237 - 1);
                    while (_loc7_ >= 0)
                    {
                        _loc6_ = 1;
                        while (_loc6_ < this._height)
                        {
                            if (this.getTileHeight(_loc7_, _loc6_) <= this.var_4280)
                            {
                                if ((_loc6_ - 1) < param2)
                                {
                                    param1 = _loc7_;
        ...
        public function getLocationOldFormat(param1:Number, param2:Number, param3:String):IVector3d
        {
            ...
            _loc4_ = 0;
            while (_loc4_ < this.var_2237)
            {
                if (((_loc5_ >= 0) && (_loc5_ < this._height)))
                {
                    if (this.getTileHeight(_loc4_, _loc5_) <= this.var_4280)
                    {
                        _loc8_ = (_loc4_ - 1);
                        _loc9_ = _loc5_;
                        _loc7_ = _loc4_;
                    ...
                    if (this.getTileHeight(_loc4_, (_loc5_ + 1)) <= this.var_4280)
                    {
                        _loc8_ = _loc4_;
                        _loc9_ = _loc5_;
