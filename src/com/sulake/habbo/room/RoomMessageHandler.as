package com.sulake.habbo.room
{
    ...
    public class RoomMessageHandler
    {
        ...
        private function onFloorHeightMap(param1: IMessageEvent): void
        {
            ...
            {
                this.addActiveObject(_loc4_, _loc5_, this.var_4372.objectData);
                this.var_4372.objectData = null;
            }
            else
            {
        ...
        private function onUsers(param1: IMessageEvent): void
        {
            ...
            while (_loc6_ < _loc3_.getUserCount())
            {
                ...
                if (_loc7_ != null)
                {
                    ...
                    this.var_4368.addObjectUser(_loc4_, _loc5_, _loc7_.id, _loc8_, _loc9_, _loc7_.dir, _loc10_, _loc7_.figure);
                    ...
                    for each (_loc19_ in _loc9_.actions)
                    {
                        switch (_loc19_.actionType)
                        {
                            ...
                            case "sign":
                                ...
                                this.var_4368.updateObjectUserState(_loc4_, _loc5_, _loc9_.id, _loc21_);
                                break;
                            case "gst":
                                _loc22_ = new RoomObjectAvatarPetGestureUpdateMessage(_loc19_.actionParameter);
                                this.var_4368.updateObjectUserState(_loc4_, _loc5_, _loc9_.id, _loc22_);
                                break;
                            case "wav":
                            case "mv":
                                _loc18_ = true;
        ...
        private function onSlideUpdate(param1: IMessageEvent): void
        {
            ...
            if (param1 is SlideObjectBundleMessageEvent)
            {
                ...
                this.var_4368.updateObjectFurniture(_loc3_, _loc4_, _loc2_.id, null, null, 1, null);
                this.var_4368.updateObjectFurniture(_loc3_, _loc4_, _loc2_.id, null, null, 2, null);
