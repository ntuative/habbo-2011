    ...
    public class RoomObjectEventHandler implements IRoomRenderingCanvasMouseListener
    {
        ...
        public function setSelectedObject(param1: int, param2: int, param3: int, param4: int): void
        {
            ...
            switch (param4)
            {
                ...
                case RoomObjectCategoryEnum.var_73:
                    ...
                    _loc5_.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.REOE_OBJECT_SELECTED, param1, param2, param3, param4));
                    return;
            }
        ...
        public function handleRoomObjectEvent(param1: RoomObjectEvent, param2: int, param3: int): void
        {
            ...
            switch (param1.type)
            {
                ...
                case RoomObjectStateChangeEvent.ROSCE_STATE_RANDOM:
                    ...
                    return;
                case RoomObjectDimmerStateUpdateEvent.RODSUE_DIMMER_STATE:
        ...
        private function handleRoomObjectMouseClick(param1: RoomObjectMouseEvent, param2: int, param3: int): void
        {
            ...
            if (_loc8_ == RoomObjectCategoryEnum.var_354)
            {
                ...
                if (_loc14_ != _loc10_ && _loc15_ != _loc10_)
                {
                    ...
                    if (_loc16_ != null)
                    {
                        _loc16_.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.REOE_OBJECT_DESELECTED, param2, param3, -1, RoomObjectCategoryEnum.var_352));
                    }
                ...
                case RoomObjectOperationEnum.OBJECT_UNDEFINED:
                    if (_loc8_ == RoomObjectCategoryEnum.var_72 || _loc8_ == RoomObjectCategoryEnum.var_73)
                    {
                        if (param1.altKey)
                        {
                            ...
                            if (_loc10_ != null)
                            {
                                _loc10_.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.REOB_OBJECT_REQUEST_MOVE, param2, param3, _loc6_, _loc8_));
                            }
            ...
            if (_loc6_ == null)
            {
                ...
                if (_loc6_ != null)
                {
                    if (_loc5_.category == RoomObjectCategoryEnum.var_72)
                    {
                        ...
                        {
                            _loc9_ = _loc6_.getModel()
                                    .getNumberArray(RoomObjectVariableEnum.FURNITURE_ALLOWED_DIRECTIONS);
        ...
        private function handleObjectWidgetRequestEvent(param1: RoomObjectEvent, param2: int, param3: int): void
        {
            ...
            if (_loc7_ != null)
            {
                ...
                {
                    case RoomObjectWidgetRequestEvent.var_411:
                        _loc7_.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.REOE_WIDGET_REQUEST_PLACEHOLDER, param2, param3, _loc4_, _loc6_));
                        return;
                    case RoomObjectWidgetRequestEvent.ROOM_OBJECT_WIDGET_REQUEST_CREDITFURNI:
                        ...
                        return;
                    case RoomObjectWidgetRequestEvent.var_407:
                        _loc7_.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.REOE_WIDGET_REQUEST_STICKIE, param2, param3, _loc4_, _loc6_));
                        return;
                    case RoomObjectWidgetRequestEvent.var_408:
                        _loc7_.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.REOE_WIDGET_REQUEST_PRESENT, param2, param3, _loc4_, _loc6_));
                        return;
                    case RoomObjectWidgetRequestEvent.ROOM_OBJECT_WIDGET_REQUEST_TROPHY:
                        ...
                        return;
                    case RoomObjectWidgetRequestEvent.var_409:
                        _loc7_.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.REOE_WIDGET_REQUEST_TEASER, param2, param3, _loc4_, _loc6_));
                        return;
                    case RoomObjectWidgetRequestEvent.var_410:
                        _loc7_.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.REOE_WIDGET_REQUEST_ECOTRONBOX, param2, param3, _loc4_, _loc6_));
                        return;
                    case RoomObjectWidgetRequestEvent.var_412:
                        _loc7_.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.REOE_WIDGET_REQUEST_DIMMER, param2, param3, _loc4_, _loc6_));
                        return;
                    case RoomObjectWidgetRequestEvent.var_417:
                        _loc7_.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.REOR_REMOVE_DIMMER, param2, param3, _loc4_, _loc6_));
                        return;
                    case RoomObjectWidgetRequestEvent.var_418:
                        _loc7_.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.REOR_REQUEST_CLOTHING_CHANGE, param2, param3, _loc4_, _loc6_));
                        return;
                    case RoomObjectWidgetRequestEvent.var_419:
                        _loc7_.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.REOR_WIDGET_REQUEST_PLAYLIST_EDITOR, param2, param3, _loc4_, _loc6_));
                        return;
                }
        ...
        private function handleObjectRoomAdEvent(param1: RoomObjectEvent, param2: int, param3: int): void
        {
            ...
            switch (param1.type)
            {
                case RoomObjectRoomAdEvent.var_50:
                    ...
                    _loc7_ = RoomEngineObjectEvent.REOE_ROOM_AD_FURNI_CLICK;
                    break;
                case RoomObjectRoomAdEvent.var_344:
                    _loc7_ = RoomEngineObjectEvent.REOE_ROOM_AD_FURNI_DOUBLE_CLICK;
                    break;
                case RoomObjectRoomAdEvent.var_345:
                    _loc7_ = RoomEngineObjectEvent.REOE_ROOM_AD_TOOLTIP_SHOW;
                    break;
                case RoomObjectRoomAdEvent.var_346:
                    _loc7_ = RoomEngineObjectEvent.REOE_ROOM_AD_TOOLTIP_HIDE;
                    break;
                case RoomObjectRoomAdEvent.ROOM_AD_LOAD_IMAGE:
        ...
        private function validateFurnitureDirection(param1: IRoomObject, param2: IVector3d, param3: TileHeightMap): Boolean
        {
            ...
            var _loc6_: int = param1.getModel().getNumber(RoomObjectVariableEnum.FURNITURE_SIZE_X);
            var _loc7_: int = param1.getModel().getNumber(RoomObjectVariableEnum.FURNITURE_SIZE_Y);
            if (_loc6_ < 1)
            {
                _loc6_ = 1;
            }
            ...
            {
                return param3.validateLocation(_loc5_.x, _loc5_.y, _loc6_, _loc7_, _loc5_.x, _loc5_.y, _loc8_, _loc9_);
        ...
        private function validateFurnitureLocation(param1: IRoomObject, param2: IVector3d, param3: IVector3d, param4: IVector3d, param5: TileHeightMap): Vector3d
        {
            ...
            var _loc7_: int = param1.getModel().getNumber(RoomObjectVariableEnum.FURNITURE_SIZE_X);
            var _loc8_: int = param1.getModel().getNumber(RoomObjectVariableEnum.FURNITURE_SIZE_Y);
            if (_loc7_ < 1)
            {
                _loc7_ = 1;
            }
        ...
        private function validateWallItemLocation(param1: IRoomObject, param2: IVector3d, param3: IVector3d, param4: IVector3d, param5: Number, param6: Number, param7: SelectedRoomObjectData): Vector3d
        {
            ...
            var _loc8_: Number = param1.getModel().getNumber(RoomObjectVariableEnum.FURNITURE_SIZE_X);
            var _loc9_: Number = param1.getModel().getNumber(RoomObjectVariableEnum.FURNITURE_SIZE_Z);
            var _loc10_: Number = param1.getModel().getNumber(RoomObjectVariableEnum.FURNITURE_CENTER_Z);
        ...
        private function setObjectAlphaMultiplier(param1: IRoomObjectController, param2: Number): void
        {
            ...
            {
                param1.getModelController().setNumber(RoomObjectVariableEnum.FURNITURE_ALPHA_MULTIPLIER, param2);
            }
        ...
        public function setSelectedAvatar(roomId: int, roomCategory: int, objectId: int, isSelected: Boolean): void
        {
            ...
            if (selectionArrow != null && selectionArrow.getEventHandler() != null)
            {
                ...
                {
                    selectionArrow.getEventHandler()
                            .processUpdateMessage(new RoomObjectVisibilityUpdateMessage(RoomObjectVisibilityUpdateMessage.var_1185));
                }
                else
                {
                    selectionArrow.getEventHandler()
                            .processUpdateMessage(new RoomObjectVisibilityUpdateMessage(RoomObjectVisibilityUpdateMessage.var_1186));
                }
        ...
        private function getValidFurnitureDirection(param1: IRoomObjectController, param2: Boolean): int
        {
            ...
            {
                _loc3_ = param1.getModel().getNumberArray(RoomObjectVariableEnum.FURNITURE_ALLOWED_DIRECTIONS);
            }
        ...
        private function placeObject(param1: int, param2: int): void
        {
            ...
            if (this._roomEngine && this._roomEngine.events)
            {
                ...
                this._roomEngine.events.dispatchEvent(new RoomEngineObjectPlacedEvent(RoomEngineObjectEvent.REOB_OBJECT_PLACED, param1, param2, _loc4_, _loc5_, _loc7_, _loc8_, _loc9_, _loc10_, _loc11_, _loc15_));
            }
