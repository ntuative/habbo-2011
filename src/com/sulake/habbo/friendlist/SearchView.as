package com.sulake.habbo.friendlist
{
    ...
    public class SearchView implements ITabView, ISearchView
    {
        ...
        private var var_3458: ITextFieldWindow;
        ...
        {
            this.var_3458 = ITextFieldWindow(param1.findChildByName("search_str"));
            this.var_3458.procedure = this.onSearchInput;
            this.var_3458.addEventListener(WindowKeyboardEvent.var_1156, this.onSearchStrInput);
        ...
        private function refreshShading(): void
        {
            ...
            {
                this.var_2190.getListItemAt(_loc1_).color = this._friendList.laf.getRowShadingColor(FriendListTab.FRIEND_LIST_SEARCH, _loc1_ % 2 == 1);
                _loc1_++;
            }
        ...
        {
            var _loc10_: IWindowContainer = this.var_2190.getListItemAt(param2) as IWindowContainer;
            if (_loc10_ == null)
            {
                if (!param1)
                {
                ...
                this.var_2190.addListItem(_loc10_);
            }
        ...
        private function onSearchEntry(param1: WindowEvent, param2: IWindow): void
        {
            ...
            if (param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
            {
                ...
                this.var_3446.setData(_loc3_.isAvatarOnline, _loc3_.avatarName, _loc3_.avatarMotto, _loc3_.avatarFigure, _loc3_.lastOnlineDate, _loc3_.realName);
                this.var_3446.showPopup(this._friendList.view.mainWindow, IWindowContainer(param2));
            }
            else
            {
        ...
        private function findIndexFor(param1: int): int
        {
            ...
            {
                if (this.var_2190.getListItemAt(_loc2_).id == param1)
                {
                    return _loc2_;
                }
        ...
        private function onSearchStrInput(param1: WindowKeyboardEvent): void
        {
            ...
            {
                _loc4_ = 25;
                _loc5_ = this.var_3458.text;
                if (_loc5_.length > _loc4_)
                {
                    this.var_3458.text = _loc5_.substring(0, _loc4_);
                }
        ...
        {
            var _loc1_: String = this.var_3458.text;
