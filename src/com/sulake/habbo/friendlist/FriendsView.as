package com.sulake.habbo.friendlist
{
    ...
    public class FriendsView implements ITabView, IFriendsView
    {
        ...
        public static const var_1917: String = "bg";

        private var _friendList: HabboFriendList;
        private var var_3442: IContainerButtonWindow;
        private var var_3443: IContainerButtonWindow;
        private var var_3444: IContainerButtonWindow;
        private var var_3445: IContainerButtonWindow;
        private var var_2190: IItemListWindow;
        private var var_3446: AvatarPopupCtrl;

        public function init(param1: HabboFriendList): void
        {
            this._friendList = param1;
            this.var_3446 = new AvatarPopupCtrl(this._friendList);
        }
        ...
        {
            this.var_3442 = this.initButton("open_minimail", this.onMinimailButtonClick, param1);
            this.var_3443 = this.initButton("open_homepage", this.onHomeButtonClick, param1);
            this.var_3444 = this.initButton("room_invite", this.onInviteButtonClick, param1);
            this.var_3445 = this.initButton("remove_friend", this.onRemoveButtonClick, param1);
            this.refreshButtons();
        }
        ...
        {
            this._friendList.tabs.findTab(FriendListTab.FRIEND_LIST_FRIENDS).setNewMessageArrived(true);
        }
        ...
        private function refreshEntry(param1: Boolean, param2: int, param3: FriendCategory, param4: Friend): Boolean
        {
            ...
            var _loc6_: IWindowContainer = this.var_2190.getListItemAt(param2) as IWindowContainer;
            if (_loc6_ == null)
            {
                if (!param1)
                {
            ...
            _loc6_.height = 20;
            _loc6_.visible = true;
            _loc6_.color = this._friendList.laf.getRowShadingColor(FriendListTab.FRIEND_LIST_FRIENDS, _loc5_);
            if (param4 == null)
            {
                param3.view = _loc6_;
        ...
        {
            return this._friendList.laf.getRowShadingColor(FriendListTab.FRIEND_LIST_FRIENDS, param1);
        }

        private function refreshButtons(): void
        {
            var _loc1_: Array = this._friendList.categories.getSelectedFriends();
            this.setEnabled(this.var_3442, this.isEnableMinimailButton(_loc1_));
            this.setEnabled(this.var_3443, this.isEnableHomeButton(_loc1_));
            this.setEnabled(this.var_3444, this.isEnableInviteButton(_loc1_));
            this.setEnabled(this.var_3445, this.isEnableRemoveButton(_loc1_));
        }
        ...
        private function onFriendClick(param1: WindowEvent, param2: IWindow): void
        {
            ...
            if (param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
            {
                ...
                this.var_3446.setData(_loc3_.online, _loc3_.name, _loc3_.motto, _loc3_.figure, _loc3_.lastAccess);
                this.var_3446.showPopup(this._friendList.view.mainWindow, _loc3_.view);
            }
            else
            {
                if (param1.type == WindowMouseEvent.var_626)
                {
                    this.var_3446.closePopup();
                }
                else
                {
                    if (param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK || param1.type == WindowMouseEvent.var_627)
                    {
                        _loc4_ = this._friendList.categories.findFriend(param2.id);
                        _loc4_.selected = !_loc4_.selected;
                        this.refreshButtons();
                        this.refreshList();
                        if (param1.type == WindowMouseEvent.var_627 && _loc4_.online)
                        {
        ...
        private function refreshPageLink(param1: IWindowContainer, param2: int, param3: int, param4: Boolean): void
        {
            ...
            _loc6_.text = "" + (param2 * FriendCategory.FRIENDS_PER_PAGE + 1) + "-" + ("" + (param2 + 1) * FriendCategory.FRIENDS_PER_PAGE);
            _loc6_.id = param2;
            _loc6_.procedure = this.onPageLinkClick;
            _loc6_.width = _loc6_.textWidth + 5;
            _loc6_.color = this._friendList.laf.getRowShadingColor(FriendListTab.FRIEND_LIST_FRIENDS, param4);
            _loc6_.visible = true;
        }
