package com.sulake.habbo.friendlist
{
    ...
    public class FriendsView implements ITabView, IFriendsView 
    {
        ...
        {
            this._friendList.tabs.findTab(FriendListTab.var_512).setNewMessageArrived(true);
        }
        ...
        private function refreshEntry(param1:Boolean, param2:int, param3:FriendCategory, param4:Friend):Boolean
        {
            ...
            _loc6_.height = 20;
            _loc6_.visible = true;
            _loc6_.color = this._friendList.laf.getRowShadingColor(FriendListTab.var_512, _loc5_);
            if (param4 == null)
            {
                param3.view = _loc6_;
        ...
        {
            return (this._friendList.laf.getRowShadingColor(FriendListTab.var_512, param1));
        }
        ...
        private function refreshPageLink(param1:IWindowContainer, param2:int, param3:int, param4:Boolean):void
        {
            ...
            _loc6_.text = ((("" + ((param2 * FriendCategory.var_1626) + 1)) + "-") + ("" + ((param2 + 1) * FriendCategory.var_1626)));
            _loc6_.id = param2;
            _loc6_.procedure = this.onPageLinkClick;
            _loc6_.width = (_loc6_.textWidth + 5);
            _loc6_.color = this._friendList.laf.getRowShadingColor(FriendListTab.var_512, param4);
            _loc6_.visible = true;
        }
