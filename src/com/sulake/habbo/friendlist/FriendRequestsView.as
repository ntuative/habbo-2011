package com.sulake.habbo.friendlist
{
    ...
    public class FriendRequestsView implements ITabView, IFriendRequestsView
    {
        ...
        private static const var_3439: String = "no_reqs_info";

        private var _friendList: HabboFriendList;
        private var var_2190: IItemListWindow;
        private var var_3440: IContainerButtonWindow;
        private var var_3441: IContainerButtonWindow;
        ...
        {
            this.var_3440 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
            this.var_3441 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
            this.var_3441.procedure = this.onDismissAllButtonClick;
            this.var_3440.procedure = this.onAcceptAllButtonClick;
            this.refreshButtons();
        }
        ...
        public function refreshShading(param1: FriendRequest, param2: Boolean): void
        {
            ...
            param1.view.color = this._friendList.laf.getRowShadingColor(FriendListTab.FRIEND_LIST_REQUESTS, param2);
        ...
        public function refreshRequestEntry(param1: FriendRequest): void
        {
            ...
            if (param1.state == FriendRequest.FRIEND_STATE_PENDING)
            {
        ...
        public function addRequest(param1: FriendRequest): void
        {
            ...
            this.var_2190.addListItem(param1.view);
            this._friendList.friendRequests.refreshShading();
            this.refreshButtons();
        }
        ...
        public function removeRequest(param1: FriendRequest): void
        {
            ...
            this.var_2190.removeListItem(param1.view);
            this.refreshButtons();
        }
        ...
        public function acceptRequest(param1: int): void
        {
            ...
            _loc2_.state = FriendRequest.FRIEND_STATE_ACCEPTED;
            ...
            {
                this._friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.FRIEND_REQUEST_ACCEPTED, param1));
            }
        ...
        public function declineRequest(param1: int): void
        {
            ...
            _loc2_.state = FriendRequest.FRIEND_STATE_REJECTED;
            ...
            if (this._friendList && this._friendList.events)
            {
                this._friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.FRIEND_REQUEST_DECLINED, param1));
            }
        ...
        private function onDismissAllButtonClick(param1: WindowEvent, param2: IWindow): void
        {
            ...
            {
                if (_loc4_.state != FriendRequest.FRIEND_STATE_ACCEPTED && _loc4_.state != FriendRequest.FRIEND_STATE_REJECTED)
                {
                    _loc4_.state = FriendRequest.FRIEND_STATE_REJECTED;
                    this.refreshRequestEntry(_loc4_);
                    if (this._friendList && this._friendList.events)
                    {
                        this._friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.FRIEND_REQUEST_DECLINED, _loc4_.requestId));
                    }
        ...
        private function onAcceptAllButtonClick(param1: WindowEvent, param2: IWindow): void
        {
            ...
            for each (_loc4_ in this._friendList.friendRequests.requests)
            {
                if (_loc4_.state != FriendRequest.FRIEND_STATE_ACCEPTED && _loc4_.state != FriendRequest.FRIEND_STATE_REJECTED)
                {
                    ...
                    _loc4_.state = FriendRequest.FRIEND_STATE_ACCEPTED;
                    this.refreshRequestEntry(_loc4_);
                    if (this._friendList && this._friendList.events)
                    {
                        this._friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.FRIEND_REQUEST_ACCEPTED, _loc4_.requestId));
                    }
        ...
        private function refreshButtons(): void
        {
            ...
            this.setEnabled(this.var_3440, _loc1_);
            this.setEnabled(this.var_3441, _loc1_);
        }
