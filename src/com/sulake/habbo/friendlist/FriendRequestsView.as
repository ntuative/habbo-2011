package com.sulake.habbo.friendlist
{
    ...
    public class FriendRequestsView implements ITabView, IFriendRequestsView 
    {
        ...
        public function refreshShading(param1:FriendRequest, param2:Boolean):void
        {
            ...
            param1.view.color = this._friendList.laf.getRowShadingColor(FriendListTab.var_516, param2);
        ...
        public function refreshRequestEntry(param1:FriendRequest):void
        {
            ...
            if (param1.state == FriendRequest.var_1530)
            {
        ...
        public function acceptRequest(param1:int):void
        {
            ...
            _loc2_.state = FriendRequest.var_1629;
            ...
            {
                this._friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.var_370, param1));
            };
        }
        ...
        public function declineRequest(param1:int):void
        {
            ...
            _loc2_.state = FriendRequest.var_1630;
            ...
            if (((this._friendList) && (this._friendList.events)))
            {
                this._friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.var_1533, param1));
            };
        }
        ...
        private function onDismissAllButtonClick(param1:WindowEvent, param2:IWindow):void
        {
            ...
            {
                if (((!(_loc4_.state == FriendRequest.var_1629)) && (!(_loc4_.state == FriendRequest.var_1630))))
                {
                    _loc4_.state = FriendRequest.var_1630;
                    this.refreshRequestEntry(_loc4_);
                    if (((this._friendList) && (this._friendList.events)))
                    {
                        this._friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.var_1533, _loc4_.requestId));
                    };
                };
            };
            this.refresh();
        ...
        private function onAcceptAllButtonClick(param1:WindowEvent, param2:IWindow):void
        {
            ...
            for each (_loc4_ in this._friendList.friendRequests.requests)
            {
                if (((!(_loc4_.state == FriendRequest.var_1629)) && (!(_loc4_.state == FriendRequest.var_1630))))
                {
                    ...
                    _loc4_.state = FriendRequest.var_1629;
                    this.refreshRequestEntry(_loc4_);
                    if (((this._friendList) && (this._friendList.events)))
                    {
                        this._friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.var_370, _loc4_.requestId));
                    };
                };
            };
            this._friendList.send(_loc3_);
