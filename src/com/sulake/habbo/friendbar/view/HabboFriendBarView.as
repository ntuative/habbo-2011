package com.sulake.habbo.friendbar.view
{
    ...
    public class HabboFriendBarView extends Component implements IHabboFriendBarView, IAvatarImageListener
    {
        ...
        override public function dispose(): void
        {
            if (!disposed)
            {
                this._windowManager.getWindowContext(var_1384).getDesktopWindow()
                        .removeEventListener(WindowEvent.var_573, this.onDesktopResized);
                if (this.var_3406)
                {
        ...
        {
            Tab.FRIEND_BAR_DATA = this.var_3404;
            Tab.FRIEND_BAR_VIEW = this;
            Tab.ASSETS = assets;
            Tab.WINDOW_MANAGER = this._windowManager;
            Tab.TEXT_CROPPER = this.var_3410;
            ...
            this.visible = true;
            this._windowManager.getWindowContext(var_1384).getDesktopWindow()
                    .addEventListener(WindowEvent.var_573, this.onDesktopResized);
        }
