    ...
    public class HabboFriendBarData extends Component implements IHabboFriendBarData 
    {
        ...
        public function followToRoom(param1:int):void
        {
            if (this.var_3380)
            {
                ...
                this.var_3380.getHabboMainConnection(null).send(new ConversionPointMessageComposer(var_1406, var_1407, TRACKING_EVENT_ACTION_VISIT));
            };
        }
        ...
        public function startConversation(param1:int):void
        {
            if (this.var_3381)
            {
                ...
                if (this.var_3380)
                {
                    this.var_3380.getHabboMainConnection(null).send(new ConversionPointMessageComposer(var_1406, var_1407, var_1408));
                };
            };
        }
        ...
        public function findNewFriends():void
        {
            if (this.var_3380)
            {
                ...
                this.var_3380.getHabboMainConnection(null).send(new ConversionPointMessageComposer(var_1406, var_1407, var_1409));
            };
        }
