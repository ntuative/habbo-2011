package com.sulake.habbo.communication.messages.parser.room.engine
{
    ...
    public class UsersMessageParser implements IMessageParser
    {
        ...
        public function parse(param1: IMessageDataWrapper): Boolean
        {
            ...
            while (_loc3_ < _loc2_)
            {
                ...
                if (_loc13_ == 1)
                {
                    ...
                    _loc14_.userType = RoomObjectTypeEnum.var_1262;
                ...
                else
                {
                    if (_loc13_ == 2)
                    {
                        _loc14_.userType = RoomObjectTypeEnum.var_1234;
                        _loc14_.figure = _loc7_;
                        _loc14_.webID = _loc4_;
                    ...
                    else
                    {
                        if (_loc13_ == 3)
                        {
                            _loc14_.userType = RoomObjectTypeEnum.var_1263;
                            ...
                            _loc14_.sex = UserMessageData.MALE;
                        }
        ...
        private function resolveSex(param1: String): String
        {
            ...
            {
                return UserMessageData.FEMALE;
            }

            return UserMessageData.MALE;
        }
