    ...
    public class HabboGroupBadgesMessageParser implements IMessageParser 
    {
        ...
        public function parse(param1:IMessageDataWrapper):Boolean
        {
            ...
            while (_loc5_ < _loc2_)
            {
                ...
                this.var_3350.add(_loc3_, _loc4_);
                _loc5_++;
            };
            return (true);
        }
        ...
        public function get badges():Map
        {
            ...
            {
                _loc1_.add(this.var_3350.getKey(_loc2_), this.var_3350.getWithIndex(_loc2_));
                _loc2_++;
            };
            return (_loc1_);
        }
