package com.sulake.habbo.communication.messages.parser.inventory.furni
{
    ...
    public class FurniListParser implements IMessageParser 
    {
        ...
        protected var var_3197:String;
        protected var var_3198:int;
        protected var var_3199:int;
        protected var var_3196:Array;

        public function parse(param1:IMessageDataWrapper):Boolean
        {
            this.var_3197 = param1.readString();
            this.var_3198 = param1.readInteger();
            this.var_3199 = param1.readInteger();
            this.var_3196 = new Array();
            var _loc2_:int = param1.readInteger();
            var _loc3_:int;
            while (_loc3_ < _loc2_)
            {
                this.var_3196.push(this.parseItem(param1));
                _loc3_++;
            };
            return (true);
        }
        ...
        {
            return (this.var_3199);
        }

        public function getFurni():Array
        {
            return (this.var_3196);
        }
