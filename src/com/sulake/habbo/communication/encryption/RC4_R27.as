package com.sulake.habbo.communication.encryption
{
    ...
    public class RC4_R27 extends RC4 implements IEncryption
    {
        ...
        private static const var_2895: String = "mWxFRJnGJ5T9Si0OMVvEBBm8laihXkN8GmH6fuv7ldZhLyGRRKCcGzziPYBaJom";
        private static const var_2896: int = 52;
        ...
        private static const var_2892: String = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/";

        private var var_2897: IEncryption;
        private var var_2898: PseudoRandom;
        ...
        {
            var _loc2_: int;
            var _loc3_: ByteArray = CryptoTools.stringToByteArray(var_2895);
            var _loc4_: int;
        ...
        override public function encipher(param1: ByteArray, param2: Boolean = false): ByteArray
        {
            ...
            if (this.var_2897 != null)
            {
                ...
                _loc6_ = this.var_2898.nextInt() % 5;
                ...
                _loc5_ = this.var_2897.encipher(_loc7_, true);
