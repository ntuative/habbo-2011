package com.sulake.habbo.communication.demo
{
    ...
    public class HabboHotelView implements IDisposable 
    {
        ...
        public function loadHotelViewImage(param1:String, param2:Function=null):void
        {
            ...
            if (param2 == null)
            {
                _loc3_.addEventListener(AssetLoaderEvent.var_35, this.hotelViewLoadedHandler);
                _loc3_.addEventListener(AssetLoaderEvent.var_36, this.hotelViewLoadedHandler);
            }
            else
            {
                this.var_2882 = param2;
                _loc3_.addEventListener(AssetLoaderEvent.var_35, this.hotelViewLoadedCallbackHandler);
                _loc3_.addEventListener(AssetLoaderEvent.var_36, this.hotelViewLoadedCallbackHandler);
            };
            this.var_2884++;
        }
        ...
        private function hotelViewLoadedHandler(param1:AssetLoaderEvent):void
        {
            ...
            _loc2_.removeEventListener(AssetLoaderEvent.var_35, this.hotelViewLoadedHandler);
            _loc2_.removeEventListener(AssetLoaderEvent.var_36, this.hotelViewLoadedHandler);
        }
        ...
        private function hotelViewLoadedCallbackHandler(param1:AssetLoaderEvent):void
        {
            ...
            var _loc2_:AssetLoaderStruct = (param1.target as AssetLoaderStruct);
            var _loc3_:IAsset = this.var_2883.getAssetByName(_loc2_.assetName);
            if (param1.type == AssetLoaderEvent.var_36)
            {
            ...
            _loc2_.removeEventListener(AssetLoaderEvent.var_35, this.hotelViewLoadedCallbackHandler);
            _loc2_.removeEventListener(AssetLoaderEvent.var_36, this.hotelViewLoadedCallbackHandler);
        }
        ...
        public function loadBannerImage(param1:String, param2:Function):void
        {
            ...
            if (param2 == null)
            {
                _loc3_.addEventListener(AssetLoaderEvent.var_35, this.bannerLoadedHandler);
                _loc3_.addEventListener(AssetLoaderEvent.var_36, this.bannerLoadedHandler);
            }
            else
            {
                if (this._events != null)
                ...
                _loc3_.addEventListener(AssetLoaderEvent.var_35, this.bannerLoadedCallbackHandler);
                _loc3_.addEventListener(AssetLoaderEvent.var_36, this.bannerLoadedCallbackHandler);
            };
            this.var_2884++;
        }
        ...
        private function bannerLoadedHandler(param1:AssetLoaderEvent):void
        {
            ...
            var _loc2_:AssetLoaderStruct = (param1.target as AssetLoaderStruct);
            var _loc3_:IAsset = this.var_2883.getAssetByName(_loc2_.assetName);
            _loc2_.removeEventListener(AssetLoaderEvent.var_35, this.bannerLoadedHandler);
            _loc2_.removeEventListener(AssetLoaderEvent.var_36, this.bannerLoadedHandler);
        }
        ...
        private function bannerLoadedCallbackHandler(param1:AssetLoaderEvent):void
        {
            ...
            _loc2_.removeEventListener(AssetLoaderEvent.var_35, this.bannerLoadedCallbackHandler);
            _loc2_.removeEventListener(AssetLoaderEvent.var_36, this.bannerLoadedCallbackHandler);
        }
