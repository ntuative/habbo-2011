package com.sulake.habbo.communication.demo
{
    ...
    public class HabboLoginDemoView extends EventDispatcher
    {
        ...
        private function initSSOTicket(param1: Boolean): void
        {
            ...
            {
                this.var_2886.removeEventListener(SSOTicket.SUCCESS, this.onParsedTicketSuccess);
                this.var_2886.removeEventListener(SSOTicket.FAILURE, this.onParsedTicketFailure);
                this.var_2886 = null;
            }
            ...
            this.var_2886.addEventListener(SSOTicket.SUCCESS, this.onParsedTicketSuccess);
            this.var_2886.addEventListener(SSOTicket.FAILURE, this.onParsedTicketFailure);
        }
