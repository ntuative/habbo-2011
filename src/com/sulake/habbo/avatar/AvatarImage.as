package com.sulake.habbo.avatar
{
    ...
    public class AvatarImage implements IAvatarImage, IDisposable
    {
        ...
        private function getFullImageCacheKey(): String
        {
            ...
            if (this.var_2573.length == 1 && this._direction == this.var_2567)
            {
                return this._direction + this.var_2575 + this.var_2408 % 4;
            }
        ...
        public function getImage(param1: String, param2: Boolean): BitmapData
        {
            ...
            var _loc6_: Array = this.getBodyParts(param1, this.var_977.definition.geometryType, this._direction);
            this.var_988.lock();
        ...
        private function sortActions(): Boolean
        {
            ...
            {
                this._canvasOffsets = this._structure.getCanvasOffsets(this.var_2573, this._scale, this._direction);
        ...
        private function setActionsToParts(): void
        {
            ...
            for each (_loc1_ in this.var_2573)
            {
                if (!(!_loc1_ || !_loc1_.definition))
                {
                    ...
                    {
                        this._isAnimating = _loc1_.definition.isAnimated(_loc1_.actionParameter);
                        _loc2_ = this._structure.getAnimation(_loc1_.definition.state + "." + _loc1_.actionParameter);
                        if (_loc2_ != null)
                        {
