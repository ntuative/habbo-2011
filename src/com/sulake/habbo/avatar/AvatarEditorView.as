package com.sulake.habbo.avatar
{
    ...
    public class AvatarEditorView 
    {
        ...
        private var var_2558:Array = [AvatarEditorFigureCategory.var_520, AvatarEditorFigureCategory.var_107, AvatarEditorFigureCategory.var_521, AvatarEditorFigureCategory.var_522, AvatarEditorFigureCategory.HOTLOOKS, AvatarEditorFigureCategory.var_523];
        ...
        public function update():void
        {
            ...
            {
                _loc3_.visible = ((this._controller.sessionData.hasUserRight("fuse_use_wardrobe", HabboClubLevelEnum.var_256)) && (this._controller.isWardrobeAllowed()));
            };
            var _loc4_:String = AvatarEditorSideCategory.var_1633;
            if ((((this._controller.sessionData) && (this._controller.sessionData.hasUserRight("fuse_use_wardrobe", HabboClubLevelEnum.var_256))) && ((this.var_2565 == AvatarEditorSideCategory.var_523) || (this.var_2566))))
            {
