package com.sulake.habbo.avatar.geometry
{
    ...
    public class GeometryBodyPart extends Node3D
    {
        ...
        public function GeometryBodyPart(param1: XML)
        {
            ...
            this._radius = parseFloat(param1.@radius);
        ...
        {
            var _loc2_: Number = Math.abs(param1.z - this.transformedLocation.z - this._radius);
            var _loc3_: Number = Math.abs((param1.z - this.transformedLocation.z) + this._radius);
