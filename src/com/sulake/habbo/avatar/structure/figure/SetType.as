package com.sulake.habbo.avatar.structure.figure
{
    ...
    public class SetType implements ISetType 
    {
        ...
        public function SetType(param1:XML)
        {
            ...
            this.var_2522["F"][0] = Boolean(parseInt(param1.@mand_f_0));
            this.var_2522["F"][1] = Boolean(parseInt(param1.@mand_f_1));
            this.var_2522["M"][0] = Boolean(parseInt(param1.@mand_m_0));
            this.var_2522["M"][1] = Boolean(parseInt(param1.@mand_m_1));
