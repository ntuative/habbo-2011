package com.sulake.habbo.avatar
{
    ...
    public class AvatarRenderManager extends Component implements IAvatarRenderManager 
    {
        ...
        private var var_2589:PaletteManager;
        ...
        public function AvatarRenderManager(param1:IContext, param2:uint=0, param3:IAssetLibrary=null)
        {
            ...
            param2 = (param2 | var_40);
            super(param1, param2, param3);
            this.var_2590 = RenderMode.var_178;
            ...
            this.var_2589 = new PaletteManager((param1.assets as AssetLibraryCollection));
        ...
        override public function dispose():void
        {
            ...
            if (this.var_2589 != null)
            {
                this.var_2589.dispose();
                this.var_2589 = null;
            };
