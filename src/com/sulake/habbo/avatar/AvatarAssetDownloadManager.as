package com.sulake.habbo.avatar
{
    ...
    public class AvatarAssetDownloadManager extends EventDispatcher 
    {
        ...
        private function addMapLoaderEventListeners():void
        {
            if (this.var_2553)
            {
                this.var_2553.addEventListener(AssetLoaderEvent.var_35, this.onConfigurationComplete);
                this.var_2553.addEventListener(AssetLoaderEvent.var_36, this.onConfigurationError);
            };
        }
        ...
        private function removeMapLoaderEventListeners():void
        {
            if (this.var_2553)
            {
                this.var_2553.removeEventListener(AssetLoaderEvent.var_35, this.onConfigurationComplete);
                this.var_2553.removeEventListener(AssetLoaderEvent.var_36, this.onConfigurationError);
            };
        }
        ...
        private function libraryComplete(param1:Event):void
        {
            ...
            for (_loc3_ in this.var_2548)
            {
                ...
                if (_loc7_)
                {
                    ...
                    delete this.var_2164[_loc3_];
                };
            };
            for each (_loc3_ in _loc2_)
            {
                delete this.var_2548[_loc3_];
            };
