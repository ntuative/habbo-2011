package com.sulake.habbo.avatar
{
    ...
    public class HabboAvatarEditor extends Component implements IHabboAvatarEditor
    {
        ...
        private var _gender: String = FigureData.MALE;
        ...
        private function init(param1: Array = null): void
        {
            ...
            if (!this.var_2067)
            {
                ...
                this.var_2070[FigureData.MALE] = new FigureData(this);
                this.var_2070[FigureData.FEMALE] = new FigureData(this);
                _loc2_ = this.var_2070[FigureData.MALE];
                _loc3_ = this.var_2070[FigureData.FEMALE];
                _loc2_.loadAvatarData(var_518, FigureData.MALE);
        ...
        public function openEditor(param1: IWindowContainer = null, param2: IHabboAvatarEditorDataSaver = null, param3: Array = null, param4: Boolean = false, param5: Boolean = true): Boolean
        {
            ...
            else
            {
                if (this._windowContext == null)
                {
                    this._windowContext = (this._windowManager.createWindow("avatarEditorContainer", "", HabboWindowType.var_182, HabboWindowStyle.var_525, HabboWindowParam.var_526 | HabboWindowParam.var_157, new Rectangle(0, 0, 2, 2), null, 0) as IWindowContainer);
        ...
        {
            this.var_2069 = this._avatarRenderManager.getFigureData(AvatarType.var_179);
        ...
        private function onCommunicationReady(param1: IID = null, param2: IUnknown = null): void
        {
            ...
            this._handler = new AvatarEditorHandler(this, this._communication);
        }
        ...
        {
            return this.var_2070[this._gender];
        }
        ...
        public function generateDataContent(param1: IAvatarEditorCategoryModel, param2: String): CategoryData
        {
            ...
            if (_loc8_ != null)
            {
                ...
                {
                    if (_loc13_.isSelectable && (_loc12_ || this._clubMemberLevel >= _loc13_.clubLevel))
                    {
                        _loc17_ = 0;
                ...
                {
                    _loc20_ = 2;
                    _loc14_ = this._avatarRenderManager.getMandatoryAvatarPartSetIds(this.gender, _loc20_);
                }
                else
                {
                    _loc14_ = this._avatarRenderManager.getMandatoryAvatarPartSetIds(this.gender, this.clubMemberLevel);
                }
                ...
                for each (_loc6_ in _loc8_.partSets)
                {
                    ...
                    if (_loc6_.isSelectable && _loc23_ && (_loc12_ || this._clubMemberLevel >= _loc6_.clubLevel))
                    {
        ...
        public function getDefaultColour(param1: String): int
        {
            ...
            if (_loc2_ != null)
            {
                ...
                {
                    if (_loc4_.isSelectable && this._clubMemberLevel >= _loc4_.clubLevel)
                    {
                        return _loc4_.id;
                    }
