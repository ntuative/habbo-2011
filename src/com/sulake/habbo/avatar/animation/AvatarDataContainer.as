package com.sulake.habbo.avatar.animation
{
    ...
    public class AvatarDataContainer implements IAvatarDataContainer
    {
        ...
        private var _isGrayscale: Boolean = true;

        public function AvatarDataContainer(param1: XML)
        {
            this._ink = parseInt(param1.@ink);
            ...
            this.var_2412 = this.var_2410 / 0xFF;
            this.var_2413 = this.var_2411 / 0xFF;
            ...
            this._colorTransform = new ColorTransform(this.var_2412, this.var_2413, this.var_2414, this._alphaMultiplier);
