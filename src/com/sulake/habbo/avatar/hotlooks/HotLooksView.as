package com.sulake.habbo.avatar.hotlooks
{
    ...
    public class HotLooksView implements IAvatarEditorCategoryView 
    {
        ...
        private var var_2446:HotLooksModel;
        private var var_2500:IItemGridWindow;
        ...
        public function init():void
        {
            ...
            this.var_2500 = (this._window.findChildByName("hotlooks") as IItemGridWindow);
        ...
        {
            while (this.var_2500.numGridItems > 0)
            {
                this.var_2500.removeGridItemAt(0);
            };
            this._window.dispose();
            this._window = null;
            this.var_2446 = null;
        ...
        public function update():void
        {
            ...
            var _loc2_:Outfit;
            this.var_2500.removeGridItems();
            for each (_loc2_ in this.var_2446.hotLooks)
            {
                _loc1_ = _loc2_.view.window;
                this.var_2500.addGridItem(_loc1_);
        ...
        private function hotLooksEventProc(param1:WindowEvent, param2:IWindow=null):void
        {
            ...
            {
                _loc3_ = this.var_2500.getGridItemIndex(param2.parent);
                this.var_2446.selectHotLook(_loc3_);
            };
        }
