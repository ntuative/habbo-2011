package com.sulake.habbo.avatar
{
    ...
    public class PlaceholderPetImage extends PetImage
    {
        ...
        public function PlaceholderPetImage(param1: AvatarStructure, param2: AssetAliasCollection, param3: String, param4: String, param5: IAssetLibrary)
        {
            ...
            this._assets = param5;
            this.var_2606 = new Map();
            var _loc6_: AvatarCanvas = _structure.getCanvas(_scale, var_977.definition.geometryType);
            if (_loc6_)
            {
                this.var_988 = new BitmapData(_loc6_.width, _loc6_.height, true, 0xFFFFFF);
            }
        ...
        override public function dispose(): void
        {
            ...
            if (this.var_2606)
            {
                for each (_loc1_ in this.var_2606)
                {
                }

                this.var_2606.dispose();
                this.var_2606 = null;
            }
        ...
        override public function getCroppedImage(param1: String): BitmapData
        {
            ...
            var _loc2_: BitmapData = this.getPlaceHolderImage(_direction, _scale);
            if (!_loc2_)
            {
                return null;
            }
        ...
        override public function getImage(param1: String, param2: Boolean): BitmapData
        {
            ...
            var _loc3_: BitmapData = this.getPlaceHolderImage(_direction, _scale);
            if (!_loc3_ || !this.var_988)
            {
                return null;
            }

            this.var_988.fillRect(this.var_988.rect, 0xFFFFFF);
            this.var_988.copyPixels(_loc3_, _loc3_.rect, new Point((this.var_988.width - _loc3_.width) / 2, this.var_988.height - _loc3_.height), null, null, true);
            if (param2)
            {
        ...
        private function getPlaceHolderImage(param1: int, param2: String): BitmapData
        {
            ...
            _loc3_ = _loc3_ + "_png";
            var _loc4_: BitmapData = this.var_2606.getValue(_loc3_);
            if (!_loc4_)
            {
                _loc5_ = (this._assets.getAssetByName(_loc3_) as BitmapDataAsset);
                _loc4_ = (_loc5_.content as BitmapData);
                this.var_2606.add(_loc3_, _loc4_.clone());
                _loc4_ = this.var_2606.getValue(_loc3_);
            }
