package com.sulake.habbo.avatar.pets
{
    ...
    public class PetDataManager implements IPetDataManager, IDisposable
    {
        ...
        public function init(): void
        {
            ...
            for each (_loc2_ in _loc1_)
            {
                if (_loc2_ != null)
                {
                    ...
                    if (this._species.getValue(_loc4_) == null)
                    {
                        this._species.add(_loc4_, new PetData(_loc3_));
                    }
        ...
        {
            var _loc3_: IPetData = this._species.getValue(param1) as IPetData;
            if (_loc3_ == null)
            {
        ...
        public function createPetFigureString(param1: int, param2: int, param3: uint): String
        {
            ...
            var _loc4_: PetData = this._species.getValue(param1);
            if (_loc4_ == null)
            {
