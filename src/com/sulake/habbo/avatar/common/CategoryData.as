package com.sulake.habbo.avatar.common
{
    ...
    public class CategoryData
    {
        ...
        public function dispose(): void
        {
            ...
            if (this.var_2471)
            {
                for each (_loc2_ in this.var_2471 as Array)
                {
                    if (_loc2_)
                    {
        ...
        public function selectColorIds(param1: Array): void
        {
            ...
            this.var_2473 = new Array(param1.length);
            var _loc3_: int;
            while (_loc3_ < this.var_2471.length)
            {
        ...
        public function selectPartIndex(param1: int): AvatarEditorGridPartItem
        {
            ...
            if (this.var_2472 >= 0 && this._parts.length > this.var_2472)
            {
                _loc2_ = this._parts[this.var_2472];
                if (_loc2_)
                {
                    _loc2_.isSelected = false;
                }
        ...
        public function selectColorIndex(param1: int, param2: int): AvatarEditorGridColorItem
        {
            ...
            this.deselectColorIndex(this.var_2473[param2], param2);
            this.var_2473[param2] = param1;
        ...
        public function getSelectedColorIds(): Array
        {
            ...
            if (!this.var_2473 || this.var_2473.length == 0)
            {
                return null;
            }

            if (!this.var_2471 || this.var_2471.length == 0)
            {
                return null;
            }

            var _loc1_: Array = this.var_2471[0] as Array;
            ...
            var _loc4_: Array = [];
            var _loc5_: int;
            while (_loc5_ < this.var_2473.length)
            {
                _loc7_ = this.var_2471[_loc5_];
                if (!(!_loc7_ || _loc7_.length <= _loc5_))
                {
                    if (_loc7_.length > this.var_2473[_loc5_])
                    {
                        _loc8_ = (_loc7_[this.var_2473[_loc5_]] as AvatarEditorGridColorItem);
        ...
        private function getSelectedColors(): Array
        {
            ...
            var _loc1_: Array = [];
            var _loc3_: int;
            while (_loc3_ < this.var_2473.length)
            {
        ...
        public function getSelectedColor(param1: int): AvatarEditorGridColorItem
        {
            ...
            if (!_loc2_ || _loc2_.length <= this.var_2473[param1])
            {
                return null;
            }

            return _loc2_[this.var_2473[param1]] as AvatarEditorGridColorItem;
        }
        ...
        public function getPalette(param1: int): Array
        {
            ...
            if (this.var_2471.length <= param1)
            {
                return null;
            }

            return this.var_2471[param1] as Array;
        }

        public function getCurrentPart(): AvatarEditorGridPartItem
        {
            return this._parts[this.var_2472] as AvatarEditorGridPartItem;
        }
