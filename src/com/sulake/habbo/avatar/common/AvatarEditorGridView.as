package com.sulake.habbo.avatar.common
{
    ...
    public class AvatarEditorGridView 
    {
        ...
        private var var_2466:IItemGridWindow;
        ...
        public function AvatarEditorGridView(param1:IAvatarEditorCategoryModel, param2:String, param3:IHabboWindowManager, param4:IAssetLibrary)
        {
            ...
            if (this._view != null)
            {
                this.var_2466 = (this._view.findChildByName("part_thumbs") as IItemGridWindow);
                this.var_2463 = new Array();
                this.var_2463.push((this._view.findChildByName("palette0") as IItemGridWindow));
                this.var_2463.push((this._view.findChildByName("palette1") as IItemGridWindow));
            };
        }
        ...
        public function dispose():void
        {
            ...
            if (this.var_2466)
            {
                this.var_2466.dispose();
                this.var_2466 = null;
            };
            if (this.var_2463)
            {
                for each (_loc1_ in this.var_2463)
                {
                    if (_loc1_ != null)
                    {
                        _loc1_.dispose();
        ...
        public function initFromList():void
        {
            ...
            var _loc1_:CategoryData = this.var_2446.getCategoryData(this.var_2465);
            if (!_loc1_)
            {
                return;
            };
            this.var_2466.removeGridItems();
            for each (_loc2_ in _loc1_.parts)
            {
                if (_loc2_)
                {
                    this.var_2466.addGridItem(_loc2_.view);
            ...
            _loc3_ = 0;
            while (_loc3_ < this.var_2076)
            {
                _loc4_ = _loc1_.getPalette(_loc3_);
                _loc5_ = (this.var_2463[_loc3_] as IItemGridWindow);
                if (!((!(_loc4_)) || (!(_loc5_))))
                {
        ...
        {
            var _loc3_:IWindow = this.var_2466.getGridItemAt(param1);
            if (!_loc3_)
            {
                return;
            };
        ...
        private function partEventProc(param1:WindowEvent, param2:IWindow):void
        {
            ...
            {
                _loc3_ = this.var_2466.getGridItemIndex(param1.window);
                this.var_2446.selectPart(this.var_2465, _loc3_);
            };
        }
        ...
        private function paletteEventProc(param1:WindowEvent, param2:IWindow):void
        {
            ...
            if (param1.type == WindowMouseEvent.var_628)
            {
                ...
                _loc7_ = 0;
                while (_loc7_ < this.var_2076)
                {
                    if (this.var_2463.length > _loc7_)
                    {
                        _loc4_ = (this.var_2463[_loc7_] as IItemGridWindow);
                        _loc5_ = _loc4_.getGridItemIndex(_loc6_);
                        if (_loc5_ > -1)
                        {
                            this.var_2446.selectColor(this.var_2465, _loc5_, _loc7_);
                            return;
                        };
                    };
                    _loc7_++;
