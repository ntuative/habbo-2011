package com.sulake.habbo.avatar.wardrobe
{
    ...
    public class WardrobeSlot implements IOutfit, IAvatarImageListener 
    {
        ...
        public function updateView():void
        {
            ...
            if (((this.var_2534) && (this.var_2536)))
            {
                _loc5_ = this._controller.avatarRenderManager.createAvatarImage(this.figure, AvatarScaleType.var_305, this.var_2071, this);
                if (_loc5_)
                {
            ...
            if (_loc4_)
            {
                _loc4_.visible = ((this.var_2536) && (!(this.var_2534 == null)));
            };
        }
        ...
        private function eventHandler(param1:WindowEvent, param2:IWindow):void
        {
            ...
            {
                case "set_button":
                    this.var_2534 = this._controller.figureData.getFigureString();
                    this.var_2071 = this._controller.gender;
                    this._controller.handler.saveWardrobeOutfit(this.var_2538, this);
                    this.updateView();
                    return;
                case "get_button":
                    if (this.var_2534)
                    {
                        this._controller.loadAvatarInEditor(this.var_2534, this.var_2071, this._controller.clubMemberLevel);
                    };
                    return;
            };
        }
