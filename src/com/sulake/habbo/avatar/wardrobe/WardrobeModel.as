package com.sulake.habbo.avatar.wardrobe
{
    ...
    public class WardrobeModel implements ISideContentModel
    {
        ...
        private function isSlotEnabled(param1: int): Boolean
        {
            if (param1 <= 5)
            {
                return this._controller.sessionData.hasUserRight("fuse_use_wardrobe", HabboClubLevelEnum.HC_LEVEL_HABBO_CLUB);
            }

            return this._controller.sessionData.hasUserRight("fuse_larger_wardrobe", HabboClubLevelEnum.HC_LEVEL_VIP);
        }
