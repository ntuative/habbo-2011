package com.sulake.habbo.avatar
{
    ...
    public class PetImage implements IAvatarImage, IDisposable 
    {
        ...
        public function PetImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:String, param4:String)
        {
            ...
            this.var_2534 = new AvatarFigureContainer(param3);
            var _loc5_:int = this.var_2534.getPartSetId("pbd");
            this.solvePetAvatarTypeAndBreed(_loc5_);
            this.var_2604 = this.var_2603;
        ...
        public function setDirection(param1:String, param2:int):void
        {
            ...
            {
                if ((((this.var_979 == 6) || (this.var_979 == 0)) && (param2 == 7)))
                {
                    param2 = this.var_979;
                };
                _loc3_ = this._structure.renderManager.petDataManager.getPetData(this.var_2604);
                if (_loc3_ != null)
                {
        ...
        public function getImage(param1:String, param2:Boolean):BitmapData
        {
            ...
            while (_loc7_ >= 0)
            {
                ...
                if ((((_loc9_) && (_loc9_.image)) && (_loc9_.regPoint)))
                {
                    ...
                    _loc15_ = this._structure.getParts(_loc8_, this.var_2534, _loc13_, "pet", _loc12_.getDirection(), []);
                    _loc16_ = (this.var_2604 < 3);
                    ...
                    if (_loc15_.length > 0)
                    {
                        ...
                        if (_loc22_ != null)
                        {
                            ...
                            if (((this.var_979 == 7) && (_loc12_.getDirection() == 6)))
                            {
                                _loc11_.offset((-1 * _loc17_), 0);
                            }
                            else
                            {
                                if (((this.var_979 == 4) && (_loc12_.getDirection() == 3)))
                                {
                                    _loc11_.offset(_loc17_, 0);
                                }
                                else
                                {
                                    if (((this.var_979 == 3) && (_loc12_.getDirection() == 4)))
                                    {
                                        _loc11_.offset((-1 * _loc17_), 0);
                                    }
                                    else
                                    {
                                        if (((this.var_979 == 6) && (_loc12_.getDirection() == 7)))
                                        {
                                            _loc11_.offset(_loc17_, 0);
                                        };
                                    };
        ...
        public function getCroppedImage(param1:String):BitmapData
        {
            ...
            while (_loc7_ >= 0)
            {
                ...
                if (_loc10_ != null)
                {
                    ...
                    _loc16_ = this._structure.getParts(_loc9_, this.var_2534, _loc14_, "pet", _loc13_.getDirection(), []);
                    _loc17_ = 32;
                    if (this._scale == AvatarScaleType.var_305)
                    {
                        _loc17_ = 6;
                    ...
                    if (_loc16_.length > 0)
                    {
                        ...
                        if (_loc23_ != null)
                        {
                            ...
                            if (((this.var_979 == 7) && (_loc13_.getDirection() == 6)))
                            {
                                _loc12_.offset((-1 * _loc17_), 0);
                            }
                            else
                            {
                                if (((this.var_979 == 4) && (_loc13_.getDirection() == 3)))
                                {
                                    _loc12_.offset(_loc17_, 0);
                                }
                                else
                                {
                                    if (((this.var_979 == 3) && (_loc13_.getDirection() == 4)))
                                    {
                                        _loc12_.offset((-1 * _loc17_), 0);
                                    }
                                    else
                                    {
                                        if (((this.var_979 == 6) && (_loc13_.getDirection() == 7)))
                                        {
                                            _loc12_.offset(_loc17_, 0);
                                        };
                                    };
        ...
        private function sortActions():void
        {
            ...
            {
                this.var_2383 = this._structure.getCanvasOffsets(this.var_2605, this._scale, this.var_979);
            };
        }
            ...
            if (_loc2_ != null)
            {
                ...
                if (_loc3_ != null)
                {
                    for each (_loc4_ in _loc3_.parts)
                    {
                        if (_loc4_.type == "pbd")
                        {
                            this.var_2603 = _loc4_.id;
                            this.var_2517 = _loc4_.breed;
                            break;
                        };
                    };
                };
