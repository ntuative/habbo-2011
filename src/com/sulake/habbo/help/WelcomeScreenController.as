    ...
    public class WelcomeScreenController implements IUpdateReceiver
    {
        ...
        public function dispose(): void
        {
            if (this.var_3498)
            {
                ...
                this.var_3498.toolbar.events.removeEventListener(HabboToolbarEvent.HTE_TOOLBAR_CLICK, this.onToolbarClicked);
        ...
        public function showWelcomeScreen(param1: Boolean): void
        {
            ...
            this.var_3498.toolbar.events.addEventListener(HabboToolbarEvent.HTE_TOOLBAR_CLICK, this.onToolbarClicked);
        ...
        private function initializeWindow(): void
        {
            ...
            this._window.findChildByName("close")
                    .addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK, this.onMouseClick);
        }
