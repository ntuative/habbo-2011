package com.sulake.habbo.help.tutorial
{
    ...
    public class TutorialClothesChangeView implements ITutorialUIView 
    {
        ...
        {
            if (((param1.menuId == HabboToolbarIconEnum.MEMENU) && (param1.type == HabboToolbarShowMenuEvent.var_146)))
            {
                this.setToolbarIconHighlight(false);
        ...
        private function showToolbarIconHighlightArrow():void
        {
            ...
            this.var_3486.help.toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.var_146, HabboToolbarIconEnum.MEMENU_ARROW, this.var_3502));
        }
