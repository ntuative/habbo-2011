package com.sulake.habbo.help.tutorial
{
    ...
    public class TutorialCallGuideBotView implements ITutorialUIView
    {
        ...
        {
            return TutorialUI.TUTORIAL_UI_GUIDEBOT_VIEW;
        }
        ...
        {
            if (param1.menuId == HabboToolbarIconEnum.HELP && param1.type == HabboToolbarShowMenuEvent.HTSME_ANIMATE_MENU_IN)
            {
                this.setToolbarIconHighlight(false);
        ...
        private function showToolbarIconHighlightArrow(): void
        {
            ...
            this.var_3486.help.toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.HTSME_ANIMATE_MENU_IN, HabboToolbarIconEnum.HELP_ARROW, this.var_3502));
        }
