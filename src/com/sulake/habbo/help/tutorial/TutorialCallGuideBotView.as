package com.sulake.habbo.help.tutorial
{
    ...
    public class TutorialCallGuideBotView implements ITutorialUIView 
    {
        ...
        public function TutorialCallGuideBotView(param1:IItemListWindow, param2:TutorialUI):void
        {
            ...
            this.var_3486.help.toolbar.events.addEventListener(HabboToolbarShowMenuEvent.var_146, this.onShowMenuEvent);
        }
        ...
        {
            return (TutorialUI.var_1429);
        }

        public function dispose():void
        {
            this.setToolbarIconHighlight(false);
            this.var_3486.help.toolbar.events.removeEventListener(HabboToolbarShowMenuEvent.var_146, this.onShowMenuEvent);
        }

        private function onShowMenuEvent(param1:HabboToolbarShowMenuEvent):void
        {
            if (((param1.menuId == HabboToolbarIconEnum.HELP) && (param1.type == HabboToolbarShowMenuEvent.var_146)))
            {
                this.setToolbarIconHighlight(false);
        ...
        {
            var _loc2_:HabboToolbarSetIconEvent = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.var_176, HabboToolbarIconEnum.HELP);
            if (param1)
            {
        ...
        private function showToolbarIconHighlightArrow():void
        {
            ...
            this.var_3486.help.toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.var_146, HabboToolbarIconEnum.HELP_ARROW, this.var_3502));
        }
        ...
        private function windowProcedure(param1:WindowEvent, param2:IWindow):void
        {
            switch (param2.name)
            {
                case "button_cancel":
                    ...
                    {
                        this.var_3486.showView(TutorialUI.var_1427);
                    };
                    return;
            };
        }
