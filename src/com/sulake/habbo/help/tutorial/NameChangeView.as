package com.sulake.habbo.help.tutorial
{
    ...
    public class NameChangeView
    {
        ...
        {
            return TutorialUI.TUTORIAL_UI_NAME_VIEW;
        }
        ...
        private function showSelectionView(): void
        {
            if (!this.var_3493)
            {
                this.var_3493 = (this._controller.buildXmlWindow("welcome_name_selection") as IWindowContainer);
                if (!this.var_3493)
                {
                    return;
                }
        ...
        private function showConfirmationView(): void
        {
            if (!this.var_3494)
            {
                this.var_3494 = (this._controller.buildXmlWindow("welcome_name_confirmation") as IWindowContainer);
                if (!this.var_3494)
                {
                    return;
                }
        ...
        public function setNameNotAvailableView(param1: int, param2: String, param3: Array): void
        {
            ...
            switch (param1)
            {
                case ChangeUserNameResultMessageEvent.NAME_CHANGE_RESULT_NAME_TAKEN:
                    ...
                    break;
                case ChangeUserNameResultMessageEvent.NAME_CHANGE_RESULT_NAME_INVALID:
                    ...
                    break;
                case ChangeUserNameResultMessageEvent.NAME_CHANGE_UNKNOWN_ERROR:
                    break;
                case ChangeUserNameResultMessageEvent.NAME_CHANGE_RESULT_NAME_TOO_LONG:
                    _loc4_.text = this._controller.localization.getKey("help.tutorial.name.long");
                    break;
                case ChangeUserNameResultMessageEvent.NAME_CHANGE_RESULT_NAME_TOO_SHORT:
                    _loc4_.text = this._controller.localization.getKey("help.tutorial.name.short");
                    break;
                case ChangeUserNameResultMessageEvent.NAME_CHANGE_RESULT_NOT_ALLOWED:
                    _loc4_.text = this._controller.localization.getKey("help.tutorial.name.change_not_allowed");
                    break;
                case ChangeUserNameResultMessageEvent.NAME_CHANGE_RESULT_HOTEL_MERGE_DOWN:
            ...
            if (param1 == ChangeUserNameResultMessageEvent.NAME_CHANGE_RESULT_HOTEL_MERGE_DOWN || param1 == ChangeUserNameResultMessageEvent.NAME_CHANGE_RESULT_NOT_ALLOWED)
            {
        ...
        private function windowEventHandler(param1: WindowEvent, param2: IWindow): void
        {
            ...
            switch (param2.name)
            {
                ...
                case "header_button_close":
                    this._controller.showView(TutorialUI.TUTORIAL_UI_MAIN_VIEW);
                    return;
            }
