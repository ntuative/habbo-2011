package com.sulake.habbo.help.cfh
{
    ...
    public class CallForHelpReportUserSelection extends HelpViewController 
    {
        ...
        private var var_3462:Map = new Map();
        ...
        override public function update(parameter:*=null):void
        {
            ...
            this.var_3462 = main.component.userRegistry.getRegistry();
            if (this.var_3462.length == 0)
            {
                main.showUI(HabboHelpViewEnum.var_1413);
            ...
            var i:int;
            while (i < this.var_3462.length)
            {
                user = this.var_3462.getWithIndex(i);
        ...
        private function handleListItemClick(param1:IWindow):void
        {
            ...
            if (((_loc3_ < 0) || (_loc3_ > this.var_3462.length)))
            {
                return;
            };
            var _loc4_:UserRegistryItem = this.var_3462.getWithIndex(_loc3_);
            if (_loc4_ == null)
            {
                return;
            };
            ...
            if (_loc3_ > -1)
            {
                main.showUI(HabboHelpViewEnum.var_302);
            };
        }
