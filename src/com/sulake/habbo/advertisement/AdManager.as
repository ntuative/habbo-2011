    ...
    public class AdManager extends Component implements IAdManager
    {
        ...
        private function onInterstitial(param1: InterstitialMessageEvent): void
        {
            ...
            if (this.var_2360 != "")
            {
                ...
                _loc5_.addEventListener(AssetLoaderEvent.ASSET_LOADER_EVENT_ERROR, this.interstitialLoaderEventHandler);
            }
            else
            {
        ...
        private function startInterstitial(param1: Bitmap): void
        {
            ...
            {
                events.dispatchEvent(new AdEvent(AdEvent.INTERSTITIAL_SHOW, 0, 0, param1.bitmapData, this.var_2361));
                this.var_2363 = getTimer();
            }
            else
            {
        ...
        private function stopInterstitial(): void
        {
            ...
            if (events != null)
            {
                events.dispatchEvent(new AdEvent(AdEvent.INTERSTITIAL_COMPLETE));
            }
        ...
        private function roomAdImageReady(param1: AssetLoaderEvent): void
        {
            ...
            if (this.isValidAdImage(_loc3_))
            {
                ...
                events.dispatchEvent(new AdEvent(AdEvent.ROOM_AD_SHOW, 0, 0, _loc4_, _loc2_.assetName, this.var_2369, this.var_2370, this.var_2371));
            }
        ...
        {
            return param1 != null && (param1.width > 1 || param1.height > 1);
        ...
        private function loadImageAsset(param1: AdImageEvent): void
        {
            ...
            _loc5_.addEventListener(AssetLoaderEvent.ASSET_LOADER_EVENT_COMPLETE, this.onBillboardImageReady);
            _loc5_.addEventListener(AssetLoaderEvent.ASSET_LOADER_EVENT_ERROR, this.onBillboardImageLoadError);
        }
        ...
        private function dispatchImageAsset(param1: BitmapData, param2: AdImageEvent): void
        {
            if (events != null)
            {
                events.dispatchEvent(new AdEvent(AdEvent.ROOM_AD_IMAGE_LOADED, param2.roomId, 0, param1.clone(), param2.imageUrl, param2.clickUrl, null, null, param2.objectId));
            }
        ...
        private function onBillboardImageLoadError(param1: AssetLoaderEvent): void
        {
            ...
            for each (_loc5_ in _loc4_)
            {
                ...
                events.dispatchEvent(new AdEvent(AdEvent.ROOM_AD_IMAGE_LOADING_FAILED, _loc5_.roomId, 0, null, _loc5_.imageUrl, _loc5_.clickUrl, null, null, _loc5_.objectId));
            }
