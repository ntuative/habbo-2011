package com.sulake.habbo.session.facebook
{
    ...
    public class FaceBookSession implements IDisposable 
    {
        ...
        private static const var_1559:String = "FlashExternalInterface.authenticateFacebook";
        private static const var_1557:String = "sendAccessTokenToServer";
        private static const var_1558:String = "fbKLogOut";
        ...
        private function onAuthenticate(param1:FaceBookAuthenticateEvent):void
        {
            ...
            {
                ExternalInterface.addCallback(var_1557, this.jsFaceBookLogInCallback);
                ExternalInterface.addCallback(var_1558, this.jsFaceBookLogOutCallback);
                Logger.log("-- -- ADDED JAVASCRIPT CALLBACK HOOKS!");
                ExternalInterface.call(var_1559);
                Logger.log(("-- -- CALLED JAVASCRIPT METHOD " + var_1559));
            };
        }
