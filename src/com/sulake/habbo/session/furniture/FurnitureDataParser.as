package com.sulake.habbo.session.furniture
{
    ...
    public class FurnitureDataParser extends EventDispatcher 
    {
        ...
        {
            this.var_4416 = param1;
            this._wallItems = param2;
            this.var_4417 = param3;
            this._localization = param4;
            this.var_2883 = new AssetLibrary("FurniDataParserAssetLib");
        }
        ...
        {
            var _loc2_:AssetLoaderStruct = this.var_2883.loadAssetFromFile(param1, new URLRequest(param1), "text/plain");
            _loc2_.addEventListener(AssetLoaderEvent.var_35, this.parseFurnitureData);
        }
        ...
        private function parseFurnitureData(param1:AssetLoaderEvent):void
        {
            ...
            for each (_loc10_ in _loc8_)
            {
                ...
                for each (_loc12_ in _loc11_)
                {
                    ...
                    if (_loc14_ == "s")
                    {
                        this.var_4416.add(_loc15_, _loc31_);
                    }
                    else
                    {
                        if (_loc14_ == "i")
                    ...
                    _loc32_ = this.var_4417[_loc17_];
                    if (_loc32_ == null)
                    {
                        _loc32_ = [];
                        this.var_4417.add(_loc17_, _loc32_);
                    };
        ...
        public function registerFurnitureLocalizations():void
        {
            ...
            for each (_loc1_ in this.var_4416.getValues())
            {
