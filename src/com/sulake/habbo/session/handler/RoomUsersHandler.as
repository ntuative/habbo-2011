package com.sulake.habbo.session.handler
{
    ...
    public class RoomUsersHandler extends BaseHandler
    {
        ...
        private function onPetPlacingError(param1: PetPlacingErrorEvent): void
        {
            ...
            {
                case 0:
                    _loc3_ = RoomSessionErrorMessageEvent.var_388;
                    break;
                case 1:
                    _loc3_ = RoomSessionErrorMessageEvent.var_389;
                    break;
                case 2:
                    _loc3_ = RoomSessionErrorMessageEvent.var_390;
                    break;
                case 3:
                    _loc3_ = RoomSessionErrorMessageEvent.var_391;
                    break;
                case 4:
