        ...
        private function onFlatAccessible(param1: FlatAccessibleMessageEvent): void
        {
            ...
            else
            {
                if (listener && listener.events)
                {
                    ...
                    if (_loc6_ != null)
                    {
                        listener.events.dispatchEvent(new RoomSessionDoorbellEvent(RoomSessionDoorbellEvent.var_370, _loc6_, _loc5_));
                    }
        ...
        private function onFlatAccessDenied(param1: FlatAccessDeniedMessageEvent): void
        {
            ...
            else
            {
                if (listener && listener.events)
                {
                    ...
                    if (_loc6_ != null)
                    {
                        listener.events.dispatchEvent(new RoomSessionDoorbellEvent(RoomSessionDoorbellEvent.var_369, _loc6_, _loc5_));
                    }
