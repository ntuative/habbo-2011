package com.sulake.habbo.session.events
{
    ...
    public class RoomSessionPetInfoUpdateEvent extends RoomSessionEvent
    {
        ...
        public static const var_1259: String = "RSPIUE_PET_INFO";

        private var var_4408: IPetInfo;
        ...
        {
            super(RoomSessionPetInfoUpdateEvent.var_1259, param1, param3, param4);
            this.var_4408 = param2;
        }
