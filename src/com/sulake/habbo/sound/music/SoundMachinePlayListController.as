package com.sulake.habbo.sound.music
{
    ...
    public class SoundMachinePlayListController implements IPlayListController 
    {
        ...
        private var var_4478:HabboMusicController;
        ...
        public function SoundMachinePlayListController(param1:HabboSoundManagerFlash10, param2:HabboMusicController, param3:IEventDispatcher, param4:IEventDispatcher, param5:IConnection)
        {
            ...
            this._events = param3;
            this.var_4378 = param4;
            this._connection = param5;
            this.var_4478 = param2;
            this.var_4465 = [];
            this.var_4465.push(new PlayListMessageEvent(this.onPlayListMessage));
            this.var_4465.push(new PlayListSongAddedMessageEvent(this.onPlayListSongAddedMessage));
            for each (_loc6_ in this.var_4465)
            {
            ...
            this._events.addEventListener(SongInfoReceivedEvent.var_937, this.onSongInfoReceivedEvent);
            this.var_4378.addEventListener(RoomEngineSoundMachineEvent.var_1552, this.onSoundMachinePlayEvent);
            this.var_4378.addEventListener(RoomEngineSoundMachineEvent.var_1553, this.onSoundMachineStopEvent);
        }
        ...
        public function dispose():void
        {
            ...
            if (!this._disposed)
            {
                ...
                if (this.var_4378)
                {
                    this.var_4378.removeEventListener(RoomEngineSoundMachineEvent.var_1552, this.onSoundMachinePlayEvent);
                    this.var_4378.removeEventListener(RoomEngineSoundMachineEvent.var_1553, this.onSoundMachineStopEvent);
                    this.var_4378 = null;
                };
                this._disposed = true;
            };
        ...
        public function checkSongPlayState(param1:int):void
        {
            ...
            if (this.var_4479 == param1)
            {
                this.playCurrentSongAndNotify(this.var_4479);
                _loc2_ = this.getNextEntry();
                if (_loc2_ != null)
                {
                    this.var_4478.addSongInfoRequest(_loc2_.id);
                };
            };
        }
        ...
        public function stopPlaying():void
        {
            this.var_4479 = -1;
            this.var_3335 = false;
            this.var_4478.stop(HabboMusicPrioritiesEnum.var_930);
        }
        ...
        private function onSongInfoReceivedEvent(param1:SongInfoReceivedEvent):void
        {
            ...
            while (_loc3_ < this._playListEntries.length)
            {
                ...
                {
                    _loc4_ = (this.var_4478.getSongInfo(param1.id) as SongDataEntry);
                    if (_loc4_ != null)
                    {
        ...
        private function playCurrentSongAndNotify(param1:int):void
        {
            ...
            if (this.var_4478.playSong(param1, HabboMusicPrioritiesEnum.var_930, _loc3_, 0, 0, 0))
            {
