package com.sulake.habbo.messenger
{
    ...
    public class ConversationView 
    {
        ...
        private function refreshEntry(param1:Boolean, param2:int, param3:Message):Boolean
        {
            ...
            _loc4_.visible = true;
            var _loc5_:String = (((param3.type == Message.var_1433) || (param3.type == Message.var_307)) ? (param3.time + ": ") : "");
        ...
        {
            if (param1 == Message.var_1433)
            {
                return (0xFFFFFFFF);
            };
            if (param1 == Message.var_307)
            {
                return (4292801535);
            };
            if (param1 == Message.var_309)
            {
                return (0xFFFF6666);
            };
            if (param1 == Message.var_1434)
            {
                return (4293454056);
            };
            if (param1 == Message.var_1435)
            {
                return (4293454056);
            };
            if (param1 == Message.var_308)
            {
                return (4288269465);
            };
            return (4291611852);
