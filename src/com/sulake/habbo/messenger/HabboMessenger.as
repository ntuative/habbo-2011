package com.sulake.habbo.messenger
{
    ...
    public class HabboMessenger extends Component implements IHabboMessenger, IAvatarImageListener 
    {
        ...
        private var var_3633:Conversations;
        private var var_3634:MessengerView;
        ...
        {
            var _loc2_:Conversation = this.var_3633.addConversation(param1);
            if (_loc2_ == null)
            {
            ...
            else
            {
                ...
                this.var_3633.setSelected(_loc2_);
                this.var_3634.openMessenger();
                this.var_3634.refresh();
            };
        }

        public function setFollowingAllowed(param1:int, param2:Boolean):void
        {
            this.var_3633.setFollowingAllowedAndUpdateView(param1, param2);
        }

        public function setOnlineStatus(param1:int, param2:Boolean):void
        {
            this.var_3633.setOnlineStatusAndUpdateView(param1, param2);
        }
        ...
        public function getAvatarFaceBitmap(param1:String):BitmapData
        {
            ...
            if (_loc2_)
            {
                _loc3_ = _loc2_.getImage(AvatarSetType.var_107, true);
                _loc2_.dispose();
                return (_loc3_);
            };
            return (null);
        ...
        public function playSendSound():void
        {
            ...
            {
                this._soundManager.playSound(HabboSoundTypesEnum.var_173);
            };
        }
        ...
        private function getPageParam(param1:String):String
        {
            ...
            if (param1 == "url.prefix")
            {
                ...
                _loc2_ = this.var_2063.getKey("url.prefix", _loc2_);
        ...
        {
            this.var_3633 = new Conversations(new ConversationsDeps(this));
            this.var_3634 = new MessengerView(this);
        ...
        public function setHabboToolbarIcon(param1:Boolean, param2:Boolean):void
        {
            if (!param1)
            {
                this.var_2844.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.var_306, HabboToolbarIconEnum.MESSENGER));
                return;
            };
            this.var_2844.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.var_145, HabboToolbarIconEnum.MESSENGER));
        ...
        private function onHabboToolbarEvent(param1:HabboToolbarEvent):void
        {
            ...
            {
                if (this.var_3634.isMessengerOpen())
                {
                    this.var_3634.close();
                }
                else
        ...
        private function onNewConsoleMessage(param1:IMessageEvent):void
        {
            ...
            var _loc3_:Message = new Message(Message.var_307, _loc2_.senderId, _loc2_.messageText, Util.getFormattedNow());
            this.addMsg(_loc3_);
        }
        ...
        private function onRoomInvite(param1:IMessageEvent):void
        {
            ...
            var _loc3_:Message = new Message(Message.var_308, _loc2_.senderId, ((this.getText("messenger.invitation") + " ") + _loc2_.messageText), Util.getFormattedNow());
            this.addMsg(_loc3_);
        }

        private function addMsg(param1:Message):void
        {
            this.var_3633.addMessageAndUpdateView(param1);
            if (!this.var_3634.isMessengerOpen())
            {
                if (this._soundManager != null)
                {
        ...
        private function onInstantMessageError(param1:IMessageEvent):void
        {
            ...
            var _loc3_:Message = new Message(Message.var_309, _loc2_.userId, this.getInstantMessageErrorText(_loc2_.errorCode), Util.getFormattedNow());
            this.var_3633.addMessageAndUpdateView(_loc3_);
        }
