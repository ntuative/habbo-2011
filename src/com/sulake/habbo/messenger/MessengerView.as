    ...
    public class MessengerView implements IDisposable 
    {
        ...
        public function openMessenger():void
        {
            ...
            if (this.var_3431 == null)
            {
                this.prepareContent();
                this.refresh();
                this.var_3447.toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.var_146, HabboToolbarIconEnum.MESSENGER, this.var_3431));
            }
            else
            {
                this.refresh();
        ...
        private function sendMsg():void
        {
            ...
            this.var_3457.text = "";
            this.var_3447.conversations.addMessageAndUpdateView(new Message(Message.var_1433, _loc2_.id, _loc1_, Util.getFormattedNow()));
        }
