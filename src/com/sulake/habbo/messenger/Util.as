package com.sulake.habbo.messenger
{
    ...
    public class Util
    {
        ...
        {
            return param1.createWindow(param2, param2, HabboWindowType.var_182, HabboWindowStyle.var_525, HabboWindowParam.var_157 | (param5
                    ? HabboWindowParam.var_158
                    : 0), new Rectangle(param3, param4, 600, 600), null) as IWindowContainer;
        }
