package com.sulake.room
{
    ...
    public class RoomManager extends Component implements IRoomManager, IRoomInstanceContainer 
    {
        ...
        public function RoomManager(param1:IContext, param2:uint=0)
        {
            ...
            this.var_5070 = [];
            this.var_5068 = [];
            events.addEventListener(RoomContentLoadedEvent.var_293, this.onContentLoaded);
            events.addEventListener(RoomContentLoadedEvent.var_294, this.onContentLoaded);
            events.addEventListener(RoomContentLoadedEvent.var_295, this.onContentLoaded);
        }
