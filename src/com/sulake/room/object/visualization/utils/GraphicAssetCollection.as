package com.sulake.room.object.visualization.utils
{
    ...
    public class GraphicAssetCollection implements IGraphicAssetCollection
    {
        ...
        private static const var_1499: int = 10;

        private var _assets: Map;
        private var var_4989: IAssetLibrary;
        private var var_2471: Map;
        private var var_4990: Array;
        private var var_4991: int = 0;

        public function GraphicAssetCollection()
        {
            this._assets = new Map();
            this.var_2471 = new Map();
            this.var_4990 = [];
        }
        ...
        public function dispose(): void
        {
            ...
            if (this.var_2471 != null)
            {
                for (_loc1_ in this.var_2471)
                {
                    _loc3_ = this.var_2471[_loc1_];
                    if (_loc3_ != null)
                    {
                        _loc3_.dispose();
                    }
                ...
                this.var_2471.dispose();
                this.var_2471 = null;
            }

            if (this.var_4990 != null)
            {
        ...
        private function defineAssets(param1: XMLList): void
        {
            ...
            while (_loc3_ < _loc2_)
            {
                ...
                if (_loc5_.length > 0)
                {
                    ...
                    _loc12_ = this.var_4989.getAssetByName(_loc6_);
                    if (_loc12_ != null)
                    {
        ...
        private function definePalettes(param1: XMLList): void
        {
            ...
            for each (_loc3_ in param1)
            {
                if (XMLValidator.checkRequiredAttributes(_loc3_, _loc2_))
                {
                    ...
                    if (this.var_2471[_loc4_] == null)
                    {
                        _loc6_ = this.var_4989.getAssetByName(_loc5_);
        ...
        public function addAsset(param1: String, param2: BitmapData, param3: Boolean, param4: int = 0, param5: int = 0): Boolean
        {
            ...
            if (_loc6_ == null)
            {
                _loc6_ = new BitmapDataAsset(this.var_4989.getAssetTypeDeclarationByClass(BitmapDataAsset));
                this.var_4989.setAsset(param1, _loc6_);
        ...
        public function disposeAsset(param1: String): void
        {
            ...
            if (_loc2_ != null)
            {
                ...
                if (_loc3_ != null)
                {
                    this.var_4989.removeAsset(_loc3_);
                    _loc3_.dispose();
                }
        ...
        {
            return this.var_4989.getAssetByName(param1) as BitmapDataAsset;
        }
        ...
        private function addLibraryAsset(param1: String, param2: BitmapData): BitmapDataAsset
        {
            ...
            if (_loc3_ == null)
            {
                _loc3_ = new BitmapDataAsset(this.var_4989.getAssetTypeDeclarationByClass(BitmapDataAsset));
                this.var_4989.setAsset(param1, _loc3_);
        ...
        private function disposePaletteAssets(param1: Boolean = true): void
        {
            ...
            if (this.var_4990 != null)
            {
                if (param1 || this.var_4990.length > var_1499)
                {
                    for each (_loc2_ in this.var_4990)
                    {
