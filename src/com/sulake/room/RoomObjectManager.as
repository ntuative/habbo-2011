package com.sulake.room
{
    ...
    public class RoomObjectManager implements IRoomObjectManager 
    {
        ...
        private var var_5076:Map;

        public function RoomObjectManager()
        {
            this._objects = new Map();
            this.var_5076 = new Map();
        }
        ...
        public function dispose():void
        {
            ...
            if (this.var_5076 != null)
            {
                this.var_5076.dispose();
                this.var_5076 = null;
            };
        }
        ...
        {
            var _loc3_:Map = this.var_5076.getValue(param1);
            if (((_loc3_ == null) && (param2)))
            {
                _loc3_ = new Map();
                this.var_5076.add(param1, _loc3_);
            };
            return (_loc3_);
        }
        ...
        public function reset():void
        {
            ...
            {
                _loc3_ = 0;
                while (_loc3_ < this.var_5076.length)
                {
                    _loc4_ = (this.var_5076.getWithIndex(_loc3_) as Map);
                    if (_loc4_ != null)
                    {
                        _loc4_.dispose();
                    };
