package com.sulake.room
{
    ...
    public class RoomInstance implements IRoomInstance
    {
        ...
        public function dispose(): void
        {
            ...
            {
                _loc2_ = 0;
                while (_loc2_ < this.var_5067.length)
                {
                    _loc3_ = (this.var_5067.getWithIndex(_loc2_) as IRoomObjectManager);
                    if (_loc3_ != null)
                    {
                        _loc3_.dispose();
                    }
        ...
        protected function disposeObjectManager(param1: int): Boolean
        {
            ...
            if (this.var_5067.getValue(_loc2_) != null)
            {
                _loc3_ = (this.var_5067.remove(_loc2_) as IRoomObjectManager);
                if (_loc3_ != null)
                {
                    _loc3_.dispose();
                }
