package com.sulake.core.localization
{
    ...
    public class CoreLocalizationManager extends Component implements ICoreLocalizationManager 
    {
        ...
        {
            return (this.var_2157[param1] as ILocalizationDefinition);
        }

        public function getActiveLocalizationDefinition():ILocalizationDefinition
        {
            return (this.getLocalizationDefinition(this.var_2158));
        }
        ...
        public function loadLocalizationFromURL(param1:String):void
        {
            ...
            _loc4_.addEventListener(AssetLoaderEvent.var_35, this.onLocalizationReady);
            _loc4_.addEventListener(AssetLoaderEvent.var_36, this.onLocalizationFailed);
        }
        ...
        {
            var _loc3_:Localization = (this.var_1364[param1] as Localization);
            if (_loc3_ == null)
            {
                this.var_2160.push(param1);
                return (param2);
            };
            return (_loc3_.value);
        }
        ...
        {
            var _loc3_:Localization = this.var_1364[param1];
            if (_loc3_ == null)
            {
                _loc3_ = new Localization(param1, param2);
                this.var_1364[param1] = _loc3_;
            }
            else
            {
            ...
            {
                _loc3_.registerParameter("predefined", this.var_2159);
            };
        }
        ...
        {
            var _loc5_:Localization = this.var_1364[param1];
            if (_loc5_ == null)
            {
                _loc5_ = new Localization(param1);
                this.var_1364[param1] = _loc5_;
            };
        ...
        {
            return (this.var_1364[param1] as ILocalization);
        }
        ...
        public function printNonExistingKeys():void
        {
            var _loc2_:String;
            var _loc1_:String = "";
            for each (_loc2_ in this.var_2160)
            {
        ...
        protected function setPredefinedUrl(param1:String):void
        {
            ...
            for each (_loc2_ in this.var_1364)
            {
                if (_loc2_.raw.indexOf("%predefined%") >= 0)
                {
                    _loc2_.registerParameter("predefined", this.var_2159);
                };
            };
        }
