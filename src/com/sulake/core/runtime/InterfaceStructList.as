package com.sulake.core.runtime
{
    ...
    internal final class InterfaceStructList implements IDisposable 
    {
        ...
        private var var_2190:Array = new Array();

        public function get length():uint
        {
            return (this.var_2190.length);
        }

        public function get disposed():Boolean
        {
            return (this.var_2190 == null);
        }

        public function dispose():void
        {
            var _loc2_:InterfaceStruct;
            var _loc1_:uint = this.var_2190.length;
            var _loc3_:uint;
            while (_loc3_ < _loc1_)
            {
                _loc2_ = this.var_2190.pop();
                _loc2_.dispose();
                _loc3_++;
            };
            this.var_2190 = null;
        ...
        {
            var _loc2_:InterfaceStruct;
            if (param1 < this.var_2190.length)
            {
                _loc2_ = this.var_2190[param1];
                this.var_2190.splice(param1, 1);
                return (_loc2_);
            };
        ...
        public function find(param1:IID):IUnknown
        {
            ...
            var _loc3_:uint = this.var_2190.length;
            var _loc5_:uint;
            while (_loc5_ < _loc3_)
            {
                _loc4_ = (this.var_2190[_loc5_] as InterfaceStruct);
        ...
        public function getStructByInterface(param1:IID):InterfaceStruct
        {
            ...
            var _loc2_:String = getQualifiedClassName(param1);
            var _loc4_:uint = this.var_2190.length;
            var _loc5_:uint;
            while (_loc5_ < _loc4_)
            {
                _loc3_ = (this.var_2190[_loc5_] as InterfaceStruct);
        ...
        public function mapStructsByInterface(param1:IID, param2:Array):uint
        {
            ...
            var _loc4_:uint;
            var _loc6_:uint = this.var_2190.length;
            var _loc7_:uint;
            while (_loc7_ < _loc6_)
            {
                _loc5_ = (this.var_2190[_loc7_] as InterfaceStruct);
        ...
        public function getStructByImplementor(param1:IUnknown):InterfaceStruct
        {
            ...
            while (_loc4_ < _loc3_)
            {
                _loc2_ = (this.var_2190[_loc4_] as InterfaceStruct);
        ...
        public function mapStructsByImplementor(param1:IUnknown, param2:Array):uint
        {
            var _loc4_:InterfaceStruct;
            var _loc3_:uint;
            var _loc5_:uint = this.var_2190.length;
            var _loc6_:uint;
            while (_loc6_ < _loc5_)
            {
                _loc4_ = (this.var_2190[_loc6_] as InterfaceStruct);
        ...
        {
            return ((param1 < this.var_2190.length) ? this.var_2190[param1] : null);
        }
