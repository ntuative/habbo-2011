package com.sulake.core.runtime
{
    ...
    internal class Profiler extends Component implements IProfiler
    {
        ...
        private var var_2191: Dictionary = new Dictionary(true);
        private var _lastUpdatedMs: int;
        ...
        override public function dispose(): void
        {
            ...
            if (!disposed)
            {
                for (_loc1_ in this.var_2191)
                {
                    IDisposable(this.var_2191[_loc1_]).dispose();
                    this.var_2191[_loc1_] = null;
                }
        ...
        public function start(): void
        {
            ...
            this._lastUpdatedMs = getTimer();
        }

        public function stop(): void
        {
            this.var_2193 = getTimer() - this._lastUpdatedMs;
        ...
        public function getProfilerAgentsInArray(): Array
        {
            ...
            var _loc3_: Object;
            var _loc1_: Array = [];
            for (_loc3_ in this.var_2191)
            {
                _loc2_ = (_loc3_ as IUpdateReceiver);
                if (IDisposable(_loc3_).disposed)
                {
                    IDisposable(this.var_2191[_loc3_]).dispose();
                    this.var_2191[_loc3_] = null;
                }
                else
                {
                    _loc1_.push(this.var_2191[_loc3_]);
                }
        ...
        {
            var _loc2_: ProfilerAgent = this.var_2191[param1];
