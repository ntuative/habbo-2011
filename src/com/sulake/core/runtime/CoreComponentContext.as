package com.sulake.core.runtime
{
    ...
    public final class CoreComponentContext extends ComponentContext implements ICore
    {
        ...
        private var _pendingFiles: LibraryLoaderQueue;
        private var var_2185: IEventDispatcher;
        private var _files: uint;
        ...
        public function CoreComponentContext(param1: DisplayObjectContainer, param2: uint)
        {
            ...
            switch (param2 & Core.CORE_SETUP_FRAME_UPDATE_MASK)
            {
                ...
                case Core.CORE_SETUP_FRAME_UPDATE_PROFILER:
                    ...
                    _displayObjectContainer.addChild(new ProfilerViewer(this.var_2182));
                    return;

                case Core.CORE_SETUP_FRAME_UPDATE_EXPERIMENTAL:
        ...
        {
            return this._files - this.getNumberOfFilesPending();
        }
        ...
        override public function dispose(): void
        {
            ...
            if (!disposed)
            {
                ...
                if (this._pendingFiles != null)
                {
                    this._pendingFiles.dispose();
        ...
        public function readConfigDocument(config: XML, loadingEventDelegate: IEventDispatcher = null): void
        {
            ...
            if (this._pendingFiles == null)
            {
                this._pendingFiles = new LibraryLoaderQueue(_debug);
            }
            ...
            try
            {
                ...
                if (node != null)
                {
                    ...
                    for each (item in list)
                    {
                        ...
                        this._pendingFiles.push(loader);
            ...
            {
                error("Failed to parse asset libraries from config xml!", true, Core.ERROR_CATEGORY_DOWNLOAD_CONFIG, e);
            }
            ...
            {
                error("Failed to parse interfaces from config xml!", true, Core.ERROR_CATEGORY_DOWNLOAD_CONFIG, e);
            }
            ...
            {
                error("Failed to parse components from config xml!", true, Core.ERROR_CATEGORY_DOWNLOAD_CONFIG, e);
            }
        ...
        private function errorInLoadingProcess(param1: LibraryLoaderEvent = null): void
        {
            ...
            this.error("Failed to download library \"" + _loc2_.url + "\" HTTP status " + param1.status + ": " + _loc2_.getLastErrorMessage(), true, Core.ERROR_CATEGORY_DOWNLOAD_LIBRARY);
            if (!disposed)
            {
        ...
        private function updateLoadingProcess(param1: LibraryLoaderEvent = null): void
        {
            ...
            if (param1 != null)
            {
                if (param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE || param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_ERROR)
                {
                    ...
                    _loc3_ = _loc2_.url;
                    debug("Loading library \"" + _loc3_ + "\" " + (param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE
                            ? "ready"
                    ...
                    if (!disposed)
                    {
                        if (this.var_2185)
                        {
                            this.var_2185.dispatchEvent(new LibraryProgressEvent(_loc2_.url, this._files - this._pendingFiles.length, this._files, _loc2_.elapsedTime));
                        }
        ...
        override public function registerUpdateReceiver(param1: IUpdateReceiver, param2: uint): void
        {
            ...
            var _loc3_: int = this.var_2182
                    ? Core.CORE_SETUP_FRAME_UPDATE_PROFILER
                    : this.var_2175 & Core.CORE_SETUP_FRAME_UPDATE_MASK;
            if (_loc3_ == Core.CORE_SETUP_FRAME_UPDATE_EXPERIMENTAL)
            {
        ...
        override public function removeUpdateReceiver(param1: IUpdateReceiver): void
        {
            ...
            while (_loc5_ < CoreComponentContext.var_2183)
            {
                ...
                if (_loc4_ == Core.CORE_SETUP_FRAME_UPDATE_EXPERIMENTAL)
                {
        ...
        private function complexFrameUpdateHandler(msCurrentTime: uint, msSinceLastUpdate: uint): void
        {
            ...
            var maxTimePerFrame: uint = uint(1000 / _displayObjectContainer.stage.frameRate);
            priority = 0;
            while (priority < CoreComponentContext.var_2183)
            {
                t = getTimer();
        ...
        public function setProfilerMode(param1: Boolean): void
        {
            ...
            else
            {
                ...
                switch (this.var_2175 & Core.CORE_SETUP_FRAME_UPDATE_MASK)
                {
                    case Core.CORE_SETUP_FRAME_UPDATE_SIMPLE:
                        this.var_2187 = this.simpleFrameUpdateHandler;
                        return;
...
class UpdateDelegate implements IDisposable
{
    ...
    public function UpdateDelegate(receiver: IUpdateReceiver, context: IContext, priority: int)
    {
        if (context && receiver)
        {
            ...
            context.displayObjectContainer.stage.addEventListener(this._priority == 0
                                                                          ? Event.EXIT_FRAME
                                                                          : Event.ENTER_FRAME, this.onFrameUpdate);
    ...
    public function dispose(): void
    {
        ...
        {
            this._receiver = null;
            this._context.displayObjectContainer.stage.removeEventListener(this._priority == 0
                                                                                   ? Event.EXIT_FRAME
                                                                                   : Event.ENTER_FRAME, this.onFrameUpdate);
            this._context = null;
        }
