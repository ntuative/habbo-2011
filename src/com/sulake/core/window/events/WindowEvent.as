package com.sulake.core.window.events
{
    ...
    public class WindowEvent 
    {
        ...
        protected var var_2225:IWindow;
        protected var var_2226:Boolean;
        protected var var_642:Boolean;
        ...
        public function recycle():void
        {
            ...
            this._window = (this.var_2225 = null);
            this.var_2223 = true;
            this.var_2226 = false;
        ...
        {
            return (((((("WindowEvent { type: " + this._type) + " cancelable: ") + this.var_642) + " window: ") + this._window) + " }");
        }
