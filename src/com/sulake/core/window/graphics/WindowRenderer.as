package com.sulake.core.window.graphics
{
    ...
    public class WindowRenderer implements IWindowRenderer 
    {
        ...
        public function WindowRenderer(param1:ISkinContainer)
        {
            ...
            this.var_2261 = new Dictionary(true);
        ...
        public function render():void
        {
            ...
            while (_loc4_ < _loc2_)
            {
                _loc1_ = (this.var_2257.pop() as WindowController);
                if (!_loc1_.disposed)
                {
                    _loc3_ = this.getWindowRendererItem(_loc1_);
                    this.var_2260.x = _loc3_.dirty.x;
                    this.var_2260.y = _loc3_.dirty.y;
        ...
        private function renderWindowBranch(param1:WindowController, param2:Rectangle, param3:Rectangle):void
        {
            ...
            if (param1.visible)
            {
                ...
                {
                    if (this.getWindowRendererItem(param1).render(param1, this.var_2258, this.var_2259))
                    {
