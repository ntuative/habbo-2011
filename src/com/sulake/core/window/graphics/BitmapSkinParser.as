package com.sulake.core.window.graphics
{
    ...
    public class BitmapSkinParser
    {
        ...
        public static const var_990: String = "default";
        public static const var_1035: String = "active";
        public static const var_1043: String = "focused";
        public static const var_1038: String = "hovering";
        public static const var_1112: String = "selected";
        public static const var_1036: String = "pressed";
        public static const var_1042: String = "disabled";
        public static const var_1041: String = "locked";
        ...
        protected static function parseLayoutEntity(param1: XML, param2: Map): SkinLayoutEntity
        {
            ...
            if (_loc8_.length() > 0)
            {
                ...
                {
                    case "fixed":
                        _loc5_.var_1777 = SkinLayoutEntity.var_1965;
                        break;
                    case "move":
                        _loc5_.var_1777 = SkinLayoutEntity.var_1778;
                        break;
                    case "strech":
                        _loc5_.var_1777 = SkinLayoutEntity.var_1779;
                        break;
                    case "tiled":
                        _loc5_.var_1777 = SkinLayoutEntity.var_1780;
                        break;
                    case "center":
                        _loc5_.var_1777 = SkinLayoutEntity.var_1966;
                        break;
                }
                ...
                {
                    case "fixed":
                        _loc5_.var_1781 = SkinLayoutEntity.var_1965;
                        break;
                    case "move":
                        _loc5_.var_1781 = SkinLayoutEntity.var_1778;
                        break;
                    case "strech":
                        _loc5_.var_1781 = SkinLayoutEntity.var_1779;
                        break;
                    case "tiled":
                        _loc5_.var_1781 = SkinLayoutEntity.var_1780;
                        break;
                    case "center":
                        _loc5_.var_1781 = SkinLayoutEntity.var_1966;
                        break;
                }
            ...
            if (_loc8_.length() > 0)
            {
                ...
                _loc5_.region.height = Number(_loc6_.charAt(0) == "$"
                                                      ? param2[_loc6_.slice(1, _loc6_.length)]
                                                      : _loc6_);
            }
        ...
        protected static function parseTemplateEntityList(param1: ISkinRenderer, param2: BitmapSkinTemplate, param3: XMLList, param4: Map): void
        {
            ...
            while (_loc16_ < _loc15_)
            {
                ...
                if (_loc6_.length() > 0)
                {
                    ...
                    _loc14_.width = Number(_loc10_.charAt(0) == "$"
                                                   ? param4[_loc10_.slice(1, _loc10_.length)]
                                                   : _loc10_);
                    _loc10_ = _loc7_.attribute("height");
                    _loc14_.height = Number(_loc10_.charAt(0) == "$"
                                                    ? param4[_loc10_.slice(1, _loc10_.length)]
                                                    : _loc10_);
                }
        ...
        protected static function parseState(param1: ISkinRenderer, param2: XML, param3: Dictionary, param4: Map): void
        {
            ...
            var _loc14_: String;
            var _loc15_: Object;
            Logger.log({ param2: param2.toXMLString().split("\n") });
            var _loc5_: String = param2.attribute("name");
            if (_loc5_.charAt(0) == "$")
            {
            ...
            var _loc10_: uint = WindowState.var_990;
            switch (_loc5_)
            {
                case BitmapSkinParser.var_1035:
                    _loc10_ = WindowState.var_1035;
                    break;
                case BitmapSkinParser.var_990:
                    _loc10_ = WindowState.var_990;
                    break;
                case BitmapSkinParser.var_1043:
                    _loc10_ = WindowState.var_1043;
                    break;
                case BitmapSkinParser.var_1042:
                    _loc10_ = WindowState.var_1042;
                    break;
                case BitmapSkinParser.var_1038:
                    _loc10_ = WindowState.var_1038;
                    break;
                case BitmapSkinParser.var_1036:
                    _loc10_ = WindowState.var_1036;
                    break;
                case BitmapSkinParser.var_1112:
                    _loc10_ = WindowState.var_1112;
                    break;
                case BitmapSkinParser.var_1041:
                    _loc10_ = WindowState.var_1041;
                    break;
                default:
