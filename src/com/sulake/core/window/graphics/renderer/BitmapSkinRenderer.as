package com.sulake.core.window.graphics.renderer
{
    ...
    public class BitmapSkinRenderer extends SkinRenderer implements ISkinRenderer 
    {
        ...
        private static var var_2231:Rectangle = new Rectangle();
        private static const TOP_LEFT:Point = new Point();

        protected var var_2232:Dictionary;
        protected var var_2233:Dictionary;
        private var var_2234:Matrix;
        private var var_2230:ColorTransform;

        public function BitmapSkinRenderer(param1:String)
        {
            super(param1);
            this.var_2232 = new Dictionary(false);
            this.var_2233 = new Dictionary(false);
            this.var_2234 = new Matrix();
        ...
        override public function dispose():void
        {
            ...
            if (!disposed)
            {
                ...
                this.var_2234 = null;
                this.var_2230 = null;
                for (_loc1_ in this.var_2232)
                {
                    _loc2_ = (this.var_2232[_loc1_] as BitmapData);
                    _loc2_.dispose();
                    delete this.var_2232[_loc1_];
                };
                this.var_2232 = null;
                for (_loc1_ in this.var_2233)
                {
                    _loc2_ = (this.var_2233[_loc1_] as BitmapData);
                    _loc2_.dispose();
                    delete this.var_2233[_loc1_];
                };
                this.var_2233 = null;
            };
        }
        ...
        override public function draw(param1:IWindow, param2:IBitmapDrawable, param3:Rectangle, param4:uint, param5:Boolean):void
        {
            ...
            var _loc7_:ISkinLayout = var_2235[param4];
            var _loc8_:ISkinTemplate = _templatesByState[param4];
            if (_loc7_ == null)
            {
                Logger.log(("LAYOUT NULL " + param4));
                _loc7_ = var_2235[WindowState.var_990];
                _loc8_ = _templatesByState[WindowState.var_990];
            };
            ...
            if (((!(_loc7_ == null)) && (_loc9_ > 0)))
            {
                ...
                if (_loc16_)
                {
                    this.var_2230.redMultiplier = (((param1.color & 0xFF0000) >> 16) / 0xFF);
                    this.var_2230.greenMultiplier = (((param1.color & 0xFF00) >> 8) / 0xFF);
                    this.var_2230.blueMultiplier = ((param1.color & 0xFF) / 0xFF);
                    this.var_2230.alphaMultiplier = 1;
                };
                _loc17_ = 0;
                while (_loc17_ < _loc9_)
                {
                    ...
                    if (_loc11_ != null)
                    {
                        ...
                        if (((_loc16_) && (_loc10_.colorize)))
                        {
                            ...
                            _loc18_.colorTransform(_loc18_.rect, this.var_2230);
                        };
                        _loc12_ = false;
                        _loc13_ = false;
                        var_2231.x = (_loc10_.region.x + param3.x);
                        var_2231.y = (_loc10_.region.y + param3.y);
                        var_2231.width = _loc10_.region.width;
                        var_2231.height = _loc10_.region.height;
                        if (_loc10_.var_1777 == SkinLayoutEntity.var_1778)
                        {
                            var_2231.x = (var_2231.x + _loc14_);
                        }
                        else
                        {
                            if (_loc10_.var_1777 == SkinLayoutEntity.var_1779)
                            {
                                _loc12_ = true;
                                var_2231.right = (var_2231.right + _loc14_);
                                if (var_2231.width < 1) break;
                            }
                            else
                            {
                                if (_loc10_.var_1777 == SkinLayoutEntity.var_1780)
                                {
                                    _loc12_ = true;
                                    var_2231.right = (var_2231.right + _loc14_);
                                    if (var_2231.width < 1) break;
                        ...
                        if (_loc10_.var_1781 == SkinLayoutEntity.var_1778)
                        {
                            var_2231.y = (var_2231.y + _loc15_);
                        }
                        else
                        {
                            if (_loc10_.var_1781 == SkinLayoutEntity.var_1779)
                            {
                                _loc13_ = true;
                                var_2231.bottom = (var_2231.bottom + _loc15_);
                                if (var_2231.height < 1) break;
                            }
                            else
                            {
                                if (_loc10_.var_1781 == SkinLayoutEntity.var_1780)
                                {
                                    _loc13_ = true;
                                    var_2231.bottom = (var_2231.bottom + _loc15_);
                                    if (var_2231.height < 1) break;
                        ...
                        if (((!(_loc12_)) && (!(_loc13_))))
                        {
                            _loc6_.copyPixels(_loc18_, _loc18_.rect, var_2231.topLeft, _loc19_, TOP_LEFT, true);
                        }
                        else
                        {
                            if (((_loc10_.var_1781 == SkinLayoutEntity.var_1780) || (_loc10_.var_1777 == SkinLayoutEntity.var_1780)))
                            {
                                _loc20_ = _loc18_.width;
                                _loc21_ = _loc18_.height;
                                _loc22_ = int((var_2231.width / _loc20_));
                                _loc23_ = int((var_2231.height / _loc21_));
                                _loc24_ = (var_2231.width % _loc20_);
                                _loc25_ = (var_2231.height % _loc21_);
                                _loc26_ = new Point(var_2231.x, var_2231.y);
                                _loc27_ = new Rectangle(0, 0, _loc24_, _loc18_.height);
                                _loc28_ = new Rectangle(0, 0, _loc18_.width, _loc25_);
                                _loc29_ = 0;
                                while (_loc29_ < _loc23_)
                                {
                                    _loc26_.x = var_2231.x;
                                    _loc30_ = 0;
                            ...
                            else
                            {
                                ...
                                {
                                    this.var_2234.a = var_2231.width;
                                    this.var_2234.d = var_2231.height;
                                    this.var_2234.tx = var_2231.x;
                                    this.var_2234.ty = var_2231.y;
                                    ALPHA.alphaMultiplier = ((_loc19_.getPixel32(0, 0) >>> 24) / 0xFF);
                                    _loc6_.draw(_loc18_, this.var_2234, ALPHA);
                                }
                                else
                                {
                                    this.var_2234.a = (var_2231.width / _loc18_.width);
                                    this.var_2234.d = (var_2231.height / _loc18_.height);
                                    this.var_2234.tx = 0;
                                    this.var_2234.ty = 0;
                                    _loc31_ = new BitmapData(var_2231.width, var_2231.height, _loc18_.transparent);
                                    _loc31_.draw(_loc18_, this.var_2234);
                                    _loc32_ = new BitmapData(var_2231.width, var_2231.height, true, 0);
                                    _loc32_.draw(_loc19_, this.var_2234, null);
                                    _loc6_.copyPixels(_loc31_, _loc31_.rect, var_2231.topLeft, _loc32_, TOP_LEFT, true);
                                    _loc32_.dispose();
                                    _loc31_.dispose();
                                };
                            };
        ...
        protected function drawStaticLayoutEntity(param1:BitmapData, param2:Rectangle, param3:ISkinLayout, param4:SkinLayoutEntity, param5:ISkinTemplate, param6:ISkinTemplateEntity):void
        {
            ...
            switch (param6.type)
            {
                case "bitmap":
                    ...
                    if (param4.var_1777 == SkinLayoutEntity.var_1778)
                    {
                        _loc7_.x = (_loc7_.x + (param2.width - param3.width));
                    };
                    if (param4.var_1781 == SkinLayoutEntity.var_1778)
                    {
        ...
        private function getBitmapFromCache(param1:ISkinTemplate, param2:String):BitmapData
        {
            ...
            var _loc4_:BitmapData = this.var_2232[_loc3_];
            if (_loc4_ == null)
            {
        ...
        private function getAlphaFromCache(param1:ISkinTemplate, param2:String):BitmapData
        {
            ...
            var _loc6_:BitmapData;
            var _loc3_:String = ((param2 + "@") + param1.name);
            var _loc4_:BitmapData = this.var_2233[_loc3_];
            if (_loc4_ == null)
            {
                _loc5_ = (param1.getChildByName(param2) as ISkinTemplateEntity);
                if (_loc5_ == null)
