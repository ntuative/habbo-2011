package com.sulake.core.window.services
{
    ...
    public class FocusManager extends ChildEntityArrayReader implements IFocusManagerService 
    {
        ...
        public function FocusManager(param1:DisplayObject)
        {
            ...
            this.var_1097.addEventListener(FocusEvent.FOCUS_OUT, this.onFocusEvent);
            this.var_1097.addEventListener(FocusEvent.KEY_FOCUS_CHANGE, this.onFocusEvent);
            this.var_1097.addEventListener(FocusEvent.MOUSE_FOCUS_CHANGE, this.onFocusEvent);
            super();
        }
        ...
        public function dispose():void
        {
            if (!this._disposed)
            {
                this.var_1097.removeEventListener(Event.ACTIVATE, this.onActivateEvent);
                this.var_1097.removeEventListener(FocusEvent.FOCUS_OUT, this.onFocusEvent);
                this.var_1097.removeEventListener(FocusEvent.KEY_FOCUS_CHANGE, this.onFocusEvent);
                this.var_1097.removeEventListener(FocusEvent.MOUSE_FOCUS_CHANGE, this.onFocusEvent);
                this.var_1097 = null;
                this._disposed = true;
                var_2217 = null;
            };
        ...
        public function registerFocusWindow(param1:IFocusWindow):void
        {
            if (param1 != null)
            {
                if (var_2217.indexOf(param1) == -1)
                {
                    var_2217.push(param1);
