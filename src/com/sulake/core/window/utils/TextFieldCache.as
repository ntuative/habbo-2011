package com.sulake.core.window.utils
{
    ...
    public class TextFieldCache implements IDisposable
    {
        ...
        private static var var_2306: Map = new Map();
        ...
        {
            var _loc2_: TextField = var_2306[param1.name];
            if (_loc2_)
            {
                return _loc2_;
            }
            ...
            if (!param1)
            {
                param1 = TextStyleManager.getStyle(TextStyleManager.var_1118);
            }
            ...
            _loc3_.underline = param1.textDecoration == TextStyle.var_1117 ? true : null;
            ...
            _loc2_.antiAliasType = param1.antiAliasType == AntiAliasType.ADVANCED
