    ...
    public class WindowParser implements IWindowParser 
    {
        ...
        public function dispose():void
        {
            ...
            if (!this._disposed)
            {
                ...
                {
                    delete this.var_2315[_loc1_];
                };
                for (_loc1_ in this.var_2316)
                {
                    delete this.var_2316[_loc1_];
                };
                for (_loc1_ in this.var_2317)
                {
                    delete this.var_2317[_loc1_];
                };
                for (_loc1_ in this.var_2318)
                {
                    delete this.var_2318[_loc1_];
                };
        ...
        private function parseSingleWindowEntity(xml:XML, parent:WindowController, variables:Map):IWindow
        {
            ...
            window = (this._context.create(name, null, type, style, params, rect, null, ((parent is IIterable) ? null : parent), id, this.parseProperties(xml.child(var_2321)[0]), tags) as WindowController);
        ...
        public function windowToXMLString(param1:IWindow):String
        {
            ...
            _loc2_ = (_loc2_ + (((((((((((((((((((((((((((((((((("<" + _loc3_) + ' x="') + param1.x) + '"') + ' y="') + param1.y) + '"') + ' width="') + param1.width) + '"') + ' height="') + param1.height) + '"') + ' params="') + param1.param) + '"') + ' style="') + param1.style) + '"') + ((param1.name != var_1231) ? ((' name="' + escape(param1.name)) + '"') : var_1231)) + ((param1.caption != var_1231) ? ((' caption="' + escape(param1.caption)) + '"') : var_1231)) + ((param1.id != 0) ? ((' id="' + param1.id.toString()) + '"') : var_1231)) + ((param1.color != 0xFFFFFF) ? ((((' color="' + "0x") + param1.alpha.toString(16)) + param1.color.toString(16)) + '"') : var_1231)) + ((param1.blend != 1) ? ((' blend="' + param1.blend.toString()) + '"') : var_1231)) + ((param1.visible != true) ? ((' visible="' + param1.visible.toString()) + '"') : var_1231)) + ((param1.clipping != true) ? ((' clipping="' + param1.clipping.toString()) + '"') : var_1231)) + ((param1.background != false) ? ((' background="' + param1.background.toString()) + '"') : var_1231)) + ((param1.mouseThreshold != 10) ? ((' treshold="' + param1.mouseThreshold.toString()) + '"') : var_1231)) + ((param1.tags.length > 0) ? ((' tags="' + escape(param1.tags.toString())) + '"') : var_1231)) + ((_loc6_.minWidth > int.MIN_VALUE) ? ((' width_min="' + _loc6_.minWidth) + '"') : var_1231)) + ((_loc6_.maxWidth < int.MAX_VALUE) ? ((' width_max="' + _loc6_.maxWidth) + '"') : var_1231)) + ((_loc6_.minHeight > int.MIN_VALUE) ? ((' height_min="' + _loc6_.minHeight) + '"') : var_1231)) + ((_loc6_.maxHeight < int.MAX_VALUE) ? ((' height_max="' + _loc6_.maxHeight) + '"') : var_1231)) + ">\r"));
