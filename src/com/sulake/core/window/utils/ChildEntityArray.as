package com.sulake.core.window.utils
{
    ...
    public class ChildEntityArray extends ChildEntityArrayReader implements IChildEntityArray
    {
        ...
        {
            var _loc2_: int = var_2217.indexOf(param1);
            if (_loc2_ < 0)
            {
                return null;
            }
        ...
        {
            var_2217.splice(param2, 0, param1);
            return param1;
        }

        public function removeChildAt(param1: int): IChildEntity
        {
            var _loc2_: IChildEntity = var_2217[param1];
            if (_loc2_ != null)
            {
                var_2217.splice(param1, 1);
                return _loc2_;
            }
        ...
        {
            var _loc3_: int = var_2217.indexOf(param1);
            if (_loc3_ > -1 && param2 != _loc3_)
            {
                var_2217.splice(_loc3_, 1);
                var_2217.splice(param2, 0, param1);
            }
        ...
        public function swapChildren(param1: IChildEntity, param2: IChildEntity): void
        {
            ...
            {
                _loc3_ = var_2217.indexOf(param1);
                if (_loc3_ < 0)
                {
                    return;
                }

                _loc4_ = var_2217.indexOf(param2);
                if (_loc4_ < 0)
                {
                    return;
                }
                ...
                var_2217.splice(_loc4_, 1);
                var_2217.splice(_loc3_, 1);
                var_2217.splice(_loc3_, 0, param2);
                var_2217.splice(_loc4_, 0, param1);
            }
        ...
        {
            this.swapChildren(var_2217[param1], var_2217[param2]);
        }
