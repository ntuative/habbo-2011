package com.sulake.core.window
{
    ...
    public class WindowController extends WindowModel implements IWindow, IGraphicContextHost
    {
        ...
        public function WindowController(param1: String, param2: uint, param3: uint, param4: uint, param5: WindowContext, param6: Rectangle, param7: IWindow, param8: Function = null, param9: Array = null, param10: Array = null, param11: uint = 0)
        {
            ...
            if (param6 == null)
            {
                param6 = new Rectangle(0, 0, _loc12_ ? int(_loc12_.attribute("width")) : 10, _loc12_
                        ? int(_loc12_.attribute("height"))
                        : 10);
            }
            ...
            if (_loc12_ != null)
            {
                _initial = new Rectangle(0, 0, int(_loc12_.attribute("width")), int(_loc12_.attribute("height")));
                _previous = _initial.clone();
                _current = _initial.clone();
                param5.getWindowParser().parseAndConstruct(_loc12_, this, null);
                _loc14_ = _param;
                _param = _param & ~WindowParam.var_710;
                this.setRectangle(param6.x, param6.y, param6.width, param6.height);
                _param = _loc14_;
                _previous.x = param6.x;
                _previous.y = param6.y;
                _previous.width = param6.width;
                _previous.height = param6.height;
            }
            ...
            if (_loc13_)
            {
                ...
                _mouseThreshold = _loc13_.var_1019;
                if (_background != _loc13_.background)
                {
                    this.background = _loc13_.background;
                }

                if (_color != _loc13_.color)
                {
                ...
                {
                    _limits.assign(_loc13_.width_min, _loc13_.width_max, _loc13_.height_min, _loc13_.height_max);
                }
        ...
        public static function resizeToAccommodateChildren(param1: WindowController, param2: Boolean = true): void
        {
            ...
            if (_loc9_)
            {
                ...
                param1.setRectangle(param1.x + _loc4_, param1.y + _loc5_, param2 ? _loc6_ - _loc4_ : _loc6_, param2
                        ? _loc7_ - _loc5_
                        : _loc7_);
                if (_loc11_)
                {
        ...
        {
            return this.var_1987 != null ? this.var_1987 : (this._parent != null
        ...
        {
            if (param1 != _current.x)
            {
                this.setRectangle(param1, _current.y, _current.width, _current.height);
            }
        ...
        {
            if (param1 != _current.y)
            {
                this.setRectangle(_current.x, param1, _current.width, _current.height);
            }
        ...
        {
            if (param1 != _current.width)
            {
                this.setRectangle(_current.x, _current.y, param1, _current.height);
            }
        ...
        {
            if (param1 != _current.height)
            {
                this.setRectangle(_current.x, _current.y, _current.width, param1);
            }
        ...
        {
            this.setRectangle(param1.x, param1.y, _current.width, _current.height);
        }
        ...
        {
            _background = param1;
            _color = _background ? _color | _alpha : _color & 0xFFFFFF;
        ...
        {
            _alpha = param1 & 0xFF000000;
            _color = _background ? param1 : param1 & 0xFFFFFF;
            _context.invalidate(this, _current, WindowRedrawFlag.var_1020);
        }
        ...
        {
            _alpha = param1 << 24;
            _color = _background ? _alpha | _color : 0xFFFFFF & _color;
            _context.invalidate(this, _current, WindowRedrawFlag.var_1020);
        }

        public function set blend(param1: Number): void
        {
            _blend = param1 > 1 ? 1 : (param1 < 0 ? 0 : param1);
            _context.invalidate(this, _current, WindowRedrawFlag.var_1022);
        }
        ...
        {
            _mouseThreshold = param1 > 0xFF ? 0xFF : param1;
        }
        ...
        public function set state(param1: uint): void
        {
            ...
            {
                _state = param1;
                _context.invalidate(this, _current, WindowRedrawFlag.var_1024);
            }
        ...
        public function set parent(param1: IWindow): void
        {
            ...
            if (this._parent != param1)
            {
                ...
                if (this._parent != null)
                {
                    ...
                    _previous.width = _current.width;
                    _previous.height = _current.height;
        ...
        public function getGraphicContext(param1: Boolean): IGraphicContext
        {
            ...
            {
                this.var_1154 = new GraphicContext("GC {" + _name + "}", GraphicContext.var_1028, _current);
                this.var_1154.visible = _visible;
            }
        ...
        public function clone(): IWindow
        {
            ...
            var _loc2_: WindowController = new _loc1_(_name, _type, _style, _param, _context, _current, null, this.var_1987, this.properties, _tags.concat(), _id) as WindowController;
            _loc2_._mouseThreshold = _mouseThreshold;
            _loc2_.var_1986 = this.var_1986;
            _loc2_._debug = this._debug;
            _loc2_.var_2353 = this.var_2353.clone();
            _loc2_._current = _current.clone();
            _loc2_._initial = _initial.clone();
            _loc2_._previous = _previous.clone();
            _loc2_._minimized = _minimized ? _minimized.clone() : null;
            _loc2_._maximized = _maximized ? _maximized.clone() : null;
            _loc2_._limits = _limits ? _limits.clone(_loc2_) : null;
            _loc2_._context = _context;
            _loc2_._color = _color;
            _loc2_._alpha = _alpha;
            _loc2_._clipping = _clipping;
            _loc2_._visible = _visible;
        ...
        public function center(): void
        {
            if (this._parent != null)
            {
                this.x = this._parent.width / 2 - _current.width / 2;
                this.y = this._parent.height / 2 - _current.height / 2;
            }
        ...
        public function setRectangle(param1: int, param2: int, param3: int, param4: int): void
        {
            ...
            param4 = Math.max(_limits.minHeight, param4);
            param4 = Math.min(_limits.maxHeight, param4);
            param3 = Math.max(_limits.minWidth, param3);
            param3 = Math.min(_limits.maxWidth, param3);
            var _loc5_: Boolean = param1 != _current.x || param2 != _current.y;
            var _loc6_: Boolean = param3 != _current.width || param4 != _current.height;
            if (_loc6_ && !_loc5_)
            {
                _loc7_ = _param & WindowParam.var_708;
                if (_loc7_ == WindowParam.var_683)
                {
                    param1 = int(param1 - (param3 - _current.width) / 2);
                    _loc5_ = true;
                }
                else
                {
                    ...
                    {
                        param1 = param1 - (param3 - _current.width);
                        _loc5_ = true;
                    }

                }

                _loc7_ = _param & WindowParam.var_709;
                if (_loc7_ == WindowParam.var_686)
                {
                    param2 = int(param2 - (param4 - _current.height) / 2);
                    _loc5_ = true;
                }
                else
                {
                    ...
                    {
                        param2 = param2 - (param4 - _current.height);
                        _loc5_ = true;
                    }
            ...
            if (testParamFlag(WindowParam.var_691))
            {
                if (this._parent != null)
                {
                    ...
                    if (_loc5_)
                    {
                        ...
                        param2 = param2 - (param2 + param4 > _loc8_.height
                                ? (param2 + param4) - _loc8_.height
                                : 0);
                        _loc5_ = param1 != _current.x || param2 != _current.y;
                    }
                    else
                    {
                        param3 = param3 - (param1 + param3 > _loc8_.width ? (param1 + param3) - _loc8_.width : 0);
                        param4 = param4 - (param2 + param4 > _loc8_.height
                                ? (param2 + param4) - _loc8_.height
                                : 0);
                        _loc6_ = param3 != _current.width || param4 != _current.height;
                    }
            ...
            if (_loc5_ || _loc6_)
            {
                ...
                if (_loc6_)
                {
                    _previous.width = _current.width;
                    _previous.height = _current.height;
                    _current.width = param3;
                    _current.height = param4;
                }
        ...
        public function getRegionProperties(param1: Rectangle = null, param2: Rectangle = null, param3: Rectangle = null, param4: Rectangle = null): void
        {
            if (param1 != null)
            {
                param1.x = _current.x;
                param1.y = _current.y;
                param1.width = _current.width;
                param1.height = _current.height;
            }

            if (param2 != null)
            {
                param2.x = _previous.x;
                param2.y = _previous.y;
                param2.width = _previous.width;
                param2.height = _previous.height;
            }

            if (param3 != null && _minimized != null)
            {
                param3.x = _minimized.x;
                param3.y = _minimized.y;
                param3.width = _minimized.width;
                param3.height = _minimized.height;
            }

            if (param4 != null && _maximized != null)
            {
                param4.x = _maximized.x;
                param4.y = _maximized.y;
                param4.width = _maximized.width;
                param4.height = _maximized.height;
            }
        ...
        public function setRegionProperties(param1: Rectangle = null, param2: Rectangle = null, param3: Rectangle = null): void
        {
            if (param3 != null)
            {
                ...
                if (_maximized == null)
                {
                    _maximized = new Rectangle();
                }

                _maximized.x = param3.x;
                _maximized.y = param3.y;
                _maximized.width = param3.width;
                _maximized.height = param3.height;
            }
            ...
            if (param2 != null)
            {
                ...
                if (_minimized == null)
                {
                    _minimized = new Rectangle();
                }

                _minimized.x = param2.x;
                _minimized.y = param2.y;
                _minimized.width = param2.width;
                _minimized.height = param2.height;
            }
        ...
        {
            return testParamFlag(WindowParam.var_693)
                    ? (this._parent != null ? this._parent.fetchDrawBuffer() : null)
                    : this.getGraphicContext(true).fetchDrawBuffer();
        }
        ...
        public function getDrawRegion(param1: Rectangle): void
        {
            ...
            else
            {
                if (this._parent != null)
                {
                    ...
                    param1.x = param1.x + _current.x;
                    param1.y = param1.y + _current.y;
                    param1.width = _current.width;
                    param1.height = _current.height;
                }
                else
            ...
            if (param2 is WindowMouseEvent)
            {
                switch (param2.type)
                {
                    case WindowMouseEvent.var_628:
                        ...
                        if ((_param & WindowParam.var_704) > 0)
                        {
                            _loc3_ = this;
                            while (_loc3_ != null)
                            {
                                ...
                                {
                                    _context.getWindowServices().getMouseScalingService()
                                            .begin(_loc3_, _param & WindowParam.var_704);
                                    break;
                                }
                ...
                if (param2 is WindowEvent)
                {
                    switch (param2.type)
                    {
                        case WindowEvent.var_573:
                            _context.invalidate(this, _current.union(_previous), WindowRedrawFlag.RESIZE);
                            if (param1 == this)
                            {
                                ...
                                {
                                    _loc6_ = _param;
                                    _param = _param & ~(WindowParam.var_697 | WindowParam.var_698);
                                    if (testParamFlag(WindowParam.var_688))
                                    {
                                        this._parent.width = this._parent.width + (_current.width - _previous.width);
                                    }

                                    if (testParamFlag(WindowParam.var_689))
                                    {
                                        this._parent.height = this._parent.height + (_current.height - _previous.height);
                                    }
                        ...
                        case WindowEvent.var_571:
                            _context.invalidate(this, _current.union(_previous), WindowRedrawFlag.var_1039);
                            if (param1 == this)
                            {
        ...
        public function childRectToClippedDrawRegion(param1: Rectangle, param2: Rectangle): Boolean
        {
            ...
            if (testParamFlag(WindowParam.var_693))
            {
                param1.offset(_current.x, _current.y);
                if (clipping)
                {
                    _loc4_ = param1.intersection(_current);
                    if (param1.x < _current.x)
                    {
                        param2.x = param2.x - (param1.x - _current.x);
                        param1.x = _current.x;
                        _loc3_ = true;
                    }

                    if (param1.y < _current.y)
                    {
                        param2.y = param2.y - (param1.y - _current.y);
                        param1.y = _current.y;
                        _loc3_ = true;
                    }
            ...
            else
            {
                if (clipping)
                {
                    ...
                    if (_current.width < param1.right)
                    {
                        param2.right = param2.right - (param1.right - _current.width);
                        param1.right = param1.width;
                        _loc3_ = true;
                    }

                    if (_current.height < param1.bottom)
                    {
                        param2.bottom = param2.bottom - (param1.bottom - _current.height);
                        param1.bottom = _current.height;
                        _loc3_ = true;
                    }
        ...
        public function setGlobalPosition(param1: Point): void
        {
            ...
            if (this._parent != null)
            {
                ...
                _loc2_.x = _loc2_.x + _current.x;
                _loc2_.y = _loc2_.y + _current.y;
            }
            else
            {
                _loc2_.x = _current.x;
        ...
        public function validateGlobalPointIntersection(param1: Point, param2: BitmapData): Boolean
        {
            ...
            return this.testLocalPointHitAgainstAlpha(_loc3_, param2, _mouseThreshold);
        }
        ...
        protected function testLocalPointHitAgainstAlpha(param1: Point, param2: BitmapData, param3: uint): Boolean
        {
            ...
            var _loc4_: Boolean;
            if (_current.width < 1 || _current.height < 1)
            {
                return false;
            }

            if (this.var_1986 && _mouseThreshold > 0)
            {
                if (!testParamFlag(WindowParam.var_693))
                {
                    if (param1.x <= _current.width && param1.y <= _current.height)
                    {
            ...
            {
                if (param1.x >= 0 && param1.x < _current.width)
                {
                    if (param1.y >= 0 && param1.y < _current.height)
                    {
                        _loc4_ = true;
                    }
        ...
        {
            return _current.height / _initial.height;
        }

        public function resolveHorizontalScale(): Number
        {
            return _current.width / _initial.width;
        }

        public function offset(param1: Number, param2: Number): void
        {
            this.setRectangle(_current.x + param1, _current.y + param2, _current.width, _current.height);
        }

        public function scale(param1: Number, param2: Number): void
        {
            this.setRectangle(_current.x, _current.y, _current.width + param1, _current.height + param2);
        }
        ...
        public function expandToAccommodateChildren(): void
        {
            ...
            var _loc2_: int;
            var _loc3_: int;
            var _loc4_: int = _current.width;
            var _loc5_: int = _current.height;
            var _loc7_: Boolean;
            ...
            if (_loc7_)
            {
                ...
                this.setRectangle(_current.x + _loc2_, _current.y + _loc3_, _loc4_, _loc5_);
                for each (_loc1_ in this._children)
                {
        ...
        public function setStyleFlag(param1: uint, param2: Boolean = true): void
        {
            ...
            var _loc3_: uint = _style;
            _style = param2 ? _style = _style | param1 : _style = _style & ~param1;
            if (_style != _loc3_)
            {
                _loc4_ = [];
        ...
        public function setParamFlag(param1: uint, param2: Boolean = true): void
        {
            ...
            _param = param2 ? _param = _param | param1 : _param = _param & ~param1;
            if (_param != _loc3_)
            {
                if (!(_param & WindowParam.var_693))
                {
                    if (!this.var_1154)
                    {
        ...
        protected function updateScaleRelativeToParent(): void
        {
            ...
            if (_loc1_ || _loc2_)
            {
                _loc3_ = _current.clone();
                if (_loc1_)
                {
                    _loc4_ = this._parent.width - this.var_2353.width;
                    _loc5_ = _param & WindowParam.var_697;
                ...
                if (_loc2_)
                {
                    ...
                    _loc5_ = _param & WindowParam.var_698;
            ...
            else
            {
                if (testParamFlag(WindowParam.var_691))
                {
                    ...
                    if (this._parent != null)
                    {
                        ...
                        _loc3_.x = _loc3_.x - (_loc3_.x + _loc3_.width > _loc7_.width
                                ? (_loc3_.x + _loc3_.width) - _loc7_.width
                                : 0);
                        _loc3_.y = _loc3_.y - (_loc3_.y + _loc3_.height > _loc7_.height
                                ? (_loc3_.y + _loc3_.height) - _loc7_.height
                                : 0);
                        _loc3_.width = _loc3_.width - (_loc3_.x + _loc3_.width > _loc7_.width
                                ? (_loc3_.x + _loc3_.width) - _loc7_.width
                                : 0);
                        _loc3_.height = _loc3_.height - (_loc3_.y + _loc3_.height > _loc7_.height
                                ? (_loc3_.y + _loc3_.height) - _loc7_.height
                                : 0);
                        if (_loc3_.x != _current.x || _loc3_.y != _current.y || _loc3_.width != _current.width || _loc3_.height != _current.height)
                        {
                            _loc6_ = _param;
                            _param = _param & ~WindowParam.var_710;
                            this.setRectangle(_loc3_.x, _loc3_.y, _loc3_.width, _loc3_.height);
        ...
        public function groupChildrenUnderPoint(param1: Point, param2: Array): void
        {
            ...
            if (_visible)
            {
                if (_current.containsPoint(param1))
                {
                    param2.push(this);
                    param1.offset(-_current.x, -_current.y);
                    for each (_loc3_ in this._children)
        ...
        public function swapChildren(param1: IWindow, param2: IWindow): void
        {
            ...
            if (param1 != null && param2 != null && param1 != param2)
            {
                ...
                {
                    this.var_1154.swapChildContexts(WindowController(param1)
                                                            .getGraphicContext(true), WindowController(param2)
                                                            .getGraphicContext(true));
                }
