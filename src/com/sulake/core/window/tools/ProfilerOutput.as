package com.sulake.core.window.tools
{
    ...
    public class ProfilerOutput implements IDevTool 
    {
        ...
        private static var var_1053:Class = ProfilerOutput_profiler_dialog_xml;
        private static var var_1054:Class = ProfilerOutput_profiler_task_xml;

        private var _disposed:Boolean = false;
        private var var_2289:IProfiler;
        ...
        {
            this.var_2288 = (param1 as ICore);
            this.var_2290 = new Array();
            this.var_2289 = this.profiler;
            this._windowManager = param2;
            this._windowRenderer = param3;
            var _loc4_:ByteArray = (new var_1053() as ByteArray);
        ...
        public function set visible(value:Boolean):void
        {
            if (value != this.visible)
            {
                ...
                if (value)
                {
                    ...
                    this.var_2288.setProfilerMode(true);
                    this.var_2288.queueInterface(new IIDProfiler(), function (param1:IID, param2:IUnknown):void
                    {
                ...
                {
                    this.var_2288.setProfilerMode(false);
                };
            };
        }
        ...
        public function set profiler(param1:IProfiler):void
        {
            if (this.var_2289)
            {
                this.var_2289.removeStopEventListener(this.refresh);
                this.var_2289 = null;
            };
            if (((!(this.var_2289)) && (param1)))
            {
                this.var_2289 = param1;
                this.var_2289.addStopEventListener(this.refresh);
            };
        }
        ...
        {
            var _loc2_:Array = this.var_2289.getProfilerAgentsInArray();
            ...
            if (this.var_2291)
            {
                this._window.findChildByName("footer").caption = ((((((((((((((("Assets - Libraries: " + this.var_2289.numAssetLibraryInstances) + " ") + "Bitmaps: ") + this.var_2289.numBitmapAssetInstances) + " / ") + this.var_2289.numAllocatedBitmapDataBytes) + " bytes \n") + "Windows - Allocated bitmap data: ") + (this._windowRenderer.allocatedByteCount + GraphicContext.allocatedByteCount)) + " bytes \n") + "Tracked bitmap data: ") + this.var_2289.numTrackedBitmapDataInstances) + " / ") + this.var_2289.numTrackedBitmapDataBytes) + " bytes");
            };
        }
        ...
        {
            var _loc2_:ByteArray = (new var_1054() as ByteArray);
