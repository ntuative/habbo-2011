package com.sulake.core.window.components
{
    ...
    public class TextLabelController extends WindowController implements ILabelWindow, ILocalizable
    {
        ...
        private function refresh(param1: Boolean = false): void
        {
            ...
            this._textWidth = _loc2_.textWidth;
            this._textHeight = _loc2_.textHeight;
            ...
            var _loc5_: int = _current.width - _loc3_;
            var _loc6_: int = _current.height - _loc4_;
            var _loc7_: int = Math.floor(_loc2_.width) + (_loc2_.border ? 1 : 0);
            var _loc8_: Boolean;
            if (_loc7_ != _loc5_)
            {
                setRectangle(_current.x, _current.y, _loc7_ + _loc3_, Math.floor(_loc2_.height) + _loc4_);
                _loc8_ = true;
            }
        ...
        override public function get properties(): Array
        {
            ...
            _loc1_.push((_loc2_.color != null
                    ? this.var_2219 != _loc2_.color
                    : this.var_2219 != null && this.var_2219 != PropertyDefaults.var_1140)
                                ? new PropertyStruct(PropertyDefaults.var_1123, this.var_2219, PropertyStruct.var_606, true)
