package com.sulake.core.window.components
{
    ...
    public class TextFieldController extends TextController implements ITextFieldWindow
    {
        ...
        override public function getGraphicContext(param1: Boolean): IGraphicContext
        {
            if (param1 && !var_1154)
            {
                var_1154 = new GraphicContext("GC {" + _name + "}", GraphicContext.var_1155, _current);
            }
        ...
        protected function refreshAutoSize(): void
        {
            ...
            {
                if (_current.width != _field.width || _current.height != _field.height)
                {
                    ...
                    setRectangle(_current.x + _loc3_.x, _current.y + _loc3_.y, _field.width, _field.height);
                }
        ...
        override protected function refreshTextImage(param1: Boolean = false): void
        {
            ...
            var _loc2_: Boolean;
            if (_current.width != _field.width)
            {
            ...
            if (_current.height != _field.height)
            {
                if (autoSize != TextFieldAutoSize.NONE)
                {
        ...
        override public function get properties(): Array
        {
            ...
            _loc1_.push(_field.type == TextFieldType.DYNAMIC
                                ? new PropertyStruct(PropertyDefaults.var_1157, false, PropertyStruct.var_611, true)
                                : PropertyDefaults.var_1158);
            _loc1_.push(this.var_2053 != PropertyDefaults.var_1159
                                ? new PropertyStruct(PropertyDefaults.var_1160, this.var_2053, PropertyStruct.var_611, true)
                                : PropertyDefaults.var_1161);
            _loc1_.push(_field.selectable != PropertyDefaults.var_1162
                                ? new PropertyStruct(PropertyDefaults.var_1163, _field.selectable, PropertyStruct.var_611, true)
                                : PropertyDefaults.var_1164);
            _loc1_.push(_field.displayAsPassword != PropertyDefaults.var_1165
                                ? new PropertyStruct("display_as_password", _field.displayAsPassword, PropertyStruct.var_611, true)
                                : PropertyDefaults.var_1166);
            return _loc1_;
        }
