package com.sulake.core.window.components
{
    ...
    public class ScrollbarController extends InteractiveController implements IScrollbarWindow, ITouchAwareWindow 
    {
        ...
        protected var var_2034:IScrollableWindow;
        ...
        {
            if (((!(this.var_2034 == null)) && (!(this.var_2034.disposed))))
            {
                this.var_2034.removeEventListener(WindowEvent.var_573, this.onScrollableResized);
                this.var_2034.removeEventListener(WindowEvent.var_591, this.onScrollableScrolled);
            };
            this.var_2034 = param1;
            if (((!(this.var_2034 == null)) && (!(this.var_2034.disposed))))
            {
                this.var_2034.addEventListener(WindowEvent.var_573, this.onScrollableResized);
                this.var_2034.addEventListener(WindowEvent.var_591, this.onScrollableScrolled);
                this.updateLiftSizeAndPosition();
            };
        }
        ...
        override public function get properties():Array
        {
            ...
            var _loc2_:String = "";
            if ((this.var_2034 is IWindow))
            {
                _loc2_ = IWindow(this.var_2034).name;
            }
            else
            {
        ...
        protected function setScrollPosition(param1:Number):Boolean
        {
            ...
            if (this._horizontal)
            {
                _loc2_ = (!(this.var_2034.scrollH == this._offset));
                if (_loc2_)
                {
                    this.var_2034.scrollH = this._offset;
                };
            }
            else
            {
                _loc2_ = (!(this.var_2034.scrollV == this._offset));
                if (_loc2_)
                {
                    this.var_2034.scrollV = this._offset;
                };
            };
            return (_loc2_);
        }
        ...
        private function updateLiftSizeAndPosition():void
        {
            ...
            if (_loc3_ != null)
            {
                if (this._horizontal)
                {
                    _loc1_ = (this.var_2034.visibleRegion.width / this.var_2034.scrollableRegion.width);
                    if (_loc1_ > 1)
                    {
                        _loc1_ = 1;
                    };
                    ...
                    _loc3_.width = _loc4_;
                    _loc3_.x = (this.var_2034.scrollH * (_loc2_.width - _loc4_));
                }
                else
                {
                    _loc1_ = (this.var_2034.visibleRegion.height / this.var_2034.scrollableRegion.height);
                    if (_loc1_ > 1)
                    {
                        _loc1_ = 1;
                    };
                    ...
                    _loc3_.y = (this.var_2034.scrollV * (_loc2_.height - _loc3_.height));
                };
            };
            if (_loc1_ == 1)
            {
            ...
            if (((param1.type == WindowMouseEvent.var_628) || (param1.type == WindowTouchEvent.var_1722)))
            {
                if (param2.name == var_2030)
                {
                    if (this.var_2034)
                    {
                        ...
                        if (this._horizontal)
                        {
                            this.scrollH = (this.scrollH + (this.var_2034.scrollStepH / this.var_2034.maxScrollH));
                        }
                        else
                        {
                            this.scrollV = (this.scrollV + (this.var_2034.scrollStepV / this.var_2034.maxScrollV));
                        };
                        this.var_2037 = false;
                    };
                }
                    ...
                    else
                    {
                        if (param2.name == var_2032)
                        {
                            ...
                            if (this._horizontal)
                            {
                                if (_loc4_ < _loc6_.x)
                                {
                                    this.scrollH = (this.scrollH - ((this.var_2034.visibleRegion.width - this.var_2034.scrollStepH) / this.var_2034.maxScrollH));
                                }
                                else
                                {
                            ...
                            else
                            {
                                if (_loc5_ < _loc6_.y)
                                {
                                    this.scrollV = (this.scrollV - ((this.var_2034.visibleRegion.height - this.var_2034.scrollStepV) / this.var_2034.maxScrollV));
                                }
                                else
                                {
