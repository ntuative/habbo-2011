package com.sulake.core.window.components
{
    ...
    public class SelectableController extends InteractiveController implements ISelectableWindow
    {
        ...
        {
            return testStateFlag(WindowState.var_1112);
        }

        public function set isSelected(param1: Boolean): void
        {
            setStateFlag(WindowState.var_1112, param1);
        }
        ...
        override public function update(param1: WindowController, param2: WindowEvent): Boolean
        {
            ...
            if (param2.type == WindowEvent.var_556)
            {
                if (_parent)
                {
                    if (!(_parent is ISelectorWindow))
                    {
                        ...
                        while (_loc3_)
                        {
                            ...
                            {
                                _loc4_ = WindowEvent.allocate(WindowEvent.var_584, this, null);
        ...
        {
            if (getStateFlag(WindowState.var_1112))
            {
                return true;
            }

            var _loc1_: WindowEvent = WindowEvent.allocate(WindowEvent.var_559, this, null);
            ...
            _loc1_.recycle();
            setStateFlag(WindowState.var_1112, true);
            _loc1_ = WindowEvent.allocate(WindowEvent.var_560, this, null);
            this.update(this, _loc1_);
            _loc1_.recycle();
            activate();
            return true;
        ...
        public function unselect(): Boolean
        {
            ...
            _loc1_.recycle();
            setStateFlag(WindowState.var_1112, false);
