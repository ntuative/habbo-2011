package com.sulake.core.window.components
{
    ...
    public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable 
    {
        ...
        protected static const var_1129:Dictionary = createPropertySetterTable();
        ...
        protected var var_1998:TextMargins = new TextMargins(0, 0, 0, 0, setTextMargins);
        protected var var_2052:Boolean = false;
        protected var var_2050:Number = 0;
        protected var var_2051:Number = 0;
        ...
        public function TextController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array=null, param10:Array=null, param11:uint=0)
        {
            ...
            setTextFormatting(this._field, this.var_2049, this._explicitStyle);
            ...
            {
                this._field.width = var_1018.width;
                this._field.height = var_1018.height;
            };
        }
        ...
        private static function setHtmlText(param1:TextController, param2:String):void
        {
            ...
            if (param1.var_1171)
            {
                param1.context.removeLocalizationListener(param1.var_1034.slice(2, param1.var_1034.indexOf("}")), param1);
                param1.var_1171 = false;
            };
            param1.var_1034 = param2;
            if (((param1.var_1034.charAt(0) == "$") && (param1.var_1034.charAt(1) == "{")))
            {
                param1.context.registerLocalizationListener(param1.var_1034.slice(2, param1.var_1034.indexOf("}")), param1);
                param1.var_1171 = true;
            }
            else
            {
                if (param1._field != null)
                {
                    param1._field.htmlText = param1.var_1034;
                    param1.refreshTextImage();
                };
            };
        }
        ...
        private static function setTextMarginMap(param1:TextController, param2:Map):void
        {
            if (param1.var_1998)
            {
                param1.var_1998.assign(int(param2["left"]), int(param2["top"]), int(param2["right"]), int(param2["bottom"]), param1.setTextMargins);
            }
            else
            {
                param1.var_1998 = new TextMargins(int(param2["left"]), int(param2["top"]), int(param2["right"]), int(param2["bottom"]), param1.setTextMargins);
            };
            param1.refreshTextImage();
        }
        ...
        {
            if (((param1.var_1998) && (!(param1.var_1998.left == param2))))
            {
        ...
        {
            if (((param1.var_1998) && (!(param1.var_1998.top == param2))))
            {
        ...
        {
            if (((param1.var_1998) && (!(param1.var_1998.right == param2))))
            {
        ...
        {
            if (((param1.var_1998) && (!(param1.var_1998.bottom == param2))))
            {
        ...
        private static function var_1119(param1:TextController, param2:Number):void
        {
        ...
        private static function setTextStyle(param1:TextController, param2:TextStyle):void
        {
            ...
            if (_loc3_)
            {
                param1.var_2049 = _loc3_.name;
                setTextFormatting(param1._field, param1.var_2049, param1._explicitStyle);
                param1.refreshTextImage();
            };
        }
        ...
        private static function setUnderline(param1:TextController, param2:Boolean):void
        {
            ...
            param1.setTextFormat(new TextFormat(_loc3_.font, _loc3_.size, _loc3_.color, _loc3_.bold, _loc3_.italic, _loc3_.underline, _loc3_.url, _loc3_.target, _loc3_.align, _loc3_.leftMargin, _loc3_.rightMargin, _loc3_.indent, _loc3_.leading));
            param1.defaultTextFormat = _loc3_;
            param1._explicitStyle.textDecoration = ((param2) ? TextStyle.var_1117 : TextStyle.NONE);
        }
        ...
        protected static function setTextFormatting(param1:TextField, param2:String, param3:TextStyle):void
        {
            ...
            if (!_loc4_)
            {
                _loc4_ = TextStyleManager.getStyle(TextStyleManager.var_1118);
            };
            ...
            {
                _loc5_.underline = ((_loc4_.textDecoration == TextStyle.var_1117) ? true : null);
            };
        ...
        protected static function createPropertySetterTable():Dictionary
        {
            ...
            _loc1_["sharpness"] = var_1119;
            _loc1_["thickness"] = setThickness;
            _loc1_["underline"] = setUnderline;
            _loc1_["word_wrap"] = setWordWrap;
            _loc1_["margins"] = setTextMarginMap;
            _loc1_[PropertyDefaults.var_1120] = setAntiAliasType;
            _loc1_[PropertyDefaults.var_1121] = setAutoSize;
            _loc1_[PropertyDefaults.var_1122] = setMouseWheelEnabled;
            _loc1_[PropertyDefaults.var_1123] = setTextColor;
            _loc1_[PropertyDefaults.var_1124] = setTextStyleString;
            _loc1_[PropertyDefaults.var_1125] = setMarginLeft;
            _loc1_[PropertyDefaults.var_1126] = setMarginTop;
            _loc1_[PropertyDefaults.var_1127] = setMarginRight;
            _loc1_[PropertyDefaults.var_1128] = setMarginBottom;
            return (_loc1_);
        }
        ...
        public function set scrollH(param1:Number):void
        {
            ...
            this._field.scrollH = (this.var_2050 * Number(this._field.maxScrollH));
        ...
        {
            return (new Rectangle((this.var_2050 * this.maxScrollH), (this.var_2051 * this.maxScrollV), width, height));
        }
        ...
        override public function clone():IWindow
        {
            ...
            _loc1_.var_2050 = this.var_2050;
            _loc1_.var_2051 = this.var_2051;
            _loc1_.var_1998 = this.var_1998.clone(_loc1_.setTextMargins);
            _loc1_._autoSize = this._autoSize;
            _loc1_.var_1171 = this.var_1171;
            return (_loc1_);
        }
        ...
        protected function refreshTextImage(param1:Boolean=false):void
        {
            ...
            this.var_2052 = true;
            var _loc2_:int = (this.var_1998.left + this.var_1998.right);
            var _loc3_:int = (this.var_1998.top + this.var_1998.bottom);
            var _loc4_:int = (var_1018.width - _loc2_);
            var _loc5_:int = (var_1018.height - _loc3_);
            ...
            if (_loc6_ != _loc4_)
            {
                ...
                {
                    setRectangle(var_1018.x, var_1018.y, (_loc6_ + _loc2_), (Math.floor(this._field.height) + _loc3_));
                    _loc7_ = true;
                }
                else
                {
            ...
            if (((!(_loc7_)) && (!(param1))))
            {
                _loc8_ = WindowEvent.allocate(WindowEvent.var_573, this, null);
        ...
        override public function get properties():Array
        {
            ...
            _loc1_.push(new PropertyStruct("always_show_selection", this._field.alwaysShowSelection, PropertyStruct.var_611, (!(this._field.alwaysShowSelection == false))));
            _loc1_.push((((_loc2_.antiAliasType != null) ? (!(this._field.antiAliasType == _loc2_.antiAliasType)) : (!(this._field.antiAliasType == PropertyDefaults.var_1130))) ? new PropertyStruct(PropertyDefaults.var_1120, this._field.antiAliasType, PropertyStruct.var_613, (!(this._field.antiAliasType == AntiAliasType.NORMAL)), PropertyDefaults.var_1131) : PropertyDefaults.var_1132));
            _loc1_.push(((this._autoSize != PropertyDefaults.var_1133) ? new PropertyStruct(PropertyDefaults.var_1121, this._autoSize, PropertyStruct.var_613, true, PropertyDefaults.var_1134) : PropertyDefaults.var_1135));
            _loc1_.push(new PropertyStruct("border", this._field.border, PropertyStruct.var_611, (this._field.border == true)));
            _loc1_.push(new PropertyStruct("border_color", this._field.borderColor, PropertyStruct.var_606, (!(this._field.borderColor == 0))));
            _loc1_.push(new PropertyStruct("condense_white", this._field.condenseWhite, PropertyStruct.var_611, (!(this._field.condenseWhite == false))));
            _loc1_.push(new PropertyStruct("font_face", this.defaultTextFormat.font, PropertyStruct.var_613, (!(this.defaultTextFormat.font == _loc2_.fontFamily))));
            _loc1_.push(new PropertyStruct("font_size", this.defaultTextFormat.size, PropertyStruct.var_608, (!(this.defaultTextFormat.size == _loc2_.fontSize))));
            _loc1_.push(((this._field.gridFitType != PropertyDefaults.var_1136) ? new PropertyStruct(PropertyDefaults.var_1137, this._field.gridFitType, PropertyStruct.var_613, true, PropertyDefaults.var_1138) : PropertyDefaults.var_1139));
            _loc1_.push((((_loc2_.color != null) ? (!(this._field.textColor == _loc2_.color)) : (!(this._field.textColor == PropertyDefaults.var_1140))) ? new PropertyStruct(PropertyDefaults.var_1123, this._field.textColor, PropertyStruct.var_606, true) : PropertyDefaults.var_1141));
            ...
            _loc1_.push(((this.var_1998.left != PropertyDefaults.var_1144) ? new PropertyStruct(PropertyDefaults.var_1125, this.var_1998.left, PropertyStruct.var_607, true) : PropertyDefaults.var_1145));
            _loc1_.push(((this.var_1998.top != PropertyDefaults.var_1146) ? new PropertyStruct(PropertyDefaults.var_1126, this.var_1998.top, PropertyStruct.var_607, true) : PropertyDefaults.var_1147));
            _loc1_.push(((this.var_1998.right != PropertyDefaults.var_1148) ? new PropertyStruct(PropertyDefaults.var_1127, this.var_1998.right, PropertyStruct.var_607, true) : PropertyDefaults.var_1149));
            _loc1_.push(((this.var_1998.bottom != PropertyDefaults.var_1150) ? new PropertyStruct(PropertyDefaults.var_1128, this.var_1998.bottom, PropertyStruct.var_607, true) : PropertyDefaults.var_1151));
            _loc1_.push(((this._field.mouseWheelEnabled != PropertyDefaults.var_1152) ? new PropertyStruct(PropertyDefaults.var_1122, this._field.mouseWheelEnabled, PropertyStruct.var_611, true) : PropertyDefaults.var_1153));
            _loc1_.push(new PropertyStruct("max_chars", this._field.maxChars, PropertyStruct.var_607, (!(this._field.maxChars == 0))));
            _loc1_.push(new PropertyStruct("multiline", this._field.multiline, PropertyStruct.var_611, (!(this._field.multiline == false))));
            _loc1_.push(new PropertyStruct("restrict", this._field.restrict, PropertyStruct.var_613, (!(this._field.restrict == null))));
            _loc1_.push(new PropertyStruct("sharpness", this._field.sharpness, PropertyStruct.var_609, (!(this._field.sharpness == 0))));
            _loc1_.push(new PropertyStruct("thickness", this._field.thickness, PropertyStruct.var_609, (!(this._field.thickness == 0))));
            _loc1_.push(new PropertyStruct("word_wrap", this._field.wordWrap, PropertyStruct.var_611, (!(this._field.wordWrap == false))));
            _loc1_.push(new PropertyStruct("bold", (!(this._field.defaultTextFormat.bold == false)), PropertyStruct.var_611, ((!(this._field.defaultTextFormat.bold == false)) && (!(_loc2_.fontWeight == FontStyle.BOLD)))));
            _loc1_.push(new PropertyStruct("italic", (!(this._field.defaultTextFormat.italic == false)), PropertyStruct.var_611, ((!(this._field.defaultTextFormat.italic == false)) && (!(_loc2_.fontStyle == FontStyle.ITALIC)))));
            _loc1_.push(new PropertyStruct("underline", (!(this._field.defaultTextFormat.underline == false)), PropertyStruct.var_611, ((!(this._field.defaultTextFormat.underline == false)) && (!(_loc2_.textDecoration == "underline")))));
            _loc1_.push(new PropertyStruct("kerning", (!(this._field.defaultTextFormat.kerning == false)), PropertyStruct.var_611, ((!(this._field.defaultTextFormat.kerning == false)) && (!(_loc2_.kerning)))));
            _loc1_.push(new PropertyStruct("spacing", this._field.defaultTextFormat.letterSpacing, PropertyStruct.var_609, (!(this._field.defaultTextFormat.letterSpacing == 0))));
            return (_loc1_);
        }
