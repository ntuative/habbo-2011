package com.sulake.core.window.components
{
    ...
    public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
    {
        ...
        protected var _margins: TextMargins = new TextMargins(0, 0, 0, 0, setTextMargins);
        ...
        public function TextController(param1: String, param2: uint, param3: uint, param4: uint, param5: WindowContext, param6: Rectangle, param7: IWindow, param8: Function, param9: Array = null, param10: Array = null, param11: uint = 0)
        {
            ...
            {
                this._field.width = _current.width;
                this._field.height = _current.height;
            }
        ...
        private static function setAutoSize(param1: TextController, param2: String): void
        {
            ...
            param1._field.autoSize = param2 != TextFieldAutoSize.NONE
        ...
        protected static function setTextFormatting(param1: TextField, param2: String, param3: TextStyle): void
        {
            ...
            {
                param1.antiAliasType = _loc4_.antiAliasType == AntiAliasType.ADVANCED
        ...
        protected static function createPropertySetterTable(): Dictionary
        {
            ...
            _loc1_[PropertyDefaults.ANTIALIAS_TYPE] = setAntiAliasType;
        ...
        public function set immediateClickMode(param1: Boolean): void
        {
            ...
            if (param1 != this._immediateClickMode)
            {
                this._immediateClickMode = param1;
        ...
        override public function clone(): IWindow
        {
            ...
            _loc1_._scrollH = this._scrollH;
            _loc1_._scrollV = this._scrollV;
            _loc1_._margins = this._margins.clone(_loc1_.setTextMargins);
        ...
        protected function refreshTextImage(param1: Boolean = false): void
        {
            ...
            this.var_2052 = true;
            var _loc2_: int = this._margins.left + this._margins.right;
            var _loc3_: int = this._margins.top + this._margins.bottom;
            var _loc4_: int = _current.width - _loc2_;
            var _loc5_: int = _current.height - _loc3_;
            ...
            if (_loc6_ != _loc4_)
            {
                ...
                {
                    setRectangle(_current.x, _current.y, _loc6_ + _loc2_, Math.floor(this._field.height) + _loc3_);
                    _loc7_ = true;
                }
                else
                {
        ...
        {
            if (param1 != this._margins)
            {
                this._margins.dispose();
                this._margins = new TextMargins(param1.left, param1.top, param1.right, param1.bottom, this.setTextMargins);
            }
        ...
        override public function get properties(): Array
        {
            ...
            _loc1_.push(new PropertyStruct("always_show_selection", this._field.alwaysShowSelection, PropertyStruct.var_611, this._field.alwaysShowSelection));
            _loc1_.push((_loc2_.antiAliasType != null
                    ? this._field.antiAliasType != _loc2_.antiAliasType
                    : this._field.antiAliasType != PropertyDefaults.ANTIALIAS_TYPE_VALUE)
                                ? new PropertyStruct(PropertyDefaults.ANTIALIAS_TYPE, this._field.antiAliasType, PropertyStruct.var_613, this._field.antiAliasType != AntiAliasType.NORMAL, PropertyDefaults.var_1131)
                                : PropertyDefaults.var_1132);
            _loc1_.push(this._autoSize != PropertyDefaults.var_1133
                                ? new PropertyStruct(PropertyDefaults.var_1121, this._autoSize, PropertyStruct.var_613, true, PropertyDefaults.var_1134)
                                : PropertyDefaults.var_1135);
            _loc1_.push(new PropertyStruct("border", this._field.border, PropertyStruct.var_611, this._field.border));
            _loc1_.push(new PropertyStruct("border_color", this._field.borderColor, PropertyStruct.var_606, this._field.borderColor != 0));
            _loc1_.push(new PropertyStruct("condense_white", this._field.condenseWhite, PropertyStruct.var_611, this._field.condenseWhite));
            ...
            _loc1_.push(this._field.gridFitType != PropertyDefaults.var_1136
                                ? new PropertyStruct(PropertyDefaults.var_1137, this._field.gridFitType, PropertyStruct.var_613, true, PropertyDefaults.var_1138)
                                : PropertyDefaults.var_1139);
            _loc1_.push((_loc2_.color != null
                    ? this._field.textColor != _loc2_.color
                    : this._field.textColor != PropertyDefaults.var_1140)
                                ? new PropertyStruct(PropertyDefaults.var_1123, this._field.textColor, PropertyStruct.var_606, true)
                                : PropertyDefaults.var_1141);
            _loc1_.push(this.var_2049 != TextStyleManager.var_1118
                                ? new PropertyStruct(PropertyDefaults.var_1124, this.var_2049, PropertyStruct.var_613, true, PropertyDefaults.var_1142)
                                : PropertyDefaults.var_1143);
            _loc1_.push(this._margins.left != PropertyDefaults.var_1144
                                ? new PropertyStruct(PropertyDefaults.var_1125, this._margins.left, PropertyStruct.var_607, true)
                                : PropertyDefaults.var_1145);
            _loc1_.push(this._margins.top != PropertyDefaults.var_1146
                                ? new PropertyStruct(PropertyDefaults.var_1126, this._margins.top, PropertyStruct.var_607, true)
                                : PropertyDefaults.var_1147);
            _loc1_.push(this._margins.right != PropertyDefaults.var_1148
                                ? new PropertyStruct(PropertyDefaults.var_1127, this._margins.right, PropertyStruct.var_607, true)
                                : PropertyDefaults.var_1149);
            _loc1_.push(this._margins.bottom != PropertyDefaults.var_1150
                                ? new PropertyStruct(PropertyDefaults.var_1128, this._margins.bottom, PropertyStruct.var_607, true)
                                : PropertyDefaults.var_1151);
            _loc1_.push(this._field.mouseWheelEnabled != PropertyDefaults.var_1152
                                ? new PropertyStruct(PropertyDefaults.var_1122, this._field.mouseWheelEnabled, PropertyStruct.var_611, true)
                                : PropertyDefaults.var_1153);
            _loc1_.push(new PropertyStruct("max_chars", this._field.maxChars, PropertyStruct.var_607, this._field.maxChars != 0));
            _loc1_.push(new PropertyStruct("multiline", this._field.multiline, PropertyStruct.var_611, this._field.multiline));
            ...
            _loc1_.push(new PropertyStruct("word_wrap", this._field.wordWrap, PropertyStruct.var_611, this._field.wordWrap));
            _loc1_.push(new PropertyStruct("bold", !!this._field.defaultTextFormat.bold, PropertyStruct.var_611, !!this._field.defaultTextFormat.bold && _loc2_.fontWeight != FontStyle.BOLD));
            _loc1_.push(new PropertyStruct("italic", !!this._field.defaultTextFormat.italic, PropertyStruct.var_611, !!this._field.defaultTextFormat.italic && _loc2_.fontStyle != FontStyle.ITALIC));
            _loc1_.push(new PropertyStruct("underline", !!this._field.defaultTextFormat.underline, PropertyStruct.var_611, !!this._field.defaultTextFormat.underline && _loc2_.textDecoration != "underline"));
            _loc1_.push(new PropertyStruct("kerning", !!this._field.defaultTextFormat.kerning, PropertyStruct.var_611, !!this._field.defaultTextFormat.kerning && !_loc2_.kerning));
