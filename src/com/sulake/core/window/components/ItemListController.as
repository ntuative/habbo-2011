package com.sulake.core.window.components
{
    ...
    public class ItemListController extends WindowController implements IItemListWindow, IInputProcessorRoot 
    {
        ...
        protected var var_2016:Boolean = PropertyDefaults.var_1733;
        protected var var_2010:Boolean = PropertyDefaults.var_1734;
        protected var var_2011:Boolean = PropertyDefaults.var_1735;
        protected var var_2012:Number = 0;
        protected var var_2013:Number = 0;
        ...
        public function ItemListController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function=null, param9:Array=null, param10:Array=null, param11:uint=0)
        {
            ...
            var_1986 = ((var_1015) || (!(testParamFlag(WindowParam.var_693))));
            this._container = (_context.create("_CONTAINER", "", WindowType.var_868, WindowStyle.var_1114, ((WindowParam.var_693 | WindowParam.var_699) | WindowParam.var_694), new Rectangle(0, 0, width, height), null, this, 0, null, [TAG_INTERNAL, TAG_EXCLUDE]) as IWindowContainer);
            ...
            this.resizeOnItemUpdate = this.var_2011;
        }
        ...
        {
            return (new Rectangle((this.var_2012 * this.maxScrollH), (this.var_2013 * this.maxScrollV), width, height));
        }
        ...
        public function set scrollH(param1:Number):void
        {
            ...
            if (param1 != this.var_2012)
            {
                this.var_2012 = param1;
                this._container.x = (-(this.var_2012) * this.maxScrollH);
        ...
        public function set scrollV(param1:Number):void
        {
            ...
            if (param1 != this.var_2013)
            {
                ...
                this._container.y = (-(this.var_2013) * this.maxScrollV);
                _context.invalidate(this._container, this.visibleRegion, WindowRedrawFlag.var_1020);
                _loc2_ = WindowEvent.allocate(WindowEvent.var_591, this, null);
                _events.dispatchEvent(_loc2_);
                _loc2_.recycle();
            ...
            switch (param2.type)
            {
                ...
                case WindowEvent.var_573:
                    if (!this.var_2010)
                    {
                        if (this._horizontal)
                        {
                            this._container.height = var_1018.height;
                        }
                        else
                        {
                            this._container.width = var_1018.width;
                        };
                    };
                    this.updateScrollAreaRegion();
                    this.var_2017 = false;
            ...
            switch (param1.type)
            {
                ...
                case WindowMouseEvent.var_634:
                    if (this.var_2023)
                    {
                        if (this._horizontal)
                        {
                            _context.getWindowServices().getGestureAgentService().begin(this, this.scrollAnimationCallback, 0, -(this.var_2021), 0);
                        }
                        else
                        {
                            _context.getWindowServices().getGestureAgentService().begin(this, this.scrollAnimationCallback, 0, 0, -(this.var_2022));
                        };
                        this.var_2023 = false;
                        _loc2_ = true;
                    };
        ...
        protected function updateScrollAreaRegion():void
        {
            ...
            var _loc3_:int;
            var _loc4_:uint;
            if ((((this.var_2016) && (!(this.var_2018))) && (this._container)))
            {
                this.var_2018 = true;
                ...
                if (this.var_2012 > 0)
                {
                    if (this.var_2014 <= var_1018.width)
                    {
                        this.scrollH = 0;
                    }
                    else
                ...
                if (this.var_2013 > 0)
                {
                    if (this.var_2015 <= var_1018.height)
                    {
                        this.scrollV = 0;
                    }
                    else
        ...
        override public function get properties():Array
        {
            ...
            if (this.var_2016 != PropertyDefaults.var_1733)
            {
                _loc1_.push(new PropertyStruct(PropertyDefaults.var_1738, this.var_2016, PropertyStruct.var_611, true));
            }
            else
            {
                _loc1_.push(PropertyDefaults.var_1739);
            };
            if (this.var_2010 != PropertyDefaults.var_1734)
            {
                _loc1_.push(new PropertyStruct(PropertyDefaults.var_1740, this.var_2010, PropertyStruct.var_611, true));
            }
            else
            {
                _loc1_.push(PropertyDefaults.var_1741);
            };
            if (this.var_2011 != PropertyDefaults.var_1735)
            {
                _loc1_.push(new PropertyStruct(PropertyDefaults.var_1742, this.var_2011, PropertyStruct.var_611, true));
            }
            else
            {
            ...
            for each (_loc2_ in param1)
            {
                switch (_loc2_.key)
                {
                    ...
                    case PropertyDefaults.var_1738:
                        this.var_2016 = (_loc2_.value as Boolean);
                        break;
