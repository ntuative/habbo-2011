package com.sulake.core.window.components
{
    ...
    public class DropMenuController extends InteractiveController implements IDropMenuWindow, ITouchAwareWindow 
    {
        ...
        private var var_1989:Array = new Array();
        ...
        {
            if (param1 > (this.var_1989.lenght - 1))
            {
        ...
        private function getSubMenu():DropMenuController
        {
            ...
            if (((this.var_1991 == null) || (this.var_1991.disposed)))
            {
                this.var_1991 = (context.create((name + "::submenu"), "", WindowType.var_871, var_1025, (WindowParam.var_706 | WindowParam.var_694), _loc1_, this.subMenuEventProc, null, 0, null, [WindowController.TAG_EXCLUDE]) as DropMenuController);
            }
            else
            {
        ...
        protected function closeMenuView():void
        {
            if (this.close())
            {
                ...
                this.var_1990 = false;
                this.getTitleLabel().text = (((this.var_1988 < this.var_1989.length) && (this.var_1988 > -1)) ? this.var_1989[this.var_1988] : caption);
            };
        }
        ...
        protected function populateMenuItemContainer(param1:Array, param2:DropMenuController, param3:Function):void
        {
            ...
            while (_loc9_ < _loc5_)
            {
                _loc6_ = (context.create(((name + "::menu_item_") + _loc9_), param1[_loc9_], WindowType.var_872, var_1025, ((((WindowParam.var_663 | WindowParam.var_667) | WindowParam.var_693) | WindowParam.var_593) | WindowParam.var_694), null, param3, null, _loc9_, null, ["_EXCLUDE"]) as DropMenuItemController);
            ...
            var _loc10_:IWindow = context.create((name + "::padding"), "", WindowType.var_868, var_1025, (((WindowParam.var_663 | WindowParam.var_667) | WindowParam.var_693) | WindowParam.var_694), new Rectangle(0, 0, 1, 2), null, null, 0, null, ["_EXCLUDE"]);
            _loc4_.addListItem(_loc10_);
            _loc4_.autoArrangeItems = true;
            this.fitToDesktop(param2);
            param2.activate();
            if (((this.var_1988 > -1) && (_loc5_)))
            {
                _loc4_.getListItemAt(this.var_1988).setStateFlag(WindowState.var_1112, true);
            };
        }
