package com.sulake.core.window.components
{
    ...
    public class InteractiveController extends WindowController implements IInteractiveWindow
    {
        ...
        protected var _toolTipDelay: uint = PropertyDefaults.var_1715;
        protected var _toolTipCaption: String = PropertyDefaults.var_1716;
        ...
        {
            this._toolTipCaption = caption == null ? PropertyDefaults.var_1716 : caption;
        }
        ...
        override public function set properties(props: Array): void
        {
            readInteractiveWindowProperties(this, props);
