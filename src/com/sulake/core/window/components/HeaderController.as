package com.sulake.core.window.components
{
    ...
    public class HeaderController extends ContainerController implements IHeaderWindow
    {
        ...
        private static const var_2001: String = "_CONTROLS";
        ...
        {
            return findChildByTag(var_1992) as ILabelWindow;
        }

        public function get controls(): IItemListWindow
        {
            return findChildByTag(var_2001) as IItemListWindow;
        }
        ...
        override public function set color(param1: uint): void
        {
            ...
            super.color = param1;
            var _loc2_: Array = [];
            groupChildrenWithTag(var_1999, _loc2_, true);
