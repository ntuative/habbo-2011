package com.sulake.core.window.components
{
    ...
    public class TabButtonController extends SelectableController implements ITabButtonWindow 
    {
        ...
        private static const var_2040:String = "TAB_BUTTON_CONTENT";
        private static const var_2041:String = "TAB_BUTTON_TITLE";
        private static const var_2042:String = "TAB_BUTTON_ICON";
        ...
        override public function set caption(param1:String):void
        {
            ...
            var _loc2_:IWindow = findChildByTag(var_2041);
            if (_loc2_ != null)
            {
        ...
        {
            if (param2.type == WindowEvent.var_583)
            {
