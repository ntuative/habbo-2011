    ...
    public class FrameController extends ContainerController implements IFrameWindow
    {
        ...
        override public function get properties(): Array
        {
            ...
            if (_loc2_)
            {
                ...
                _loc1_.push(new PropertyStruct(PropertyDefaults.var_1127, _current.width - _loc3_.right, PropertyStruct.var_607, _loc2_));
                _loc1_.push(new PropertyStruct(PropertyDefaults.var_1128, _current.height - _loc3_.bottom, PropertyStruct.var_607, _loc2_));
            }
            else
            {
            ...
            for each (_loc2_ in param1)
            {
                switch (_loc2_.key)
                {
                    ...
                    case PropertyDefaults.var_1127:
                        this.margins.right = _current.width - (_loc2_.value as int);
                        break;
                    case PropertyDefaults.var_1128:
                        this.margins.bottom = _current.height - (_loc2_.value as int);
                        break;
                }
