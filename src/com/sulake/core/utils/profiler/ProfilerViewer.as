package com.sulake.core.utils.profiler
{
    ...
    public class ProfilerViewer extends TextField implements IDisposable 
    {
        ...
        private var var_2182:IProfiler;
        ...
        public function ProfilerViewer(param1:IProfiler)
        {
            ...
            if (param1)
            {
                ...
                this.var_2182.addStopEventListener(this.refresh);
            };
        }
        ...
        public function dispose():void
        {
            if (!this._disposed)
            {
                ...
                if (this.var_2182)
                {
                    this.var_2182.removeStopEventListener(this.refresh);
                    this.var_2182 = null;
                };
                this._disposed = true;
            };
        ...
        public function refresh():void
        {
            ...
            var _loc1_:Array = this.var_2182.getProfilerAgentsInArray();
