package com.sulake.core.utils
{
    ...
    public class FontEnum
    {
        ...
        private static const var_1066: Map = new Map();
        private static const var_1067: Map = new Map();
        private static var var_1068: Boolean = false;
        ...
        {
            return var_1066.getValue(param1) != null;
        }

        public static function isEmbeddedFont(param1: String): Boolean
        {
            return var_1067.getValue(param1) != null;
        }
        ...
        public static function registerFont(param1: Class): Font
        {
            ...
            var_1067.add(_loc4_.fontName, _loc4_);
            return _loc4_;
        }
        ...
        private static function init(): void
        {
            ...
            if (!var_1068)
            {
                ...
                for each (_loc3_ in _loc1_)
                {
                    ...
                    {
                        var_1066.add(_loc3_.fontName, _loc3_);
                    }
        ...
        public static function refresh(): void
        {
            ...
            while (_loc5_ < _loc4_)
            {
                ...
                _loc3_ = var_1067.getValue(_loc2_.fontName);
                if (!_loc3_ || _loc3_.fontType != _loc2_.fontType || _loc3_.fontStyle != _loc2_.fontStyle)
                {
                    var_1067.add(_loc2_.fontName, _loc2_);
                }
