package com.sulake.core.assets.loaders
{
    ...
    public class SoundFileLoader extends AssetLoaderEventBroker implements IAssetLoader 
    {
        ...
        protected var var_2103:Sound;

        public function SoundFileLoader(param1:String, param2:URLRequest=null)
        {
            this.var_2104 = ((param2 == null) ? "" : param2.url);
            this._type = param1;
            this.var_2103 = new Sound(null, null);
            this.var_2103.addEventListener(Event.ID3, loadEventHandler);
            this.var_2103.addEventListener(Event.OPEN, loadEventHandler);
        ...
        override public function dispose():void
        {
            if (!disposed)
            {
                this.var_2103.removeEventListener(Event.ID3, loadEventHandler);
                this.var_2103.removeEventListener(Event.OPEN, loadEventHandler);
        ...
        public function load(param1:URLRequest):void
        {
            ...
            this.var_2103.load(param1, null);
        }
