package com.hurlant.crypto.prng
{
    ...
    public class Random 
    {
        ...
        private var var_2092:ByteArray;
        ...
        public function Random(param1:Class=null)
        {
            ...
            this.var_2092 = new ByteArray();
            this.var_2093 = 0;
            while (this.var_2093 < this.psize)
            {
                _loc2_ = uint((0x10000 * Math.random()));
                var _loc3_:* = this.var_2093++;
                this.var_2092[_loc3_] = (_loc2_ >>> 8);
                var _loc4_:* = this.var_2093++;
                this.var_2092[_loc4_] = (_loc2_ & 0xFF);
            };
            this.var_2093 = 0;
            this.seed();
        }
        ...
        public function seed(param1:int=0):void
        {
            ...
            var _loc2_:* = this.var_2093++;
            this.var_2092[_loc2_] = (this.var_2092[_loc2_] ^ (param1 & 0xFF));
            var _loc3_:* = this.var_2093++;
            this.var_2092[_loc3_] = (this.var_2092[_loc3_] ^ ((param1 >> 8) & 0xFF));
            var _loc4_:* = this.var_2093++;
            this.var_2092[_loc4_] = (this.var_2092[_loc4_] ^ ((param1 >> 16) & 0xFF));
            var _loc5_:* = this.var_2093++;
            this.var_2092[_loc5_] = (this.var_2092[_loc5_] ^ ((param1 >> 24) & 0xFF));
            this.var_2093 = (this.var_2093 % this.psize);
            this.var_2094 = true;
        }
        ...
        public function nextByte():int
        {
            if (!this.ready)
            {
                ...
                this.state.init(this.var_2092);
                this.var_2092.length = 0;
                this.var_2093 = 0;
                this.ready = true;
            };
        ...
        {
            var _loc1_:uint;
            while (_loc1_ < this.var_2092.length)
            {
                this.var_2092[_loc1_] = (Math.random() * 0x0100);
                _loc1_++;
            };
            this.var_2092.length = 0;
            this.var_2092 = null;
