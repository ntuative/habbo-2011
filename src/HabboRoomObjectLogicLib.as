package 
{
    ...
    public class HabboRoomObjectLogicLib extends SimpleApplication 
    {
        ...
        public static var RoomObjectFactory:Class = com.sulake.habbo.room.RoomObjectFactory;
        public static var IIDRoomObjectFactory:Class = com.sulake.iid.IIDRoomObjectFactory;
